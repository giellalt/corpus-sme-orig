...
<xsl:variable name="filename" select="'http://www.metsa.fi/sivustot/metsa/se/Vanddardeapmijameahcceturisma/Meahccebearraigeahccu/Sivut/Meahccebearraigeahčču.aspx'"/>
