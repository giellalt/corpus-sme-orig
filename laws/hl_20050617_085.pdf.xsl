...
<!-- Add the metainformation manually -->
  ...
  <xsl:variable name="title" select="'L&#xE1;hka geassem&#xE1;nu 17. 2005 nr. 85 riektediliid ja eatnamiid ja luondduvalljodagaid h&#xE1;lddaheami birra Finnm&#xE1;rkku fylkkas (finnm&#xE1;rkkul&#xE1;hka) '"/>
...
<xsl:variable name="main_sizes" select="'10pt'"/>
<xsl:variable name="title_sizes" select="'10pt'"/>
