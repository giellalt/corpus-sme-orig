...
<xsl:variable name="title" select="'LÁHKA 1999-07-02 nr 63: Láhka divššohasvuoigatvuođaid birra (divššohasvuoigatvuođaláhka)'"/>
...
<xsl:variable name="wordcount" select="'3222'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pasientrettighetsloven_hl-19990702-063.html" xml:lang="nob"/>
</xsl:variable>
