...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dok/lagat-ja-njuolggadusat-/lover/lahka-njuoskaguliid-gavppaeami-birra.html?id=516850'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="raafiskloven_nob_hl-19511214-003.html"/>
