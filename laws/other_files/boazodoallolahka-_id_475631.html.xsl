...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dok/lagat-ja-njuolggadusat-/lover/boazodoallolahka-.html?id=475631'"/>
<<<<<<< HEAD
...
<xsl:variable name="para_nob" select="'hl-20070615-040.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reindriftsloven_hl-20070615-040.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> f21e8bd7e1 (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
