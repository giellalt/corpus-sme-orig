...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.regjeringen.no/contentassets/968800378e9d47e794f7c252904f98b0/forskrift_rammeplan_samisk_barnehagelaererutdanning_samisk_versjon.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Našunála láhkaásahus Sámi rámmaplánii mánáidgárdeoahpaheaddjioahpu bachelora várás.'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="forskrift_rammeplan_samisk_barnehagelaererutdanning.pdf"/>
