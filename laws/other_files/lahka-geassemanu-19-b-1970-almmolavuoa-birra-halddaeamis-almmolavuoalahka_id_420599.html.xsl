...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/dok/lover_regler/reglement/2004/Lahka-geassemanu-19-b-1970-almmolavuoa-birra-halddaeamis-almmolavuoalahka.html?id=420599'"/>
<xsl:variable name="title" select="'Láhka geassemánu 19. b. 1970 almmolašvuođa birra hálddašeamis (almmolašvuođaláhka). - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1570'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="offentleglova_nno.doc" xml:lang="nno"/>
</xsl:variable>
