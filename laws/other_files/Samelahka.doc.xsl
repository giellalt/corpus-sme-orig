...
<!-- Add the metainformation manually -->
  ...
  <xsl:variable name="title" select="'S&#xE1;mel&#xE1;hka'"/>
  ...
  <xsl:variable name="translator_fn" select="'Inger Marie'"/>
  <xsl:variable name="translator_ln" select="'Gaup Eira'"/>
  ...
  <xsl:variable name="wordcount" select="'2193'"/>
