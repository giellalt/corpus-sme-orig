...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.regjeringen.no/contentassets/5d22847e34e144b49a406a7ba5603256/se-no/pdfs/prp201720180042000se_pdfs.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Rievdadusat kulturmuitolágas (sámi kulturmuittuid ráfáiduhttinrádji)'"/>
    <!--
