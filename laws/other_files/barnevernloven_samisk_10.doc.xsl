...
<xsl:variable name="title" select="'LÁHKA MÁNÁIDSUODJALUSBÁLVALUSAID BIRRA (MÁNÁIDSUODJALUSLÁHKA)'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barnevernsloven_nb_hl-19920717-100.html" xml:lang="nob"/>
</xsl:variable>
