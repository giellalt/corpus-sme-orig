...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Láhka divššohasvuoigatvuođaid birra (divššohasvuoigatvuođaláhka)'"/>
    <!--
    ...
    <!-- Publication year -->
    <xsl:variable name="year" select="'05.10.2004'"/>
    ...
    <xsl:variable name="wordcount" select="'3316'"/>
    ...
    <xsl:variable name="bottom_margin" select="'7=35'"/>
    ...
    -->
    <xsl:variable name="main_sizes" select="'8pt'"/>
