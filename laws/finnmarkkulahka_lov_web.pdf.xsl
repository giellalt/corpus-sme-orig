...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/JD/Vedlegg/finnmarkkulahka_lov_web.pdf'"/>
...
<xsl:variable name="para_nob" select="'finnmarksloven_lov_web.pdf'"/>
