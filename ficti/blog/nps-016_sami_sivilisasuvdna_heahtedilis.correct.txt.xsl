...
<xsl:variable name="filename" select="'http://johanailo.blogspot.com/2009/04/sami-sivilisasuvdna-lea.html'"/>
...
<xsl:variable name="note" select="'Innamlingsdato: 28.07.2010'"/>
