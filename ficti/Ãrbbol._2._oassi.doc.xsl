...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Árbbol._2._oassi.doc'"/>
  <xsl:variable name="title" select="'Árbbolaččat 2'"/>
  <xsl:variable name="author1_fn" select="'Jovnna-Ánde'"/>
  <xsl:variable name="author1_ln" select="'Vest'"/>
  ...
  <xsl:variable name="ISBN" select="'82-7374-477-9	'"/>
