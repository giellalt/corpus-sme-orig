...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'SIPIRJÁ.doc'"/>
  <xsl:variable name="title" select="'Sipirjá'"/>
  <xsl:variable name="author1_fn" select="'Timo K.'"/>
  <xsl:variable name="author1_ln" select="'Mukka'"/>
  <xsl:variable name="author1_gender" select="'m'"/>
  <xsl:variable name="author1_born" select="'1944'"/>
  ...
  <xsl:variable name="translator_fn" select="'Jovnna-Ánde'"/>
  <xsl:variable name="translator_ln" select="'Vest'"/>
  ...
  <xsl:variable name="note" select="'Sent by e-mail 11.5.2007 to borre.gaup@samediggi.no'"/>
