...
<xsl:variable name="para_eng" select="'karasjok_kulturskole_yksi_meista_one_of_us_24.11.2009_eng.doc'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="'karasjok_kulturskole_yksi_meista_one_of_us_24.11.2009.doc'"/>
