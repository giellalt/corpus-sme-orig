...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="nsr_valgmagasin_trykkfil_2017_sme.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-3, 5-9, 11-12, 14-25, 27, 29-35, 37, 39-40'"/>
    ...
    <xsl:variable name="bottom_margin" select="'13=50, 17=45'"/>
