...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://nsr.no/4633/birasdirektorahta-balkesta-birasberostumiid-merrii?lang=se#more-4633'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="miljodirektoratet-kaster-miljoet-pa-havet_more-4628.html"/>
