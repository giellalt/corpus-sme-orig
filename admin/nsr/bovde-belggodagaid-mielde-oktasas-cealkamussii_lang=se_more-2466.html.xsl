...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://nsr.no/2466/bovde-belggodagaid-mielde-oktasas-cealkamussii?lang=se#more-2466'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="inviterer-partiene-med-pa-felles-mineraluttalelse_more-2463.html"/>
