...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://nsr.no/5430/nsr-presideantaevttohas-davviriikkalas-samekonvensuvnna-birra-allot-vajaldahte-aigumusa?lang=se#more-5430'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="nsrs-presidentkandidat-om-nordisk-samekonvensjon-ikke-mist-malet-av-syne.html"/>
