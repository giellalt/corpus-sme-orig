...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://julkaisut.metsa.fi/assets/pdf/lp/Csarja/c149.pdf'"/>
    ...
    <xsl:variable name="ISBN" select="'978-952-295-186-1'"/>
    ...
    <xsl:variable name="translator_fn" select="'Jouni'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="c145.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1, 18, 23, 26, 27, 33, 37, 46, 51, 85, 90, 123'"/>
