...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://julkaisut.metsa.fi/assets/pdf/mt/mt71.pdf'"/>
    ...
    <xsl:variable name="ISBN" select="'978-952-295-140-3'"/>
    ...
    <xsl:variable name="translator_fn" select="'Seija'"/>
    <xsl:variable name="translator_ln" select="'Somby'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="mt68.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-3, 5-8, 35, 37, 38, 46, 91, 115-119, 146-154, 230-234'"/>
