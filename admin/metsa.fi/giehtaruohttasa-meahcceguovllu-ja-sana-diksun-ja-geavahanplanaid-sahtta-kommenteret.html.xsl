...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.metsa.fi/web/se/-/giehtaruohttasa-meahcceguovllu-ja-sana-diksun-ja-geavahanplanaid-sahtta-kommenteret'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kasivarren-eramaa-alueen-ja-saanan-hoito-ja-kayttosuunnitelmia-voi-kommentoida_inheritredirect=false.html"/>
