...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://sh.pedit.no/web/NettskoleRessurs.axd?id=bbda4124-1170-4fe3-acab-d53385483b39'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oahppoprográmmaplána. Sámi vuođđoskuvlaoahpaheaddjeoahppu 5.-10. dássi'"/>
    <!--
    ...
    <xsl:variable name="note" select="'Source http://sh.pedit.no/web/PageND.aspx?id=229798'"/>
    ...
    <xsl:variable name="top_margin" select="'10=40'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'9=17'"/>
    <xsl:variable name="inner_bottom_margin" select="'9=35'"/>
