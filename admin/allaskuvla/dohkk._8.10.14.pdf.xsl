...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://sh.pedit.no/web/NettskoleRessurs.axd?id=e8ef14df-a3e9-43a7-a2f4-17b431063a2a'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oahppoprográmmaplána. Sámi vuođđoskuvlaoahpaheaddjioahppu 1.-7. dássi. Joavku VUO2014-2018'"/>
    <!--
    ...
    <xsl:variable name="note" select="'Source http://sh.pedit.no/web/PageND.aspx?id=229832'"/>
    ...
    <xsl:variable name="top_margin" select="'8=45, 9=15'"/>
    <xsl:variable name="bottom_margin" select="'all=10, 8=25'"/>
    ...
    <xsl:template match="p[parent::body][not(./em | ./span)][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                ...
                <xsl:with-param name="target" select="'Prográ mma/Prográ mmá/'"/>
                <xsl:with-param name="replacement" select="'Prográmma/Prográmma/'"/>
