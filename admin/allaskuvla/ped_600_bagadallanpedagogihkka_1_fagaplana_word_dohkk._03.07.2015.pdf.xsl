...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://sh.pedit.no/web/NettskoleRessurs.axd?id=d389fbe2-7393-4d7e-86ed-e8d82b11ce88'"/>
    ...
    <xsl:variable name="note" select="'Source http://sh.pedit.no/web/PageND.aspx?id=241978'"/>
