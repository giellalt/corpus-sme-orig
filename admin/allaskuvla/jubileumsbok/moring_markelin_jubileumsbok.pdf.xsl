...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sámi allaskuvla – strategiija sámegiela máŋggabealálašvuhtii alit oahpahusas eurohpalaš geahččanvugiin'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Tom'"/>
    <xsl:variable name="author1_ln" select="'Moring'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Lia'"/>
    <xsl:variable name="author2_ln" select="'Markelin'"/>
    ...
    <language xml:lang="eng"/><language xml:lang="nno"/><language xml:lang="swe"/><language xml:lang="nob"/></xsl:variable>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-95, 104-153'"/>
    ...
    <!--
        ...
        1;3;8=20, 4;5;7=10
    -->
    <xsl:variable name="right_margin" select="'all=10'"/>
    <xsl:variable name="left_margin" select="''"/>
    <xsl:variable name="top_margin" select="''"/>
    <xsl:variable name="bottom_margin" select="'103=85'"/>
