...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sámi oahpaheaddjioahppu ja vuođđoskuvla nuppástuhttináiggis 1980-logu gaskamuttus – soames pedagogalaš ovddidanhástalusat'"/>
    <!--
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-71, 78-153'"/>
    ...
    <xsl:variable name="bottom_margin" select="'69=60'"/>
