...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'«– Áigon šaddat oahpaheaddjin ja šadden...» Sámi allaskuvlla ávvuoahpaheaddji skuvlamuittut ja muhtun jurdagat sámi oahppoáššiid birra'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Kristine'"/>
    <xsl:variable name="author1_ln" select="'Nystad'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-33, 38-153'"/>
