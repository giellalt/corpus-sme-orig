...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samas.no/se/studier/sam-lullisamegiella-praktihkalas-dilis-algooahppu-1-plassjeroros'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sam-sorsamisk-i-praktiske-situasjoner-innforingsstudium-1-del-plassjeroros.html"/>
