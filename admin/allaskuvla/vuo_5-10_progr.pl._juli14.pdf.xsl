...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://sh.pedit.no/web/NettskoleRessurs.axd?id=f7d6a284-b4ae-47ae-9715-1f6462d18d3e'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oahppoprográmma. Sámi vuođđoskuvlaoahpaheaddjeoahppu 5.-10. dássi'"/>
    <!--
    ...
    <xsl:variable name="note" select="'Source http://sh.pedit.no/web/PageND.aspx?id=165043'"/>
    ...
    <xsl:variable name="top_margin" select="'9=25'"/>
    <xsl:variable name="bottom_margin" select="'8=23'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'8=20'"/>
    <xsl:variable name="inner_bottom_margin" select="'8=35'"/>
