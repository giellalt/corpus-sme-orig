...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://helsenorge.no/pobo-seksjon/Documents/Jahkedieđáhus%202016%20Buhcciid-%20ja%20geavaheddjiidáittardeaddjit%20Norggas.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Jahkedieđáhus 2016 Buhcciid- ja geavaheddjiidaittardeaddjit Norggas'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="jahkediedahus_2016_buhcciid_ja_geavaheddjiidaittardeaddjit_norggas.pdf"/>
