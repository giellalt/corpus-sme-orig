...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'7-9, 58-60'"/>
    ...
    <xsl:variable name="top_margin" select="'16=23, 17=31, 19=37, 20=24, 21=28, 23=28'"/>
    <xsl:variable name="bottom_margin" select="'17=35, 18=63, 23=48, all=12'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'16=33, 17=40, 20=40, 22=25, 25=30'"/>
    <xsl:variable name="inner_bottom_margin" select="'16=48, 17=51, 20=44, 22=56, 25=53'"/>
