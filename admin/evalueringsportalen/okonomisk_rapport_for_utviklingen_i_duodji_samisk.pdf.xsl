...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="author1_fn" select="'Asplan Viak'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="okonomisk_rapport_for_utviklingen_i_duodji.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'6=35'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'7=69, 9=25, 10=47, 11=25, 12=22'"/>
    <xsl:variable name="inner_bottom_margin" select="'7=19, 9=50, 10=33, 11=60, 12=43'"/>
