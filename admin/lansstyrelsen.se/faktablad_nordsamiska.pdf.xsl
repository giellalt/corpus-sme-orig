...
<xsl:variable name="filename" select="'http://www.lansstyrelsen.se/dalarna/SiteCollectionDocuments/Sv/manniska-och-samhalle/nationella-minoriteter/Faktablad%20nordsamiska.pdf'"/>
