...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.saamicouncil.net/fileadmin/user_upload/Documents/Beavdegirjjit_ja_ear%C3%A1_mearr%C3%A1dusat/Beavdegirji_Johkamohkki_2015.pdf'"/>
