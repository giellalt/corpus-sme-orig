...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.kautokeino.kommune.no/Finnmark/Kautokeino/kautokeinok2.nsf/Attachments/B754982F6510C4B2412577280043DF82/$FILE/Suohkastivračoahkkin+081009.pdf'"/>
    ...
    <xsl:variable name="publisher" select="'Guovdageainnu suohkan'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="kommunestyret081009.pdf"/>
