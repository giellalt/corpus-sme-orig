...
<xsl:variable name="author1_ln" select="'Hetta'"/>
...
<xsl:variable name="wordcount" select="'9437'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="1.doc" xml:lang="nob"/>
</xsl:variable>
...
<xsl:element name="p">
			...
			<xsl:value-of select="translate($text,'±','ž') "/>
</xsl:element>
</xsl:template>
