...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.fefo.no/no/presse/Documents/2016%20Historien%20om%20finnmarkseiendommens%20ti%20første%20år,%20bakgrunn%20og%20muligheter%202006–2016%20%20Samisk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Finnmárkkuopmodaga vuosttaš logi jagi historjá, duogáš ja vejolašvuođat 2006–2016.'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="fefo_10jagi.pdf"/>
