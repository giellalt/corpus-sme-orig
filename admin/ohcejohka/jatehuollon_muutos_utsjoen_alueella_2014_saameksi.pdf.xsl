...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.utsjoki.fi/media/Tekninen/Tiedotteet/Jatehuollon%20muutos%20Utsjoen%20alueella%202014%20saameksi.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="jatehuollon_muutos_utsjoen_alueella_2014.pdf"/>
