...
<!-- variable filename contains the original name of the file (from submitter)-->
  ...
  <xsl:variable name="title" select="' EUROHPÃ UNIOVNNA CHARTER
VUOÄÄOVUOIGATVUOÄAID BIRRA
(2000/C 364/01)'"/>
  ...
  <xsl:variable name="publisher" select="'Nordisk samisk institutt'"/>
  <xsl:variable name="publChannel" select="''"/>
  <xsl:variable name="year" select="'2000'"/>
  <xsl:variable name="ISBN" select="''"/>
  <xsl:variable name="ISSN" select="''"/>
  <xsl:variable name="place" select="'http://www.nsi.no/Hoved/Publikasjoner/Publications_Other/20020528_EUCHRT02c 364-01.pdf'"/>
