...
<xsl:variable name="filename" select="'http://www.tromsfylke.no/Portals/0/Vedlegg/Publikasjoner/Rapporter/samiskarsrapport0000.pdf'"/>
...
<xsl:variable name="para_nob" select="'rsrapport20030001.pdf'"/>
