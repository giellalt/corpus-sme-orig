...
<xsl:variable name="filename" select="'http://www.udir.no/upload/larerplaner/Fastsatte_lareplaner_for_Kunnskapsloeftet/Samiske/Fordypning_i_samisk_nordsamisk.rtf'"/>
<xsl:variable name="title" select="'SÁMEGIELA ČIEKŊUDEAPMI - OAHPPOPLÁNA'"/>
