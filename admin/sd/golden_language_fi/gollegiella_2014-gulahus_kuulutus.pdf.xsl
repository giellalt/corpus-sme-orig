...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Davviriikkalaš sámi giellabálkkašupmi geigejuvvo čakčat 2014'"/>
    <!--
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'2-9'"/>
    ...
    <xsl:variable name="bottom_margin" select="'1=41'"/>
