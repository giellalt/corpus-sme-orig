...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/594/5240/version/1/file/Ovttasbargo%C5%A1iehtadus+S%C3%A1medikki+ja+Innova%C5%A1uvdna+Norgga+gaskka+%282009%29.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ovttasbargošiehtadus Sámedikki ja Innovašuvdna Norgga gaskka'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="samarbeidsavtale_mellom_sametinget_og_innovasjon_norge_2009_.pdf"/>
