...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Sámedikki boazodoallošiehtadus 2021 dievasčoahkkinášši sámgillii.docx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="samedikki_boazodoallosiehtadus_2021_dievascoahkkinassi_darogillii.docx"/>
