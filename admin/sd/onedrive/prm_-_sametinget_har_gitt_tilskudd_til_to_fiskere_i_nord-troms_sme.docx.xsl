...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'PRM_-_Sametinget_har_gitt_tilskudd_til_to_fiskere_i_Nord-Troms sme.docx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm_-_sametinget_har_gitt_tilskudd_til_to_fiskere_i_nord-troms.docx"/>
