...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Programutkast_detaljert_nordisk_konferanse_samisk_ika_for_publisering sme.docx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="programutkast_detaljert_nordisk_konferanse_samisk_ika_for_publisering_nob.docx"/>
