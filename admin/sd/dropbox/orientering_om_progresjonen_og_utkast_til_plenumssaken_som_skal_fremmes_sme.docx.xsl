...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'orientering om progresjonen og utkast til plenumssaken som skal fremmes sme.docx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="orientering_om_progresjonen_og_utkast_til_plenumssaken_som_skal_fremmes_nob.docx"/>
