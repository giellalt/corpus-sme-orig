...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Oppfølging av Unescos konvensjon om vern av immateriell kulturarv sme.docx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="oppfolging_av_unescos_konvensjon_om_vern_av_immateriell_kulturarv_nob.docx"/>
