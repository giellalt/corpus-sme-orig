...
<xsl:stylesheet version="1.0" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:variable name="filename" select="'stedsnavn3..doc'"/>
  <xsl:variable name="title" select="'Duorga'"/>
  <xsl:variable name="author1_fn" select="'Kajsa'"/>
  <xsl:variable name="author1_ln" select="'Rautio Helander'"/>
