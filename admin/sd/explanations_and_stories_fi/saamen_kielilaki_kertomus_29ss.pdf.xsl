...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=428&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámegiela doaimmahaga ja sámedikki ásahan giellaráđi muitalus sámi giellalága ollašuvvan jagiin 2004-2006'"/>
...
b         (or add new lines with the right ISO-639-3 language codes) and
...
<parallel_text location="saamen_kielilain_29_ss_mukainen_kertomus_saamelaiskarajille.pdf" xml:lang="fin"/>
</xsl:variable>
    ...
    <xsl:variable name="top_margin" select="'all=14,1=15'"/>
