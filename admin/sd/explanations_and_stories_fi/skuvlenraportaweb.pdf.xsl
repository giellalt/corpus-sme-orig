...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1210&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámeoahpahus ruovttuguovllu olggobealde'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="koulutusraportti_web_2_.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'8=15,10=38,12=60,13=18,14=21,16=22,17=17,18=20,20=57,22=15,23=19,24=24,25=15,27=64,29=14,31=15,32=15,34=15,36=17,41=86,42=71,43=86,44=86,45=89'"/>
