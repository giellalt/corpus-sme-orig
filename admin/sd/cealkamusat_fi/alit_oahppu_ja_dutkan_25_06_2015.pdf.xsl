...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=2692&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikki diedáhusa valmmaštallan alit oahpu ja dutkama birra'"/>
    ...
    <xsl:variable name="top_margin" select="'1=27,2=7,3=7'"/>
    <xsl:variable name="bottom_margin" select="'1=7,3=40'"/>
