...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Boazodoallu/Oaivvilda-ahte-Listhaug-ain-sahtta-njulget-boasttuvuoda'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_reindrift_mener-listhaug-enda-kan-rette-opp-skaden.html"/></xsl:variable>
