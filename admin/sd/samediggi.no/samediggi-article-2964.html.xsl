...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2964&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: NČE ja Sámediggi vuolláičálliba ovttasbargošiehtadusa  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2964.html" xml:lang="nob"/>
</xsl:variable>
