...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1313&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Duđavaš Meavkki ja Arvenjárgga čovdosiin - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1313.html" xml:lang="nob"/>
</xsl:variable>
