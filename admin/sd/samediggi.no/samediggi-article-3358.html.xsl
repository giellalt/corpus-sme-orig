...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3358&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Maŋidehket Vågsfjord joatkkaskuvlla heaittiheami - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3358.html" xml:lang="nob"/>
</xsl:variable>
