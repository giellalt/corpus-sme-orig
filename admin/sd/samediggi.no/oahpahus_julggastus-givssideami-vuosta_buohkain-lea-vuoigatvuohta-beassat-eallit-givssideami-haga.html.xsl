...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Oahpahus/Julggastus-givssideami-vuosta/Buohkain-lea-vuoigatvuohta-beassat-eallit-givssideami-haga'"/>
	...
	<parallel_text xml:lang="nob" location="opplaering_arbeidet-mot-mobbing_alle-har-rett-til-en-mobbefri-hverdag.html"/></xsl:variable>
