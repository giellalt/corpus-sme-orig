...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3476&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Gulaskuddan plánabagadanevttohusas - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3476.html" xml:lang="nob"/>
</xsl:variable>
