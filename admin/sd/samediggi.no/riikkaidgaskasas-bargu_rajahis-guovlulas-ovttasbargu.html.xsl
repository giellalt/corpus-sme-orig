...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Riikkaidgaskasas-bargu/Rajahis-guovlulas-ovttasbargu'"/>
	...
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_grenseoverskridende-regionalt-samarbeid.html"/></xsl:variable>
