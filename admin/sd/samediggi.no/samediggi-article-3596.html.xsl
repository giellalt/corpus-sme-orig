...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3596&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Buorre ovttasbargu lea deaŧalaš - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3596.html" xml:lang="nob"/>
</xsl:variable>
