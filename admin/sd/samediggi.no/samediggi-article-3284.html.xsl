...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3284&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Nuorat ja oahppu boahtteáiggi Sámis  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3284.html" xml:lang="nob"/>
</xsl:variable>
