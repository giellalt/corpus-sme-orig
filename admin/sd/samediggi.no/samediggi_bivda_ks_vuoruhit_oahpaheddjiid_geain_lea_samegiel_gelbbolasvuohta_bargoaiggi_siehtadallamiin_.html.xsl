...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/sametinget-ber-ks-prioritere-larere-med-samisk-sprakkompetanse-i-arbeidstidsforhandlinger.25313.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi bivdá KS vuoruhit oahpaheddjiid geain lea sámegiel gelbbolašvuohta bargoáiggi šiehtadallamiin  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_ber_ks_prioritere_laerere_med_samisk_sprakkompetanse_i_arbeidstidsforhandlinger.html"/>
