...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=404&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki álbmotválljen áirasiid mátkit  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-404.html" xml:lang="nob"/>
</xsl:variable>
