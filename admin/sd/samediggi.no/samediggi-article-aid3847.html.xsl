...
<xsl:variable name="filename" select="'http://www.sametinget.no/artikkel.aspx?MId1=3471&amp;AId=3847&amp;Print=1'"/>
<xsl:variable name="title" select="'Last ned læremidler gratis'"/>
