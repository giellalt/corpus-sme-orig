...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1701&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: PRM: Ilus Romsa lea válljejuvvon OG 2018 evttohassan - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1701.html" xml:lang="nob"/>
</xsl:variable>
