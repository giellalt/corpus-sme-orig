...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politikk/taler-og-innlegg/tale-ved-nim-sin-lansering-av-rapporten-en-menneskerettighetsbasert-tilnarming-til-samisk-statistikk-i-norge.7912.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sárdni go NIM almmuhii sámi statistihka raportta - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tale_ved_nim_sin_lansering_av_rapporten_en_menneskerettighetsbasert_tilnaerming_til_samisk_statistikk_i_norge_.html"/>
