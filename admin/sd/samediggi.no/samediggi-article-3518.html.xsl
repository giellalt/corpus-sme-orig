...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3518&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Áŋgiruššá boarrásiidpolitihkain - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3518.html" xml:lang="nob"/>
</xsl:variable>
