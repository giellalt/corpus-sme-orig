...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/samediggepresideantta-cealkamus-oljo-ja-energiijaministara-cilgehussii-fovsen-njaarke-assis.25155.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggepresideantta cealkámuš oljo- ja energiijaministara čilgehussii Fovsen Njaarke -áššis - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingspresidentens_uttalelse_til_olje-_og_energiministerens_redegjorelse_om_fosen-saken.html"/>
