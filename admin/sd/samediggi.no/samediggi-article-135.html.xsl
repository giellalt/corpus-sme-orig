...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=135&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Gonagasa nammačállosat  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-135.html" xml:lang="nob"/>
</xsl:variable>
