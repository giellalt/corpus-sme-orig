...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/PRD-Guolasteddjiid-ferte-gullat-bieggafapmoproseavttaid-oktavuodas-merrii'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: Guolásteddjiid ferte gullat bieggafápmoprošeavttaid oktavuođas merrii'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm-fiskerne-maa-hoeres-i-forbindelse-med-vindkraftprosjekter-til-havs.html"/>
