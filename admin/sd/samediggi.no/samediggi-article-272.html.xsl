...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=272&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Máhttolokten - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-272.html" xml:lang="nob"/>
</xsl:variable>
