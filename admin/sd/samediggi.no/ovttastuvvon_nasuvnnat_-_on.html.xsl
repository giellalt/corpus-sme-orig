...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/riikkaidgaskasas-bargu/riikkaidgaskasas-konvensuvnnat-ja-algoalbmotvuoigatvuodat/on-algoalbmotvuoigatvuodat/ovttastuvvan-nasuvnnat-on/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ovttastuvvon našuvnnat - ON - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="de_forente_nasjoner_-_fn.html"/>
