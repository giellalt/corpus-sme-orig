...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1250&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Sierra prográmma davviguovlluid eamiálbmotdutkamii  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1250.html" xml:lang="nob"/>
</xsl:variable>
