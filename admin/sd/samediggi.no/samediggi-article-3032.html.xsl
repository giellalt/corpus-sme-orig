...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3032&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggepresideantta Egil Olli sáhkavuorru ON:a Bissovaš forumi New York:as - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3032.html" xml:lang="nob"/>
</xsl:variable>
