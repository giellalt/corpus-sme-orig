...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/viiddiduvvon-diedihanaigemearri-eamialbmot-luossakonferansii.33659.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Viiddiduvvon dieđihanáigemearri eamiálbmot luossakonferánsii - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="utvidet_pameldingsfrist_til_urfolkskonferanse_om_laks.html"/>
