...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Giella/Samegielaid-halddasanguovlu/Nannet-gulahallama-gielddaiguin-ja-fylkkagielddaiguin'"/>
	...
	<parallel_text xml:lang="nob" location="spraak_forvaltningsomraade_styrker-kommunikasjonen-med-kommunene-og-fylkeskommunene.html"/></xsl:variable>
