...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=97&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámi musihkka - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-97.html" xml:lang="nob"/>
</xsl:variable>
