...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3755&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Áigu vuoruhit iešsorbmema eastadeami - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3755.html" xml:lang="nob"/>
</xsl:variable>
