...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3454&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Deanujogaraporta gulaskuddamis - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3454.html" xml:lang="nob"/>
</xsl:variable>
