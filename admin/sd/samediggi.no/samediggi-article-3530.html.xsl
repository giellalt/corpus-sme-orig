...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3530&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Bovde álbmotčoahkkimiidda - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3530.html" xml:lang="nob"/>
</xsl:variable>
