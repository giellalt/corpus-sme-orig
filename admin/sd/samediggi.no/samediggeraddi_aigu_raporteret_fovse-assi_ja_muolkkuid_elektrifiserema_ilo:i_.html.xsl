...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingsradet-vil-rapportere-fosen-saken-og-elektrifiseringa-av-melkoya-til-ilo.27572.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggeráđđi áigu raporteret Fovse-ášši ja Muolkkuid elektrifiserema ILO:i  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingsradet_vil_rapportere_fosen-saken_og_elektrifiseringa_av_melkoya_til_ilo.html"/>
