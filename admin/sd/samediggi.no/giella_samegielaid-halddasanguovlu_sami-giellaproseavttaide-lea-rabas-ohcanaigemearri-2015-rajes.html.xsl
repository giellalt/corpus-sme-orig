...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Giella/Samegielaid-halddasanguovlu/Sami-giellaproseavttaide-lea-rabas-ohcanaigemearri-2015-rajes'"/>
	...
	<parallel_text xml:lang="nob" location="spraak_forvaltningsomraade_samiske-spraakprosjekter-har-aapen-soeknadsfrist-fra-2015.html"/></xsl:variable>
