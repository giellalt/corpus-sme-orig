...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3654&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'James Anaya s&#225;rdni Roavenj&#225;rggas - S&#225;mediggi Sametinget'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-3654.html'"/>
