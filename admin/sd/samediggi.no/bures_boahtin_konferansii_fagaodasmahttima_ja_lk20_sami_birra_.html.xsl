...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/velkommen-til-konferanse-om-fagfornyelsen-og-lk20-samisk-i-alta.33403.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bures boahtin konferánsii fágaođasmahttima ja LK20 sámi birra! - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="velkommen_til_konferanse_om_fagfornyelsen_og_lk20_samisk_i_alta.html"/>
