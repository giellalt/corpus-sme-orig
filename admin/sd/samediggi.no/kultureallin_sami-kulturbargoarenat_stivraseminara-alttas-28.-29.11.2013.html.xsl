...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Kultureallin/Sami-kulturbargoarenat/Stivraseminara-Alttas-28.-29.11.2013'"/>
	...
	<parallel_text xml:lang="nob" location="kulturliv_arenaer-for-samisk-kulturutoevelse_styreseminar-i-alta-28.-29.11.html"/></xsl:variable>
