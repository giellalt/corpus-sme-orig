...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3491&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Nuvttá mielkeearit nuoraide - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3491.html" xml:lang="nob"/>
</xsl:variable>
