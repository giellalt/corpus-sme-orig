...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3648&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki presideanta searvá ON álgoálbmotforumii - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3648.html" xml:lang="nob"/>
</xsl:variable>
