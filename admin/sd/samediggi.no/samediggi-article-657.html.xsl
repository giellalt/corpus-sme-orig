...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=657&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Áirasat birra - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'1778'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-657.html" xml:lang="nob"/>
</xsl:variable>
