...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Giella/Faktadiedut-sami-gielaid-birra/Lavdegoddi-galga-nannet-samegiela'"/>
	...
	<parallel_text xml:lang="nob" location="spraak_fakta-om-samiske-spraak_utvalg-skal-styrke-samisk-spraak.html"/></xsl:variable>
