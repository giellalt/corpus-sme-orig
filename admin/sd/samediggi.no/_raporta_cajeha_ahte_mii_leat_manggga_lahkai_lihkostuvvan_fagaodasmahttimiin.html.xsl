...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/rapporten-viser-at-vi-pa-mange-mater-har-lykkes-med-fagfornyelsen.31922.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'– Raporta čájeha ahte mii leat máŋgga láhkái lihkostuvvan fágaođasmahttimiin - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="_rapporten_viser_at_vi_pa_mange_mater_har_lykkes_med_fagfornyelsen.html"/>
