...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Rabas-joavkkus-2019-s-ii-leat-birgenvejolas-bivdoearri'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Rabas joavkkus 2019:s ii leat birgenvejolaš bivdoearri'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="ikke-fiskekvote-aa-leve-av-for-aapen-gruppe-i-2019.html"/>
