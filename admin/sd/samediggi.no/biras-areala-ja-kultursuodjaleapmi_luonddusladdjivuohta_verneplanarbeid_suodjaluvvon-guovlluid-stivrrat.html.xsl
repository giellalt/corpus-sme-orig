...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Biras-areala-ja-kultursuodjaleapmi/Luonddusladdjivuohta/Verneplanarbeid/Suodjaluvvon-guovlluid-stivrrat'"/>
	...
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_naturmangfold_verneplanarbeid_verneomraadestyrer.html"/></xsl:variable>
