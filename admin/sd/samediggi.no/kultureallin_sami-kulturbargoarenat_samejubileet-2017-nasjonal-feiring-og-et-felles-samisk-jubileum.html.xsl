...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Kultureallin/Sami-kulturbargoarenat/Samejubileet-2017-nasjonal-feiring-og-et-felles-samisk-jubileum'"/>
	...
	<parallel_text xml:lang="nob" location="kulturliv_arenaer-for-samisk-kulturutoevelse_samejubileet-2017-nasjonal-feiring-og-et-felles-samisk-jubileum.html"/></xsl:variable>
