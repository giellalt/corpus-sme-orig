...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Giella/Samas-muinna/Artikler/Movt-don-alggat-samasmuinna'"/>
	...
	<parallel_text xml:lang="nob" location="spraak_snakk-samisk-te-mae_artikler_hvordan-komme-i-gang-med-snakksamisktemae.html"/></xsl:variable>
