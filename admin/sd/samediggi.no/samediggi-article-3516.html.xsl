...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3516&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ráđđi áigu hábmet Sámedikki minerálapolitihka - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3516.html" xml:lang="nob"/>
</xsl:variable>
