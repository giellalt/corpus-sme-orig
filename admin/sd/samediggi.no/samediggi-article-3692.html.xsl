...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3692&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Deanu ja Várjjaga museasiida lea ásahuvvon - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3692.html" xml:lang="nob"/>
</xsl:variable>
