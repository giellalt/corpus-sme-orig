...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3943&amp;sprak=Samisk&amp;Print=1'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3943.html" xml:lang="nob"/>
</xsl:variable>
