...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Lavdegoddi-evttoha-ahte-algoalbmotriekti-ja-servodatekonomalas-arvvostallamat-fertejit-mineralalahkii'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lávdegoddi evttoha ahte álgoálbmotriekti ja servodatekonomalaš árvvoštallamat fertejit minerálaláhkii'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="utvalg-forslaar-at-urfolksrett-og-samfunnsoekonomiske-vurderinger-maa-inn-i-mineralloven.html"/>
