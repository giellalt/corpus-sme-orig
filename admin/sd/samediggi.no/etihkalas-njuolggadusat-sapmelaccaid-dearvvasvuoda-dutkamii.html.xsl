...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Dearvvasvuohta-ja-sosiala/Dearvvasvuohta/Etihkalas-njuolggadusat-sapmelaccaid-dearvvasvuoda-dutkamii'"/>
    ...
    <parallel_text location="etiske-retningslinjer-for-helseforskning-paa-samer.html" xml:lang="nob"/>
</xsl:variable>
