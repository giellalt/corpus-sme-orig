...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2723&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggepresideantta Egil Olli rahpansárdni álgoálbmotforuma 25 jagi ávvudeapmái Brasilas - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2723.html" xml:lang="nob"/>
</xsl:variable>
