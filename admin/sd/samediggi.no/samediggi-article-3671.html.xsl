...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3671&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Gulahallankonferánsa Sámedikkis - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3671.html" xml:lang="nob"/>
</xsl:variable>
