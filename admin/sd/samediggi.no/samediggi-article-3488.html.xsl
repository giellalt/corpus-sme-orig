...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3488&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki sáhkavuorru bievlavuoddjin semináras - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'1883'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3488.html" xml:lang="nob"/>
</xsl:variable>
