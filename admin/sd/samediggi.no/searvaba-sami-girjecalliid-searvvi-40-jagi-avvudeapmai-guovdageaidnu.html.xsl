...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Lagideamit/Searvaba-Sami-Girjecalliid-Searvvi-40-jagi-avvudeapmai-Guovdageaidnu'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Searvaba Sámi Girječálliid Searvvi 40 jagi ávvudeapmái - Guovdageaidnu'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="deltar-paa-samisk-forfatterforenings-feiring-av-40-aars-jubileum-kautokeino.html"/>
