...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-har-gitt-1-3-milliarder-i-tilskudd-sjekk-hvor-mye-din-kommune-har-fatt.16108.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi lea juolludan 1,3 miljárdda doarjagiidda - iskka man ollu du suohkan lea ožžon doarjjan - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_har_gitt_1_3_milliarder_i_tilskudd_-_sjekk_hvor_mye_din_kommune_har_fatt.html"/>
