...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/reviderejuvvon-buseahtta-divvun-dihte-daruiduhttima-vahagiid.32358.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Reviderejuvvon bušeahtta divvun dihte dáruiduhttima vahágiid - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="et_revidert_budsjett_for_a_reparere_fornorskningsskader.html"/>
