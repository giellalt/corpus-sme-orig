...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Dearvvasvuohta-ja-sosiala/Dearvvasvuohta/Doarjja-applikasuvnna-ovddideapmai-ovdaeastadanoahpahusa-birra'"/>
	...
	<parallel_text xml:lang="nob" location="helse-og-sosial_helse_stoette-til-utvikling-av-applikasjon-om-prevensjon.html"/></xsl:variable>
