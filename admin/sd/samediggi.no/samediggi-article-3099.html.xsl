...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3099&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Gulahallanossodat - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3099.html" xml:lang="nob"/>
</xsl:variable>
