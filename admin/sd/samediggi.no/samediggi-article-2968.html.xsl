...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2968&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Válgakonfereanssaid čalmmušteapmi - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'15'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2968.html" xml:lang="nob"/>
</xsl:variable>
