...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/samedikki-2024-buseahtta-vuoruheamit-divodan-varas-daruiduhttima-vahagiid.28297.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikki 2024 bušeahtta: vuoruheamit divodan várás dáruiduhttima vahágiid - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingsbudsjett_2024:_satsinger_for_a_reparere_skadene_etter_fornorskningen.html"/>
