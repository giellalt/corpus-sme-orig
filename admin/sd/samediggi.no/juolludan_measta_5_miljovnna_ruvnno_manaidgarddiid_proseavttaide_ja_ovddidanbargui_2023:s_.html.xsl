...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/tildelt-nesten-5-millioner-kroner-til-prosjekter-og-utviklingsarbeid-i-barnehager-i-2023.28883.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Juolludan measta 5 miljovnna ruvnno mánáidgárddiid prošeavttaide ja ovddidanbargui 2023:s  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tildelt_nesten_5_millioner_kroner_til_prosjekter_og_utviklingsarbeid_i_barnehager_i_2023.html"/>
