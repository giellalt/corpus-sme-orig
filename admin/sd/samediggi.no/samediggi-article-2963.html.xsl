...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2963&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'VÁLGA: Statistihkka - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2963.html" xml:lang="nob"/>
</xsl:variable>
