...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/bekymret-etter-at-nve-har-lagt-ut-en-ny-oversikt-over-vindkraftprosjekter.28556.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Fuolastuvvan go NČE lea almmuhan ođđa bajilgova bieggafápmoprošeavttain - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="bekymret_etter_at_nve_har_lagt_ut_en_ny_oversikt_over_vindkraftprosjekter.html"/>
