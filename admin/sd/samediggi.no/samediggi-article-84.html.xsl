...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=84&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Almmolašvuohta ja vuoigatvuohta geahččat áššebáhpiriid - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-84.html" xml:lang="nob"/>
</xsl:variable>
