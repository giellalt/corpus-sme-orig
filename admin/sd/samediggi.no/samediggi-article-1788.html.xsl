...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1788&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Sámedikki presideanta ohcalii ONa eamiálbmovuoigatvuođaid julggaštusa - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1788.html" xml:lang="nob"/>
</xsl:variable>
