...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-signerer-samarbeidsavtale-med-foreldreutvalg-for-barnehage-og-foreldreutvalg-for-grunnopplaring.20961.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi vuolláičállá ovttasbargošiehtadusa vuođđooahppu váhnenlávdegottiin  ja mánáidgárdde váhnenlávdegottiin  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_signerer_samarbeidsavtale_med_foreldreutvalg_for_barnehage_og_foreldreutvalg_for_grunnopplaering_.html"/>
