...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Gulaskuddan-etihkalas-njuolggadusaid-birra-sami-dearvvasvuodadutkamii-ja-sami-humana-biologalas-avdnasiid-geavaheapmai-ja-halddaseapmai'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Gulaskuddan etihkalaš njuolggadusaid birra sámi dearvvašvuođadutkamii ja sámi humána biologalaš ávdnasiid geavaheapmái ja hálddašeapmái'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="hoering-paa-forslag-til-etiske-retningslinjer-for-samisk-helseforskning-og-forskning-paa-samisk-humant-biologisk-materiale.html"/>
