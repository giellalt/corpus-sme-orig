...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/presideantta-ovttastuvvan-nasuvnnaid-riikkaidgaskasas-algoalbmogiidbeaivvi-2022-sardni.21562.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Presideantta Ovttastuvvan Našuvnnaid riikkaidgaskasaš álgoálbmogiidbeaivvi 2022 sárdni - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="presidentens_tale_til_fns_internasjonale_urfolksdag_2022.html"/>
