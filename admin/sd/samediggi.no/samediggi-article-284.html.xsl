...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=284&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'2005 sámediggeválgga jienasteaddjit Oslos besset jienastit buot gávpoga jienastanlanjain - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-284.html" xml:lang="nob"/>
</xsl:variable>
