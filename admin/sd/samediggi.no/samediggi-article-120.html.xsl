...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=120&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'LivsIT – diehtojuohkin du eallindili mielde  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-120.html" xml:lang="nob"/>
</xsl:variable>
