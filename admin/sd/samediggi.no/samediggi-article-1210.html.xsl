...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1210&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sáhkavuorru - Blåfjella-Skjækerfjella/Låarte - Skæhkere álbmotmeahci ja Lierne/Lijre álbmotmeahci rahpan - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1210.html" xml:lang="nob"/>
</xsl:variable>
