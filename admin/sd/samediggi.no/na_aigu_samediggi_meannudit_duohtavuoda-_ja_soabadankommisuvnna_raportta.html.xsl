...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/slik-skal-sametinget-behandle-sannhets-og-forsoningskommisjonens-rapport.30995.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ná áigu Sámediggi meannudit Duohtavuođa- ja soabadankommišuvnna raportta - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="slik_skal_sametinget_behandle_sannhets-_og_forsoningskommisjonens_rapport.html"/>
