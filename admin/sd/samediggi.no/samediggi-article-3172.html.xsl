...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3172&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Válddes oktavuođa, jos it beasaš jienastit - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3172.html" xml:lang="nob"/>
</xsl:variable>
