...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3262&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggi 2009 - 2013 - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'18'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3262.html" xml:lang="nob"/>
</xsl:variable>
