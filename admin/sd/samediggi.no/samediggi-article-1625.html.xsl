...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1625&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Synnøve Persena dahkan málagovva &quot;Vávvu&quot; - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1625.html" xml:lang="nob"/>
</xsl:variable>
