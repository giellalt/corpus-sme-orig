...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Sardni-Baaaastede-sami-kulturarbbi-mahcaheami-siehtadusa-vuollaicallimis'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sárdni Bååstede - sámi kulturárbbi máhcaheami šiehtadusa vuolláičállimis'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tale-i-forbindelse-med-baaaastede-avtalen-om-tilbakefoering-av-samisk-kulturarv.html"/>
