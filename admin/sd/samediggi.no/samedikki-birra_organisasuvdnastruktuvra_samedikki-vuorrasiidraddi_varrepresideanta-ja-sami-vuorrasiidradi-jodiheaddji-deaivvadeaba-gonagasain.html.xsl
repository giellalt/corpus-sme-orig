...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Samedikki-birra/Organisasuvdnastruktuvra/Samedikki-vuorrasiidraddi/Varrepresideanta-ja-sami-vuorrasiidradi-jodiheaddji-deaivvadeaba-Gonagasain'"/>
	...
	<parallel_text xml:lang="nob" location="om-sametinget_organisasjonsstruktur_sametingets-eldreraad_visepresidenten-og-samisk-eldreraadsleder-moeter-kongen.html"/></xsl:variable>
