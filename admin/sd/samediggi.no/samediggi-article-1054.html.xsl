...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1054&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Stáhta eiseválddiid ja sámedikki gaskasaš konsultašuvnnaid prosedyrat  - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'890'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1054.html" xml:lang="nob"/>
</xsl:variable>
