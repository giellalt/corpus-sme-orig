...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Kulturealahus/Angirussat-kulturealahusaiguin-Romssas'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_kulturnaering_satser-paa-kulturnaering-i-troms.html"/></xsl:variable>
