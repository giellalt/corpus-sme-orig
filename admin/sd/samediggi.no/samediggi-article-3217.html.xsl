...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3217&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Gaskaboddosaš válgabohtosat sámediggeválggas - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3217.html" xml:lang="nob"/>
</xsl:variable>
