...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3135&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Rabas virgi: Čálli/konsuleanta - arkiiva - bistevaš virgi - 3. almmuheapmi – Ref. nr. 08/5017 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3135.html" xml:lang="nob"/>
</xsl:variable>
