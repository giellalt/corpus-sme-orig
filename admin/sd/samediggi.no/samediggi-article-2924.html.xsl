...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2924&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sávvat lihku nissonbeaivái  – njukčamánu 8. b! - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2924.html" xml:lang="nob"/>
</xsl:variable>
