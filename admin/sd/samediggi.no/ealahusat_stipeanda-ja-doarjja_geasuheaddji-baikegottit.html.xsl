...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Stipeanda-ja-doarjja/Geasuheaddji-baikegottit'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_stipend-og-tilskudd_attraktive-lokalsamfunn.html"/></xsl:variable>
