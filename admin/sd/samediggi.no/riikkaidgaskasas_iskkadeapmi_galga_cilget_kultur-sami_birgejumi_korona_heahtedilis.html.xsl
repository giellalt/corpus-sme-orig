...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/grenseoverskridende-undersokelse-skal-bidra-med-informasjon-om-hvordan-kultur-sapmi-klarer-seg-under-koronakrisen.7640.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Riikkaidgaskasaš iskkadeapmi galgá čilget kultur-sámi birgejumi korona heahtedilis - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="grenseoverskridende_undersokelse_skal_bidra_med_informasjon_om_hvordan_kultur-sapmi_klarer_seg_under_koronakrisen.html"/>
