...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3161&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggepresideanta Egil Olli skeŋke sámeleavgga  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3161.html" xml:lang="nob"/>
</xsl:variable>
