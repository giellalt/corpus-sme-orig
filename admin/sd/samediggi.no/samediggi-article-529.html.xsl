...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=529&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Sámediggi juolluda 300 000 ruvnno mánáid- ja nuoraidgirjjiid almmuheapmái - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-529.html" xml:lang="nob"/>
</xsl:variable>
