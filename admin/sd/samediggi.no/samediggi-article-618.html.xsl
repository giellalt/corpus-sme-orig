...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=618&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Viđát sámedikki vuosttas dábálaš dievasčoahkkima gulaheapmi golggotmánu 19. – 20. b. 2005 Kárášjogas  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-618.html" xml:lang="nob"/>
</xsl:variable>
