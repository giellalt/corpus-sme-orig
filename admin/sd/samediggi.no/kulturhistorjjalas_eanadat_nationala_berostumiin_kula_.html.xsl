...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/kulturminne-og-bygningsvern/samiske-kulturminner-og-landskap/utvalgte-samiske-kulturlandskap/kulturhistoriske-landskap-av-nasjonal-interesse-kula/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kulturhistorjjálaš eanadat nationála beroštumiin (KULA) - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="kulturhistoriske_landskap_av_nasjonal_interesse_kula_.html"/>
