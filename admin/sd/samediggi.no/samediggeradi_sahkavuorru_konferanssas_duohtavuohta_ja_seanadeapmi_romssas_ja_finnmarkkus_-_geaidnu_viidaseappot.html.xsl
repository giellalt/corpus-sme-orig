...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingsradens-innlegg-under-konferansen-sannhet-og-forsoning-i-troms-og-finnmark-veien-videre.28247.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggeráđi sáhkavuorru konferánssas Duohtavuohta ja seanadeapmi Romssas ja Finnmárkkus - geaidnu viidáseappot - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingsradens_innlegg_under_konferansen_sannhet_og_forsoning_i_troms_og_finnmark_-_veien_videre.html"/>
