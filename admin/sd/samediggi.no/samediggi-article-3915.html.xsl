...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3915&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámi logut muitalit 3 almmuhuvvo bearjadaga golggotmánu 1. b.  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3915.html" xml:lang="nob"/>
</xsl:variable>
