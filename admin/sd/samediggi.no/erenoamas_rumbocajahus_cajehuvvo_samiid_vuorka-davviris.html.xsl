...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/unik-samling-trommer-vises-pa-samiid-vuorka-davvirat.20223.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Erenoamáš rumbočájáhus čájehuvvo Sámiid Vuorká-Dávviris - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="unik_samling_trommer_vises_pa_samiid_vuorka-davvirat.html"/>
