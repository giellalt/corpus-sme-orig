...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-og-sno-enige-om-at-reindriften-trenger-flere-rovviltkontakter-og-at-reineiere-skal-fa-opplaring-i-a-dokumentere-kadavre.16172.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi ja Stáhta luonddubearráigeahčču soahpan ahte boazodoalus dárbbašit eanet boraspirebargiid ja badjeolbmuide fállo gursa dokumenteret ráppiid  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_og_sno_enige_om_at_reindriften_trenger_flere_rovviltkontakter_og_at_reineiere_skal_fa_opplaering_i_a_dokumentere_kadavre.html"/>
