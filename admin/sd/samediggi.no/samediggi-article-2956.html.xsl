...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2956&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'VÁLGA: Sámedikki jienastuslohku - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2956.html" xml:lang="nob"/>
</xsl:variable>
