...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Riikkaidgaskasas-bargu/Alta-2013/Additional-logisitics-information'"/>
	...
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_alta-2013_additional-logisitics-information.html"/></xsl:variable>
