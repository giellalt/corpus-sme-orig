...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Preassadiedahusat/Preassaoktavuodat'"/>
	...
	<parallel_text xml:lang="nob" location="presse_pressekontakter.html"/></xsl:variable>
