...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Riikkaidgaskasas-bargu/Alta-2013/Searvva-don-nai-hutkat-ovttas-eara-manaiguin-ja-nuoraiguin-miehta-mailmmi'"/>
