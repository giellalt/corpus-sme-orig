...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/giellaoahttse-ja-giellaguovdatja-ja-vajmogiella-budsjettavtodusan.8503.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Giellaáittardeaddji ja giellaguovddážat ja váibmogiella bušeahttaevttohusas - Sámediggi'"/>
    <!--
