...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Kultureallin/Stipeanda-ja-doarjja/Daidda-ja-kulturgaskkustanarenat'"/>
	...
	<parallel_text xml:lang="nob" location="kulturliv_stipend-og-tilskudd_arena-for-kunst-og-kulturformidling.html"/></xsl:variable>
