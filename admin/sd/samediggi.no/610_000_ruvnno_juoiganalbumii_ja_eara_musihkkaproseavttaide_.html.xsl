...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/610-000-kroner-til-joikealbum-og-andre-musikkrelaterte-prosjekter.29017.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'610 000 ruvnno juoiganálbumii ja eará musihkkaprošeavttaide  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="610_000_kroner_til_joikealbum_og_andre_musikkrelaterte_prosjekter_.html"/>
