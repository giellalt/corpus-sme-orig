...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sok-sprakprosjektmidler-til-spraktiltak-i-forbindelse-med-samisk-sprakuke-2020.8011.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oza giellaprošeaktadoarjaga sámegieldoaimmaide sámi giellavahkku 2020 oktavuođas - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sok_sprakprosjektmidler_til_spraktiltak_i_forbindelse_med_samisk_sprakuke_2020.html"/>
