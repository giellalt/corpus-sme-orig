...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/prd-samedikkis-liigedoarjja-guolastanfatnasiidda-ja-sami-asahusaide.28796.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: Sámedikkis liigedoarjja guolástanfatnasiidda ja sámi ásahusaide - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm:_ekstra_stotte_til_fiskefartoy_og_samiske_institusjoner_fra_sametinget.html"/>
