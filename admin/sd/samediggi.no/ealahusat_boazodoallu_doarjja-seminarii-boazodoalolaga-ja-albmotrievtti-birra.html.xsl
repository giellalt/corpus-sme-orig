...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Boazodoallu/Doarjja-seminarii-boazodoalolaga-ja-albmotrievtti-birra'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_reindrift_tilskudd-til-seminar-om-reindriftsloven-og-folkeretten.html"/></xsl:variable>
