...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1815&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Ođđa boazodoalloláhka dohkkehuvvon - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1815.html" xml:lang="nob"/>
</xsl:variable>
