...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2644&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Áigemearit 2009 sámediggeválgga oktavuođas - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2644.html" xml:lang="nob"/>
</xsl:variable>
