...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Artikler/1000-kulturmuittu-gaskal-Bahccavuona-ja-Hammarfeastta'"/>
	...
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_1000-kulturminner-registrert-mellom-balsfjord-og-hammerfest.html"/></xsl:variable>
