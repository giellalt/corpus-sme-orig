...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2485&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Rievdaduvvon šiehtadus sisriikkálaš mátkkiin 01.05.2008 rájes - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'24'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2485.html" xml:lang="nob"/>
</xsl:variable>
