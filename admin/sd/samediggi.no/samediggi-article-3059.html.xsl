...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3059&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikkiráđđi Ráissas  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3059.html" xml:lang="nob"/>
</xsl:variable>
