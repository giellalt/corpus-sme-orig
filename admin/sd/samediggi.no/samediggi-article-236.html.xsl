...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=236&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'2005 Sámedikki jienastuslohku - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-236.html" xml:lang="nob"/>
</xsl:variable>
