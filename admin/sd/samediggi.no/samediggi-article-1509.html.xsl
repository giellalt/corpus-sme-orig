...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1509&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ođđajagisárdni 2007 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1509.html" xml:lang="nob"/>
</xsl:variable>
