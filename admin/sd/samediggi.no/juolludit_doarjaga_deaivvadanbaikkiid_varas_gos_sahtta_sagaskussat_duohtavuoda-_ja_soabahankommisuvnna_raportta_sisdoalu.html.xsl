...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/juolludit-doarjaga-deaivvadanbaikkiid-varas-gos-sahtta-sagaskussat-duohtavuoda-ja-soabahankommisuvnna-raportta-sisdoalu.26830.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Juolludit doarjaga deaivvadanbáikkiid várás gos sáhttá ságaškuššat Duohtavuođa- ja soabahankommišuvnna raportta sisdoalu - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="gir_tilskudd_til_moteplasser_som_skal_drofte_innholdet_i_sannhets-_og_forsoningskommisjonens_rapport.html"/>
