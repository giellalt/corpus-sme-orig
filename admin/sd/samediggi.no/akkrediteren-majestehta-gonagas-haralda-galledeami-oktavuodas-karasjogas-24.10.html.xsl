...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Akkrediteren-Majestehta-Gonagas-Haralda-galledeami-oktavuodas-Karasjogas-24.10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Akkrediteren Majestehta Gonagas Haralda galledeami oktavuođas Kárášjogas 24.10'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="akkreditering-h.m.-kongen-besoeker-karasjok-24.-oktober.html"/>
