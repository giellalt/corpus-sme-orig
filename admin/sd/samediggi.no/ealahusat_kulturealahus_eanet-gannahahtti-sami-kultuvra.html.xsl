...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Kulturealahus/Eanet-gannahahtti-sami-kultuvra'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_kulturnaering_oekt-loennsomhet.html"/></xsl:variable>
