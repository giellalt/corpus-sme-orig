...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/kultuvrramujtto-ja-huonajsuodjalus/metallaahtamus/metallsok-i-forhold-til-samiske-kulturminner-og-lokaliteter/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dieđut metállaohcama birra sámi kulturmuittuid ja lokalitehtaid oktavuođas - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="informasjon_om_metallsok_i_forhold_til_samiske_kulturminner_og_lokaliteter.html"/>
