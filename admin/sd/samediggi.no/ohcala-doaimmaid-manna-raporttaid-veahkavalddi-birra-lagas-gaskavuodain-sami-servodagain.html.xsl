...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Ohcala-doaimmaid-manna-raporttaid-veahkavalddi-birra-lagas-gaskavuodain-sami-servodagain'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ohcala doaimmaid maŋŋá raporttaid veahkaválddi birra lagas gaskavuođain sámi servodagain'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="etterlyser-tiltak-etter-rapporter-om-vold-i-naere-relasjoner-i-samiske-samfunn.html"/>
