...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Eatnan-ja-resursavuoigatvuodat/Karten/Finnmarkokommisuvdna/Kartemis-ja-dohkkeheames-gavdni-vuoigatvuodaid-Finnmarkkus.'"/>
	...
	<parallel_text xml:lang="nob" location="kartlegging-og-anerkjennelse-av-eksisterende-rettigheter-i-finnmark..html"/></xsl:variable>
