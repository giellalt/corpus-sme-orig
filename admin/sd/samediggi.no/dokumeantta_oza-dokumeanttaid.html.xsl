...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Dokumeantta/Oza-dokumeanttaid'"/>
	...
	<parallel_text xml:lang="nob" location="dokumenter_soek-etter-dokumenter.html"/></xsl:variable>
