...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1177&amp;sprak=Samisk&amp;Print=1'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1177.html" xml:lang="nob"/>
</xsl:variable>
