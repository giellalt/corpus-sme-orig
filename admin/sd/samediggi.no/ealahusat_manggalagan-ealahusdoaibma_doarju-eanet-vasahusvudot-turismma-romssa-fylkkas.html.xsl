...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Manggalagan-ealahusdoaibma/Doarju-eanet-vasahusvudot-turismma-Romssa-fylkkas'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_variert-naeringsliv_stoetter-oekt-opplevelsesturisme-i-troms.html"/></xsl:variable>
