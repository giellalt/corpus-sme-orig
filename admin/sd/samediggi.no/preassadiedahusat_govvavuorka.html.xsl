...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Preassadiedahusat/Govvavuorka'"/>
	...
	<parallel_text xml:lang="nob" location="presse_bildegalleri.html"/></xsl:variable>
