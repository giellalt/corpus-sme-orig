...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/dialogmoter-og-kulturelle-aktiviteter-har-fatt-stotte.28279.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Gullahallančoahkkimat ja kultuvrralaš doaimmat leat ožžon doarjaga - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="dialogmoter_og_kulturelle_aktiviteter_har_fatt_stotte.html"/>
