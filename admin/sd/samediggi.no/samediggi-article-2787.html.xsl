...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2787&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Loahppadokumeanta nubbi sámeparlamentarihkarkonferánsa 2008 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2787.html" xml:lang="nob"/>
</xsl:variable>
