...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2886&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggeválga 2009 – válgalisttat  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2886.html" xml:lang="nob"/>
</xsl:variable>
