...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Eatnan-ja-resursavuoigatvuodat/Bivdovuoigatvuohta/Riddoguolastanlavdegotti/Gahttejit-riddo-ja-vuotnaalbmoga-historjjalas-vuoigatvuodaid'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="slaar-ring-om-kyst-og-fjordbefolkningens-historiske-rettigheter.html"/>
