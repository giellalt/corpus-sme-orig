...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Doarjagat-ja-stipeanddat/Stipeanda-alit-oahppui-mattasamegielas-ja-julevsamegielas-ja-sami-giellaoahppui-markosami-guovllu-studeanttaide'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Stipeanda alit oahppui máttasámegielas ja julevsámegielas, ja sámi giellaoahppui márkosámi guovllu studeanttaide'"/>
    <!--
