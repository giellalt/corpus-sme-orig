...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Dearvvasvuohta-ja-sosiala/Dearvvasvuohta/Etihkalas-njuolggadusa-sami-humana-biologalas-avdnasiid-varas'"/>
	...
	<parallel_text xml:lang="nob" location="helse-og-sosial_helse_etiske-retningslinjer-for-samisk-human-biologisk-materiale.html"/></xsl:variable>
