...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/regjeringens-handlingsplan-mot-hets-og-diskriminering-av-samer-en-seier.35265.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ráđđehusa doaibmaplána sápmelaččaid cielaheami ja vealaheami vuostá: – Vuoitu!  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="regjeringens_handlingsplan_mot_hets_og_diskriminering_av_samer:_-_en_seier_.html"/>
