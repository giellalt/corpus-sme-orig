...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2898&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Rávesolbmot miehtá riikka besset oahppat sámegiela - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2898.html" xml:lang="nob"/>
</xsl:variable>
