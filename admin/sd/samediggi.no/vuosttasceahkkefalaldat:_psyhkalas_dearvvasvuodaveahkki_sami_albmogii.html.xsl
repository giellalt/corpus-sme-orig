...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/lavterskeltilbud-psykisk-helsehjelp-for-den-samiske-befolkningen.25010.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vuosttašceahkkefálaldat: Psyhkalaš dearvvašvuođaveahkki sámi álbmogii - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="lavterskeltilbud:_psykisk_helsehjelp_for_den_samiske_befolkningen.html"/>
