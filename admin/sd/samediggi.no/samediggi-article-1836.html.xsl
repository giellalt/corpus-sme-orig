...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1836&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Oza ja gávnna: diehtovuođut - Sámedikki girjeradju - Sametingets bilbiotek'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1836.html" xml:lang="nob"/>
</xsl:variable>
