...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=786&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Vuoigatvuohta-, ealáhus- ja birasossodat - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-786.html" xml:lang="nob"/>
</xsl:variable>
