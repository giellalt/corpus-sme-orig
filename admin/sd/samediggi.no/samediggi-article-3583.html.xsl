...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3583&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Carsten Smith oažžu 2010  Riektesihkarvuođabálkkašumi  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3583.html" xml:lang="nob"/>
</xsl:variable>
