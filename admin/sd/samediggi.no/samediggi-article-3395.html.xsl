...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3395&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ohcanvuđot doarjagat - areálat, birasgáhtten ja kultursuodjaleapmi - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3395.html" xml:lang="nob"/>
</xsl:variable>
