...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/diddi-luosjuolgi-goadjin-ja-duovvi-sametingsmelding-om-laks-2021.15375.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Diddi, luosjuolgi, goadjin ja duovvi. Sámediggedieđáhus luosa birra 2021 - Sámediggi'"/>
    <!--
