...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/ealahus/avkkalas-resurssat/diddi-luosjuolgi-goadjin-ja-duovvi-samediggediedahus-luosa-birra-2021/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Diddi, luosjuolgi, goadjin ja duovvi. Sámediggedieđáhus luosa birra 2021 - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="diddi_luosjuolgi_goadjin_ja_duovvi__sametingsmelding_om_laks_2021.html"/>
