...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3189&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Lea hoahppu jus fertet ovdagiihtii jienastit!  - S&#225;mediggi Sametinget'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-3189.html'"/>
