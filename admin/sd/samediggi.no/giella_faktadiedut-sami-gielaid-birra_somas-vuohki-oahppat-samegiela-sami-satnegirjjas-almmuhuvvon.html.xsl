...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Giella/Faktadiedut-sami-gielaid-birra/Somas-vuohki-oahppat-samegiela-sami-satnegirjjas-almmuhuvvon'"/>
	...
	<parallel_text xml:lang="nob" location="spraak_fakta-om-samiske-spraak_en-artig-maate-aa-laere-samisk-paa-samisk-lommeparloer-lansert.html"/></xsl:variable>
