...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Giella/Faktadiedut-sami-gielaid-birra/Somas-vuohki-oahppat-samegiela-sami-satnegirjjas-almmuhuvvon'"/>
