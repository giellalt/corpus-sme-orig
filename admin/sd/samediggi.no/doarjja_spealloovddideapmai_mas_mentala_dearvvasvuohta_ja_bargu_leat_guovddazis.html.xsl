...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/doarjja-spealloovddideapmai-mas-mentala-dearvvasvuohta-ja-bargu-leat-guovddazis.26850.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Doarjja spealloovddideapmái mas mentála dearvvašvuohta ja bargu leat guovddážis - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="stotte_til_spillutvikling_der_mental_helse_og_arbeid_er_i_fokus.html"/>
