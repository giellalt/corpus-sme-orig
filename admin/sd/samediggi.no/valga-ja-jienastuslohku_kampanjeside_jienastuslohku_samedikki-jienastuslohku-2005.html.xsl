...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Valga-ja-jienastuslohku/Kampanjeside/Jienastuslohku/Samedikki-jienastuslohku-2005'"/>
	...
	<parallel_text xml:lang="nob" location="valg-og-manntall_kampanjeside_valgmanntall_sametingets-valgmanntall-2005.html"/></xsl:variable>
