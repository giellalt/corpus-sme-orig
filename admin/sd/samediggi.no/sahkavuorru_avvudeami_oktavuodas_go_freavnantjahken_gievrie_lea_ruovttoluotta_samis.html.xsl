...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/tale-ved-feiringen-av-tilbakeforingen-av-freavnantjahke-gievrie-til-saepmie.28288.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sáhkavuorru ávvudeami oktavuođas go Freavnantjahken gievrie lea ruovttoluotta Sámis - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tale_ved_feiringen_av_tilbakeforingen_av_freavnantjahke_gievrie_til_saepmie_.html"/>
