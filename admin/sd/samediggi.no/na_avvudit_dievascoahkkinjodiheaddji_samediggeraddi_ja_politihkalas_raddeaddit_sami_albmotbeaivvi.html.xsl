...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/slik-feirer-plenumsleder-sametingsradet-og-politiske-radgivere-samenes-nasjonaldag.29182.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ná ávvudit dievasčoahkkinjođiheaddji, sámediggeráđđi ja politihkalaš ráđđeaddit sámi álbmotbeaivvi - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="slik_feirer_plenumsleder_sametingsradet_og_politiske_radgivere_samenes_nasjonaldag.html"/>
