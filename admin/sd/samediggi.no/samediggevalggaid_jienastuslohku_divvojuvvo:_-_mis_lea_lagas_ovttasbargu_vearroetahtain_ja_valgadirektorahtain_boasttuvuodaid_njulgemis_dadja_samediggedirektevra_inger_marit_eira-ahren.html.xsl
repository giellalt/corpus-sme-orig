...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/valgmanntallet-til-sametingsvalget-vil-bli-rettet-vi-jobber-tett-sammen-med-skatteetaten-og-valgdirektoratet-for-a-rydde-opp-sier-sametingsdirektor-inger-marit-eira-ahren.15918.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggeválggaid jienastuslohku divvojuvvo: – Mis lea lagas ovttasbargu Vearroetáhtain ja Válgadirektoráhtain boasttuvuođaid njulgemis, dadjá sámediggedirektevra Inger Marit Eira-Åhrén - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="valgmanntallet_til_sametingsvalget_vil_bli_rettet:_-_vi_jobber_tett_sammen_med_skatteetaten_og_valgdirektoratet_for_a_rydde_opp_sier_sametingsdirektor_inger_marit_eira-_ahren_.html"/>
