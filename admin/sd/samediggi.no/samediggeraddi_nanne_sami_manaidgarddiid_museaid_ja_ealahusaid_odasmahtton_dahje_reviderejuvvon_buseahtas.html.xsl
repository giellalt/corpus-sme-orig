...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingsradet-styrker-samiske-barnehager-museer-og-naringer-i-revidert-budsjett.20812.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggeráđđi nanne sámi mánáidgárddiid, museaid ja ealáhusaid ođasmahtton dahje reviderejuvvon bušeahtas - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingsradet_styrker_samiske_barnehager_museer_og_naeringer_i_revidert_budsjett.html"/>
