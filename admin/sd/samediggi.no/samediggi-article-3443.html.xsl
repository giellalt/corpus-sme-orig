...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3443&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Beanavuoddji ja bođuvaláštalli oažžuba Sámedikki valáštallanstipendda - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3443.html" xml:lang="nob"/>
</xsl:variable>
