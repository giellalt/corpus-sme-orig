...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Presideantas-lihkkusavaldagat-ONa-riikkaidgaskasas-algoalbmotbeaivai'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Presideantas lihkkusávaldagat ONa riikkaidgaskasaš álgoálbmotbeaivái'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="presidentens-lykkeoenskninger-til-fns-internasjonale-urfolksdag.html"/>
