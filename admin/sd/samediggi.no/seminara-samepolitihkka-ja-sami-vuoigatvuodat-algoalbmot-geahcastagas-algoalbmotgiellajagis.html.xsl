...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Lagideamit/Seminara-Samepolitihkka-ja-sami-vuoigatvuodat-algoalbmot-geahcastagas-algoalbmotgiellajagis'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Seminára &quot;Sámepolitihkka ja sámi vuoigatvuođat álgoálbmot geahčastagas álgoálbmotgiellajagis&quot;'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="seminar-samepolitikk-og-samiske-rettigheter-i-et-aktuelt-urfolksperspektiv-i-urfolksspraakaaret.html"/>
