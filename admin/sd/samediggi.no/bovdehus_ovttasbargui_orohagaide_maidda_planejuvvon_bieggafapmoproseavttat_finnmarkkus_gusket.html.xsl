...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/invitasjon-til-samarbeid-til-reinbeitedistrikter-berort-av-de-planlagte-vindkraftprosjektene-i-finnmark.33546.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bovdehus ovttasbargui orohagaide maidda plánejuvvon bieggafápmoprošeavttat Finnmárkkus gusket - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="invitasjon_til_samarbeid_til_reinbeitedistrikter_berort_av_de_planlagte_vindkraftprosjektene_i_finnmark.html"/>
