...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Girjeradju/Mii-avzzuhit/Sami-bibliografiija/Norgga-sami-bibliografia'"/>
	...
	<parallel_text xml:lang="nob" location="bibliotek_vi-anbefaler_samisk-bibliografi_norsk-samisk-bibliografi.html"/></xsl:variable>
