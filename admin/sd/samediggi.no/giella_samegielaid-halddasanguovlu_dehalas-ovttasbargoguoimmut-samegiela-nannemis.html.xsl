...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Giella/Samegielaid-halddasanguovlu/Dehalas-ovttasbargoguoimmut-samegiela-nannemis'"/>
	...
	<parallel_text xml:lang="nob" location="spraak_forvaltningsomraade_viktige-samarbeidspartnere-i-arbeidet-for-aa-styrke-samisk-spraak.html"/></xsl:variable>
