...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Presideantta-rahpansahkavuorru-gulaskuddankonferanssas-etihkalas-njuolggadusaid-birra-sami-dearvvasvuodadutkamis'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Presideantta rahpansáhkavuorru gulaskuddankonferánssas etihkalaš njuolggadusaid birra sámi dearvvašvuođadutkamis'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingspresidenten-sitt-aapningsinnlegg-paa-hoeringskonferansen-om-etiske-retningslinjer-for-samisk-helseforskning.html"/>
