...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/pilotbarnehager-i-samisk-barnehageprosjekt-er-valgt-ut.4592.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Pilohtamánáidgárddit mánáidgárdeprošeavttas leat dál válljejuvvon - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="pilotbarnehager_i_samisk_barnehageprosjekt_er_valgt_ut_.html"/>
