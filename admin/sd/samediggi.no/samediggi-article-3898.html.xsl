...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3898&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Bovde čoahkkimii lohkan- ja čállinveahki birra boarrásiidda - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3898.html" xml:lang="nob"/>
</xsl:variable>
