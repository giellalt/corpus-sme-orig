...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3179&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sรกmedikki girjeradju - Sametingets bilbiotek'"/>
...
<xsl:variable name="wordcount" select="'7'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3179.html" xml:lang="nob"/>
</xsl:variable>
