...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3150&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Várrepresideanta kommentere Dagbladet.no Gamst Pedersen skuovaid  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3150.html" xml:lang="nob"/>
</xsl:variable>
