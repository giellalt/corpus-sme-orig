...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Kultureallin/Falastallan/Samedikki-kultur-ja-valastallanstipeanddat'"/>
	...
	<parallel_text xml:lang="nob" location="kulturliv_idrett_sametingets-kultur-og-idrettsstipend.html"/></xsl:variable>
