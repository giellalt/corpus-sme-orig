...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3056&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Rabas virggit - geassemánnu 2009 - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'654'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3056.html" xml:lang="nob"/>
</xsl:variable>
