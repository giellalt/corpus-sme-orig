...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/dat-njealjis-ozzot-samedikki-kultur-ja-valastallanstipeandda-2022.23208.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dát njealjis ožžot Sámedikki kultur- ja valáštallanstipeandda 2022 - Sametinget'"/>
    <!--
