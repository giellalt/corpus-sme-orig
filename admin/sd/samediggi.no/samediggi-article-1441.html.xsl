...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1441&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Beahtahallan go ferte ođđasis dáistalit ONa eamiálbmotjulggaštusa alde - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1441.html" xml:lang="nob"/>
</xsl:variable>
