...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3978&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Daid doarjagiid árvvoštallan maid Sámediggi juolluda sámi mánáidgárddiide - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3978.html" xml:lang="nob"/>
</xsl:variable>
