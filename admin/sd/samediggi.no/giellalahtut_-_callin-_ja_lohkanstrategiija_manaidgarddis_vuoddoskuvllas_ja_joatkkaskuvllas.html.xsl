...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oppfolging-av-nou-2016-18-hjertespraket/tiltak-i-giellalokten/innsatsomrade-spraktilbud-for-barn-og-unge/sprakloyper-strategi-for-lesing-og-skriving-i-barnehage-grunnskole-og-videregaende-opplaring/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Giellaláhtut - čállin- ja lohkanstrategiija mánáidgárddis, vuođđoskuvllas ja joatkkaskuvllas - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sprakloyper_-_strategi_for_lesing_og_skriving_i_barnehage_grunnskole_og_videregaende_opplaering.html"/>
