...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Arkiv/Valgperiode-2009-2013/Artikler/Samediggi-ja-Romsa-aigot-dahkat-ovttasbargosiehtadusa'"/>
	...
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_sametinget-og-tromsoe-kommune-vil-inngaa-samarbeidsavtale.html"/></xsl:variable>
