...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/deltatt-i-oppstartssamling-for-den-nasjonale-komiteen-for-nasjonaljubileet-2030.26617.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oassálastán Našunála 2030 ávvudeami našunála lávdegotti álggahandeaivvadeamis - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="deltatt_i_oppstartssamling_for_den_nasjonale_komiteen_for_nasjonaljubileet_2030.html"/>
