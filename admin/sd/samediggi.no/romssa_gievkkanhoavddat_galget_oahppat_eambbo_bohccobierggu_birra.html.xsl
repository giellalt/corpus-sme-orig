...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/kjokkensjefer-i-tromso-skal-bli-bedre-kjent-med-reinkjott.16245.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Romssa gievkkanhoavddat galget oahppat eambbo bohccobierggu birra - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="kjokkensjefer_i_tromso_skal_bli_bedre_kjent_med_reinkjott.html"/>
