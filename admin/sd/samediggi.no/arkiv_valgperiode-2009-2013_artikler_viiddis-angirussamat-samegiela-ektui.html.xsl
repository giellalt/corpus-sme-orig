...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Arkiv/Valgperiode-2009-2013/Artikler/Viiddis-angirussamat-samegiela-ektui'"/>
	...
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_bred-satsning-paa-samisk-spraak2.html"/></xsl:variable>
