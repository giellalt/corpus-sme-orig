...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-bevilger-stotte-til-jubileumsbok-til-beaivvas-og-konsert-pa-roros-med-marja-mortensson-og-kork.4003.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi juolluda doarjaga ávvogirjái Beaivváš ja konsertii Rørosas Marja Mortensson ja KORK bokte - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_bevilger_stotte_til_jubileumsbok_til_beaivvas_og_konsert_pa_roros_med_marja_mortensson_og_kork.html"/>
