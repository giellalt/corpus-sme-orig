...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Samediggi-adda-1-7-miljon-ru.-ealahusproseavttaide-Davvenjarggas-ja-Skiervvas'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi addá 1,7 miljon ru. ealáhusprošeavttaide Davvenjárggas ja Skiervvás'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget-gir-1-7-millioner-kroner-til-naeringsprosjekter-i-nordkapp-og-skjervoey.html"/>
