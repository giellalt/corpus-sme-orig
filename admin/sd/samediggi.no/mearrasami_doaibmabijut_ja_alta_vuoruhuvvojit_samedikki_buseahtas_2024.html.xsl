...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sjosamiske-tiltak-og-alta-prioriteres-i-sametingsbudsjettet-2024.28273.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Mearrasámi doaibmabijut ja Áltá vuoruhuvvojit Sámedikki bušeahtas 2024 - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sjosamiske_tiltak_og_alta_prioriteres_i_sametingsbudsjettet_2024.html"/>
