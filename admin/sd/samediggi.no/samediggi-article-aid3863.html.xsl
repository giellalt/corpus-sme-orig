...
<xsl:variable name="filename" select="'http://www.sametinget.no/artikkel.aspx?MId1=3471&amp;AId=3863&amp;Print=1'"/>
<xsl:variable name="title" select="'9.4 millioner kroner til duodjinæringen'"/>
