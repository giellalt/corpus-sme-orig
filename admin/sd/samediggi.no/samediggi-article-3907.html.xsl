...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3907&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggi áigu čuovvolit álggaheddjiid máttasámi guovllus - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3907.html" xml:lang="nob"/>
</xsl:variable>
