...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Duodji/Juolluda-doarjaga-lullisami-fagagirjai-duojis'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_duodji_bevilger-stoette-til-soersamisk-fagbok-i-duodji.html"/></xsl:variable>
