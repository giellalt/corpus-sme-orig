...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/odda-ealahuspolitihkka-galga-sihkkarastit-positiivvalas-ealahusovdaneami-sami-guovlluin.22307.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'– Ođđa ealáhuspolitihkka galgá sihkkarastit positiivvalaš ealáhusovdáneami sámi guovlluin - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="_ny_naeringspolitikk_skal_sikre_positiv_naeringsutvikling_i_samiske_omrader.html"/>
