...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Valde-ovdan-hastalusaid-maid-sami-manat-ja-nuorat-deaividit-coahkkimis-ON-manaidkomiteain'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Válde ovdan hástalusaid maid sámi mánát ja nuorat deaividit, čoahkkimis ON mánáidkomiteain'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tok-opp-utfordringer-samiske-barn-og-unge-moeter-med-fns-barnekomite.html"/>
