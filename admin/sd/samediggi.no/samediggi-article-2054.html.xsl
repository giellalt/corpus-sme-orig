...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2054&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Kulturmuittuid registreren Ráissa álbmotmeahcis - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2054.html" xml:lang="nob"/>
</xsl:variable>
