...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/apningstale-ved-apning-av-studiearet-2022-23-ved-sami-allaskuvla.21697.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Rahpansárdni Sámi allaskuvlla oahppojagi 2022/23 rahpamis - Sámediggi'"/>
    <!--
