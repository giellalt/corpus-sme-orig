...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/likestilling/nyttige-ressurser/sametingsradets-likestillingspolitiske-redegjorelse-om-vold-i-samiske-samfunn/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggeráđi dásseárvopolitihkalaš čilgehus veahkaválddi birra sámi servodagas - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingsradets_likestillingspolitiske_redegjorelse_om_vold_i_samiske_samfunn.html"/>
