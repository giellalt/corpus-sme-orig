...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingspresidenten-et-resultat-av-regjeringens-umenneskelige-press-mot-reinbeitedistriktet.27858.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggepresideanta: - Boađus ráđđehusa olmmošmeahttumis deattus orohaga vuostá  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingspresidenten:_-_et_resultat_av_regjeringens_umenneskelige_press_mot_reinbeitedistriktet.html"/>
