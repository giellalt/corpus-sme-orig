...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=268&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámi IT-strategiijat - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-268.html" xml:lang="nob"/>
</xsl:variable>
