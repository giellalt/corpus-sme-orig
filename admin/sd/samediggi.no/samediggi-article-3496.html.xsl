...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3496&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Gáivuonas ii šatta álbmotčoahkkin  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3496.html" xml:lang="nob"/>
</xsl:variable>
