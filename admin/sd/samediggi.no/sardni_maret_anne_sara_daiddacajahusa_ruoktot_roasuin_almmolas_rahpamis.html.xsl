...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politikk/taler-og-innlegg/tale-ved-apningen-av-maret-anne-saras-kunstutstilling-ruoktot-roasuin.15859.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sárdni Máret Ánne Sara dáiddačájáhusa Ruoktot roasuin almmolaš rahpamis - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tale_ved_apningen_av_maret_anne_saras_kunstutstilling_ruoktot_roasuin.html"/>
