...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/historjjalas-bargu-odda-boazodoallolagas-maid-boazodoallolahkalavdegoddi-ovdanbukta.21867.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Historjjálaš bargu ođđa boazodoallolágas maid boazodoalloláhkalávdegoddi ovdanbuktá - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="historisk_arbeid_om_ny_reindriftslov_presenteres_av_reindriftslovutvalget.html"/>
