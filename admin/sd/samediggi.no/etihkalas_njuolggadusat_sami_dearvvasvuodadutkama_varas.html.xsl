...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/barnevern-helse-og-sosial/etiske-retningslinjer-for-samisk-helseforskning-og-kollektiv-samtykke/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Etihkalaš njuolggadusat sámi dearvvašvuođadutkama várás - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="etiske_retningslinjer_for_samisk_helseforskning.html"/>
