...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3659&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ođđa jođiheaddji válljejuvvon sámi giellalávdegotti ságadoallin - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3659.html" xml:lang="nob"/>
</xsl:variable>
