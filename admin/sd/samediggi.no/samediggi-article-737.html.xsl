...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=737&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki dievasčoahkkin juovlamánus - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-737.html" xml:lang="nob"/>
</xsl:variable>
