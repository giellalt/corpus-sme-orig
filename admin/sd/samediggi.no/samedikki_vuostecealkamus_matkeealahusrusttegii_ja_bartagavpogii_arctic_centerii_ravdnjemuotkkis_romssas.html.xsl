...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingets-innsigelse-til-reiselivsanlegget-og-hyttebyen-arctic-center-pa-ravdnjemuotki-finnheia-ved-tromso.4181.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikki vuostecealkámuš mátkeealáhusrusttegii ja bartagávpogii Arctic Centerii Rávdnjemuotkkis Romssas - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingets_innsigelse_til_reiselivsanlegget_og_hyttebyen_arctic_center_pa_ravdnjemuotki_finnheia_ved_tromso.html"/>
