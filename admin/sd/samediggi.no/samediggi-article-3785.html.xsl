...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3785&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Prošeakta &quot;Menneskejerven&quot; oažžu doarjaga Sámedikkis - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3785.html" xml:lang="nob"/>
</xsl:variable>
