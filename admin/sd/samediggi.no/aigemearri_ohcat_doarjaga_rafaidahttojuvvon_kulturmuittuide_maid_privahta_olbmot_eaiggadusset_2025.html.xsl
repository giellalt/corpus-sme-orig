...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/soknadsfrist-for-tilskudd-til-freda-kulturminner-i-privat-eie-2025.34058.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Áigemearri ohcat doarjaga ráfáidahttojuvvon kulturmuittuide maid priváhta olbmot eaiggáduššet, 2025 - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="soknadsfrist_for_tilskudd_til_freda_kulturminner_i_privat_eie_2025.html"/>
