...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/karen-marie-eira-buljo-er-mottaker-av-sametingets-sprakmotiveringspris-2021.15322.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Jusse Juhán Niillasa Gáre Márjá oažžu Sámedikki giellamovttiidahttinbálkkašumi 2021  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="karen_marie_eira_buljo_er_mottaker_av_sametingets_sprakmotiveringspris_2021_.html"/>
