...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/PRD-Samit-fuolas-go-boazoguohtunguovllut-main-juo-leat-ollu-sisabahkkemat-sahttet-rahppojuvvot-bieggafapmohuksemii'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: Sámit fuolas go boazoguohtunguovllut main juo leat ollu sisabahkkemat sáhttet rahppojuvvot bieggafápmohuksemii'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm-samisk-bekymring-over-at-allerede-sterkt-belastede-reinbeiteomraader-kan-aapnes-for-vindkraftutbygging.html"/>
