...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3735&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Rabas virgi, ohcanáigi: 14.06.10 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3735.html" xml:lang="nob"/>
</xsl:variable>
