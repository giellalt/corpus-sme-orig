...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3632&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Lihkku go ON erenoamášdieđiheaddji galleda Sámi juste dál - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3632.html" xml:lang="nob"/>
</xsl:variable>
