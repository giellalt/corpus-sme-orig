...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=308&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikkit ávžžuhit šiehtadallat ođđa boazoguotunšiehtadusa  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-308.html" xml:lang="nob"/>
</xsl:variable>
