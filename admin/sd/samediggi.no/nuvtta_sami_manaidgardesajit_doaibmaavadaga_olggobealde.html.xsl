...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/stipeanddat-ja-doarjagat/buot-doarjjaortnegat/manaidgardi/nuvtta-sami-manaidgardesajit-doaibmaavadaga-olggobealde/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nuvttá sámi mánáidgárdesajit doaibmaavádaga olggobealde - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="gratis_samiskspraklig_barnehageplass_utenfor_regjeringens_geografiske_prioritering_for_gratis_barnehageordning.html"/>
