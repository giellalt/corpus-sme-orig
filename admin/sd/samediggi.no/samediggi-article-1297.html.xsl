...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1297&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Boazodoalloláhka ii doala dási - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1297.html" xml:lang="nob"/>
</xsl:variable>
