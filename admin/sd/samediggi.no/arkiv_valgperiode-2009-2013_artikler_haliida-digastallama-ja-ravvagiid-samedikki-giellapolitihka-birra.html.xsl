...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Arkiv/Valgperiode-2009-2013/Artikler/Haliida-digastallama-ja-ravvagiid-Samedikki-giellapolitihka-birra'"/>
