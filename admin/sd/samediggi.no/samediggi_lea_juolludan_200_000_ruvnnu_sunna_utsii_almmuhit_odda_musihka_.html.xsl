...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/samediggi-lea-juolludan-200-000-ruvnnu-sunna-utsii-almmuhit-odda-musihka.22292.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi lea juolludan 200 000 ruvnnu Sunna Utsii almmuhit ođđa musihka  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_har_tildelt_200_000_-_kroner_til_sunna_utsi_for_utgivelse_av_samisk_musikk__.html"/>
