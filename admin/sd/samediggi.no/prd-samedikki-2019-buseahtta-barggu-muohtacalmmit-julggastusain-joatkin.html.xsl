...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Preassa/PRD-Samedikki-2019-buseahtta-barggu-Muohtacalmmit-julggastusain-joatkin'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: Sámedikki 2019 bušeahtta – barggu Muohtačalmmit julggaštusain joatkin'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm-sametingets-budsjett-for-2019-en-viderefoering-av-muohtacalmmit-erklaeringen.html"/>
