...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3738&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki dievasčoahkkin 2010 geassemánus - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3738.html" xml:lang="nob"/>
</xsl:variable>
