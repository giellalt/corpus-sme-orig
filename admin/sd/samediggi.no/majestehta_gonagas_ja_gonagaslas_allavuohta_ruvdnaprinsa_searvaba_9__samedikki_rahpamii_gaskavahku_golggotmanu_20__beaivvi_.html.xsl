...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/h-m-kongen-og-h-k-h-kronprinsen-vil-vare-til-stede-under-apningen-av-det-9-sametinget-onsdag-20-oktober-2021.16490.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Majestehta Gonagas ja Gonagaslaš Allavuohta Ruvdnaprinsa searvaba 9. Sámedikki rahpamii gaskavahku golggotmánu 20. beaivvi  - Sámediggi'"/>
    <!--
