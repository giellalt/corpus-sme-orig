...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3587&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sápmelaččain ja kvenain leat ollu seammalágan hástalusat - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3587.html" xml:lang="nob"/>
</xsl:variable>
