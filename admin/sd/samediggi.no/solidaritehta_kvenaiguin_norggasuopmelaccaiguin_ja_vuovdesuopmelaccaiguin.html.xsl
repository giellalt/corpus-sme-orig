...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/solidaritehta-kvenaiguin-norggasuopmelaccaiguin-ja-vuovdesuopmelaccaiguin.31523.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Solidaritehta kvenaiguin/norggasuopmelaččaiguin ja vuovdesuopmelaččaiguin - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingets_solidaritet_med_kvenene_norskfinnene_og_skogfinnene.html"/>
