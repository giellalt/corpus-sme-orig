...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/emil-karlsen-lea-dan-jagas-giellaloktenbalkkasumi-vuoiti.28106.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Emil Karlsen lea dán jagáš Giellaloktenbálkkašumi vuoiti - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="emil_karlsen_er_arets_vinner_av_sprakloftprisen_.html"/>
