...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3761&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámi oahpahus - vuoigatvuođat ja geatnegasvuođat - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3761.html" xml:lang="nob"/>
</xsl:variable>
