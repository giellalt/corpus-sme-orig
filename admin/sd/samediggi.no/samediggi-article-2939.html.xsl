...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2939&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Várrepresideantta Marianne Balto dearvvahansárdni ON bissovaš forumii  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2939.html" xml:lang="nob"/>
</xsl:variable>
