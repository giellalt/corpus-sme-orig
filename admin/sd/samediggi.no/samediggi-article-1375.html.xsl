...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1375&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Gulaskuddan - Sámegiela čiekŋudeapmi - Sámediggi Sametinget'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-1375.html'"/>
