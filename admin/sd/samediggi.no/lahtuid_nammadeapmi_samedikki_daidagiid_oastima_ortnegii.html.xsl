...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/oppnevning-av-medlemmer-til-sametingets-innkjopsordning-for-kunst.7322.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lahtuid nammadeapmi Sámedikki dáidagiid oastima ortnegii - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="oppnevning_av_medlemmer_til_sametingets_innkjopsordning_for_kunst.html"/>
