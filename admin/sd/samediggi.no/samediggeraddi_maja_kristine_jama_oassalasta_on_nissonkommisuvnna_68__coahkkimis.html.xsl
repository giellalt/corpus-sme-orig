...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/samediggeraddi-maja-kristine-jama-oassalasta-on-nissonkommisuvnna-68-coahkkimis.31587.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggeráđđi Maja Kristine Jåma oassálastá ON nissonkommišuvnna 68. čoahkkimis - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingsrad_maja_kristine_jama_deltar_pa_fns_68__kvinnekommisjon.html"/>
