...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/erklaring-offentliggjores-felles-verdigrunnlag-og-overordnede-prinsipper-til-barnehagetilbudet-og-for-opplaring-i-skolen-over-hele-sapmi.20533.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Julggaštus almmuhuvvo: “Oktasaš árvovuođđu ja bajit doaibmaprinsihpat mánáidgárdefálaldahkii ja oahpahussii miehtá Sámi”  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="erklaering_offentliggjores:_felles_verdigrunnlag_og_overordnede_prinsipper_til_barnehagetilbudet_og_for_opplaering_i_skolen_over_hele_sapmi_.html"/>
