...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3836&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggeráđđi doarju Noereh! - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3836.html" xml:lang="nob"/>
</xsl:variable>
