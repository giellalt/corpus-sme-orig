...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Eatnan-ja-resursavuoigatvuodat/Eananvuoigatvuodat/Finnmarkkulaga-cuovvoleapmi'"/>
	...
	<parallel_text xml:lang="nob" location="land-og-ressursrettigheter_landrettigheter_foelger-opp-finnmarksloven.html"/></xsl:variable>
