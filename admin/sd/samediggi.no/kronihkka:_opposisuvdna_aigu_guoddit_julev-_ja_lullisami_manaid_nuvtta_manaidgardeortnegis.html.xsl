...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/kronikk-opposisjonen-vil-utelate-lule-og-sorsamiske-barn-fra-ordningen-med-gratis-barnehage.28661.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kronihkka: Opposišuvdna áigu guođđit julev- ja lullisámi mánáid nuvttá mánáidgárdeortnegis - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="kronikk:_opposisjonen_vil_utelate_lule-_og_sorsamiske_barn_fra_ordningen_med_gratis_barnehage.html"/>
