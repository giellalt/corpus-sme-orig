...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3069&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Rabas virgi: Vuosttaškonsuleanta/ráđđeaddi – sadjásaš - Ref.nr. 09/2785 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3069.html" xml:lang="nob"/>
</xsl:variable>
