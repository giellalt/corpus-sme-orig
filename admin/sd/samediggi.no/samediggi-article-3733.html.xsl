...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3733&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Jahki sámi ofelažžan – mii darvána muitui! - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3733.html" xml:lang="nob"/>
</xsl:variable>
