...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/kulturmuito-ja-vistesuodjalus/avkkalas-resurssat/fagaraporttat/geahcadanraporta-2020-sami-kulturmuittuid-karten-ja-arvobidjan-svellingsflaket-eanadatsuodjalanguovllus-suohkaniin-lodingen-ja-vagan.8699.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Geahčadanraporta 2020. Sámi kulturmuittuid kárten ja árvobidjan Svellingsflaket eanadatsuodjalanguovllus - suohkaniin Lødingen ja Vågan - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="befaringsrapport_2020:_kartlegging_og_verdisetting_av_samiske_kulturminner_i_svellingsflaket_landskapsvernomrade_-_kommunene_lodingen_og_vagan.html"/>
