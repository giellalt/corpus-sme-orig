...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3847&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Viečča oahpponeavvuid nuvttá  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3847.html" xml:lang="nob"/>
</xsl:variable>
