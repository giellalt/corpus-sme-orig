...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3782&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Doarju sámi mánáidteáhtera - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3782.html" xml:lang="nob"/>
</xsl:variable>
