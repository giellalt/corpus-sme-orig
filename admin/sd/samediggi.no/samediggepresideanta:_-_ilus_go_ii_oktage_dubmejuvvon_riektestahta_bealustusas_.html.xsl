...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/sametingspresidenten-glad-for-at-ingen-ble-domt-for-sitt-forsvar-av-rettsstaten.31945.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggepresideanta: - Ilus go ii oktage dubmejuvvon riektestáhta bealuštusas  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingspresidenten:_-_glad_for_at_ingen_ble_domt_for_sitt_forsvar_av_rettsstaten.html"/>
