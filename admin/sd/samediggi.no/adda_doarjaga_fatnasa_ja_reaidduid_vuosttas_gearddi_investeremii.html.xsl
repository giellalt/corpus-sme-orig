...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/gir-tilskudd-til-forstegangsinvestering-i-fiskebat-og-redskaper.8953.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Addá doarjaga fatnasa ja reaidduid vuosttaš gearddi investeremii - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="gir_tilskudd_til_forstegangsinvestering_i_fiskebat_og_redskaper.html"/>
