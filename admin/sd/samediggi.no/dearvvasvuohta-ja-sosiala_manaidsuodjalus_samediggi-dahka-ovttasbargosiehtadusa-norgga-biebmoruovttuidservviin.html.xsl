...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Dearvvasvuohta-ja-sosiala/Manaidsuodjalus/Samediggi-dahka-ovttasbargosiehtadusa-Norgga-biebmoruovttuidservviin'"/>
	...
	<parallel_text xml:lang="nob" location="helse-og-sosial_barnevern_inngaar-samarbeidsavtale-med-norsk-fosterhjemsforening.html"/></xsl:variable>
