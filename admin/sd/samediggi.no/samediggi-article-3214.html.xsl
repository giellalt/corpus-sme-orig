...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3214&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Dárogiel- lullisámegiela sátnegirji lea vuovdimassii golggotmánu 29. beaivvi rájis.   - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3214.html" xml:lang="nob"/>
</xsl:variable>
