...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-og-norsk-fosterhjemsforening-skal-sikre-rettigheter-til-samiske-fosterbarn.21037.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi ja Norsk Fosterhjemsforening áigut nannet sámi mánáid vuoigatvuođaid geat leat biebmoruovttuin  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_og_norsk_fosterhjemsforening_skal_sikre_rettigheter_til_samiske_fosterbarn.html"/>
