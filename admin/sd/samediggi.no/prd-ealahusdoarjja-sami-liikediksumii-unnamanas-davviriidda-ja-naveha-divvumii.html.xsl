...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/PRD-Ealahusdoarjja-sami-liikediksumii-unnamanas-davviriidda-ja-naveha-divvumii'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: Ealáhusdoarjja sámi liikedikšumii, unnamánáš dávviriidda ja náveha divvumii'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm-naeringsstoette-til-samisk-hudpleie-babyutstyr-og-fjoesombygging.html"/>
