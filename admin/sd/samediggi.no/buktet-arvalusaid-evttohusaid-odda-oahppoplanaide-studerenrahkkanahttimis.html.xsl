...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Buktet-arvalusaid-evttohusaid-odda-oahppoplanaide-studerenrahkkanahttimis'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Buktet árvalusaid – evttohusaid ođđa oahppoplánaide studerenráhkkanahttimis'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="gi-innspill-skisser-til-nye-laereplaner-paa-studieforberedende.html"/>
