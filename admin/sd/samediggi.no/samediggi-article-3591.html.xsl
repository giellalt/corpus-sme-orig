...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3591&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki ođđa bargoortnet - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3591.html" xml:lang="nob"/>
</xsl:variable>
