...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3475&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggi ii áiggo gieldit sámegávtti geavaheames rievttis - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3475.html" xml:lang="nob"/>
</xsl:variable>
