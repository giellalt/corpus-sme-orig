...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Lohkkiidcalus-Veaikeruvke-ii-sahte-gadjut-mailmmi-dalkkadaga'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lohkkiidčálus: Veaikeruvke ii sáhte gádjut máilmmi dálkkádaga'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="leserinnlegg-ei-kobbergruve-kan-ikke-berge-verdens-klima.html"/>
