...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Valga-ja-jienastuslohku/Kampanjeside/Bellodagat-Valgabargit/Gosa-galget-ovddalgihtiijienastagat-saddejuvvot'"/>
	...
	<parallel_text xml:lang="nob" location="valg-og-manntall_kampanjeside_partier-valgmedarbeidere_hvor-skal-forhaandsstemmene-sendes.html"/></xsl:variable>
