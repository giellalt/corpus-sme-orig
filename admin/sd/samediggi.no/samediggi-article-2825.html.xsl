...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2825&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ođđa áŋgiruššamat Sámedikki jienastuslogu ektui - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2825.html" xml:lang="nob"/>
</xsl:variable>
