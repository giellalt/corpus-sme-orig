...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1101&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Davveoarjesámi museasiida lea vuođđuduvvon - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1101.html" xml:lang="nob"/>
</xsl:variable>
