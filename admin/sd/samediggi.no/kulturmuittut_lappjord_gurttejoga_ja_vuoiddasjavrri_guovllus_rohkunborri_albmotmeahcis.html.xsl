...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/kultuvrramujtto-ja-huonajsuodjalus/avkalasj-ressursa/fagrapporter/kulturminner-ved-lappjord-gurttejohka-og-budalsvatnet-vuoiddasjavri-i-rohkunborri-nasjonalpark.18074.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kulturmuittut Lappjord, Gurttejoga ja Vuoiddasjávrri guovllus Rohkunborri álbmotmeahcis - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="kulturminner_ved_lappjord_gurttejohka_og_budalsvatnet_vuoiddasjavri_i_rohkunborri_nasjonalpark.html"/>
