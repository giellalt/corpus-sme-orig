...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/PRD-WALT-DISNEY-ANIMATION-STUDIOS-RAHKADA-DAVVISAMI-VERSUVNNA-FROZEN-2-FILMMAS'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: WALT DISNEY ANIMATION STUDIOS RÁHKADA DAVVISÁMI VERŠUVNNA FROZEN 2 FILMMAS'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm-samisk-versjon-av-frozen-2.html"/>
