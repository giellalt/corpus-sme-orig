...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3297&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'S&#225;medikki l&#225;vdegottit 2009 - 2013 &#225;igodahkii - S&#225;mediggi Sametinget'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-3297.html'"/>
