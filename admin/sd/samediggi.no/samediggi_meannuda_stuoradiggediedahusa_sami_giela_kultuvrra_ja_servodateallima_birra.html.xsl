...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/sametinget-behandler-stortingsmelding-om-samisk-sprak-kultur-og-samfunnsliv.26161.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi meannuda stuoradiggedieđáhusa sámi giela, kultuvrra ja servodateallima birra - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_behandler_stortingsmelding_om_samisk_sprak_kultur_og_samfunnsliv.html"/>
