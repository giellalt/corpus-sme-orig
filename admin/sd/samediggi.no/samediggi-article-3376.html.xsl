...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3376&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámeálbmotfoandda vuoruheamit 2009 - 2013 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3376.html" xml:lang="nob"/>
</xsl:variable>
