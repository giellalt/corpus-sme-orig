...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/tildeler-over-2-3-millioner-kroner-til-utgivelse-av-samisk-skjonn-og-faglitteratur.10747.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Juolluda badjel 2,3 miljovnna ruvnna sámi čáppagirjjálašvuođa- ja fágagirjjálašvuođa almmuheapmái - Sámediggi'"/>
    <!--
