...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3961&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Vuoruhit mánáid, nuoraid, boarrásiid ja kultuvrra - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3961.html" xml:lang="nob"/>
</xsl:variable>
