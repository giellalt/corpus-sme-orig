...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3653&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Presideantta mátki dievva vásáhusaiguin - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3653.html" xml:lang="nob"/>
</xsl:variable>
