...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1833&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ohcan Sámedikkis - Sámedikki girjeradju - Sametingets bilbiotek'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1833.html" xml:lang="nob"/>
</xsl:variable>
