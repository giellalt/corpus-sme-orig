...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/gruppemoter-komitemoter-og-plenumsmote-8-11-juni.4798.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Joavkočoahkkimat, lávdegoddečoahkkimat ja dievasčoahkkin geassemánu 8.- 11. b. - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="gruppemoter_komitemoter_og_plenumsmote_8__-_11__juni.html"/>
