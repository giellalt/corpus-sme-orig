...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Boazodoallu/Juolluda-300-000-ruvnno-ovddidit-NBR'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_reindrift_bevilger-300-000-til-aa-utvikle-nrl.html"/></xsl:variable>
