...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politikk/taler-og-innlegg/hilsningstale-fra-sametinget-i-sverige-under-apningen-av-sametinget-i-norge.17086.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dearvuođasárdni ruoŧabeal Sámedikkis norgga Sámedikki rahpamii - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="hilsningstale_fra_sametinget_i_sverige_under_apningen_av_sametinget_i_norge.html"/>
