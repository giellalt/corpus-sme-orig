...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-skal-vare-en-tydelig-stemme-for-a-forebygge-vold-mot-kvinner.17951.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'– Sámediggi galgá leat čielga jietna veahkaválddi eastadeamis nissonolbmuid vuostá. - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="_sametinget_skal_vaere_en_tydelig_stemme_for_a_forebygge_vold_mot_kvinner.html"/>
