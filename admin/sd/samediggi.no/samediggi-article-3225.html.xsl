...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3225&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Stipeanda joatkkaskuvlla ohppiide geain lea sámegiella - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3225.html" xml:lang="nob"/>
</xsl:variable>
