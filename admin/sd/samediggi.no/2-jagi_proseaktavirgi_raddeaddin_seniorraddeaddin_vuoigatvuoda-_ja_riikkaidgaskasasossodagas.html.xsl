...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/2-jagi-proseaktavirgi-raddeaddin-seniorraddeaddin-vuoigatvuoda-ja-riikkaidgaskasasossodagas.25001.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'2-jagi prošeaktavirgi ráđđeaddin/seniorráđđeaddin Vuoigatvuođa- ja riikkaidgaskasašossodagas - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="to-arig_prosjektstilling_i_avdeling_for_rettigheter_og_internasjonale_sporsmal.html"/>
