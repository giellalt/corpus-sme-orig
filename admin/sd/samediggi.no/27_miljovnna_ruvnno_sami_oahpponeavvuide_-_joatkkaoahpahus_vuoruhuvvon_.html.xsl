...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/27-millioner-kroner-til-samiske-laremidler-videregaende-opplaring-prioritert.26894.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'27 miljovnna ruvnno sámi oahpponeavvuide – joatkkaoahpahus vuoruhuvvon  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="27_millioner_kroner_til_samiske_laeremidler_-_videregaende_opplaering_prioritert.html"/>
