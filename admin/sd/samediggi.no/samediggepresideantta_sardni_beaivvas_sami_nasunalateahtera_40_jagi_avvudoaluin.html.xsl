...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politikk/taler-og-innlegg/sametingspresidentens-tale-i-anledning-40-ars-markeringen-til-beaivvas-sami-nasunalateahter.15248.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggepresideantta sárdni Beaivváš Sámi Našunálateáhtera 40 jagi ávvudoaluin - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingspresidentens_tale_i_anledning_40_ars_markeringen_til_beaivvas_sami_nasunalateahter.html"/>
