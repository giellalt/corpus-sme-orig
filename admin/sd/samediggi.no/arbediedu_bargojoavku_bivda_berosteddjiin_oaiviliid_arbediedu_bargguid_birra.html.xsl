...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/hoyere-utdanning-og-forskning/prosjektet-arbediehtu/arbeidsgruppen-for-arbediehtu-ber-om-innspill-fra-aktorer-innen-arbediehtu/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Árbedieđu bargojoavku bivdá berošteddjiin oaiviliid árbedieđu bargguid birra - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="arbeidsgruppen_for_arbediehtu_ber_om_innspill_fra_aktorer_innen_arbediehtu.html"/>
