...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3771&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Háliidit deaivat sápmelaččaid Trøndelagas  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3771.html" xml:lang="nob"/>
</xsl:variable>
