...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=413&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'*Politihkka ja demokratiija - Áirasiide - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-413.html" xml:lang="nob"/>
</xsl:variable>
