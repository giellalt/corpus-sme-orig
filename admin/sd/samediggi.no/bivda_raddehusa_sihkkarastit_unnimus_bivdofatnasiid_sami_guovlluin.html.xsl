...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/ber-regjeringen-sikre-den-minste-flaten-i-de-samiske-omradene.25293.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bivdá ráđđehusa sihkkarastit unnimus bivdofatnasiid sámi guovlluin - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="ber_regjeringen_sikre_den_minste_flaten_i_de_samiske_omradene.html"/>
