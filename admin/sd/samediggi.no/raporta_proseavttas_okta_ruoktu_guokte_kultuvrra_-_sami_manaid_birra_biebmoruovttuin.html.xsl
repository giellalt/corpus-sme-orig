...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/rapport-om-prosjektet-et-hjem-to-kulturer-om-samiske-barn-i-fosterhjem.31645.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Raporta prošeavttas «Okta ruoktu, guokte kultuvrra» - sámi mánáid birra biebmoruovttuin - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="rapport_om_prosjektet_et_hjem_to_kulturer_om_samiske_barn_i_fosterhjem.html"/>
