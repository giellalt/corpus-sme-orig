...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=4004&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sámediggi gitta čakčamánu 9. ja 10. beivviid - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-4004.html" xml:lang="nob"/>
</xsl:variable>
