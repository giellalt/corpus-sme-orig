...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3279&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Movt bargit ja áirasat loggejit sisa  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3279.html" xml:lang="nob"/>
</xsl:variable>
