...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3100&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Doarjja searvat Sámediggeválgii - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3100.html" xml:lang="nob"/>
</xsl:variable>
