...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Samediggi-juolluda-doarjaga-avvogirjai-Beaivvas-ja-konsertii-Roerosas-Marja-Mortensson-ja-KORK-bokte'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi juolluda doarjaga ávvogirjái Beaivváš ja konsertii Rørosas Marja Mortensson ja KORK bokte'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget-bevilger-stoette-til-jubileumsbok-til-beaivvas-og-konsert-paa-roeros-med-marja-mortensson-og-kork.html"/>
