...
<xsl:variable name="filename" select="'http://www.sametinget.no/artikkel.aspx?AId=2687&amp;Print=1'"/>
<xsl:variable name="title" select="'Stipend for elever med samisk i fagkretsen i videregående skole'"/>
