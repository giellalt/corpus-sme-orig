...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1740&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Raporta Sámedikki formálalaš sajádaga ja bušeahttavugiid birra  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1740.html" xml:lang="nob"/>
</xsl:variable>
