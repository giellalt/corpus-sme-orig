...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/badjel-1-3-miljovnna-ruvnno-sami-kulturdoaimmaide-ja-proseavttaide.33088.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Badjel 1,3 miljovnna ruvnno sámi kulturdoaimmaide ja -prošeavttaide - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="over_1_3_millioner_i_stotte_til_samiske_kulturformal-_og_prosjekter.html"/>
