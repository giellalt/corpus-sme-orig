...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2326&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggi vuostá rievdadusaid mearraluossa-bivddus - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2326.html" xml:lang="nob"/>
</xsl:variable>
