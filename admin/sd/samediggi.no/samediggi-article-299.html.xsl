...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=299&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Dearvvášlágádus ferte váldit stuorit ovddasvástádusa sámi dearvvašvuođa- ja sosiálabálvalusaid ovddas - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'53'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-299.html" xml:lang="nob"/>
</xsl:variable>
