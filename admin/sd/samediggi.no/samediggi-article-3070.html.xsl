...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3070&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Rabas virgi: Ráđđeaddi/Seniorráđđeaddi – bistevaš virgi - ref. nr. 09/2784 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3070.html" xml:lang="nob"/>
</xsl:variable>
