...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/om-sametinget/administrasjonen/statistikk-fra-sametinget/statistikk-fra-sametinget-2-publikasjon-april-2018.16076.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikki statistihkka - 2. publikašuvdna (cuoŋománnu 2018) - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="statistikk_fra_sametinget_-_2__publikasjon_april_2018_.html"/>
