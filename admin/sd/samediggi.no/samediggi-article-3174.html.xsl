...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3174&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Don sáhtát rievdadit jienastuslihpu - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3174.html" xml:lang="nob"/>
</xsl:variable>
