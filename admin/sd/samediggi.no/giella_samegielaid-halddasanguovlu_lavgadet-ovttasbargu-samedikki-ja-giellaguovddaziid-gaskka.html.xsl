...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Giella/Samegielaid-halddasanguovlu/Lavgadet-ovttasbargu-Samedikki-ja-giellaguovddaziid-gaskka'"/>
	...
	<parallel_text xml:lang="nob" location="spraak_forvaltningsomraade_tettere-samarbeid-mellom-sametinget-og-spraaksentrene.html"/></xsl:variable>
