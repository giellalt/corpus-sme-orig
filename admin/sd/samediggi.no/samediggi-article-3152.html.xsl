...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3152&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Válgaprográmmat - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3152.html" xml:lang="nob"/>
</xsl:variable>
