...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Balvalusat2/Biras-areala-ja-kultursuodjaleapmi/Siehtadus-Samedikki-ja-Birasgahttendepartemeantta-gaskka-suodjalanplanabarggu-njuolggadusaid-harrai-luondduvalljodatlaga-mielde-sami-guovlluin'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Šiehtadus Sámedikki ja Birasgáhttendepartemeantta gaskka suodjalanplánabarggu njuolggadusaid hárrái luondduvalljodatlága mielde sámi guovlluin'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="avtale-mellom-sametinget-og-miljoeverndepartementet-om-retningslinjer-for-verneplanarbeid-etter-naturvernloven-i-samiske-omraader.html"/>
