...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Mearraealahusat/Algoalbmotjietna-ferte-gullot-luondduluosa-halddaseamis'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_marine-naeringer_urfolksstemmen-maa-bli-hoert-i-forvaltningen-av-villaks.html"/></xsl:variable>
