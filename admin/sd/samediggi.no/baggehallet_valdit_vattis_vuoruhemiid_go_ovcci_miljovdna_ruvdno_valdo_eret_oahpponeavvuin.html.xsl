...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/ni-millioner-i-kutt-i-laremidler-tvinger-sametinget-til-a-gjore-vanskelige-prioriteringer.22716.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bággehallet váldit váttis vuoruhemiid go ovcci miljovdna ruvdno váldo eret oahpponeavvuin - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="ni_millioner_i_kutt_i_laeremidler_tvinger_sametinget_til_a_gjore_vanskelige_prioriteringer.html"/>
