...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/samisk-legeforening-far-okt-direktestilskudd-og-stotte-til-seminar-om-helse-for-eldre-samer-i-oslo.22643.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámi doaktáriid searvi oažžu lasi njuolggodoarjaga ja doarjaga seminára lágideapmái dearvvašvuođa birra sámi vuorasolbmuide Oslos - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="samisk_legeforening_far_okt_direktestilskudd_og_stotte_til_seminar_om_helse_for_eldre_samer_i_oslo_.html"/>
