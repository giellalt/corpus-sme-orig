...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Sardni-NBR-riikacoahkkimii-Mii-aigut-nannet-ja-ovddidit-boazodoalu'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sárdni NBR riikačoahkkimii: - Mii aigut nannet ja ovddidit boazodoalu'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tale-til-nrl-sitt-landsmoete-vi-skal-styrke-og-utvikle-reindriften.html"/>
