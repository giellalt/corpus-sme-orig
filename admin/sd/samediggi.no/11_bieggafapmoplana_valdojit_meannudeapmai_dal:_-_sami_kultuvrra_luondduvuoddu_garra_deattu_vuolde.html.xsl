...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/11-vindkraftplaner-tas-til-behandling-na-naturgrunnlaget-for-samisk-kultur-under-et-enormt-press.32926.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'11 bieggafápmoplána váldojit meannudeapmái dál: – Sámi kultuvrra luondduvuođđu garra deattu vuolde - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="11_vindkraftplaner_tas_til_behandling_na:_-_naturgrunnlaget_for_samisk_kultur_under_et_enormt_press_.html"/>
