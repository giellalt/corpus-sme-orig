...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3210&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Fierpmádatčoahkkin mánáidgárdebargiide geat barget lullisámi mánáiguin - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3210.html" xml:lang="nob"/>
</xsl:variable>
