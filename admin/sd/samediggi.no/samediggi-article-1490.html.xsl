...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1490&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Sámediggeráđi mielas lea buorre go guovllubivdoearreortnet evaluerejuvvo - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1490.html" xml:lang="nob"/>
</xsl:variable>
