...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/foreslar-at-sametinget-prioriterer-8-1-millioner-kroner-til-utvikling-av-samisk-tradisjonskunnskap.14455.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Evttoha Sámedikki vuoruhit 8,1 miljon kruvnnu bušeahtas sámi árbevirolaš máhtu ovddideapmái - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="foreslar_at_sametinget_prioriterer_8_1_millioner_kroner_til_utvikling_av_samisk_tradisjonskunnskap.html"/>
