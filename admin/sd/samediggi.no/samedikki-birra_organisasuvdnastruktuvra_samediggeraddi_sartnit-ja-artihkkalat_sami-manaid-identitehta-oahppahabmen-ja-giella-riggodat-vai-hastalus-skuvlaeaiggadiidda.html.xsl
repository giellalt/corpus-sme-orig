...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Samedikki-birra/Organisasuvdnastruktuvra/Samediggeraddi/Sartnit-ja-artihkkalat/Sami-manaid-identitehta-oahppahabmen-ja-giella-riggodat-vai-hastalus-skuvlaeaiggadiidda'"/>
	...
	<parallel_text xml:lang="nob" location="om-sametinget_organisasjonsstruktur_sametingsraadet_taler-og-artikler_samiske-elever-en-berikelse-eller-en-utfordring-for-skoleeiere.html"/></xsl:variable>
