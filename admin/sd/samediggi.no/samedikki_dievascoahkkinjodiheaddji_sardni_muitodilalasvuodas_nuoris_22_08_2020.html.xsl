...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politihkka/sartnit-ja-sahkavuorut/samedikki-dievascoahkkinjodiheaddji-sardni-muitodilalasvuodas-nuoris-22-08-2020.7859.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikki dievasčoahkkinjođiheaddji sárdni muitodilálašvuođas Nuoris 22.08.2020 - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingets_plenumsleders_tale_ved_minnemarkeringen_pa_hopseidet.html"/>
