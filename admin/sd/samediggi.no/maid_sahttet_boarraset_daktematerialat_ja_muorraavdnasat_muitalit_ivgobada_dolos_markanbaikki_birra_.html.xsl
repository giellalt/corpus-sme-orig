...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/hva-kan-eldre-beinmateriale-og-treverk-fortelle-om-den-gamle-markedsplassen-i-skibotn.14965.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Maid sáhttet boarráset dáktemateriálat ja muorraávdnasat muitalit Ivgobađa dološ márkanbáikki birra? - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="hva_kan_eldre_beinmateriale_og_treverk_fortelle_om_den_gamle_markedsplassen_i_skibotn_.html"/>
