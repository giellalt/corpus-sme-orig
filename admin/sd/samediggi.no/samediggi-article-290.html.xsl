...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=290&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámi divvunprográmma elekrovnnalaš teakstagieđahallama várás - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-290.html" xml:lang="nob"/>
</xsl:variable>
