...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=94&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Gollegiella - Davviriikkalaš sámi giellabálkkašupmi 2006  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-94.html" xml:lang="nob"/>
</xsl:variable>
