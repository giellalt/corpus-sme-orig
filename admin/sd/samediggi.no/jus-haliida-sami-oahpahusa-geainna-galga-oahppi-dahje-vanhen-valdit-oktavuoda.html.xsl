...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Balvalusat2/Oahpahus-ja-oahpponeavvut/Jus-haliida-sami-oahpahusa-geainna-galga-oahppi-dahje-vanhen-valdit-oktavuoda'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Jus háliida sámi oahpahusa – geainna galgá oahppi dahje vánhen váldit oktavuođa'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="oenske-om-samisk-opplaering-hvor-skal-foreldre-henvende-seg.html"/>
