...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=487&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Stipeanda oahpaheaddjiohppui ja alit dási sámegielohppui  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-487.html" xml:lang="nob"/>
</xsl:variable>
