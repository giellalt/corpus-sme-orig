...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/invitasjon-til-a-foresla-kandidater-til-sametingets-ungdomspolitiske-utvalg-supu.19414.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bovdehus evttohit kandidáhtaid Sámedikki nuoraidpolitihkalaš lávdegoddái (SáNuL) - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="invitasjon_til_a_foresla_kandidater_til_sametingets_ungdomspolitiske_utvalg_supu_.html"/>
