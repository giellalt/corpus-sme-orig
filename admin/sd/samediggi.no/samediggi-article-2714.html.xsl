...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2714&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki lávdegoddečoahkkimat 2008 čakčamánus - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2714.html" xml:lang="nob"/>
</xsl:variable>
