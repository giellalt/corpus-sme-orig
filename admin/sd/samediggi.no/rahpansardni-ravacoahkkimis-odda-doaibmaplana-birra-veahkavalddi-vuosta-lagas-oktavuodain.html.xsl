...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Rahpansardni-ravacoahkkimis-odda-doaibmaplana-birra-veahkavalddi-vuosta-lagas-oktavuodain'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Rahpansárdni rávačoahkkimis ođđa doaibmaplána birra veahkaválddi vuostá lagaš oktavuođain'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="aapningstale-ved-innspillsmoetet-til-ny-handlingsplan-mot-vold-i-naere-relasjoner.html"/>
