...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3022&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Nuortasámi musea Deanu ja Várjjat museasiidda vuođđudussii - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3022.html" xml:lang="nob"/>
</xsl:variable>
