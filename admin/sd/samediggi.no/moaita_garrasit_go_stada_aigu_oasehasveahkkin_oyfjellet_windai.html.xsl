...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sterkt-kritisk-til-at-staten-vil-ga-inn-som-partshjelp-for-oyfjellet-wind.20506.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Moaitá garrasit go stáda áigu oasehasveahkkin Øyfjellet Windai - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sterkt_kritisk_til_at_staten_vil_ga_inn_som_partshjelp_for_oyfjellet_wind.html"/>
