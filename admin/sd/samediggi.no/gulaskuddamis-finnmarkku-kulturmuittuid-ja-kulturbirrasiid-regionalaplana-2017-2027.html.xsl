...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Samedikki-birra2/Arkiiva-aigodat-2016-2017/Odasarkiiva/Gulaskuddamis-Finnmarkku-kulturmuittuid-ja-kulturbirrasiid-regionalaplana-2017-2027'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Gulaskuddamis: Finnmárkku kulturmuittuid ja kulturbirrasiid regionálaplána 2017-2027'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="regional-plan-for-kulturminner-paa-hoering.html"/>
