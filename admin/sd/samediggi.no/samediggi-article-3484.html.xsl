...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3484&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggi juolluda 10 000 ruvnno Rukses Russii - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3484.html" xml:lang="nob"/>
</xsl:variable>
