...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/gleder-seg-til-etablering-av-sapmi-business-arena-og-samisk-naringskonferanse.15595.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Illuda Sápmi Business Arena ásaheapmái ja sámi ealáhuskonferánsii - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="gleder_seg_til_etablering_av_sapmi_business_arena_og_samisk_naeringskonferanse.html"/>
