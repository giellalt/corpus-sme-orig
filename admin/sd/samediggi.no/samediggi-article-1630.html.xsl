...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1630&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Sámediggi sávvá lihku G.M. Gonagas Harald Vii riegádanbeivviin - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1630.html" xml:lang="nob"/>
</xsl:variable>
