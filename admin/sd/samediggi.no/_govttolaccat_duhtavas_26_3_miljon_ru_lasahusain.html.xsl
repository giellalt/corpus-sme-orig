...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/rimelig-fornoyd-med-okningen-pa-26-3-mill-kroner-i-statsbudsjettet.8278.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'– Govttolaččat duhtavaš 26,3 miljon ru lasáhusain - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="_rimelig_fornoyd_med_okningen_pa_26_3_mill__kroner_i_statsbudsjettet.html"/>
