...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=776&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Sámediggi bivdá ráđđehusa čilget WTO-šiehtadallamiid birra - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-776.html" xml:lang="nob"/>
</xsl:variable>
