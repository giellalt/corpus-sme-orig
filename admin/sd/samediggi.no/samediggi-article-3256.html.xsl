...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3256&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Dáiddačájáhus – Sámepolitihkka ovdal...dál...boahtte áiggis... - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3256.html" xml:lang="nob"/>
</xsl:variable>
