...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/3-3-miljovnna-ruvnnu-ovddidit-pedagogalas-avdnasiid-manaidgarddiide.33114.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'3,3 miljovnna ruvnnu ovddidit pedagogalaš ávdnasiid mánáidgárddiide - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="3_3_millioner_til_utvikling_av_pedagogisk_materiell_i_barnehager.html"/>
