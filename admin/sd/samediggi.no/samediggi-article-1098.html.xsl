...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1098&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggepresideanta sávvá hálddašanođastussii bures boahtin    - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1098.html" xml:lang="nob"/>
</xsl:variable>
