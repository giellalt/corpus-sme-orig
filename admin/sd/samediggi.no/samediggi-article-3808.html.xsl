...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3808&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'12 500 evro geigejuvvo – lea áigi evttohit kandidáhtaid GOLLEGIELLA sámi giellabálkkašupmái  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3808.html" xml:lang="nob"/>
</xsl:variable>
