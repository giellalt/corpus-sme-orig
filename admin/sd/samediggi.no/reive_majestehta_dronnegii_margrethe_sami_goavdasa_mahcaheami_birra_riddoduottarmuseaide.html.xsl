...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/brev-til-h-m-dronning-margrethe-om-repatriering-av-samisk-tromme-til-riddoduottarmuseat.16507.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Reive Majestehta Dronnegii Margrethe sámi goavdása máhcaheami birra RiddoDuottarMuseaide - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="brev_til_h_m__dronning_margrethe_om_repatriering_av_samisk_tromme_til_riddoduottarmuseat.html"/>
