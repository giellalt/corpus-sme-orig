...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3134&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Rabas virgi: Ráđđeaddi/seniorráđđeaddi - gulahallan - bistevaš virgi - 2. almmuheapmi - Ref.nr. 09/1629 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3134.html" xml:lang="nob"/>
</xsl:variable>
