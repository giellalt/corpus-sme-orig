...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-stotter-nytt-utsalgssted-for-samisk-design-og-duodji-pa-nordnorsk-kunstmuseum.1832.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi doarju ođđa vuovdinbáikki sámi designii ja duodjái Nordnorsk Kunstmuseumas - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_stotter_nytt_utsalgssted_for_samisk_design_og_duodji_pa_nordnorsk_kunstmuseum.html"/>
