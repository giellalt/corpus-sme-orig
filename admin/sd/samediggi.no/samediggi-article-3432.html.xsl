...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3432&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Retter, Gunn-Britt - Sámediggi Sametinget'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-3432.html'"/>
