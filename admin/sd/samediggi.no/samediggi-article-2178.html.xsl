...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2178&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Bajit njuolggadusat daid doarjagiid hálddašeami odasmahttin maid Sámedikkis sáhttá ohcat - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2178.html" xml:lang="nob"/>
</xsl:variable>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               ...
               <xsl:with-param name="target" select="'Sámediddi/'"/>
               <xsl:with-param name="replacement" select="'Sámediggi/'"/>
