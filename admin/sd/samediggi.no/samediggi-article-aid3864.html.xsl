...
<xsl:variable name="filename" select="'http://www.sametinget.no/artikkel.aspx?AId=3864&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets komitémøter i september 2010'"/>
