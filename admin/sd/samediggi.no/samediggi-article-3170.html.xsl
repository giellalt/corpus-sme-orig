...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3170&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Heahtediehtobálvalus konsulterejuvvo odne - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3170.html" xml:lang="nob"/>
</xsl:variable>
