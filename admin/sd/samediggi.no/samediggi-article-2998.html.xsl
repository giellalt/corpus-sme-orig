...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2998&amp;sprak=Samisk&amp;Print=1'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2998.html" xml:lang="nob"/>
</xsl:variable>
