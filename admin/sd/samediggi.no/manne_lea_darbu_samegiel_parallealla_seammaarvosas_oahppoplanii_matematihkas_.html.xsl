...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/hvorfor-det-er-nodvendig-med-en-samisk-parallell-likeverdig-lareplan-i-matematikk.32144.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Manne lea dárbu sámegiel parallealla seammaárvosaš oahppoplánii matematihkas  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="hvorfor_det_er_nodvendig_med_en_samisk_parallell_likeverdig_laereplan_i_matematikk.html"/>
