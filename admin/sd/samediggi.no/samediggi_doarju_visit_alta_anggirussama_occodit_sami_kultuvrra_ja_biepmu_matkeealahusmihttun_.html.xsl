...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/sametinget-stotter-visit-altas-satsing-pa-samisk-kultur-og-mat-som-reiselivsmal.34897.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi doarju Visit Alta áŋgiruššama oččodit sámi kultuvrra ja biepmu mátkeealáhusmihttun. - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_stotter_visit_altas_satsing_pa_samisk_kultur_og_mat_som_reiselivsmal.html"/>
