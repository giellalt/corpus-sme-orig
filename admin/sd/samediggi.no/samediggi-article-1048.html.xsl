...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1048&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Eanandoallo- ja biebmoministtar galleda Sámedikki - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1048.html" xml:lang="nob"/>
</xsl:variable>
