...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/vuoddooahpahus/oahpponeavvut/oahpponeavvoguovddas/koaffar-sami-sisdoaluin-luoikamassii-manaidgarddiide/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Koaffar sámi sisdoaluin luoikamassii mánáidgárddiide  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="koffert_med_samisk_innhold_til_utlan_til_barnehager.html"/>
