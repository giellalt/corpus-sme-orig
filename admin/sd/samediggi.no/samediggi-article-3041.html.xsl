...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3041&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: - Buorre ahte KS doarju sámegielat skuvlafálaldagaid - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3041.html" xml:lang="nob"/>
</xsl:variable>
