...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2889&amp;sprak=Samisk&amp;Print=1'"/>
...
<xsl:variable name="wordcount" select="'10'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-2889.html'"/>
