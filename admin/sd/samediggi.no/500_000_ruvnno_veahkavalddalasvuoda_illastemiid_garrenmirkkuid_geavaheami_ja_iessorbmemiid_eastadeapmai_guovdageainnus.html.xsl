...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/500-000-kroner-til-forebygging-av-vold-overgrep-rus-og-selvmord-i-kautokeino.34978.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'500.000 ruvnno veahkaválddálašvuođa, illastemiid, gárrenmirkkuid geavaheami ja iešsorbmemiid eastadeapmái Guovdageainnus - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="500_000_kroner_til_forebygging_av_vold_overgrep_rus_og_selvmord_i_kautokeino.html"/>
