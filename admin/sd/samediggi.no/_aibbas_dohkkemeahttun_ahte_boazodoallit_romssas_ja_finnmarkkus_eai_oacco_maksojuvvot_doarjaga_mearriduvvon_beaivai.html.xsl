...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/totalt-uakseptabelt-at-reineiere-i-troms-og-finnmark-ikke-far-utbetalt-tilskuddet-til-fastsatt-dato.21399.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'– Áibbas dohkkemeahttun ahte boazodoallit Romssas ja Finnmárkkus eai oaččo máksojuvvot doarjaga mearriduvvon beaivái - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="_totalt_uakseptabelt_at_reineiere_i_troms_og_finnmark_ikke_far_utbetalt_tilskuddet_til_fastsatt_dato.html"/>
