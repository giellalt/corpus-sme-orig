...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1450&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Gulaskuddan: Oahpahusa prinsihpat Máhttolokten - Sámi oahppoplánabuktosis - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1450.html" xml:lang="nob"/>
</xsl:variable>
