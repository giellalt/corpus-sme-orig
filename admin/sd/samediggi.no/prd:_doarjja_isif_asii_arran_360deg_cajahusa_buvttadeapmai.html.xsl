...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/prd-doarjja-isif-asii-arran-360-cajahusa-buvttadeapmai.21908.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: Doarjja ISIF ASii ÁRRÁN 360° čájáhusa buvttadeapmái - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm:_stotte_til_isfi_as_for_produksjoner_og_utstilling_for_arran_360deg.html"/>
