...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2987&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggi lea juolludan 10, 2 miljon ru ealáhus- ja kulturulbmiliidda - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2987.html" xml:lang="nob"/>
</xsl:variable>
