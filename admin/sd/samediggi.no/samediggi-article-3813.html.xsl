...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3813&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sávvat lihku sámi dáiddaskuvlii - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3813.html" xml:lang="nob"/>
</xsl:variable>
