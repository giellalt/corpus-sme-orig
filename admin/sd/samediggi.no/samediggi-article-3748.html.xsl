...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3748&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Hui erenoamáš vuohki nannet máttasámegiela - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3748.html" xml:lang="nob"/>
</xsl:variable>
