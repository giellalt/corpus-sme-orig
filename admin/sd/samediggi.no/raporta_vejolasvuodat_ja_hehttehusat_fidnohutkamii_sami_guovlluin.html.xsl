...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/naring/nyttige-ressurser/rapporter/muligheter-og-barrierer-for-entreprenorskap-i-samiske-omrader/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Raporta Vejolašvuođat ja hehttehusat fidnohutkamii sámi guovlluin - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="rapport_muligheter_og_barrierer_for_entreprenorskap_i_samiske_omrader.html"/>
