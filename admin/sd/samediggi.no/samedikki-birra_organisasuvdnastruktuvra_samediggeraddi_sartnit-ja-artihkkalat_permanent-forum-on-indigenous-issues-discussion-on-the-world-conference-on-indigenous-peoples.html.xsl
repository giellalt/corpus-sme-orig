...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Samedikki-birra/Organisasuvdnastruktuvra/Samediggeraddi/Sartnit-ja-artihkkalat/Permanent-Forum-on-Indigenous-Issues-Discussion-on-the-World-Conference-on-Indigenous-Peoples'"/>
	...
	<parallel_text xml:lang="nob" location="om-sametinget_organisasjonsstruktur_sametingsraadet_taler-og-artikler_permanent-forum-on-indigenous-issues-discussion-on-the-world-conference-on-indigenous-peoples.html"/></xsl:variable>
