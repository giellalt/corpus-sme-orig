...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingsradet-styrker-samisk-kulturliv-og-gir-6-8-millioner-i-investeringsstotte-til-institusjoner-og-festivaler.17978.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggeráđđi nanne sámi kultureallima ja juolluda 6,8 miljon ru investerendoarjjan ásahusaide ja festiválaide - Sámediggi'"/>
    <!--
