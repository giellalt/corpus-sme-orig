...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=82&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ealáhus- ja kulturlávdegoddi - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-82.html" xml:lang="nob"/>
</xsl:variable>
