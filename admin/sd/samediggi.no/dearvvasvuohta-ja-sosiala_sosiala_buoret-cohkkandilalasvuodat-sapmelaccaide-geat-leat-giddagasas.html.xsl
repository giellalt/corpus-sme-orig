...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Dearvvasvuohta-ja-sosiala/Sosiala/Buoret-cohkkandilalasvuodat-sapmelaccaide-geat-leat-giddagasas'"/>
	...
	<parallel_text xml:lang="nob" location="helse-og-sosial_sosial_bedre-soning-for-samiske-innsatte.html"/></xsl:variable>
