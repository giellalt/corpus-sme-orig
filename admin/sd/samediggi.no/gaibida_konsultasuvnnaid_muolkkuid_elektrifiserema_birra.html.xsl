...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/krever-konsultasjoner-om-elektrifisering-av-melkoya.26654.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Gáibida konsultašuvnnaid Muolkkuid elektrifiserema birra - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="krever_konsultasjoner_om_elektrifisering_av_melkoya.html"/>
