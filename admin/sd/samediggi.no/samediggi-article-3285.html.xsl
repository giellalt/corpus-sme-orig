...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3285&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Almmolaš ohcanlistu - Ossodatdirektevra - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3285.html" xml:lang="nob"/>
</xsl:variable>
