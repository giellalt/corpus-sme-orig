...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Ealahusat/Duodji/Doarju-duodjegavppiid-Inka-AS-ja-Manndalen-Husflidlag'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_duodji_stoetter-duodjibutikkene-inka-as-og-manndalen-husflidlag.html"/></xsl:variable>
