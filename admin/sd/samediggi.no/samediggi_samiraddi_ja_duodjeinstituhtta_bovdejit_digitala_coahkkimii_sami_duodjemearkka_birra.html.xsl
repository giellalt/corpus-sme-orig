...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/sametinget-samiraddi-og-duodjeinstituhtta-inviterer-til-digitalt-mote-om-sami-duodji-merket.28148.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi, Sámiráđđi ja Duodjeinstituhtta bovdejit digitála čoahkkimii Sámi duodjemearkka birra - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_samiraddi_og_duodjeinstituhtta_inviterer_til_digitalt_mote_om_sami_duodji_merket.html"/>
