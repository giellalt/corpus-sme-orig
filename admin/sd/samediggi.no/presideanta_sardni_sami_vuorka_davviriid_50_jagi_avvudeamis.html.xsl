...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/presidentens-tale-pa-50-ars-jubileumet-for-de-samiske-samlinger.20351.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Presideanta sárdni Sámi Vuorká Dávviriid 50 jagi ávvudeamis - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="presidentens_tale_pa_50_ars_jubileumet_for_de_samiske_samlinger.html"/>
