...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/dette-kan-du-gjore-dersom-du-opplever-hets-i-forbindelse-med-fosen-aksjonene.27854.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Maid sáhtát dahkat jus vásihat cielaheami Fovsen-akšuvnnaid oktavuođas - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="dette_kan_du_gjore_dersom_du_opplever_hets_i_forbindelse_med_fosen-aksjonene.html"/>
