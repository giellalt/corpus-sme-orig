...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3763&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Multi nammasaš matematihkkabuvttus jorgaluvvo sámegillii - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3763.html" xml:lang="nob"/>
</xsl:variable>
