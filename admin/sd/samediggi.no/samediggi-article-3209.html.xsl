...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3209&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Davvi- Trøndelága boraspireraporta lea suhttadeaddji lohkamuš - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3209.html" xml:lang="nob"/>
</xsl:variable>
