...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Dearvvasvuohta-ja-sosiala/Sosiala/Haliidit-buoridit-mahtu-veahkavalddi-birra-lagas-oktavuodain'"/>
	...
	<parallel_text xml:lang="nob" location="helse-og-sosial_sosial_vil-oeke-kunnskapen-om-vold-i-naere-relasjoner.html"/></xsl:variable>
