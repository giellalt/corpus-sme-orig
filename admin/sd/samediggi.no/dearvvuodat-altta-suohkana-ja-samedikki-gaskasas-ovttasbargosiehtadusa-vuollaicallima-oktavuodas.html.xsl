...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Dearvvuodat-Altta-suohkana-ja-Samedikki-gaskasas-ovttasbargosiehtadusa-vuollaicallima-oktavuodas'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dearvvuođat Álttá suohkana ja Sámedikki gaskasaš ovttasbargošiehtadusa vuolláičállima oktavuođas'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="hilsen-ved-signering-av-samarbeidsavtalen-mellom-alta-kommune-og-sametinget.html"/>
