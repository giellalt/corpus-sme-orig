...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Stipeanda-ja-doarjja/Tidligere-regelverk'"/>
	...
	<parallel_text xml:lang="nob" location="stipend-og-tilskudd_tidligere-regelverk.html"/></xsl:variable>
