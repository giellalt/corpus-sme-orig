...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2969&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ovttasdoaibman stáhta eiseválddiid ja Sámedikki gaskka - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'1176'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2969.html" xml:lang="nob"/>
</xsl:variable>
