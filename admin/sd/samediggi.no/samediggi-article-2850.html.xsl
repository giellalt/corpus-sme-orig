...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2850&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD:Dálkkádatheivehanlávdegoddi galgá čielggadit oktavuohta sámi kultuvrii  - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'120'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2850.html" xml:lang="nob"/>
</xsl:variable>
