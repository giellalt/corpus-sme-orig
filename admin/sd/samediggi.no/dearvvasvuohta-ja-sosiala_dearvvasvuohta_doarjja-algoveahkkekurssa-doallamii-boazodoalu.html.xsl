...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Dearvvasvuohta-ja-sosiala/Dearvvasvuohta/Doarjja-algoveahkkekurssa-doallamii-boazodoalu'"/>
	...
	<parallel_text xml:lang="nob" location="helse-og-sosial_helse_stoetter-foerstehjelpskurs-for-reindriften.html"/></xsl:variable>
