...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/juolludit-lagabui-3-4-miljovnna-ruvnno-proseavttaide-ja-ovdanahttinbargui-manaidgarddis.22414.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Juolludit lagabui 3,4 miljovnna ruvnno prošeavttaide ja ovdánahttinbargui mánáidgárddis - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="bevilger_naermere_3_4_millioner_kroner_til_prosjekter_og_utviklingsarbeid_i_barnehager.html"/>
