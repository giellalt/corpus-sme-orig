...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/stipende-jih-daarjoe/daarjoe/jieleme/kultuvrejielemh-evtiedimmie-jih-skaarvemeraajvarimmieh/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámi mátkeealáhus, hutkkálaš ealáhusat ja sámi borramuš - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="samisk_reiseliv_kreative_naeringer_og_samisk_mat_-_sokerbasert_tilskudd.html"/>
