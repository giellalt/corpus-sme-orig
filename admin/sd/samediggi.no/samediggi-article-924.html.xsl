...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=924&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggepresideantta álbmotbeaivvi dearvvuođat - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-924.html" xml:lang="nob"/>
</xsl:variable>
