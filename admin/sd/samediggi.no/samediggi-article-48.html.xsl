...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=48&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámegiel čálamearkkat Windows XP várás. - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-48.html" xml:lang="nob"/>
</xsl:variable>
