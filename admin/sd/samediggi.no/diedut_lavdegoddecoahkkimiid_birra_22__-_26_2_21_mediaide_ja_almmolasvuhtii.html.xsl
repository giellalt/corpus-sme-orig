...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/informasjon-til-media-og-offentligheten-om-komitemoter-22-26-2-21.12452.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dieđut lávdegoddečoahkkimiid birra 22. – 26.2.21 mediaide ja almmolašvuhtii - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="informasjon_til_media_og_offentligheten_om_komitemoter_22__-_26_2_21.html"/>
