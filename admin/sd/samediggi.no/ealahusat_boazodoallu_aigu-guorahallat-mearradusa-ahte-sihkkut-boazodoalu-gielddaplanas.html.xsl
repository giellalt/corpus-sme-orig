...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Boazodoallu/Aigu-guorahallat-mearradusa-ahte-sihkkut-boazodoalu-gielddaplanas'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_reindrift_vil-granske-vedtak-om-aa-fjerne-reindrift-fra-kommunal-plan.html"/></xsl:variable>
