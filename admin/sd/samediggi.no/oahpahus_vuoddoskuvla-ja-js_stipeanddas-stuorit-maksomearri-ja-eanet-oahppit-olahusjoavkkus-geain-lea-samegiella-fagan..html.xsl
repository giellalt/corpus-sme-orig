...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Oahpahus/Vuoddoskuvla-ja-JS/Stipeanddas-stuorit-maksomearri-ja-eanet-oahppit-olahusjoavkkus-geain-lea-samegiella-fagan.'"/>
