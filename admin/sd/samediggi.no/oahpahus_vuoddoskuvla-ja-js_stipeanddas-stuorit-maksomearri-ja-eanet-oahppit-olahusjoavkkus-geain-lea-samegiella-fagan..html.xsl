...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Oahpahus/Vuoddoskuvla-ja-JS/Stipeanddas-stuorit-maksomearri-ja-eanet-oahppit-olahusjoavkkus-geain-lea-samegiella-fagan.'"/>
	...
	<parallel_text xml:lang="nob" location="opplaering_grunnskole-og-vgs_oekte-satser-og-utvidet-maalgruppe-for-stipend-til-elever-med-samisk-i-fagkretsen.html"/></xsl:variable>
