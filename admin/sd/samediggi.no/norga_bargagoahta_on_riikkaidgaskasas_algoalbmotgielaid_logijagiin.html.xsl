...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/norge-starter-arbeidet-med-fns-internasjonale-tiar-for-urfolkssprak.20715.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Norga bargagoahtá ON riikkaidgaskasaš álgoálbmotgielaid logijagiin - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="norge_starter_arbeidet_med_fns_internasjonale_tiar_for_urfolkssprak.html"/>
