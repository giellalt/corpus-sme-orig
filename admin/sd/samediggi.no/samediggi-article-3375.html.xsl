...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3375&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'*Doarjja ja stipeanda - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3375.html" xml:lang="nob"/>
</xsl:variable>
