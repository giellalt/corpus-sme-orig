...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/skuffelse-over-at-sametinget-ikke-er-prioritert-i-tilleggsproposisjonen.17483.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Beahtahallan go Sámediggi ii leat vuoruhuvvon lassiproposišuvnnas  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="skuffelse_over_at_sametinget_ikke_er_prioritert_i_tilleggsproposisjonen.html"/>
