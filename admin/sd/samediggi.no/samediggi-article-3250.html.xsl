...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3250&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ođđa Sámedikki rahpan ja dievasčoahkkin 2009 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3250.html" xml:lang="nob"/>
</xsl:variable>
