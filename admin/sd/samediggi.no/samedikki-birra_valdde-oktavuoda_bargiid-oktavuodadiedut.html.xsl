...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Samedikki-birra/Valdde-oktavuoda/Bargiid-oktavuodadiedut'"/>
	...
	<parallel_text xml:lang="nob" location="om-sametinget_kontakt-oss_kontaktinformasjon-til-ansatte.html"/></xsl:variable>
