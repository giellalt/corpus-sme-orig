...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingsradet-stotter-bergens-kunstforening-og-samisk-utstilling-med-200-000-kroner.3628.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Doarju Birggona dáiddasearvvi ja sámi čájáhusa 200 000 ruvnnuin - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingsradet_stotter_bergens_kunstforening_og_samisk_utstilling_med_200_000_kroner.html"/>
