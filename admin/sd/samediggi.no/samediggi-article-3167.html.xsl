...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3167&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki presideanta rábai logát giellaguovddáža,  Ástávuona giellagoahtie - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3167.html" xml:lang="nob"/>
</xsl:variable>
