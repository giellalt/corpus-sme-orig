...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2899&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ruvndoprinsabárra fitná Sámedikkis - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2899.html" xml:lang="nob"/>
</xsl:variable>
