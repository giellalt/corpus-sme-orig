...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Dearvvasvuohta-ja-sosiala/Dearvvasvuohta/Vailevas-sami-gelbbolasvuohta-dorvvohuhtta'"/>
	...
	<parallel_text xml:lang="nob" location="helse-og-sosial_helse_manglende-samisk-kompetanse-skaper-utrygghet.html"/></xsl:variable>
