...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/likestilling/nyttige-ressurser/om-du-tor-a-sporre-tor-folk-a-svare-hjelpeapparatets-og-politiets-erfaringer-med-vold-i-nare-relasjoner-i-samiske-samfunn/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'«Jos duosttat jearrat, de dustet olbmot vástidit» Veahkkeapparáhta ja politiija vásihusat veahkaválddi ektui lagaš oktavuođain sámi servodagas - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="_om_du_tor_a_sporre_tor_folk_a_svare_hjelpeapparatets_og_politiets_erfaringer_med_vold_i_naere_relasjoner_i_samiske_samfunn.html"/>
