...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=739&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Sámediggeráđđi váldá vuhtii mearkkašumiid - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-739.html" xml:lang="nob"/>
</xsl:variable>
