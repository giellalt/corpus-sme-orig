...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=87&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Neahttasiiddut buohkaide - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-87.html" xml:lang="nob"/>
</xsl:variable>
