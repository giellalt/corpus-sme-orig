...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3226&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámi mánáidgárde- ja skuvlakonferánsa - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3226.html" xml:lang="nob"/>
</xsl:variable>
