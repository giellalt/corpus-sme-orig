...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=833&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ođđajagisárdni 2006 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-833.html" xml:lang="nob"/>
</xsl:variable>
