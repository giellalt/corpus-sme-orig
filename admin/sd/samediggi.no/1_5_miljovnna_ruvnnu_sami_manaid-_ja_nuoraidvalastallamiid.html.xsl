...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/1-5-millioner-kroner-til-samisk-barne-og-ungdomsidrett.15090.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'1,5 miljovnna ruvnnu sámi mánáid- ja nuoraidvaláštallamiid - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="1_5_millioner_kroner_til_samisk_barne-_og_ungdomsidrett.html"/>
