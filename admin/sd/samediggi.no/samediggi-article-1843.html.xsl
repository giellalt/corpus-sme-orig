...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1843&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Kártauskkádat DavviAtlas viiddiduvvo - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1843.html" xml:lang="nob"/>
</xsl:variable>
