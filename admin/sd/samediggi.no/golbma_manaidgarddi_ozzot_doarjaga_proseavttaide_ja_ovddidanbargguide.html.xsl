...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/tre-barnehager-far-tilskudd-til-prosjekter-og-utviklingsarbeid.33624.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Golbma mánáidgárddi ožžot doarjaga prošeavttaide ja ovddidanbargguide - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tre_barnehager_far_tilskudd_til_prosjekter_og_utviklingsarbeid.html"/>
