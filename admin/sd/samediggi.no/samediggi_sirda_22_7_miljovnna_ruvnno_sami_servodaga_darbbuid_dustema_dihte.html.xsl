...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-omdisponerer-22-7-millioner-kroner-for-a-mote-det-samiske-samfunnets-behov.35011.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi sirdá 22,7 miljovnna ruvnno sámi servodaga dárbbuid dustema dihte - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_omdisponerer_22_7_millioner_kroner_for_a_mote_det_samiske_samfunnets_behov.html"/>
