...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/konsuleanta-samedikki-dokumentasuvdna-ja-parlameantahalddasanjuhkosis.26386.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Konsuleanta Sámedikki dokumentašuvdna- ja parlameantahálddašanjuhkosis - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="konsulent_sametingets_seksjon_for_dokumentasjon-_og_parlamentsforvaltning.html"/>
