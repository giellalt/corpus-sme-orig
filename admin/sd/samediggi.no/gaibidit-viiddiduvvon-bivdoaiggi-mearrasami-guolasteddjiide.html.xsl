...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Ealahusat/Mearraealahusat/Gaibidit-viiddiduvvon-bivdoaiggi-mearrasami-guolasteddjiide'"/>
    ...
    <parallel_text location="krever-utvidet-fisketid-for-sjoelaksefiskere.html" xml:lang="nob"/>
