...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3278&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggeráđi áššesuorggit - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3278.html" xml:lang="nob"/>
</xsl:variable>
