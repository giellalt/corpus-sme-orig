...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=4016&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sámedikki valáštallanstipeanda addojuvvo heargevuoddjái ja luođuvaláštallái - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-4016.html" xml:lang="nob"/>
</xsl:variable>
