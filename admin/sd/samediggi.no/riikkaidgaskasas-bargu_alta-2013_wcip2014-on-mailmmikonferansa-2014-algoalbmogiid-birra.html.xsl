...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Riikkaidgaskasas-bargu/Alta-2013/WCIP2014-ON-mailmmikonferansa-2014-algoalbmogiid-birra'"/>
	...
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_alta-2013_wcip2014-urfolkskonferanse.html"/></xsl:variable>
