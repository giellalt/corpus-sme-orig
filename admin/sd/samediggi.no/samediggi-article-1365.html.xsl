...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1365&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ole Henrik Magga nammaduvvon kommandøran St Olavs Orden:is - Sámediggi Sametinget'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-1365.html'"/>
