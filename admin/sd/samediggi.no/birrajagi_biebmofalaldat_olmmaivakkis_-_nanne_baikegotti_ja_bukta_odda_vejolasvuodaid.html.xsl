...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/helars-mattilbud-i-manndalen-styrke-lokalsamfunn-og-skape-nye-muligheter.34496.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Birrajagi biebmofálaldat Olmmáivákkis – nanne báikegotti ja buktá ođđa vejolašvuođaid - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="helars_mattilbud_i_manndalen_-_styrke_lokalsamfunn_og_skape_nye_muligheter.html"/>
