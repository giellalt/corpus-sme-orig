...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Boazodoallu/Bohccuid-vuddjomiidda-fertejit-gavdnot-doaibmabijut'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_reindrift_tiltak-mot-reinpaakjoersler-paa-nordlandsbanen-maa-paa-plass.html"/></xsl:variable>
