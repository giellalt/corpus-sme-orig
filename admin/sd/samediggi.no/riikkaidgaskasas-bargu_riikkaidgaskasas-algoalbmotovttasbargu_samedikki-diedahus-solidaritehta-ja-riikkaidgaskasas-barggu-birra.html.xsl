...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Riikkaidgaskasas-bargu/Riikkaidgaskasas-algoalbmotovttasbargu/Samedikki-diedahus-solidaritehta-ja-riikkaidgaskasas-barggu-birra'"/>
	...
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_internasjonalt-urfolkssamarbeid_sametingsmelding-om-solidaritet-og-internasjonalt-arbeid.html"/></xsl:variable>
