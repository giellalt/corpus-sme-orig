...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Eanandoallu/Balla-vaikkuhusain-sami-guovlluid-eanadollui'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_jordbruk_frykter-for-jordbruket-i-samiske-omraader.html"/></xsl:variable>
