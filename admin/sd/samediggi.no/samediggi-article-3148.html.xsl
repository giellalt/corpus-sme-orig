...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3148&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Jahkebealásaš konsultašuvdnačoahkkin stáhtaráđiin Dag Terje Anderseniin - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3148.html" xml:lang="nob"/>
</xsl:variable>
