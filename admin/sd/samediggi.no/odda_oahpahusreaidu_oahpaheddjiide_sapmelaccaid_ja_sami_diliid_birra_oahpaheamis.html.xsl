...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/odda-oahpahusreaidu-oahpaheddjiide-sapmelaccaid-ja-sami-diliid-birra-oahpaheamis.23585.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ođđa oahpahusreaidu oahpaheddjiide sápmelaččaid ja sámi diliid birra oahpaheamis - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="nytt_verktoy_for_laererne_i_opplaeringen_om_samer_og_samiske_forhold.html"/>
