...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/likestilling/toleranse-for-mennesker-med-nedsatt-funksjonsevne/fn-konvensjonen-om-rettigheter-til-mennesker-med-nedsatt-funksjonsevne/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'ON konvenšuvdna doaibmanávccahit olbmuid vuoigatvuođaid birra - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="fn-konvensjonen_om_rettigheter_til_mennesker_med_nedsatt_funksjonsevne.html"/>
