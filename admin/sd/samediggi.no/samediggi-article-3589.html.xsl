...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3589&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Konsultašuvnnat leat álggahuvvon - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3589.html" xml:lang="nob"/>
</xsl:variable>
