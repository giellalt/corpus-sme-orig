...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3288&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Sámediggi bargá bisuhandihtii boahttobeale sámi skuvllaid  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3288.html" xml:lang="nob"/>
</xsl:variable>
