...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/en-stor-begivenhet-for-samene-nar-bade-h-m-kongen-og-h-k-h-kronprinsen-skal-vare-med-pa-sametingsapningen.16516.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámiide stuorra dáhpáhus go sihke Majestehta Gonagas ja H.K.H Ruvdnaprinsa searvaba sámediggerahpamii - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="en_stor_begivenhet_for_samene_nar_bade_h_m__kongen_og_h_k_h_kronprinsen_skal_vaere_med_pa_sametingsapningen_.html"/>
