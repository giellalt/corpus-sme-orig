...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/riikkaidgaskasas-bargu/sami-ovttasbargu/davviriikkalas-sami-assiid-ammatorgana/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Davviriikkalaš sámi áššiid ámmátorgána (NÄS) - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="nordisk_embetsmannsorgan_for_samiske_sporsmal_nas_.html"/>
