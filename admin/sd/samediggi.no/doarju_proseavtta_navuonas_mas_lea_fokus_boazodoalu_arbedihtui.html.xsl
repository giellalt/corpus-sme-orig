...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/doarju-proseavtta-navuonas-mas-lea-fokus-boazodoalu-arbedihtui.31911.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Doarju prošeavtta Návuonas mas lea fokus boazodoalu árbedihtui - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="stotter_prosjekt_i_kvaenangen_som_har_fokus_pa_tradisjonell_kunnskap_om_reindrift.html"/>
