...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2856&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggi lea váldán badjelasas Njávdáma gohttensaji - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2856.html" xml:lang="nob"/>
</xsl:variable>
