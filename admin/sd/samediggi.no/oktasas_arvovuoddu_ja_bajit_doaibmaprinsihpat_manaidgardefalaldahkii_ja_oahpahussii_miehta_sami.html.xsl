...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/vuoddooahpahus/avkkalas-resurssat/oktasas-arvovuoddu-ja-bajit-doaibmaprinsihpat-manaidgardefalaldahkii-ja-oahpahussii-miehta-sami/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oktasaš árvovuođđu ja bajit doaibmaprinsihpat mánáidgárdefálaldahkii ja oahpahussii miehtá Sámi - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="felles_verdigrunnlag_og_overordnede_prinsipper_for_barnehagetilbudet_og_opplaeringen_i_hele_sapmi.html"/>
