...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Riikkaidgaskasas-bargu/Riikkaidgaskasas-algoalbmotovttasbargu/Iessoardimiid-eastadeapmi-guorahallojuvvo-ON-algoalbmogiid-bissovas-forumis'"/>
	...
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_internasjonalt-urfolkssamarbeid_forebygging-av-selvmord-droeftes-paa-fns-permanente-forum-for-urfolkssaker.html"/></xsl:variable>
