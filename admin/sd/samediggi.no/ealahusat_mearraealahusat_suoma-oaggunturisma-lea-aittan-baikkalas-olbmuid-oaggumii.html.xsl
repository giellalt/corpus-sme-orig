...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Mearraealahusat/Suoma-oaggunturisma-lea-aittan-baikkalas-olbmuid-oaggumii'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_marine-naeringer_finsk-fisketurisme-er-en-trussel-for-lokalbefolkningens-fiske.html"/></xsl:variable>
