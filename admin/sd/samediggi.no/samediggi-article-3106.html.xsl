...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3106&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Ovttamielalašvuohta mearraenergiija birra - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3106.html" xml:lang="nob"/>
</xsl:variable>
