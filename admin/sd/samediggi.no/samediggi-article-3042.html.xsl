...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3042&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sáhkavuorru seminára rahpamis mánáidkonvenšuvnna birra - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3042.html" xml:lang="nob"/>
</xsl:variable>
