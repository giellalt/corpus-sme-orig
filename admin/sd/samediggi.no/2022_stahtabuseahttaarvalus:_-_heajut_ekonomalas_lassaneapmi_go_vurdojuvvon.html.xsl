...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/forslag-til-statsbudsjett-2022-svakere-okonomisk-vekst-enn-forventet.16646.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'2022 stáhtabušeahttaárvalus: – Heajut ekonomalaš lassáneapmi go vurdojuvvon - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="forslag_til_statsbudsjett_2022:_-_svakere_okonomisk_vekst_enn_forventet.html"/>
