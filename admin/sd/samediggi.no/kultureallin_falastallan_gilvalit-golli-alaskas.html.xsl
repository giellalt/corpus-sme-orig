...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Kultureallin/Falastallan/Gilvalit-golli-Alaskas'"/>
	...
	<parallel_text xml:lang="nob" location="kulturliv_idrett_gaar-for-gull-i-alaska.html"/></xsl:variable>
