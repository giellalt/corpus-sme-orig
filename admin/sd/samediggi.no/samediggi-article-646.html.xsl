...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=646&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggeráđi, lávdegottiid ja čoahkkinjođihangotti válljen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-646.html" xml:lang="nob"/>
</xsl:variable>
