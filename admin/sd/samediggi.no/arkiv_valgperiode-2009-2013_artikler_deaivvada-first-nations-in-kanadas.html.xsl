...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Arkiv/Valgperiode-2009-2013/Artikler/Deaivvada-First-Nations-in-Kanadas'"/>
	...
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_skal-moete-first-nations-i-canada.html"/></xsl:variable>
