...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=170&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Earenoamášpedagogihka oahppostipeanda – skuvlajahki 2007/2008 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-170.html" xml:lang="nob"/>
</xsl:variable>
