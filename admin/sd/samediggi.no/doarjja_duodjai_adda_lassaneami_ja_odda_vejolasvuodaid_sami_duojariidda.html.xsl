...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/doarjja-duodjai-adda-lassaneami-ja-odda-vejolasvuodaid-sami-duojariidda.35023.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Doarjja duodjái addá lassáneami ja ođđa vejolašvuođaid sámi duojáriidda - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="stotte_til_duodji_gir_vekst_og_nye_muligheter_for_samisk_handverk.html"/>
