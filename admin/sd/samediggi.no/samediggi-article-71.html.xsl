...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=71&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Preassadieđáhusaid birra dieđiheapmi - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-71.html" xml:lang="nob"/>
</xsl:variable>
