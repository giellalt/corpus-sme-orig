...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/felles-samisk-historieverk-og-digitale-laremidler-i-sametingets-budsjett-2021.8507.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oktasaš sámi historjáoahpponeavvu ja digitála oahpponeavvut Sámedikki 2021 bušeahtas  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="felles_samisk_historieverk_og_digitale_laeremidler_i_sametingets_budsjett_2021_.html"/>
