...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Lohkkiidcalus-Odasmuvvi-ealahusat-addet-midjiide-juoga-man-dihtii-ja-mas-mii-eallit'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lohkkiidčálus: - Ođasmuvvi ealáhusat addet midjiide juoga man dihtii ja mas mii eallit'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="leserinnlegg-fornybare-naeringer-gir-oss-noe-aa-leve-for-og-av.html"/>
