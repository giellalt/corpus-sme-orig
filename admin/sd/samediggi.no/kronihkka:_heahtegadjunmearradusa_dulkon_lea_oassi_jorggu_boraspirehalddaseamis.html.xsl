...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/kronikk-tolking-av-nodvergebestemmelsen-er-en-del-av-feilslatt-rovviltforvaltning.27751.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kronihkka: Heahtegádjunmearrádusa dulkon lea oassi jorggu boraspirehálddašeamis - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="kronikk:_tolking_av_nodvergebestemmelsen_er_en_del_av_feilslatt_rovviltforvaltning.html"/>
