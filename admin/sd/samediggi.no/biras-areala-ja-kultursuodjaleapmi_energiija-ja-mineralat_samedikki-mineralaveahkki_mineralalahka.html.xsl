...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Biras-areala-ja-kultursuodjaleapmi/Energiija-ja-mineralat/Samedikki-mineralaveahkki/Mineralalahka'"/>
	...
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_energi-og-mineraler_sametinget-mineralveileder_mineralloven.html"/></xsl:variable>
