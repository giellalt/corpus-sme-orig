...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/sahkavuorru-samediggeradi-doaibmadiedahussii-juovlamanu-2023.28647.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sáhkavuorru sámediggeráđi doaibmadieđáhussii, juovlamánu 2023 - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingspresidentens_tale_til_sametingsradets_beretning_om_virksomheten_desember_2023.html"/>
