...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Riikkaidgaskasas-bargu/Riikkaidgaskasas-algoalbmotovttasbargu/Aili-Keskitalo-rahpa-ON-mailmmikonferanssa-algoalbmogiid-birra'"/>
	...
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_internasjonalt-urfolkssamarbeid_aili-keskitalo-aapner-fns-verdenskonferanse-om-urfolk.html"/></xsl:variable>
