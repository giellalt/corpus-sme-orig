...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1837&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'GIELLA: giella.org - Ođđasat - Giella.org'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1837.html" xml:lang="nob"/>
</xsl:variable>
