...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/muotka-oppnevnt-til-styringsgruppen-for-regional-plan-for-reindrift-i-troms-og-finnmark.14832.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Muotka nammaduvvon Romssa ja Finnmárkku boazodoalu regionála plána stivrenjovkui  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="muotka_oppnevnt_til_styringsgruppen_for_regional_plan_for_reindrift_i_troms_og_finnmark_.html"/>
