...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-om-revidert-nasjonalbudsjett-forventningene-til-statsbudsjettet-2023-oker.20697.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi reviderejuvvon našunálabušeahta birra: – Vuordámušat 2023 stáhtabušehttii lassánit - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_om_revidert_nasjonalbudsjett_-_forventningene_til_statsbudsjettet_2023_oker.html"/>
