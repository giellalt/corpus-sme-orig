...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1792&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki dievasčoahkkin 2007 miessemánu - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1792.html" xml:lang="nob"/>
</xsl:variable>
