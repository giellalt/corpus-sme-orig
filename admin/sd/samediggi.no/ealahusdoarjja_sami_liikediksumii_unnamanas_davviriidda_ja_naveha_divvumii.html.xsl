...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/naringsstotte-til-samisk-hudpleie-babyutstyr-og-fjosombygging.3281.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ealáhusdoarjja sámi liikedikšumii, unnamánáš dávviriidda ja náveha divvumii - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="naeringsstotte_til_samisk_hudpleie_babyutstyr_og_fjosombygging.html"/>
