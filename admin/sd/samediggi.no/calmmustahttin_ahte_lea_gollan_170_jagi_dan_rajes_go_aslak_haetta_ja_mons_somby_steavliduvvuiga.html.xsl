...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/markering-av-170-arsdagen-for-henrettelsen-av-aslak-hatta-og-mons-somby.34173.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Čalmmustahttin ahte lea gollan 170 jagi dan rájes go Aslak Hætta ja Mons Somby steavliduvvuiga - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="markering_av_170-arsdagen_for_henrettelsen_av_aslak_haetta_og_mons_somby_.html"/>
