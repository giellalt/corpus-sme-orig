...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3774&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ráđđečoahkkin Troanddimis - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3774.html" xml:lang="nob"/>
</xsl:variable>
