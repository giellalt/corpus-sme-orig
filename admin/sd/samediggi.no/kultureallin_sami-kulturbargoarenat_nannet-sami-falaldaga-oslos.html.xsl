...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Kultureallin/Sami-kulturbargoarenat/Nannet-sami-falaldaga-Oslos'"/>
	...
	<parallel_text xml:lang="nob" location="kulturliv_arenaer-for-samisk-kulturutoevelse_styrke-det-samiske-tilbudet-i-oslo.html"/></xsl:variable>
