...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3413&amp;sprak=Samisk&amp;Print=1'"/>
...
<xsl:variable name="wordcount" select="'6'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3413.html" xml:lang="nob"/>
</xsl:variable>
