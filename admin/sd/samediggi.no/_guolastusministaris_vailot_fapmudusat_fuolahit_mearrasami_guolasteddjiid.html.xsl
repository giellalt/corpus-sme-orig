...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/fiskeriministeren-mangler-fullmakter-for-a-ivareta-sjosamiske-fiskere.35093.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'– Guolástusministaris váilot fápmudusat fuolahit mearrasámi guolásteddjiid - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="_fiskeriministeren_mangler_fullmakter_for_a_ivareta_sjosamiske_fiskere.html"/>
