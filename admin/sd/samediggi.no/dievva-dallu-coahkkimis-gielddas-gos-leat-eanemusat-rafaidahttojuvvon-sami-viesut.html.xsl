...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Dievva-dallu-coahkkimis-gielddas-gos-leat-eanemusat-rafaidahttojuvvon-sami-viesut'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dievva dállu čoahkkimis gielddas gos leat eanemusat ráfáidahttojuvvon sámi viesut'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="fullt-hus-paa-moete-i-kommunen-med-flest-freda-samiske-hus.html"/>
