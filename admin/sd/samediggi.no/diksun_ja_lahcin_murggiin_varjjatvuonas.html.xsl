...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/kultuvremojhtese-jih-gaetievaarjelimmie/saemien-kultuvremojhtesh-jih-eatneme/vaeljehke-saemien-kultuvre-eatnemh/vaeljehke-arkeoglogeles-kultuvremojhtesh-bark/gorredimmie-jih-sjiehteladteme-sijjesne-klubben-varangerisnie/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dikšun ja láhčin Murggiin Várjjatvuonas - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="skjotsel_og_tilrettelegging_pa_murggiid_klubben_i_varanger_.html"/>
