...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3888&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Streaming Sámediggeráđi/dievasčoahkkinjođihangotti áššiid ovddideapmi - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'57'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3888.html" xml:lang="nob"/>
</xsl:variable>
