...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=315&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'(UkjentRessurs) - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'4'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-315.html'"/>
