...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/naringsstotte-til-smittevernutstyr-og-sportsbutikketablering.7644.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ealáhusdoarjja njoammudávddaid eastadanbiergasiidda ja valáštallangávppi ásaheapmái  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="naeringsstotte_til_smittevernutstyr_og_sportsbutikketablering.html"/>
