...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Valga-ja-jienastuslohku/Kampanjeside/Jienastuslohku/Samedikki-jienastuslohku-2009'"/>
	...
	<parallel_text xml:lang="nob" location="valg-og-manntall_kampanjeside_valgmanntall_sametingets-valgmanntall-2009.html"/></xsl:variable>
