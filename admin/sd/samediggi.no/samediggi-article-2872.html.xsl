...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2872&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Almmola&#353; ohcalistu - S&#225;mediggi Sametinget'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-2872.html'"/>
