...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3451&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Buorit juovllat ja ilolaš ođđa jahki - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3451.html" xml:lang="nob"/>
</xsl:variable>
