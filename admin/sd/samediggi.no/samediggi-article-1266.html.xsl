...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1266&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki nuoraidkonferánsa 2006 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1266.html" xml:lang="nob"/>
</xsl:variable>
