...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/en-halv-million-kroner-til-gatejuristen-i-tromso-for-a-styrke-samiske-barn-og-unges-rettssikkerhet.35036.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bealle miljovnna ruvnno Gatejuristenii Romssas nannen dihtii sámi mánáid ja nuoraid riektesihkarvuođa - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="en_halv_million_kroner_til_gatejuristen_i_tromso_for_a_styrke_samiske_barn_og_unges_rettssikkerhet.html"/>
