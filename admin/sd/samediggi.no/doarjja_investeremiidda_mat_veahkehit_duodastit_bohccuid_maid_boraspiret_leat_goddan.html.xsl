...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/daarjoe-skaarvemidie-mah-viehkiehtieh-bovtsh-vihtiestidh-mah-juvrijste-bavvalgamme.27296.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Doarjja investeremiidda mat veahkehit duođaštit bohccuid maid boraspiret leat goddán - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="stotte_til_investeringer_som_bidrar_til_dokumentasjon_av_rein_drept_av_rovvilt.html"/>
