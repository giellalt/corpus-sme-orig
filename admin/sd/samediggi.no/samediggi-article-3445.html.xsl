...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3445&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Árvalus ođđa neahttasiidui - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3445.html" xml:lang="nob"/>
</xsl:variable>
