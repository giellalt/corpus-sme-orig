...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/gir-300-000-kroner-til-filmlavvo-hvor-man-kan-se-360-graders-filmer.16593.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Addet 300 000 kruvnnu filbmalávvui gos sáhttá geahččat 360-gráda filmmaid - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="gir_300_000_kroner_til_filmlavvo_hvor_man_kan_se_360-graders_filmer.html"/>
