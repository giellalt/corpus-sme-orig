...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/vaajmoegiele-voesteskonsulente-raeriestajja-gieleraajvarimmie.10677.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Váibmogiella - Vuosttaškonsuleanta / Ráđđeaddi - Gielladoaimmat - Lullisámegiella - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="hjertespraket_-_forstekonsulent_radgiver_0_.html"/>
