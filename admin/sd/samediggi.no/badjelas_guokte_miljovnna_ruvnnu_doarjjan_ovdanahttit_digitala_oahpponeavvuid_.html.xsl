...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/over-to-millioner-kroner-i-stotte-til-forlag-for-a-utvikle-digitale-laremidler.22765.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Badjelaš guokte miljovnna ruvnnu doarjjan ovdánahttit digitála oahpponeavvuid  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="over_to_millioner_kroner_i_stotte_til_forlag_for_a_utvikle_digitale_laeremidler.html"/>
