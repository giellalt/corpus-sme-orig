...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1275&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Rádjalovssaid bargui addojuvvo árvu - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1275.html" xml:lang="nob"/>
</xsl:variable>
