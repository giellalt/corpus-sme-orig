...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Oahpahus/Julggastus-givssideami-vuosta/Buoremus-plakahtas-givssideami-vuosta-lea-10-000-ruvdnosas-arvu'"/>
	...
	<parallel_text xml:lang="nob" location="opplaering_arbeidet-mot-mobbing_beste-plakat-mot-mobbing-verdt-10.000-kroner.html"/></xsl:variable>
