...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=475&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Válgabeavdegirjjit (čoahkkingirjjit) - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-475.html" xml:lang="nob"/>
</xsl:variable>
