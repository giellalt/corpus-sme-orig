...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3594&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Åarjelsaemien – giella mii ovdána!  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3594.html" xml:lang="nob"/>
</xsl:variable>
