...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3520&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'O&#273;&#273;a boazodoallostivra nammaduvvon - S&#225;mediggi Sametinget'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-3520.html'"/>
