...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1024&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki politihkalaš dási mátkepolitihkka - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1024.html" xml:lang="nob"/>
</xsl:variable>
