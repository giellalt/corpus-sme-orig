...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Kronihkka-Mo-samiid-riekti-mearridit-iezaset-boahtteaiggi-gahttejuvvo-Samediggepresideanta-Aili-Keskitalo'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kronihkka: Mo sámiid riekti mearridit iežaset boahtteáiggi gáhttejuvvo? Sámediggepresideanta Aili Keskitalo'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="kronikk-hvordan-ivaretas-samenes-rett-til-aa-bestemme-over-egen-fremtid.html"/>
