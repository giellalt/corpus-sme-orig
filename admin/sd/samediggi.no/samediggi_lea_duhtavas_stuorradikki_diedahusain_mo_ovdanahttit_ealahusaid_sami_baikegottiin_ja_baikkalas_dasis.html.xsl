...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-er-tilfreds-med-at-stortingsmeldingen-om-naringsgrunnlag-for-levende-samiske-lokalsamfunn-presenteres-16-06-21.15304.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi lea duhtavaš Stuorradikki dieđáhusain mo ovdánahttit ealáhusaid sámi báikegottiin ja báikkálaš dásis - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_er_tilfreds_med_at_stortingsmeldingen_om_naeringsgrunnlag_for_levende_samiske_lokalsamfunn_presenteres_16_06_21.html"/>
