...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3101&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'S&#225;medikki doarjja girjj&#225;la&#353;vuo&#273;a almmuheapm&#225;i 2009 - S&#225;mediggi Sametinget'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-3101.html'"/>
