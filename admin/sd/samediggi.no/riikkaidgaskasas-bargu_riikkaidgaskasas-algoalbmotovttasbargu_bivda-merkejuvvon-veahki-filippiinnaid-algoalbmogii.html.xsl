...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Riikkaidgaskasas-bargu/Riikkaidgaskasas-algoalbmotovttasbargu/Bivda-merkejuvvon-veahki-Filippiinnaid-algoalbmogii'"/>
	...
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_internasjonalt-urfolkssamarbeid_ber-om-oeremerket-bistand-til-urbefolkningen-i-filippinene.html"/></xsl:variable>
