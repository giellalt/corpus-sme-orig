...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/20-barnehager-far-3-6-millioner-kroner-til-samiske-sprak-og-kulturprosjekter.34243.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'20 mánáidgárddi ožžot 3,6 miljovnna ruvnno sámi giella- ja kulturprošeavttaide - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="20_barnehager_far_3_6_millioner_kroner_til_samiske_sprak-_og_kulturprosjekter.html"/>
