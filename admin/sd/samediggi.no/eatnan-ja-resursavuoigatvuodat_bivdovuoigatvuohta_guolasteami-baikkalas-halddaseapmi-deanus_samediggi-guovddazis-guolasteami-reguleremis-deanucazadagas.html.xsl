...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Eatnan-ja-resursavuoigatvuodat/Bivdovuoigatvuohta/Guolasteami-baikkalas-halddaseapmi-Deanus/Samediggi-guovddazis-guolasteami-reguleremis-Deanucazadagas'"/>
	...
	<parallel_text xml:lang="nob" location="land-og-ressursrettigheter_fiskerettigheter_lokal-forvaltning-av-fiske-i-tana_sametinget-sentral-i-regulering-av-fisket-i-tanavassdraget.html"/></xsl:variable>
