...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=148&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Earenoamášpedagogihka oahppostipeanddaid njuolggadusat - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'741'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-148.html" xml:lang="nob"/>
</xsl:variable>
