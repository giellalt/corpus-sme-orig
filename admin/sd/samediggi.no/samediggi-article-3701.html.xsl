...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3701&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Geaidnu viidásat - Finnmark Mineralforum - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3701.html" xml:lang="nob"/>
</xsl:variable>
