...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=209&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Mearkkašumit: Sámi leavgga geavaheami - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'1053'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-209.html" xml:lang="nob"/>
</xsl:variable>
