...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/viktig-at-ansvar-erkjennes-og-skader-blir-kompensert.14921.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'– Dehálaš ahte ovddasvástádus mieđihuvvo ja ahte vahágat buhtaduvvojit - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="_viktig_at_ansvar_erkjennes_og_skader_blir_kompensert.html"/>
