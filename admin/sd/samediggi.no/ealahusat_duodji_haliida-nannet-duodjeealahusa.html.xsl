...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Ealahusat/Duodji/Haliida-nannet-duodjeealahusa'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_duodji_vil-styrke-duodjinaeringen.html"/></xsl:variable>
