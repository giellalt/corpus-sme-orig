...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1304&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Ruvkeindustriija ferte árvvusatnit eamiálbmogiid vuoigatvuođaid - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1304.html" xml:lang="nob"/>
</xsl:variable>
