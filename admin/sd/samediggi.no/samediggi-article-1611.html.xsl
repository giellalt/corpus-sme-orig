...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1611&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Ođđa museastruktuvra Davit Nordlándda ja Mátta-Romssa várás - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1611.html" xml:lang="nob"/>
</xsl:variable>
