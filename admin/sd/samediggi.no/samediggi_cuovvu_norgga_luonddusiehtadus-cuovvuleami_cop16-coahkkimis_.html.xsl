...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/samediggi-cuovvu-norgga-luonddusiehtadus-cuovvuleami-cop16-coahkkimis.34294.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi čuovvu Norgga luonddušiehtadus-čuovvuleami COP16-čoahkkimis  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_folger_norges_oppfolging_av_naturavtalen_pa_cop16-motet.html"/>
