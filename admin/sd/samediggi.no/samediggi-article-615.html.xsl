...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=615&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki politihkalaš dási njuolggadusat - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-615.html" xml:lang="nob"/>
</xsl:variable>
