...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Mearraealahusat/Ministtar-beahtta-reabbabivdiid'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_marine-naeringer_ministeren-svikter-krabbefiskerne.html"/></xsl:variable>
