...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2818&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Biehttaleapmi minerálaláhkii - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2818.html" xml:lang="nob"/>
</xsl:variable>
