...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3539&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Áigeguovdilis áššit, ohccanáigemearit, konferánsat.... - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3539.html" xml:lang="nob"/>
</xsl:variable>
