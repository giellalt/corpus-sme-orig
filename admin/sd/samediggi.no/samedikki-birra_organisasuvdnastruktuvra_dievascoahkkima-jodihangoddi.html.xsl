...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Samedikki-birra/Organisasuvdnastruktuvra/Dievascoahkkima-jodihangoddi'"/>
	...
	<parallel_text xml:lang="nob" location="om-sametinget_organisasjonsstruktur_plenumsledelsen.html"/></xsl:variable>
