...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/utvider-horingsfrist-av-reindriftslovutvalgets-forslag-til-endret-reindriftslov-til-5-januar-2023.23173.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Boazodoalloláhkalávdegotti evttohus rievdadit boazodoallolága gulaskuddanáigemearri guhkiduvvo ođđajagemánu 5.b. 2023 rádjai - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="utvider_horingsfrist_av_reindriftslovutvalgets_forslag_til_endret_reindriftslov_til_5__januar_2023.html"/>
