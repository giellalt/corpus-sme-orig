...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Doarjagat-ja-stipeanddat/Doarjjarudat-2020-Rafaidahttojuvvon-sami-visttit-privahta-oamastusas'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Doarjjaruđat 2020 - Ráfáidahttojuvvon sámi visttit priváhta oamastusas'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tilskuddsmidler-2020-freda-samiske-bygninger-i-privat-eie.html"/>
