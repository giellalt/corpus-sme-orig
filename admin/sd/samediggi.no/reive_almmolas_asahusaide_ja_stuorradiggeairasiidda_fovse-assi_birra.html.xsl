...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/brev-til-offentlige-institusjoner-og-stortingsrepresentanter-om-fosen-saken.28981.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Reive almmolaš ásahusaide ja stuorradiggeáirasiidda Fovse-ášši birra - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="brev_til_offentlige_institusjoner_og_stortingsrepresentanter_om_fosen-saken.html"/>
