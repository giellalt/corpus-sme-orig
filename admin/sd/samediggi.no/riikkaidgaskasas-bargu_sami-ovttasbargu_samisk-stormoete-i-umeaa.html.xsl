...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Riikkaidgaskasas-bargu/Sami-ovttasbargu/Samisk-stormoete-i-Umeaa'"/>
	...
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_samisk-samarbeid_samisk-stormoete-i-umeaa.html"/></xsl:variable>
