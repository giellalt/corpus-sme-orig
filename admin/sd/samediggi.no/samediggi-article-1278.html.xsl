...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1278&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Hálddahusođastus ferte sihkkarastit sámiid beroštumiid - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1278.html" xml:lang="nob"/>
</xsl:variable>
