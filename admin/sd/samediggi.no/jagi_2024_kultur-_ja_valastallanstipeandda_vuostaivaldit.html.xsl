...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/jagi-2024-kultur-ja-valastallanstipeandda-vuostaivaldit.34971.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Jagi 2024 kultur- ja valáštallanstipeandda vuostáiváldit - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="offentliggjoring_av_stipendmottakere_av_kultur-_og_idrettsstipend_2024.html"/>
