...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=879&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki bušeahta 2006 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-879.html" xml:lang="nob"/>
</xsl:variable>
