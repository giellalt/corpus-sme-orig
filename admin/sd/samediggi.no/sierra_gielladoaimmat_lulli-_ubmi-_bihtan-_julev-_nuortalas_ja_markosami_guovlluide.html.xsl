...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/stipenda-ja-darja/darja/giella/samiske-spraktiltak-i-sor-ume-pite-lule-skolte-og-markasamisk-omrade/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sierra gielladoaimmat lulli-, ubmi-, bihtán-, julev-, nuortalaš ja márkosámi guovlluide - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="samiske_spraktiltak_i_sor-_ume-_pite-_lule-_skolte-_og_markasamisk_omrade.html"/>
