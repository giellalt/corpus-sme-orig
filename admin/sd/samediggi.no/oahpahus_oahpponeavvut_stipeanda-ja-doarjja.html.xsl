...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Oahpahus/Oahpponeavvut/Stipeanda-ja-doarjja'"/>
	...
	<parallel_text xml:lang="nob" location="opplaering_laeremidler_stipend-og-tilskudd.html"/></xsl:variable>
