...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Biras-areala-ja-kultursuodjaleapmi/Areala/Samedikki-planaveahkki/Samedikki-njuolggadusat-man-mielde-arvvostallat-sami-berostumiid-meahci-rievdaduvvon-anu-ektui'"/>
	...
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_areal_sametinget-planveileder_sametingets-retningslinjer-for-vurdering-av-samiske-hensyn-ved-endret-bruk-av-utmark..html"/></xsl:variable>
