...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=57&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Čáliheapmi Sámedikki jienastuslohkui - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-57.html" xml:lang="nob"/>
</xsl:variable>
