...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/handlingsplan-mot-vold-i-nare-relasjoner-med-egen-del-om-vold-og-overgrep-i-samiske-samfunn.15847.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Doaibmaplánas veahkaválddi vuostá lagas gaskavuođain lea sierra oassi veahkaválddi ja illastemiid birra sámi servodagain  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="handlingsplan_mot_vold_i_naere_relasjoner_med_egen_del_om_vold_og_overgrep_i_samiske_samfunn.html"/>
