...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Boazodoallu/Boazodoalu-boahtteaigi-Sami-calmmiiguin'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_reindrift_framtidig-reindrift-fra-et-samisk-perspektiv.html"/></xsl:variable>
