...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3747&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Mis lea buorre oktavuohta FeFo stivrrain - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3747.html" xml:lang="nob"/>
</xsl:variable>
