...
<xsl:variable name="filename" select="'http://www.sametinget.no/artikkel.aspx?MId1=3471&amp;AId=3808&amp;Print=1'"/>
<xsl:variable name="title" select="'12 500 euro deles ut – det er tid for å foreslå kandidater til GOLLEGIELLA'"/>
