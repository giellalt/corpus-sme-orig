...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3030&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Čalmmustahttá Mánáidkonvenšuvnna 20 jagi ávvudeami - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3030.html" xml:lang="nob"/>
</xsl:variable>
