...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=80&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Plána- ja finánsalávdegoddi - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-80.html" xml:lang="nob"/>
</xsl:variable>
