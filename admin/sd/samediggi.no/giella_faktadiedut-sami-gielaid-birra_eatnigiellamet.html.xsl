...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Giella/Faktadiedut-sami-gielaid-birra/Eatnigiellamet'"/>
	...
	<parallel_text xml:lang="nob" location="spraak_fakta-om-samiske-spraak_morsmaalet-vaart.html"/></xsl:variable>
