...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/bevilget-2-9-millioner-kroner-til-sprakprosjekter-ogsa-motorklubb-og-pitesamisk-applikasjon-far-stotte.15777.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Juolludan 2,9 milj. ru. giellaprošeavttaide, doarjja maid mohtorsearvái ja bihtánsámegiela applikašuvdnii - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="bevilget_2_9_millioner_kroner_til_sprakprosjekter_ogsa_motorklubb_og_pitesamisk_applikasjon_far_stotte.html"/>
