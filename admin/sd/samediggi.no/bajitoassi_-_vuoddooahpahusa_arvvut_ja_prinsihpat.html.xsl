...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/grunnopplaring/lareplaner/overordnet-del-verdier-og-prinsipper-for-grunnopplaringen/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bajitoassi – vuođđooahpahusa árvvut ja prinsihpat - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="overordnet_del_-_verdier_og_prinsipper_for_grunnopplaeringen.html"/>
