...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/sametinget-lofter-samisk-idrett-til-nye-hoyder-enighet-i-idrettsavtalen.26548.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi lokte sámi valáštallama ođđa allodagaide – soahpan valáštallanšiehtadusa - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_lofter_samisk_idrett_til_nye_hoyder_-_enighet_i_idrettsavtalen.html"/>
