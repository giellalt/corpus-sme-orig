...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingsradet-tildeler-over-1-3-millioner-kroner-til-utgivelse-av-samisk-musikk-og-joik.7216.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggeráđđi juolluda 1,388 miljon ruvnno sámi musihka ja luđiid almmuheapmái - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingsradet_tildeler_over_1_3_millioner_kroner_til_utgivelse_av_samisk_musikk_og_joik.html"/>
