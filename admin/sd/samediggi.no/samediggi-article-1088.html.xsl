...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1088&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Ođđa sámi áirasat dearvvašvuođadoaimmain - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1088.html" xml:lang="nob"/>
</xsl:variable>
