...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1139&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Eamiálbmotvuoigatvuođat leat deaŧalaččat juksamis ONa duhátjahkemihttomeari - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1139.html" xml:lang="nob"/>
</xsl:variable>
