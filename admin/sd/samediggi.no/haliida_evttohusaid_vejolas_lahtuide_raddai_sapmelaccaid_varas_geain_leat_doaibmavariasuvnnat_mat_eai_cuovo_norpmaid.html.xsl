...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/vil-ha-forslag-pa-mulige-medlemmer-til-rad-for-samer-med-normbrytende-funksjonsvariasjoner.35053.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Háliida evttohusaid vejolaš lahtuide ráđđái sápmelaččaid várás geain leat doaibmavariašuvnnat mat eai čuovo norpmaid - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="vil_ha_forslag_pa_mulige_medlemmer_til_rad_for_samer_med_normbrytende_funksjonsvariasjoner.html"/>
