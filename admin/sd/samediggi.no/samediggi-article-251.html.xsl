...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=251&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Odelstinget jienastii Sámedikki evttohusa vuostá - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-251.html" xml:lang="nob"/>
</xsl:variable>
