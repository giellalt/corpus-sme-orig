...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Ealahusat/Kulturealahus/Dahttu-angirussan-sami-kulturealahusain/Eanet-angirussan-duodjeealahussii'"/>
	...
	<parallel_text xml:lang="nob" location="naeringer_kulturnaering_dahttu-en-satsing-paa-samisk-kulturnaering_nysatsing-paa-duodjinaeringen.html"/></xsl:variable>
