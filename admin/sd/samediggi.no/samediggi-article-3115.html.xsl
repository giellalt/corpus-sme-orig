...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3115&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Dohkkehuvvon listta sámediggeválgii - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3115.html" xml:lang="nob"/>
</xsl:variable>
