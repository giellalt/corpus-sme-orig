...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2722&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Doarjja Doarjjastivrras &#269;ak&#269;am&#225;nu 2008 - S&#225;mediggi Sametinget'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-2722.html'"/>
