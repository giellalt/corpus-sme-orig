...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1647&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'RSS Feed - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1647.html" xml:lang="nob"/>
</xsl:variable>
