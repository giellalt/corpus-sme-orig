...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Samedikki-vuostecealkamus-matkeealahusrusttegii-ja-bartagavpogii-Arctic-Centerii-Ravdnjemuotkkis-Romssas'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikki vuostecealkámuš mátkeealáhusrusttegii ja bartagávpogii Arctic Centerii Rávdnjemuotkkis Romssas'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingets-innsigelse-til-reiselivsanlegget-og-hyttebyen-arctic-center-paa-ravdnjemuotki-finnheia-ved-tromsoe.html"/>
