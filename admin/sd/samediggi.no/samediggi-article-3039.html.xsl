...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3039&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: -BB Ráđđi duddjo rabasvuođa Sámedikki birra - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3039.html" xml:lang="nob"/>
</xsl:variable>
