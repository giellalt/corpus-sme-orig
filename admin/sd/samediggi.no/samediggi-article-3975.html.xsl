...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3975&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sámedikki lávdegoddečoahkkin 2010 skábmamánus - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3975.html" xml:lang="nob"/>
</xsl:variable>
