...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Media/Files/Filarkiv/Planer/Dahkoesoejkesje-saemien-gielide-staatuse-2011-20132'"/>
    ...
    <parallel_text location="dahkoesoejkesje-saemien-gielide-staatuse-2011-20132.html" xml:lang="nob"/>
