...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1271&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Vuordá divatluvvema boazodollui - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1271.html" xml:lang="nob"/>
</xsl:variable>
