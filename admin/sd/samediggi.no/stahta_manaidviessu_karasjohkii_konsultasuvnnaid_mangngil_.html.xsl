...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/stahta-manaidviessu-karasjohkii-konsultasuvnnaid-mannil.26405.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Stáhta Mánáidviessu Kárášjohkii konsultašuvnnaid maŋŋil  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="statens_barnehus_til_karasjok_etter_konsultasjoner.html"/>
