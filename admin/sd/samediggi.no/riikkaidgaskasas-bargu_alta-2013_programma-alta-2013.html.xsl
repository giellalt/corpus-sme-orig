...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Riikkaidgaskasas-bargu/Alta-2013/Programma-Alta-2013'"/>
	...
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_alta-2013_program-alta-2013.html"/></xsl:variable>
