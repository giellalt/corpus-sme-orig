...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Oppalasgeahcastat-movt-leat-jienastan-iesgudet-valgabiirres-ja-obbalaccat-Norggas'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oppalašgeahčastat movt leat jienastan iešguđet válgabiirres ja obbalaččat Norggas'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="oversikt-over-stemmegivning-for-valgkretsene-og-hele-landet.html"/>
