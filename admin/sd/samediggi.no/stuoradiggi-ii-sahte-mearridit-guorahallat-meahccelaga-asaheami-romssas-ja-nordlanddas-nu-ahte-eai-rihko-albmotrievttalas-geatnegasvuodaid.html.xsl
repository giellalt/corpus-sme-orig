...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Samedikki-birra2/Arkiiva-aigodat-2016-2017/Odasarkiiva/Stuoradiggi-ii-sahte-mearridit-guorahallat-meahccelaga-asaheami-Romssas-ja-Nordlanddas-nu-ahte-eai-rihko-albmotrievttalas-geatnegasvuodaid'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Stuoradiggi ii sáhte mearridit guorahallat meahccelága ásaheami Romssas ja Nordlánddas nu ahte eai rihko álbmotrievttálaš geatnegasvuođaid'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="stortinget-kan-ikke-vedta-aa-utrede-innfoering-av-fjellova-i-troms-og-nordland-uten-at-folkerettslige-forpliktelser-brytes.html"/>
