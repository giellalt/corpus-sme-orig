...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Biras-areala-ja-kultursuodjaleapmi/Kulturmuittut/Stipeanda-ja-doarjja'"/>
	...
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_kulturminner_stipend-og-tilskudd.html"/></xsl:variable>
