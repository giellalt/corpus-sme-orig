...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3533&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámi giellavuoigatvuođat árgabeaivvis - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3533.html" xml:lang="nob"/>
</xsl:variable>
