...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3216&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Sámegielat skuvlaluohkát buot stuora gávpogiin Norggas - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3216.html" xml:lang="nob"/>
</xsl:variable>
