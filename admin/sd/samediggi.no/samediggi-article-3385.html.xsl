...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3385&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sagka Stångberg oažžu Sámedikki giellabálkkašumi - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3385.html" xml:lang="nob"/>
</xsl:variable>
