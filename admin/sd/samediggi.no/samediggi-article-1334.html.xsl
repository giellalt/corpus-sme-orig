...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1334&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Álkit válljet: sámegiela vai dárogiela neahtas - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1334.html" xml:lang="nob"/>
</xsl:variable>
