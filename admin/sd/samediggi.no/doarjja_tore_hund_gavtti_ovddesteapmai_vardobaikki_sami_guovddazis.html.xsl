...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/stotte-til-rekonstruksjon-av-tore-hunds-kofte-pa-vardobaiki-samiske-senter.7344.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Doarjja Tore Hund gávtti ovddešteapmái Várdobáikki sámi guovddážis - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="stotte_til_rekonstruksjon_av_tore_hunds_kofte_pa_vardobaiki_samiske_senter.html"/>
