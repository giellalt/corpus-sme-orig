...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2938&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Almmolaš ohccánlisttu Sámedikki virggiide: - Sámediggi Sametinget'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-2938.html'"/>
