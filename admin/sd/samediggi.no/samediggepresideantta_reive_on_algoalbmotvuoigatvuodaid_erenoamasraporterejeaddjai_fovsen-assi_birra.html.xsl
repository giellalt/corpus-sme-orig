...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/samediggepresideantta-reive-on-algoalbmotvuoigatvuodaid-erenoamasraporterejeaddjai-fovsen-assi-birra.24985.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggepresideantta reive ON álgoálbmotvuoigatvuođaid erenoamášraporterejeaddjái Fovsen-ášši birra - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingspresidentens_brev_til_fns_spesialrapportor_for_urfolks_rettigheter_om_fosen-saken.html"/>
