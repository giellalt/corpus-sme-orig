...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1651&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Njuolggadusevttohus rievdaduvvon meahccegeavaheami várás - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1651.html" xml:lang="nob"/>
</xsl:variable>
