...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/oppnevnt-nye-styremedlemmer-til-beaivvas-sami-nasunalateahter.6804.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ođđa stivralahtuid nammadan Beaivváš Sámi Našunálateáhterii  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="oppnevnt_nye_styremedlemmer_til_beaivvas_sami_nasunalateahter.html"/>
