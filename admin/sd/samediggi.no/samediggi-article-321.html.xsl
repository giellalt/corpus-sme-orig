...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=321&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Duhtavaš juolludusaiguin reviderejuvvon stáhtabušeahtas  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-321.html" xml:lang="nob"/>
</xsl:variable>
