...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2893&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'SÁMEDIGGERÁĐI EVTTOHUS Sámi vuoigatvuođalávdegotti guorahallamii - vuođđu ja eavttuu láhksbrgui - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2893.html" xml:lang="nob"/>
</xsl:variable>
