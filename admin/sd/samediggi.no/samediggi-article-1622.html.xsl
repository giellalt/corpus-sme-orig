...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1622&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sárdni - Eamiálbmogiid riikkaidgaskasaš polárajahki - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1622.html" xml:lang="nob"/>
</xsl:variable>
