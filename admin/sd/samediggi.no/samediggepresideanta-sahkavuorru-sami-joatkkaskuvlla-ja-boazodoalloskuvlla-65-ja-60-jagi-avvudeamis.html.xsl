...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Samediggepresideanta-sahkavuorru-Sami-joatkkaskuvlla-ja-boazodoalloskuvlla-65-ja-60-jagi-avvudeamis'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggepresideanta sáhkavuorru Sámi joatkkaskuvlla ja boazodoalloskuvlla 65 ja 60 jagi ávvudeamis'"/>
    <!--
