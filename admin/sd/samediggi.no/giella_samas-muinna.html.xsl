...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Giella/Samas-muinna'"/>
	...
	<parallel_text xml:lang="nob" location="spraak_snakk-samisk-te-mae.html"/></xsl:variable>
