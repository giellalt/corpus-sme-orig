...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2747&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikkis lea ođđa oktasaš poastačujuhus - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2747.html" xml:lang="nob"/>
</xsl:variable>
