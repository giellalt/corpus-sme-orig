...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingets-plenum-to-motedeltakere-har-testet-positivt-pa-korona.18104.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikki dievasčoahkkin: Guokte čoahkkinoasseváldi leaba testen positiivvalaččat koronaiskosis - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingets_plenum:_to_motedeltakere_har_testet_positivt_pa_korona.html"/>
