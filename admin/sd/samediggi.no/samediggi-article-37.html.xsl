...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=37&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'*Politihkka ja demokratiija - Sámiid birra - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-37.html" xml:lang="nob"/>
</xsl:variable>
