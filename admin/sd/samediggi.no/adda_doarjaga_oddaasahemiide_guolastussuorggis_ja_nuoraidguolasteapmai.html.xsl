...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/adda-doarjaga-oddaasahemiide-guolastussuorggis-ja-nuoraidguolasteapmai.28154.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Addá doarjaga ođđaásahemiide guolástussuorggis ja nuoraidguolásteapmái - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="gir_tilskudd_til_nyetableringer_innen_fiskeri_og_til_ungdomsfiske.html"/>
