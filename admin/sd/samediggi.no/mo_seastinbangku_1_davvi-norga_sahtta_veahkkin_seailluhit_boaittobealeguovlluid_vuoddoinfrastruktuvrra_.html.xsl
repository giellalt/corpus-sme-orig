...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/hvordan-kan-sparebank1-nord-norge-bidra-til-a-bevare-grunnleggende-infrastruktur-i-distriktene.8136.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Mo SeastinBáŋku 1 Davvi-Norga sáhttá veahkkin seailluhit boaittobealeguovlluid vuođđoinfrastruktuvrra? - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="hvordan_kan_sparebank1_nord-norge_bidra_til_a_bevare_grunnleggende_infrastruktur_i_distriktene_.html"/>
