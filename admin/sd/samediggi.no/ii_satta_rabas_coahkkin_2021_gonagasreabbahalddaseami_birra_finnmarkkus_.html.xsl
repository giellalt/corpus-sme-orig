...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/ii-satta-rabas-coahkkin-2021-gonagasreabbahalddaseami-birra-finnmarkkus.8389.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'II ŠATTA! Rabas čoahkkin 2021 gonagasreabbáhálddašeami birra Finnmárkkus  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="avlyst_apent_mote_om_kongekrabbeforvaltningen_i_finnmark_2021.html"/>
