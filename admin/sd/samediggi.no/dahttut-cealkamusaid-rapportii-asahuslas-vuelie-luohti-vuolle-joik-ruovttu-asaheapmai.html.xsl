...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Dahttut-cealkamusaid-rapportii-asahuslas-vuelie-luohti-vuolle-joik-ruovttu-asaheapmai'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dáhttut cealkámušaid rapportii ásahuslaš vuelie/luohti/vuolle/joik ruovttu ásaheapmái'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="oensker-innspill-til-rapport-om-etablering-av-institusjonelt-hjem-for-vuelie-luohti-vuolle-joik.html"/>
