...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/prm-sameministre-og-sametingspresidenter-motes-i-stockholm-denne-uken.23441.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: Sámeministarat ja sámediggepresideanttat deaivvadit Stockholmmas dán vahku - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm:_sameministre_og_sametingspresidenter_motes_i_stockholm_denne_uken.html"/>
