...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Balvalusat2/Oahpahus-ja-oahpponeavvut/Oahpaheddjiide-bagadallan-ja-ravven-sami-oahpahusa-birra'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oahpaheddjiide bagadallan ja rávven sámi oahpahusa birra'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="veiledning-for-laerere-om-samisk-opplaering.html"/>
