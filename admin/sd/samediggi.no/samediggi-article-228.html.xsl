...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=228&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámi kultuvra - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-228.html" xml:lang="nob"/>
</xsl:variable>
