...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/sametingets-retningslinjer-for-endret-bruk-av-utmark-behandles-pa-nytt-i-sametingets-plenum.26272.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikki dievasčoahkkin meannuda ođđasit Sámedikki njuolggadusaid rievdaduvvon meahccegeavaheapmái  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingets_retningslinjer_for_endret_bruk_av_utmark_behandles_pa_nytt_i_sametingets_plenum.html"/>
