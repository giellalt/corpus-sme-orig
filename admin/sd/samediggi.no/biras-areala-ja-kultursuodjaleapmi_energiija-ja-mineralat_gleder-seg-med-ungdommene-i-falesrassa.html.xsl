...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Biras-areala-ja-kultursuodjaleapmi/Energiija-ja-mineralat/Gleder-seg-med-ungdommene-i-Falesrassa'"/>
	...
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_energi-og-mineraler_gleder-seg-med-ungdommene-i-falesrassa.html"/></xsl:variable>
