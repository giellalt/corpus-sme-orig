...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/kulturminne-og-bygningsvern/nyttige-ressurser/fagrapporter/sluttrapport-kvanangsbotn-og-navitdalen-landskapsvernomrader-kulturminneregistreringer-og-kartlegging-av-historisk-bruk-av-utmarka-2021.10870.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Loahpparaporta Bađaávžži ja Gearbbehiid suodjemeahcci ja Návetvuomi suodjemeahcci: Kulturmuitoregistreremat ja meahci historjjálaš geavaheami kárten (2021) - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sluttrapport_kvaenangsbotn_og_navitdalen_landskapsvernomrader:_kulturminneregistreringer_og_kartlegging_av_historisk_bruk_av_utmarka_2021_.html"/>
