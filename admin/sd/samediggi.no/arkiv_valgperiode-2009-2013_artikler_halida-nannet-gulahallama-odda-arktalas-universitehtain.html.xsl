...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Arkiv/Valgperiode-2009-2013/Artikler/Halida-nannet-gulahallama-odda-Arktalas-Universitehtain'"/>
	...
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_vil-ha-tettere-dialog-med-det-nye-arktiske-universitetet.html"/></xsl:variable>
