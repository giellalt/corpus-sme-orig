...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=342&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki dievasčoahkkin miessemánu 30. b. - geassemánu 2. b. - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-342.html" xml:lang="nob"/>
</xsl:variable>
