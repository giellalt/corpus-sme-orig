...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/layout/set/print/Samedikki-birra/Organisasuvdnastruktuvra/SaNuL/Haliida-digastalla-rasismma-vaikkuhusaid'"/>
	...
	<parallel_text xml:lang="nob" location="om-sametinget_organisasjonsstruktur_supu_vil-diskutere-rasismens-konsekvenser.html"/></xsl:variable>
