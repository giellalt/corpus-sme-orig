...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Riikkaidgaskasas-bargu/Rajahis-guovlulas-ovttasbargu/Ilus-go-evttohuvvo-sierra-mahttostrategiija-Davvi-Norgii'"/>
	...
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_grenseoverskridende-regionalt-samarbeid_positiv-til-egen-kunnskapsstrategi-for-nord-norge.html"/></xsl:variable>
