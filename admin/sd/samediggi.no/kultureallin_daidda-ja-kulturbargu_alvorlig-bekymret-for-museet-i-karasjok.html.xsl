...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Kultureallin/Daidda-ja-kulturbargu/Alvorlig-bekymret-for-museet-i-Karasjok'"/>
	...
	<parallel_text xml:lang="nob" location="kulturliv_kunst-og-kulturutoevelse_alvorlig-bekymret-for-museet-i-karasjok.html"/></xsl:variable>
