...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/2-radgivere-i-sametingets-dokumentasjon-og-parlamentsforvaltning.26136.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'2 ráđđeaddi Sámedikki dokumentašuvdna ja parlameantahálddašeamis - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="2_radgivere_i_sametingets_dokumentasjon_og_parlamentsforvaltning.html"/>
