...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=277&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámeláhka rievdaduvvon - addá Sámediggái njealljá dássenmandáhta.  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-277.html" xml:lang="nob"/>
</xsl:variable>
