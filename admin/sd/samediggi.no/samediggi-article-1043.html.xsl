...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1043&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Eamiálbmotdimenšuvdna váilu hálddašanplána - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1043.html" xml:lang="nob"/>
</xsl:variable>
