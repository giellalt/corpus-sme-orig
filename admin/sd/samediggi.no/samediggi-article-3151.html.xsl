...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3151&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Olli duhtavaš konsultašuvnnain sámeministariin - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3151.html" xml:lang="nob"/>
</xsl:variable>
