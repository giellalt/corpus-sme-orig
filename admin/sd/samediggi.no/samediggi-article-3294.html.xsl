...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3294&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'*Politihkka ja demokratiija - Doarjjastivra - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3294.html" xml:lang="nob"/>
</xsl:variable>
