...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1103&amp;sprak=Samisk&amp;Print=1'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1103.html" xml:lang="nob"/>
</xsl:variable>
