...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3597&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sierra njuolggadusat bearráigeahččanlávdegotti ovddasvástádussii ja bargosuorgái - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3597.html" xml:lang="nob"/>
</xsl:variable>
