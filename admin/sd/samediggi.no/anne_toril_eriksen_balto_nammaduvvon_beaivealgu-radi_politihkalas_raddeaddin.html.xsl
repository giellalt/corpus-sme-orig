...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/anne-toril-eriksen-balto-utnevnt-som-politisk-radgiver-for-beaivealgu-radet.17476.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Anne Toril Eriksen Balto nammaduvvon Beaiveálgu-ráđi politihkalaš ráđđeaddin - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="anne_toril_eriksen_balto_utnevnt_som_politisk_radgiver_for_beaivealgu-radet.html"/>
