...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3027&amp;sprak=Samisk&amp;Print=1'"/>
...
<xsl:variable name="para_nob" select="'samediggi-article-3027.html'"/>
