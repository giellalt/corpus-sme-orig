...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3138&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ná jienastat ovddalgihtii  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3138.html" xml:lang="nob"/>
</xsl:variable>
