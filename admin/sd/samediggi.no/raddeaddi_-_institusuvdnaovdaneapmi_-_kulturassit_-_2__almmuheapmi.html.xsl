...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/radgiver-institusjonsutvikling-kultursaker-2-gangs-utlysning.19628.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ráđđeaddi - Institušuvdnaovdáneapmi - kulturáššit - 2. almmuheapmi - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="radgiver_-_institusjonsutvikling_-_kultursaker_-_2__gangs_utlysning.html"/>
