...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=402&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Sámediggi rahpá sámegiel sátnevuorká interneahtas - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-402.html" xml:lang="nob"/>
</xsl:variable>
