...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Valga-ja-jienastuslohku/Kampanjeside/Diedut/Samediggevalga-2013-listoevttohusat-mat-leat-boahtan-midjiide'"/>
	...
	<parallel_text xml:lang="nob" location="valg-og-manntall_kampanjeside_info_sametingsvalget-2013-innkomne-listeforslag.html"/></xsl:variable>
