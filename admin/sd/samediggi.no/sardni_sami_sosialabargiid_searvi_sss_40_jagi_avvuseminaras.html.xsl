...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politihkka/hala/tale-ved-40-ars-jubileumsseminar-for-sami-sosialbargiid-searvi-samisk-sosialarbeider-forening.33611.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sárdni Sámi Sosiálabargiid Searvi (SSS) 40 jagi ávvusemináras - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tale_ved_40_ars_jubileumsseminar_for_sami_sosialbargiid_searvi_samisk_sosialarbeider_forening_.html"/>
