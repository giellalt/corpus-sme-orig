...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3232&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ovttajienalaš Deanujogalávdegoddi - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3232.html" xml:lang="nob"/>
</xsl:variable>
