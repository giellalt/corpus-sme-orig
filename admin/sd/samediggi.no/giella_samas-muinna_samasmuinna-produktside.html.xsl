...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Giella/Samas-muinna/Samasmuinna-produktside'"/>
	...
	<parallel_text xml:lang="nob" location="spraak_snakk-samisk-te-mae_snakksamisktemae-produktside.html"/></xsl:variable>
