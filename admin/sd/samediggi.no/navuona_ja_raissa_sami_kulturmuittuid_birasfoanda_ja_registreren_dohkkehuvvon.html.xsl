...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/gjennomslag-for-miljofond-og-registrering-av-samiske-kulturminner-i-kvanangen-og-nordreisa.8051.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Návuona ja Ráissa sámi kulturmuittuid birasfoanda ja registreren dohkkehuvvon - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="gjennomslag_for_miljofond_og_registrering_av_samiske_kulturminner_i_kvaenangen_og_nordreisa.html"/>
