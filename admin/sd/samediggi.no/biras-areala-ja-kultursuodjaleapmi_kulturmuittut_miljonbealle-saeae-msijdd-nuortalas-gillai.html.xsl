...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Biras-areala-ja-kultursuodjaleapmi/Kulturmuittut/Miljonbealle-Saeae-msijdd-nuortalas-gillai'"/>
	...
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_kulturminner_en-halv-million-til-skoltebyen.html"/></xsl:variable>
