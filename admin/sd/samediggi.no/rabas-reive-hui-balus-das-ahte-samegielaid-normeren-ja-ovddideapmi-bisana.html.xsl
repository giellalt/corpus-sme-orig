...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/Rabas-reive-Hui-balus-das-ahte-samegielaid-normeren-ja-ovddideapmi-bisana'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Rabas reive: Hui balus das ahte sámegielaid normeren ja ovddideapmi bisána'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="aapent-brev-bekymret-for-at-normering-og-utvikling-av-de-samiske-spraakene-stopper-opp.html"/>
