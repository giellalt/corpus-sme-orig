...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2934&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'ONa Álgoálbmotáššiid Bistevaš Forum Sámis - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2934.html" xml:lang="nob"/>
</xsl:variable>
