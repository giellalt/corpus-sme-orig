...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/stipende-jih-daarjoe/daarjoe/jieleme/duedtie/skaarvemh-evtiedimmieraajvarimmie-konsulenteviehkie-jih-prosjekth/?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Duodji: Investeren- ja ovddidandoarjja,konsuleantaveahki, álggahandoarjja ja prošeavttat - ohcanvuođot doarjja - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="duodji:_investeringer_utviklingstiltak_konsulentbistand_og_etablerertilskudd.html"/>
