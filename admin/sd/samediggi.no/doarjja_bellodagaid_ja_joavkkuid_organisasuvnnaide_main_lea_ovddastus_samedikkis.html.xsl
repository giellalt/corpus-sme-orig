...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/stipeanddat-ja-doarjagat/buot-doarjjaortnegat/doarjja-bellodagaid-ja-joavkkuid-organisasuvnnaide-main-lea-ovddastus-samedikkis/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Doarjja bellodagaid ja joavkkuid organisašuvnnaide main lea ovddastus Sámedikkis - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tilskudd_til_organisasjonene_til_partier_og_grupper_som_er_representert_i_sametinget.html"/>
