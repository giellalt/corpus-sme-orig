...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3372&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Norgga gažadeapmi ON olmmošvuoigatvuođaráđis juovlamánu 2. beaivvi.  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3372.html" xml:lang="nob"/>
</xsl:variable>
