...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3553&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggi ávvuda nissonbeaivvi njukčamánu 8. b. - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3553.html" xml:lang="nob"/>
</xsl:variable>
