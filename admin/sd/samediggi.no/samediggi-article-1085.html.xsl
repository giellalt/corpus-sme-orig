...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1085&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki lávdegoddečoahkkimat - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1085.html" xml:lang="nob"/>
</xsl:variable>
