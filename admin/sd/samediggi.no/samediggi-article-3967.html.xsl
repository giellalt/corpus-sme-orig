...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3967&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Áigu nannet sámi mánáid vuoigatvuođaid - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3967.html" xml:lang="nob"/>
</xsl:variable>
