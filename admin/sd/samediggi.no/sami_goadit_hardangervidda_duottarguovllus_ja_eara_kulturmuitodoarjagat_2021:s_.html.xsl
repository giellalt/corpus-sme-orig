...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/samegammene-pa-hardangervidda-og-andre-kulturminnetilskudd-for-2021.15868.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámi goađit Hardangervidda duottarguovllus ja eará kulturmuitodoarjagat 2021:s  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="samegammene_pa_hardangervidda_og_andre_kulturminnetilskudd_for_2021_.html"/>
