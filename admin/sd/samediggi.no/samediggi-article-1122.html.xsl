...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1122&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Ilus go Nuortasámi musea huksemat leat álggahuvvon - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1122.html" xml:lang="nob"/>
</xsl:variable>
