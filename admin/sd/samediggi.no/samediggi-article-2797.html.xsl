...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2797&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Doarjja diehtojuohkindoaibmabijuide 2009 stuorradigge- ja sámediggeválgga oktavuođas - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2797.html" xml:lang="nob"/>
</xsl:variable>
