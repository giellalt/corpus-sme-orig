...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3734&amp;sprak=Samisk&amp;Print=1'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3734.html" xml:lang="nob"/>
</xsl:variable>
