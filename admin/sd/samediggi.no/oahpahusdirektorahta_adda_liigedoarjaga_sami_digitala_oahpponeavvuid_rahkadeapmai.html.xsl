...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/utdanningsdirektoratet-gir-ekstra-tilskudd-til-utvikling-av-samiske-digitale-laremidler.5838.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oahpahusdirektoráhta addá liigedoarjaga sámi digitála oahpponeavvuid ráhkadeapmái - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="utdanningsdirektoratet_gir_ekstra_tilskudd_til_utvikling_av_samiske_digitale_laeremidler.html"/>
