...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Odasarkiiva/PRD-30-jagi-dassa-go-ILO-konvensuvdna-eamialbmogiid-vuoigatvuodaid-birra-mearriduvvui'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: 30 jagi dassá go ILO-konvenšuvdna eamiálbmogiid vuoigatvuođaid birra mearriduvvui'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm-30-aar-siden-ilo-konvensjon-nr.-169-om-urfolks-rettigheter-ble-vedtatt.html"/>
