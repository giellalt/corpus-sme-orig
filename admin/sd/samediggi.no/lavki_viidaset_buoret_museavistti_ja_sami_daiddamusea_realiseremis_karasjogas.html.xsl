...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/et-steg-videre-i-realiseringen-av-et-bedre-museumsbygg-og-samisk-kunstmuseum-i-karasjok.20735.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lávki viidáset buoret museavistti ja sámi dáiddamusea realiseremis Kárášjogas - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="et_steg_videre_i_realiseringen_av_et_bedre_museumsbygg_og_samisk_kunstmuseum_i_karasjok.html"/>
