...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3168&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ruoŧabeal Sámediggi rahpá odne - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3168.html" xml:lang="nob"/>
</xsl:variable>
