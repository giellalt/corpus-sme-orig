...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3158&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Eai leat nu ollusat geat FERTEJIT ovddalgihtii jienastit - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3158.html" xml:lang="nob"/>
</xsl:variable>
