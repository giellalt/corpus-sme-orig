...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3478&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámi pedagogalaš fágabeaivvit Guovdageainnus - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3478.html" xml:lang="nob"/>
</xsl:variable>
