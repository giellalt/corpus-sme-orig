...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1690&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Ráđđehus addá boasttu dieđuid Stuorradiggái - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1690.html" xml:lang="nob"/>
</xsl:variable>
