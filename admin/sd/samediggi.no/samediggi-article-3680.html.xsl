...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3680&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Rabas virgi Sámedikkis mas ohcanáigi lea: 19.05.10 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3680.html" xml:lang="nob"/>
</xsl:variable>
