...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2761&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Makkár ekonomalaš doarjjaortnegat leat sámediggeválgga várás? - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2761.html" xml:lang="nob"/>
</xsl:variable>
