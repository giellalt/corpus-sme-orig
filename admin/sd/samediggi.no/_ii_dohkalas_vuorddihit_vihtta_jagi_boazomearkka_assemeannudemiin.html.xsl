...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/ikke-akseptabelt-a-vente-i-fem-ar-pa-saksbehandling-av-reinmerke.33188.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'– Ii dohkálaš vuorddihit vihtta jagi boazomearkka áššemeannudemiin - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="_ikke_akseptabelt_a_vente_i_fem_ar_pa_saksbehandling_av_reinmerke.html"/>
