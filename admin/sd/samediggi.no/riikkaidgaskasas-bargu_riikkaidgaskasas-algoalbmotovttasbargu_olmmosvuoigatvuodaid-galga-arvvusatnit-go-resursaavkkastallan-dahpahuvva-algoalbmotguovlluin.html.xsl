...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Riikkaidgaskasas-bargu/Riikkaidgaskasas-algoalbmotovttasbargu/Olmmosvuoigatvuodaid-galga-arvvusatnit-go-resursaavkkastallan-dahpahuvva-algoalbmotguovlluin'"/>
	...
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_internasjonalt-urfolkssamarbeid_menneskerettigheter-maa-respekteres-naar-ressursutvinning-skjer-i-urfolks-omraader.html"/></xsl:variable>
