...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2944&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRD: Erenoamáš liiba oahppat sámegiela - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2944.html" xml:lang="nob"/>
</xsl:variable>
