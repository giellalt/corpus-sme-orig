...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/tilskudd-til-samiske-bygningsvernprosjekter-for-2022-se-hvor-bra-det-kan-bli.16635.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Doarjja sámi vistesuodjalusprošeavttaide jahkái 2022 - geahčes man buorren sáhttá šaddat! - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tilskudd_til_samiske_bygningsvernprosjekter_for_2022_-_se_hvor_bra_det_kan_bli_.html"/>
