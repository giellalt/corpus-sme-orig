...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/ny-strategiplan-for-samiskspraklig-laremiddelutvikling-skal-behandles-av-sametinget.34665.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi meannuda sámegiel oahpponeavvoráhkadeami ođđa strategiijaplána - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="ny_strategiplan_for_samiskspraklig_laeremiddelutvikling_skal_behandles_av_sametinget.html"/>
