...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.no/Samedikki-birra2/Arkiiva-aigodat-2016-2017/Preassadiedahusat/ON-algoalbmotvuoigatvuodaid-julggastus-10-jagi-Dal-ferte-Norga-bidjat-doibmii-julggastusa'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'ON álgoálbmotvuoigatvuođaid julggaštus 10 jagi: – Dál ferte Norga bidjat doibmii julggaštusa'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="fns-urfolkserklaering-10-aar-naa-maa-norge-implementere-erklaeringen.html"/>
