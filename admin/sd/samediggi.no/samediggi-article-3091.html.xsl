...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3091&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggi báikkálaš kantuvra fárrii Diehtosiidii - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3091.html" xml:lang="nob"/>
</xsl:variable>
