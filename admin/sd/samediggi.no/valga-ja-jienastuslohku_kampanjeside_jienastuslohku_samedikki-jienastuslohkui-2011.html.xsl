...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Valga-ja-jienastuslohku/Kampanjeside/Jienastuslohku/Samedikki-jienastuslohkui-2011'"/>
	...
	<parallel_text xml:lang="nob" location="valg-og-manntall_kampanjeside_valgmanntall_sametingets-valgmanntall-2011.html"/></xsl:variable>
