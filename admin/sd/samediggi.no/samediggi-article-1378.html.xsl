...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1378&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Davviriikkaid Ráđđi bidjá guovddážii bargat rádjacakkiiguin - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1378.html" xml:lang="nob"/>
</xsl:variable>
