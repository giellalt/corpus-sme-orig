...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2877&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Orustehket soahtama seammás - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2877.html" xml:lang="nob"/>
</xsl:variable>
