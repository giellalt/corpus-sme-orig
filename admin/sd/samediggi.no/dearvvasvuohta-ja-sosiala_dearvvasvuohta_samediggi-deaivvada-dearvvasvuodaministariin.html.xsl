...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Dearvvasvuohta-ja-sosiala/Dearvvasvuohta/Samediggi-deaivvada-dearvvasvuodaministariin'"/>
	...
	<parallel_text xml:lang="nob" location="helse-og-sosial_helse_sametinget-moeter-helseminister.html"/></xsl:variable>
