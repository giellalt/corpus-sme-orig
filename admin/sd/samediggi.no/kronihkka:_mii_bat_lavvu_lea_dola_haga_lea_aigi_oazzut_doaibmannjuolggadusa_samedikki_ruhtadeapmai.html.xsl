...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/kronihkka-mii-bat-lavvu-lea-dola-haga-lea-aigi-oazzut-doaibmannjuolggadusa-samedikki-ruhtadeapmai.27504.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kronihkka: Mii bat lávvu lea dola haga? Lea áigi oažžut doaibmannjuolggadusa Sámedikki ruhtadeapmái - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="kronikk:_hva_er_vel_en_lavvo_uten_bal_tid_for_en_handlingsregel_for_sametingets_finansiering.html"/>
