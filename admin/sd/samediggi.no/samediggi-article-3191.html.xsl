...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3191&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki presideanta oassálastá birasčoahkkimmii Svalbárddas - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3191.html" xml:lang="nob"/>
</xsl:variable>
