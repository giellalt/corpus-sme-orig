...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=845&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggi rahpá kantuvrra Gáivuonas - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-845.html" xml:lang="nob"/>
</xsl:variable>
