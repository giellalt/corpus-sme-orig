...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-gratulerer-h-k-h-prinsesse-ingrid-alexandra-med-18-ars-dagen.19305.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi sávvá lihku 18 jagi beivviin Gonagaslaš Allavuhtii Prinseassa Ingrid Alexandrai  - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_gratulerer_h_k_h__prinsesse_ingrid_alexandra_med_18-ars_dagen.html"/>
