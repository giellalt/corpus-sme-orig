...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3547&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Hagbart Grønmo ođđa ráđđeaddin Sámediggeráđđái - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3547.html" xml:lang="nob"/>
</xsl:variable>
