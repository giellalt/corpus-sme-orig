...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/videreforing-av-sprakprosjektet-giellabaiki-samiskspraklig-arena-i-vesteralen-og-lofoten.7908.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Giellaprošeavtta Giellabáiki joatkin – sámegielat arena Viesterállásis ja Lofuohtas - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="videreforing_av_sprakprosjektet_giellabaiki_-_samiskspraklig_arena_i_vesteralen_og_lofoten.html"/>
