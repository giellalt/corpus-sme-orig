...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/2-arig-prosjektstilling-i-seksjon-for-bygningsvern-skjotsel-og-kulturlandskap-radgiver.19847.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'2- jagá prošeaktavirgi vistegáhtten, seailluhan ja kultureanadatjuhkosis - Ráđđeaddi - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="2-arig_prosjektstilling_i_seksjon_for_bygningsvern_skjotsel_og_kulturlandskap_-_radgiver.html"/>
