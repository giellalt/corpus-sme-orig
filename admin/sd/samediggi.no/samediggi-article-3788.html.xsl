...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3788&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'- Deaŧalaš lea čađahit buriid gielladoaibmabijuid - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3788.html" xml:lang="nob"/>
</xsl:variable>
