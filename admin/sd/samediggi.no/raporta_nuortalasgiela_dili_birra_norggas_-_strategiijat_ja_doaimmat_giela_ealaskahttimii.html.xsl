...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/rapport-om-skoltesamisk-spraksituasjon-i-norge-strategier-og-tiltak-for-vitalisering-av-spraket.13831.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Raporta nuortalašgiela dili birra Norggas – strategiijat ja doaimmat giela ealáskahttimii - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="rapport_om_skoltesamisk_spraksituasjon_i_norge_-_strategier_og_tiltak_for_vitalisering_av_spraket.html"/>
