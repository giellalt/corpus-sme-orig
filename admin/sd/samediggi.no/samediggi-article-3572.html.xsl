...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3572&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámediggi ávvuda mánáidgárdebeaivvi - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3572.html" xml:lang="nob"/>
</xsl:variable>
