...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-justerer-sine-tilbud-for-a-mote-endrede-behov-i-naringslivet-som-folge-av-korona-pandemien-fra-og-med-01-04-20.3622.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámediggi heiveha iežas fálaldagaid 01.04.20 rájes gokčan dusten ealáhuseallima rievdan dárbbuid koronapandemiija geažil - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_justerer_sine_tilbud_for_a_mote_endrede_behov_i_naeringslivet_som_folge_av_korona-pandemien_fra_og_med_01_04_20.html"/>
