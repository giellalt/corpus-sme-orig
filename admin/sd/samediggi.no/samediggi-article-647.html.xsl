...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=647&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sámedikki čoahkkinplána 2006  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-647.html" xml:lang="nob"/>
</xsl:variable>
