...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/digital-ordbok-app-skal-hjelpe-flere-til-a-lare-seg-samisk.8569.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Digitála sátnegirje-appa galgá veahkehit eanet olbmuid oahppat sámegiela - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="digital_ordbok-app_skal_hjelpe_flere_til_a_laere_seg_samisk.html"/>
