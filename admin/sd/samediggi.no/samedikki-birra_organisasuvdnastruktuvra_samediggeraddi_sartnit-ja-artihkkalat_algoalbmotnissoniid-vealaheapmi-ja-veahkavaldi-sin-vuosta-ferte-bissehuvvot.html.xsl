...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.no/Samedikki-birra/Organisasuvdnastruktuvra/Samediggeraddi/Sartnit-ja-artihkkalat/Algoalbmotnissoniid-vealaheapmi-ja-veahkavaldi-sin-vuosta-ferte-bissehuvvot'"/>
	...
	<parallel_text xml:lang="nob" location="om-sametinget_organisasjonsstruktur_sametingsraadet_taler-og-artikler_diskriminering-og-vold-mot-urfolkskvinner-maa-stoppes.html"/></xsl:variable>
