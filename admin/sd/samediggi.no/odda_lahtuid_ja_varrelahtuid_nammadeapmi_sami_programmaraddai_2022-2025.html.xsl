...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/oppnevning-av-samisk-programrad-for-perioden-2022-2025.19554.aspx?sprak=12'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ođđa lahtuid ja várrelahtuid nammadeapmi Sámi Prográmmaráđđái 2022-2025 - Sámediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="oppnevning_av_samisk_programrad_for_perioden_2022-2025.html"/>
