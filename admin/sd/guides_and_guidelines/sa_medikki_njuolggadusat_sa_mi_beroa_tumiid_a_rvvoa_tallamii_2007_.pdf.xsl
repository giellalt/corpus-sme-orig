...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <parallel_text location="sametingets_retningslinjer_for_vurderingen_av_samiske_hensyn_ved_endret_bruk_av_meahcci-utmark_i_finnmark_2007_.pdf" xml:lang="nob"/>
</xsl:variable>
