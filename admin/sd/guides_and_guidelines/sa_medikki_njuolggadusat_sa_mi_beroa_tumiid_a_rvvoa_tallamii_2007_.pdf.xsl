...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/556/4948/version/1/file/S%C3%A1medikki+njuolggadusat+s%C3%A1mi+bero%C5%A1tumiid+%C3%A1rvvo%C5%A1tallamii+%282007%29.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingets_retningslinjer_for_vurderingen_av_samiske_hensyn_ved_endret_bruk_av_meahcci-utmark_i_finnmark_2007_.pdf"/>
