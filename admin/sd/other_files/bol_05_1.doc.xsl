...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'bol_1_05.1.doc'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Karen Lovise'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Hege'"/>
    <xsl:variable name="author2_ln" select="'Fjellheim Sarre'"/>
    <xsl:variable name="author2_gender" select="'f'"/>
    <xsl:variable name="author2_nat" select="'NO'"/>
    <xsl:variable name="author2_born" select="'1962'"/>
    ...
    <xsl:variable name="wordcount" select="'5694'"/>
