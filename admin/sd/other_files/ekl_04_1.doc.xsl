...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'ekl_1_04.doc'"/>
  <xsl:variable name="title" select="'Mteprotokoll'"/>
  ...
  <xsl:variable name="translator_ln" select="'Eira Murud'"/>
  ...
  <xsl:variable name="wordcount" select="'2235'"/>
