...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=2199&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Sámi logut muitalit 2'"/>
...
<xsl:variable name="wordcount" select="'29656'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samiske_tall_2.pdf" xml:lang="nob"/>
</xsl:variable>
