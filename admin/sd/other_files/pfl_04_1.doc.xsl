...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'pfl_1_04.doc'"/>
  ...
  <xsl:variable name="author2_fn" select="'Toril'"/>
  <xsl:variable name="author2_ln" select="'Iversen'"/>
  ...
  <xsl:variable name="wordcount" select="'14914'"/>
