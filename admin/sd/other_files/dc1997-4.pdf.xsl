...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2479'"/>
<xsl:variable name="title" select="'Čoahkkingirji 4/97'"/>
...
<xsl:variable name="wordcount" select="'17079'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sp1997-4.pdf" xml:lang="nob"/>
</xsl:variable>
