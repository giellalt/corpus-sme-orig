...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'bl_1_05.doc'"/>
  <xsl:variable name="title" select="'Møteprotokoll'"/>
  <xsl:variable name="author1_fn" select="'Laila'"/>
  <xsl:variable name="author1_ln" select="'Palojärvi'"/>
  <xsl:variable name="author1_gender" select="'f'"/>
  <xsl:variable name="author1_born" select="''"/>
  <xsl:variable name="author1_nat" select="'fin'"/>
  <xsl:variable name="author2_fn" select="'Berit Karen'"/>
  <xsl:variable name="author2_ln" select="'Paulsen'"/>
