...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_samisk/wfdocument.aspx?journalpostid=2010005269&amp;dokid=247310&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF
'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Plána- ja finánsalávdegoddi Čoahkkingirji 01/10'"/>
...
<xsl:variable name="mlang_nob" select="'pfk2010-1.pdf'"/>
...
<xsl:variable name="para_nob" select="'pfk2010-1.pdf'"/>
