...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=1817&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'SÁMEDIKKI DOAIBMAPLÁNA MÁNÁIDGÁRDDIID MIELLAÁVKKÁLAŠ BARGGUID OVDDIDEAMI VÁRÁS'"/>
...
<xsl:variable name="wordcount" select="'2839'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sametingets_handlingsplan_for_holdningsskapende_arbeid_i_barnehagen.pdf" xml:lang="nob"/>
</xsl:variable>
