...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=125&amp;ct=.doc'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámegielaid geavaheapmi 2000'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'22701'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="bruken_av_samiske_sprak_2000.doc"/>
