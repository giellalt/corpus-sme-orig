...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_samisk/wfdocument.aspx?journalpostid=2010017522&amp;dokid=269199&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="title" select="'Čoahkkingirji 02/08'"/>
...
<xsl:variable name="wordcount" select="'9053'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ts2008-2.pdf" xml:lang="nob"/>
</xsl:variable>
