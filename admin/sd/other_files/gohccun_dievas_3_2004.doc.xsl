...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'gohccun_dievas_3_2004.doc'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'MELAND KOMMUNE'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Anja Guttorm'"/>
    <xsl:variable name="author1_ln" select="'Graven'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'1979'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'14848'"/>
