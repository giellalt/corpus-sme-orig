...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'satnelistu.doc'"/>
  <xsl:variable name="title" select="'Sátnelistu'"/>
  <xsl:variable name="author1_fn" select="'Amund'"/>
  <xsl:variable name="author1_ln" select="'Nergård'"/>
  ...
  <xsl:variable name="wordcount" select="'14067'"/>
  <xsl:variable name="metadata" select="'uncomplete'"/>
  <xsl:variable name="template_version" select="'$Revision: 1.7 $'"/>
