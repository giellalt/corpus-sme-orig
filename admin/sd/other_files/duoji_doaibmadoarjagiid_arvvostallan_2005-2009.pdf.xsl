...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=2868&amp;ct=.pdf'"/>
    ...
    <xsl:variable name="wordcount" select="'19138'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="evaluering_av_driftstilskuddsordningen_for_duodji_2005-2009.pdf"/>
