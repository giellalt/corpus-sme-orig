...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2460'"/>
<xsl:variable name="title" select="'ČOAHKKINGIRJI 4/95 - RÁĐĐÁDALLANOASSI'"/>
...
<xsl:variable name="wordcount" select="'6398'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sp1995-4a.pdf" xml:lang="nob"/>
</xsl:variable>
