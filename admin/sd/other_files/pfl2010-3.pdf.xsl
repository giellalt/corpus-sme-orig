...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_samisk/wfdocument.aspx?journalpostid=2010023895&amp;dokid=280914&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Plána- ja finánsalávdegoddi Čoahkkingirji 3/2010'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pfk2010-3.pdf" xml:lang="nob"/>
</xsl:variable>
