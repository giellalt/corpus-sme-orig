...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2471'"/>
<xsl:variable name="title" select="'Čoahkkingirji 4/96'"/>
...
<xsl:variable name="wordcount" select="'34250'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sp1996-4.pdf" xml:lang="nob"/>
</xsl:variable>
