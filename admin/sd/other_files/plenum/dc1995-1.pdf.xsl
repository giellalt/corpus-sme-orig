...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2453'"/>
<xsl:variable name="title" select="'ČOAHKKINGIRJI 1/95 MEARRÁDUSOASSI'"/>
...
<xsl:variable name="wordcount" select="'12525'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sp1995-1.pdf" xml:lang="nob"/>
</xsl:variable>
