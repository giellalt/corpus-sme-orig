...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_samisk/wfdocument.aspx?journalpostid=2010014805&amp;dokid=264558&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="title" select="'Čoahkkingirji 02/10'"/>
...
<xsl:variable name="wordcount" select="'1775'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="oouk2010-2.pdf" xml:lang="nob"/>
</xsl:variable>
