...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_samisk/wfdocument.aspx?journalpostid=2010017690&amp;dokid=269495&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="title" select="'Čoahkkingirji 03/09'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ts2009-3.pdf" xml:lang="nob"/>
</xsl:variable>
