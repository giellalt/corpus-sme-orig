...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'ds_2_04.doc'"/>
    ...
    <xsl:variable name="wordcount" select="'22301'"/>
    ...
    <language xml:lang="sma"/><language xml:lang="smj"/><language xml:lang="nob"/></xsl:variable>
