...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_samisk/wfdocument.aspx?journalpostid=2011024259&amp;dokid=340001&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ealáhus- ja kulturlávdegoddi Čoahkkingirji 3/11'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nkk2011-3.pdf" xml:lang="nob"/>
</xsl:variable>
