...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_samisk/wfdocument.aspx?journalpostid=2010014745&amp;dokid=264434&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
...
<xsl:variable name="wordcount" select="'1568'"/>
