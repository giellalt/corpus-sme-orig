...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/689/5708/version/2/file/S%C3%A1mediggedie%C4%91ahus+eal%C3%A1husovddideami+birra+%282011%29.pdf'"/>
    ...
    <xsl:variable name="ISBN" select="'978-82-91200-12-5'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingsmelding_om_na_ringsutviking_2011_.pdf"/>
