...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.regjeringen.no/contentassets/b3497da7cab1411094b96772d57b8d4e/se-no/pdfs/stm201820190031000se_pdfs.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dieđ.St.31 (2018–2019). Dieđáhus Stuorradiggái. Sámi giella, kultuvra ja servodateallin'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="stm201820190031000dddepub.epub"/>
