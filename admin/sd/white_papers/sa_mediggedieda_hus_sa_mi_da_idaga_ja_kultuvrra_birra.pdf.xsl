...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/4059/36751/version/2/file/S%C3%A1mediggedied%C3%A1hus+s%C3%A1mi+d%C3%A1idaga+ja+kultuvrra+birra.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingsmelding_om_samisk_kunst_og_kultur.pdf"/>
