...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.saemiedigkie.no/content/download/549/4917/version/1/file/S%C3%A1medigger%C3%A1%C4%91i+die%C4%91%C3%A1hus+s%C3%A1mi+boazodoalu+birra+%282009%29.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <!-- <parallel_text xml:lang="nno" location=""/> -->
         <parallel_text xml:lang="nob" location="sametingsray=dets_melding_om_samisk_reindrift_2009_.pdf"/>
