...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=blogcategory&amp;id=253&amp;Itemid=406&amp;lang=davvi'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=253_itemid=406_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=253_itemid=406_lang=anaras" xml:lang="smn"/>
</xsl:variable>
