...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=271&amp;Itemid=195&amp;lang=davvi'"/>
    ...
    <parallel_text location="index.php_option=com_content_task=view_id=271_itemid=195_lang=finnish.html" xml:lang="fin"/>
</xsl:variable>
