...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=556&amp;Itemid=149&amp;lang=davvi'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=view_id=556_itemid=149_lang=finnish.html" xml:lang="fin"/>
</xsl:variable>
