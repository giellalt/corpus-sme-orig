...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=308&amp;Itemid=305&amp;lang=davvi'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="index2.php_option=com_content_task=view_id=308_lang=finnish.html" xml:lang="fin"/>
