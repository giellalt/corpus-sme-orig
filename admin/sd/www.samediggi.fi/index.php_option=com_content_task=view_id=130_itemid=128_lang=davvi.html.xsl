...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=130&amp;Itemid=128&amp;lang=davvi'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="index.php_option=com_content_task=view_id=130_itemid=128_lang=finnish" xml:lang="fin"/>
</xsl:variable>
