...
<xsl:variable name="para_fin" select="'index.php_option=com_content_task=blogcategory_id=105_itemid=167_lang=finnish'"/>
...
<xsl:variable name="para_smn" select="'index.php_option=com_content_task=blogcategory_id=105_itemid=167_lang=anaras'"/>
