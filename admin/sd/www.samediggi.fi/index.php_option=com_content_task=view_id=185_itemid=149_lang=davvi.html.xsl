...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=185&amp;Itemid=149&amp;lang=davvi'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="index.php_option=com_content_task=view_id=185_itemid=149_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=view_id=185_itemid=149_lang=anaras" xml:lang="smn"/>
</xsl:variable>
