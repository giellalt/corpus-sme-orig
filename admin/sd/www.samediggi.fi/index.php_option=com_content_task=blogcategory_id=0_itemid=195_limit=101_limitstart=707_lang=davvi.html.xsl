...
<xsl:variable name="para_fin" select="'index.php_option=com_content_task=blogcategory_id=0_itemid=195_limit=101_limitstart=707_lang=finnish'"/>
...
<xsl:variable name="para_smn" select="'index.php_option=com_content_task=blogcategory_id=0_itemid=195_limit=101_limitstart=707_lang=anaras'"/>
