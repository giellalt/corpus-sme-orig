...
<xsl:variable name="para_fin" select="'index.php_option=com_content_task=blogcategory_id=186_itemid=327_lang=finnish'"/>
...
<xsl:variable name="para_smn" select="'index.php_option=com_content_task=blogcategory_id=186_itemid=327_lang=anaras'"/>
