...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=blogcategory&amp;id=0&amp;Itemid=195&amp;limit=101&amp;limitstart=404&amp;lang=davvi'"/>
