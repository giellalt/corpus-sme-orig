...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=784&amp;Itemid=128&amp;lang=davvi'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="index.php_option=com_content_task=view_id=784_itemid=128_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=view_id=784_itemid=128_lang=anaras" xml:lang="smn"/>
</xsl:variable>
