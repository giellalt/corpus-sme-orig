...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=blogcategory&amp;id=235&amp;Itemid=370&amp;lang=davvi'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=235_itemid=370_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=235_itemid=370_lang=anaras" xml:lang="smn"/>
</xsl:variable>
