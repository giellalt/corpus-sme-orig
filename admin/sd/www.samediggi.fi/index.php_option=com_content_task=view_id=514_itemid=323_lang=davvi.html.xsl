...
<xsl:variable name="para_fin" select="'index.php_option=com_content_task=view_id=514_itemid=323_lang=finnish'"/>
...
<xsl:variable name="para_smn" select="'index.php_option=com_content_task=view_id=514_itemid=323_lang=anaras'"/>
