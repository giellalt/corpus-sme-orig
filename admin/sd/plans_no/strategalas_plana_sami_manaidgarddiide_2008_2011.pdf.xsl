...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=1818&amp;ct=.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Strategalaš plána sámi mánáidgárddiide 2008–2011'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'4480'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="strategisk_plan_for_samiske_barnehager_2008_2011.pdf"/>
