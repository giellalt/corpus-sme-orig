...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/6433/59213/version/1/file/S%C3%A1medikki+oahpponeavvor%C3%A1hkadeami+doaibmapl%C3%A1na+2015-2018.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingets_handlingsplan_for_la_remiddelutvikling_2015-2018.pdf"/>
