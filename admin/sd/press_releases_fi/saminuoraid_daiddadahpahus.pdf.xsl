...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=60&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Čeahpes sámenuorat čoahkkanedje ohcejohkii'"/>
    ...
    <parallel_text location="saamelaisnuorten_taidetapahtuma.pdf" xml:lang="fin"/>
</xsl:variable>
    ...
    <xsl:variable name="bottom_margin" select="'2=46,3=84'"/>
