...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Oahpásnuvvanbeaivi Sámedikki Heahtá doaimmahagas'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="oahpasnuvvanbeaivi_samedikki_heahta_doaimmahagas_avoimien_ovien_paiva_saamelaiskarajien_hetan_toimistossa.pdf"/>
