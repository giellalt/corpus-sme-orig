...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/2032/19281/version/3/file/Revidert+budsjett+2012+-+samisk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samedikki 2012 reviderejuvvon buseahtta'"/>
    ...
    <parallel_text location="revidert_budsjett_2012_-_norsk.pdf" xml:lang="nob"/>
</xsl:variable>
