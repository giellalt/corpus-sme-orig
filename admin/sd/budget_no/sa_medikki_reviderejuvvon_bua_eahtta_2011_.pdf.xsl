...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/505/4738/version/1/file/S%C3%A1medikki+reviderejuvvon+bu%C5%A1eahtta+%282011%29.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikki 2011 reviderejuvvon bušeahtta'"/>
    ...
    <parallel_text location="sametingets_reviderte_budsjett_2011_.pdf" xml:lang="nob"/>
</xsl:variable>
