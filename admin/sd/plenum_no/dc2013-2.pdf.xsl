...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_samisk/wfdocument.ashx?journalpostid=2013018157&amp;dokid=450101&amp;versjon=1&amp;variant=A&amp;ct=RA-PDF'"/>
    ...
    <parallel_text location="sp2013-2.pdf" xml:lang="nob"/>
</xsl:variable>
