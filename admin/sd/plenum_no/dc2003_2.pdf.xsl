...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/3574/32362/version/1/file/P+2-2003+Samisk.pdf'"/>
    ...
    <parallel_text location="p_2-2003_norsk.pdf" xml:lang="nob"/>
</xsl:variable>
