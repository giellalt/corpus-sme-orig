...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_samisk/wfdocument.aspx?journalpostid=2011016048&amp;dokid=325776&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sámedikki dievasčoahkkin Čoahkkingirji 002/11'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sp2011-2.pdf" xml:lang="nob"/>
</xsl:variable>
