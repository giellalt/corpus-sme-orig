...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2455'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'ČOAHKKINGIRJI 2/95 - MEARRÁDUSAT'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'12164'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sp1995-2.pdf"/>
