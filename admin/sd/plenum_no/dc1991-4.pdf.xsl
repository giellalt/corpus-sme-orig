...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2423'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'ČOAHKKINGIRJI 4/91'"/>
    <!--
    ...
    <!-- Publication year -->
    <xsl:variable name="year" select="'1991'"/>
    ...
    <xsl:variable name="wordcount" select="'5941'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sp1991-4.pdf"/>
