...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2475'"/>
<xsl:variable name="title" select="'Čoahkkingirji'"/>
...
<xsl:variable name="wordcount" select="'25536'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sp1997-2.pdf" xml:lang="nob"/>
</xsl:variable>
