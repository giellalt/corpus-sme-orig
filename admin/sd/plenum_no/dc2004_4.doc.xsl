...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'dc_4_04.doc'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Inga Margrethe'"/>
    <xsl:variable name="author1_ln" select="'Eira Bjørn'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="wordcount" select="'14415'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sp2004_4.pdf"/>
