...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2436'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'ČOAHKKINGIRJI 4/92'"/>
    <!--
    ...
    <!-- Publication year -->
    <xsl:variable name="year" select="'1992'"/>
    ...
    <xsl:variable name="wordcount" select="'5526'"/>
    ...
    <language xml:lang="nob"/><language xml:lang="sma"/><language xml:lang="smj"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sp1992-4.pdf"/>
