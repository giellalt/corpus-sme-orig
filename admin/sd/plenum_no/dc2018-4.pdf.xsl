...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sámedikki dievasčoahkkin Čoahkkingirji 04/18'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sp2018-4.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'3=66, 17=45, 165=60'"/>
    <xsl:variable name="bottom_margin" select="'14=30'"/>
