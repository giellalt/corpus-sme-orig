...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sámedikki dievasčoahkkin Čoahkkingirji 02/19'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sp2019-2.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-18, 22-26, 34-49, 75-76, 197'"/>
    ...
    <xsl:variable name="top_margin" select="'19=70, 27=31'"/>
    <xsl:variable name="bottom_margin" select="'21=16, 33=42'"/>
