...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2321'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'BEAVDEGIRJI 1/90'"/>
    <!--
    ...
    <!-- Publication year -->
    <xsl:variable name="year" select="'1990'"/>
    ...
    <xsl:variable name="wordcount" select="'11925'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sp1990-1.pdf"/>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               <xsl:with-param name="inputString" select="$text"/>
               <xsl:with-param name="target" select="'vuoooo/vuoda/vuoaa/Vuodu/vuodu/vuoddo/vuoddu/vuddu/'"/>
               <xsl:with-param name="replacement" select="'vuođđo/vuođa/vuođa/Vuođu/vuođu/vuođđo/vuođđu/vuđđu/'"/>
                <xsl:with-param name="continue" select="0"/>    
            </xsl:call-template>
</xsl:element>
</xsl:template>
