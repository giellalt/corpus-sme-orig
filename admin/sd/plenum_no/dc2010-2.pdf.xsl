...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_samisk/wfdocument.aspx?journalpostid=2010016243&amp;dokid=267090&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
...
<xsl:variable name="wordcount" select="'40385'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sp2010-2.pdf" xml:lang="nob"/>
</xsl:variable>
