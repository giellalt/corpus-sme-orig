...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2477'"/>
...
<xsl:variable name="wordcount" select="'4816'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sp1997-3.pdf" xml:lang="nob"/>
</xsl:variable>
