...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2532'"/>
<xsl:variable name="title" select="'ČOAHKKINGIRJI 2/93'"/>
...
<xsl:variable name="wordcount" select="'7238'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sp1993-2.pdf" xml:lang="nob"/>
</xsl:variable>
