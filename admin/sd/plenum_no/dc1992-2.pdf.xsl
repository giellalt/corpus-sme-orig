...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2432'"/>
<xsl:variable name="title" select="'ČOAHKKINGIRJI 2/92'"/>
...
<xsl:variable name="wordcount" select="'15157'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sp1992-2.pdf" xml:lang="nob"/>
</xsl:variable>
