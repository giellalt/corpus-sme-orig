...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://dokumentit.solinum.fi/samediggi/download/?d=dokumenttipankki/koulutus_ja_oppimateriaali/saamelaisnuorten_taidetapahtuma/taidetapahtuma_2016/s%C3%A1menuoraid_d%C3%A1iddad%C3%A1hp%C3%A1hussii_2016_almmuheapmi_davvis%C3%A1megillii.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisnuorten_taidetapahtumaan_ilmoittautuminen_suomeksi.pdf"/>
