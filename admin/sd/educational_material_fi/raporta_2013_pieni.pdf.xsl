...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Raporta sámenuoraid dáiddadaáhpáhusas 2013'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="raporta_2013_pieni.pdf"/>
    ...
    <xsl:variable name="left_margin" select="'2=50, 3=50, 4=50'"/>
