...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Meahcci - identitehta, kultuvrra ja birgejumi vuođđun – Raporta sámedikki meahccebargojoavkkus, guovvamánu 29.b. 2016.'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="meahccirapport2016.pdf"/>
