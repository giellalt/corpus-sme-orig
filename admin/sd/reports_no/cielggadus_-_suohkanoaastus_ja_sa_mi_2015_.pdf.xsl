...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/9523/81306/version/2/file/Cielggadus+-+Suohkano%C4%91astus+ja+s%C3%A1mi+%282015%29.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="utredning_-_kommunereformen_og_samiske_interesser_2015_.pdf"/>
