...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.saemiedigkie.no/content/download/9888/83751/version/3/file/Sametingets+%C3%A5rsrapport+2015+-+nordsamisk.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingets_ay=rsrapport_2015_-_norsk.pdf"/>
