...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/1692/15745/version/1/file/S%C3%A1medikki+jahkedie%C4%91%C3%A1hus+%282011%29.pdf'"/>
    ...
    <parallel_text location="sametingets_ay=rsmelding_2011_.pdf" xml:lang="nob"/>
</xsl:variable>
