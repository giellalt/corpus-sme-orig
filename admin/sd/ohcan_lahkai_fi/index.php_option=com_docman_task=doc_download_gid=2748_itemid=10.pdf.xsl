...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sámedikki sámegiela doaimmahat ohcá davvisámegiela jorgaleaddji vurohallanfriijavuođa sadjásačča'"/>
    ...
    <parallel_text location="pohjoisaamen_kaantajan_vuorotteluvapaan_sijainen_davvisamegiela_jorgaleaddji_vurohallanfriijavuo_273_a_sadjasa.pdf" xml:lang="fin"/>
</xsl:variable>
    ...
    <xsl:variable name="bottom_margin" select="'1=53'"/>
