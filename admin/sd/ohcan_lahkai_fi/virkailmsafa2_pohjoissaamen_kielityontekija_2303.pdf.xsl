...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sámediggi ohcá mearreáigásaš davvisámegiela giellabargi áigodahkii 8.4.2013 – 31.5.2014'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="virkailmsafa2_pohjoissaamen_kielityontekija_2303.pdf"/>
