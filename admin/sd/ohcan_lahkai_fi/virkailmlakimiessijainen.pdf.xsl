...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sámediggi almmuha ohcanláhkai láhkačálli virgesadjásašvuođa áigodahkii 1.10.2013 – 31.7.2014'"/>
...
<parallel_text location="virkailmlakimiessijainen.pdf" xml:lang="fin"/>
    ...
    <xsl:variable name="bottom_margin" select="'1=55'"/>
