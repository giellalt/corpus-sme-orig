...
<xsl:variable name="filename" select="'http://www.ffk.no/docs/16bf97d8-4664-4b68-83e2-e027a9e61b4a.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼Strategiijat alit ohppui ja dutkamii Finnmárkkus 2011-2014'"/>
...
<xsl:variable name="publisher" select="'Finnmárkku fylkkagielda'"/>
...
<xsl:variable name="para_nob" select="'sf2011-2014.pdf'"/>
