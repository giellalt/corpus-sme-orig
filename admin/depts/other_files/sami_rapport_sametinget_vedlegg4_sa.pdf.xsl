...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Upload/AID/temadokumenter/sami/sami_rapport_sametinget_vedlegg4_SA.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sami_rapport_sametinget_vedlegg4.pdf" xml:lang="nob"/>
</xsl:variable>
