...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.regjeringen.no/upload/LMD/Vedlegg/Brosjyrer_veiledere_rapporter/Okologisk_baerekraftig_reindrift_rapport_2008_samisk.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="rapport_okologisk_reintallskriterier.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1,2,15'"/>
    ...
    <xsl:variable name="top_margin" select="'all=7,9=47'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'3=58,7=26'"/>
    <xsl:variable name="inner_bottom_margin" select="'3=22,7=49'"/>
