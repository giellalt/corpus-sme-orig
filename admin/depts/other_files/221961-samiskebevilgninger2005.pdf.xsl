...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.regjeringen.no/upload/kilde/krd/rus/2004/0032/ddd/pdfv/221961-samiskebevilgninger2005.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="221959-bevilgningertilsamiskeformal.pdf"/>
    ...
    <xsl:variable name="inner_top_margin" select="'2=24'"/>
    <xsl:variable name="inner_bottom_margin" select="'2=50'"/>
...
<xsl:template match="p">
    ...
    <xsl:element name="p">
        ...
        <xsl:call-template name="globalTextReplace">
            <xsl:with-param name="inputString" select="$text"/>
            <xsl:with-param name="target" select="'má asdoallan/Vuo oskuvlla/'"/>
            <xsl:with-param name="replacement" select="'máŧasdoallan/Vuođđoskuvlla/'"/>
            <xsl:with-param name="continue" select="0"/>
        </xsl:call-template>
    </xsl:element>
</xsl:template>
