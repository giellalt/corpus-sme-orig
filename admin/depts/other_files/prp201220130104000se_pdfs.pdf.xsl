...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.regjeringen.no/se/dokumenter/prop.-104-s-2012-2013/id719953/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Prop. 104 S (2012-2013) Boazodoallošiehtadus 2013/2014, ja rievdadusat stáhtabušehttii 2013 earret eará.'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prp201220130104000dddepub.epub"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-5, 18, 21, 22, 55, 68, 69'"/>
    ...
    <xsl:variable name="top_margin" select="'23=75, 25=15'"/>
    <xsl:variable name="bottom_margin" select="'all=10, 17=75, 20;25=60, 24=30'"/>
