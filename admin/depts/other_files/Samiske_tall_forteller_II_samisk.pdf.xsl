...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/AID/publikasjoner/rapporter_og_planer/2009/Samiske_tall_forteller_II_samisk.pdf'"/>
...
<xsl:variable name="para_nob" select="'Samiske_tall_forteller_II_Norsk.pdf'"/>
