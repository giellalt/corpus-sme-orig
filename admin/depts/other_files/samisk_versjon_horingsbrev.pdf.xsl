...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Upload/LMD/Vedlegg/Horinger/Samisk_versjon_horingsbrev.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="1_id_95738.html" xml:lang="nob"/>
</xsl:variable>
