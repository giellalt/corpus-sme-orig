...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'STM_TS007SA.pdf'"/>
  <xsl:variable name="title" select="'St.die&#x111;. nr. 7 (2006-2007)'"/>
  ...
  <xsl:variable name="place" select="'http://odin.dep.no/filarkiv/294471/STM-TS007SA.pdf'"/>
  ...
  <xsl:variable name="wordcount" select="'24102'"/>
...
<!-- Add the locations of the parallel files to the variables-->
  ...
  <xsl:variable name="para_nob" select="'STM_TS007.pdf'"/>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               ...
               <xsl:with-param name="target" select="'St.die˜./ð/'"/>
               <xsl:with-param name="replacement" select="'St.dieđ./đ/'"/>
