...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Upload/LMD/Vedlegg/Brosjyrer_veiledere_rapporter/Reindriftsloven_NordSamisk.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reindriftsloven_norsk.pdf" xml:lang="nob"/>
</xsl:variable>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               ...
               <xsl:with-param name="target" select="'ﬂyttlei/'"/>
               <xsl:with-param name="replacement" select="'flyttlei/'"/>
...
<xsl:variable name="top_margin" select="'24=22'"/>
...
<xsl:variable name="skip_pages" select="'1,2,5,7,13,20,23,36'"/>
</xsl:stylesheet>