...
<xsl:variable name="filename" select="'http://www.regjeringen.no/pages/2079569/PDFS/STM200720080028000SE_PDFS.pdf'"/>
<xsl:variable name="title" select="'St.dieđ. nr. 28 (2007–2008)'"/>
...
<xsl:variable name="para_nob" select="'STM200720080028000DDDPDFS.pdf'"/>
