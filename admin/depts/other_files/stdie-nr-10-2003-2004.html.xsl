...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Stdie-nr-10-2003-2004-.html'"/>
  <xsl:variable name="title" select="'St.die nr. 10 (2003-2004)'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stdie-nr-10-2003-2004.html" xml:lang="nob"/>
</xsl:variable>
