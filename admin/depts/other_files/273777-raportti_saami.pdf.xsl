...
<xsl:variable name="inner_top_margin" select="'32=0'"/>
<xsl:variable name="inner_bottom_margin" select="'32=76'"/>
<xsl:variable name="inner_left_margin" select="'32=41'"/>
<xsl:variable name="inner_right_margin" select="'32=0'"/>
