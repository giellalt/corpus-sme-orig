...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.regjeringen.no/upload/kilde/rap/2006/0004/ddd/pdfv/273777-raportti_saami.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sami_publikasjoner_grenselost_i_nord.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1,2,5,6'"/>
    ...
    <xsl:variable name="bottom_margin" select="'all=7,4=38,15=14,28=14,32=14'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'32=0,34=50'"/>
    <xsl:variable name="inner_left_margin" select="'32=41,34=16'"/>
    <xsl:variable name="inner_top_margin" select="'32=0,34=39'"/>
    <xsl:variable name="inner_bottom_margin" select="'32=76,34=23'"/>
