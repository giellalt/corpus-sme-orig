...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Prop. 42 L (2017–2018) Rievdadusat kulturmuitolágas (sámi kulturmuittuid ráfáiduhttinrádji)'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prp201720180042000dddepub.epub"/>
