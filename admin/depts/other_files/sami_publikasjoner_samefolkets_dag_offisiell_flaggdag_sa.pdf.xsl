...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/AID/temadokumenter/sami/Publikasjoner/sami_publikasjoner_samefolkets_dag_offisiell_flaggdag_SA.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sami_publikasjoner_samefolkets_dag_offisiell_flaggdag.pdf" xml:lang="nob"/>
</xsl:variable>
...
<xsl:variable name="bottom_margin" select="'all=7,4=30,9=26,10=29'"/>
