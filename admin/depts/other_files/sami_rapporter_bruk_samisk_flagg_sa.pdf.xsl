...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/AID/temadokumenter/sami/Publikasjoner/sami_rapporter_bruk_samisk_flagg_SA.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="136171-rapport_25._juli_2001.pdf" xml:lang="nob"/>
</xsl:variable>
...
<xsl:variable name="bottom_margin" select="'all=7,5=14,6=16'"/>
...
<xsl:variable name="inner_top_margin" select="'3=23'"/>
<xsl:variable name="inner_bottom_margin" select="'3=59'"/>
<xsl:variable name="inner_left_margin" select="''"/>
<xsl:variable name="inner_right_margin" select="''"/>
<xsl:variable name="skip_pages" select="'1,15'"/>
</xsl:stylesheet>