...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/kilde/000/stm/20012002/0033/se_/pdts/stm200120020033000se_pdts.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="19_id_327502.html" xml:lang="nob"/>
</xsl:variable>
...
<xsl:variable name="inner_top_margin" select="'10=64'"/>
<xsl:variable name="inner_bottom_margin" select="'10=31'"/>
<xsl:variable name="inner_left_margin" select="'10=50'"/>
<xsl:variable name="inner_right_margin" select="'10=0'"/>
