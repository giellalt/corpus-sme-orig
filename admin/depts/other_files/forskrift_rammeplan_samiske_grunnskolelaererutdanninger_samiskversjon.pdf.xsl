...
<xsl:variable name="filename" select="'http://www.regjeringen.no/pages/2275837/Forskrift_rammeplan_samiske_grunnskolelaererutdanninger_samiskversjon.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift_rammeplan_samiske_grunnskolelaererutdanninger_norskversjon.pdf" xml:lang="nob"/>
</xsl:variable>
