...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.regjeringen.no/Upload/MD/Vedlegg/Retningslinjer/retningslinjerforverneplanarbeid_sametinget_samisk.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="retningslinjerforverneplanarbeid_sametinget.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'all=7,1=14'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'1=28'"/>
    <xsl:variable name="inner_bottom_margin" select="'1=60'"/>
