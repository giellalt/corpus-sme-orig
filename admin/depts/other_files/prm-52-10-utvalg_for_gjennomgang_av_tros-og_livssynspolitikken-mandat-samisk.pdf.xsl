...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.regjeringen.no/upload/KUD/Samfunn_og_frivillighet/Tro-og_livssyn/PRM-52-10-Utvalg_for_gjennomgang_av_tros-og_livssynspolitikken-MANDAT-samisk.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm-52-10-utvalg_for_gjennomgang_av_tros-og_livssynspolitikken-mandat.pdf"/>
