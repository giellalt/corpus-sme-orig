...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/Upload/larerplaner/Fastsatte_lareplaner_for_Kunnskapsloeftet/Samiske/planer_samisk/5/musikk_nordsamisk.rtf'"/>
    ...
    <parallel_text xml:lang="nob" location="laereplan_musikk.html"/></xsl:variable>
