...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/LMD/Vedlegg/Regelverk/Reindrift_Omraadeprotokoll_til_konvensjon_mellom_Norge_Sverige_Nordsamisk.pdf'"/>
...
<xsl:variable name="monolingual" select="'sme'"/> <!-- checked for all the languages below. -->
