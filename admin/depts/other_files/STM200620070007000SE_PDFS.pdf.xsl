...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Rpub/STM/20062007/007SA/PDFS/STM200620070007000SE_PDFS.pdf'"/>
...
<xsl:variable name="para_nob" select="'STM200620070007000DDDPDFS.pdf'"/>
