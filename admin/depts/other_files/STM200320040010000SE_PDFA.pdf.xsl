...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Rpub/STM/20032004/010SA/PDFA/STM200320040010000SE_PDFA.pdf'"/>
<xsl:variable name="title" select="'St.dieđ. nr. 10 (2003-2004)'"/>
...
<xsl:variable name="para_nob" select="'STM200320040010000DDDPDFS.pdf'"/>
