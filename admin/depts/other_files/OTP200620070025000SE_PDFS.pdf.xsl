...
<xsl:variable name="filename" select="'http://www.regjeringen.no/pages/1961827/PDFS/OTP200620070025000SE_PDFS.pdf'"/>
...
<xsl:variable name="para_nob" select="'OTP200620070025000DDDPDFS.pdf'"/>
