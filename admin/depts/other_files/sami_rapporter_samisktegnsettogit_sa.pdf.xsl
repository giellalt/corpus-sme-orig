...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/AID/temadokumenter/sami/Publikasjoner/sami_rapporter_samisktegnsettogit_SA.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sami_publikasjoner_samisk_tegnsett_og_it_norsk.pdf" xml:lang="nob"/>
</xsl:variable>
...
<xsl:variable name="bottom_margin" select="'all=7,3=12,12=28,13=16'"/>
...
<xsl:variable name="inner_top_margin" select="'6=40'"/>
<xsl:variable name="inner_bottom_margin" select="'6=24'"/>
