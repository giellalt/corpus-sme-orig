...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/larerplaner/fastsatte_lareplaner_for_kunnskapsloeftet/samiske/planer_samisk/religion_og_etikk_nordsamisk.rtf'"/>
    ...
    <parallel_text xml:lang="nob" location="laereplan_religion.html"/></xsl:variable>
