...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'STM200720080028000SE_PDFS.pdf'"/>
  <xsl:variable name="title" select="'Stmeld nr. 28 (2007-2008)'"/>
  ...
  <xsl:variable name="author3_fn" select="'Trond'"/>
  <xsl:variable name="author3_ln" select="'Trosterud'"/>
  <xsl:variable name="author3_gender" select="''"/>
  <xsl:variable name="author3_born" select="''"/>
  <xsl:variable name="author3_nat" select="''"/>
  <xsl:variable name="author4_fn" select="'Trond'"/>
  <xsl:variable name="author4_ln" select="'Trosterud'"/>
  <xsl:variable name="author4_gender" select="''"/>
  <xsl:variable name="author4_born" select="''"/>
  <xsl:variable name="author4_nat" select="''"/>
  <xsl:variable name="translated_from" select="'nob'"/>
  <xsl:variable name="publisher" select="'Departementenes servicesenter'"/>
  ...
  <xsl:variable name="collection" select="'Stortingsmelding'"/>
