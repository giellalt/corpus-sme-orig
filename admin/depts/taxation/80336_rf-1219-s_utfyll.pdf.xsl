...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.skatteetaten.no/upload/Skjemaer/2014/80336%20RF-1219-S_Utfyll.pdf'"/>
    ...
    <parallel_text location="rf-1219b.pdf" xml:lang="nob"/>
</xsl:variable>
