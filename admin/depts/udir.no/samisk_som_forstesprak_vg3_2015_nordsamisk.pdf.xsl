...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'Samisk_som_forstesprak_Vg3_2015_Nordsamisk.pdf'"/>
    ...
    <parallel_text xml:lang="nob" location="samisk_som_forstesprak_vg3_2015_bm.pdf"/>
	<parallel_text xml:lang="sma" location="samisk_som_forstesprak_vg3_2015_sorsamisk.pdf"/></xsl:variable>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1,8-10'"/>
    ...
    <xsl:variable name="bottom_margin" select="'all=8,4=45,7=87'"/>
