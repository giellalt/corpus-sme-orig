...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/PageFiles/82639/Foreldrebrosjyre_Nasjonaleprover_2014_Nordsamisk.pdf'"/>
...
<xsl:variable name="inner_top_margin" select="'2=72'"/>
<xsl:variable name="inner_bottom_margin" select="'2=0'"/>
<xsl:variable name="inner_left_margin" select="'2=30'"/>
