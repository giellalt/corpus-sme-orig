...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/vurdering/vfl/grunnlagsdokument-20142017-samisk.pdf'"/>
	...
	<parallel_text xml:lang="nob" location="grunnlagsdokument-2014-2017.pdf"/></xsl:variable>
    ...
    <xsl:variable name="bottom_margin" select="'2=18,3=11,5=17,8=12,9=12,10=46'"/>
