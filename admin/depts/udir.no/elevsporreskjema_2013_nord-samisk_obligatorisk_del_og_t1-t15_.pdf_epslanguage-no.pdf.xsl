...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/PageFiles/5977/Elevspørreskjema%202013%20nord-samisk%20(obligatorisk%20del%20og%20T1-T15).pdf?epslanguage=no'"/>
	...
	<parallel_text xml:lang="nob" location="elevundersokelsen_sporsmal2014.pdf"/></xsl:variable>
