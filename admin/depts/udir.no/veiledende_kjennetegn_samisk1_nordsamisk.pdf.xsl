...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/vurdering/kjennetegn/kjennetegn_samisk1_nordsamisk.pdf'"/>
	...
	<parallel_text xml:lang="sma" location="veiledende_kjennetegn_samisk1_sorsamisk.pdf"/></xsl:variable>
