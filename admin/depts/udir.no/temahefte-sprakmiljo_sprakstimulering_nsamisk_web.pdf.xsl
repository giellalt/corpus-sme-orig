...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/barnehage/pedagogikk/temahefter/temahefte-sprakmiljo_sprakstimulering_nsamisk_web.pdf'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-4,8,14,26,32,38,52,56,64,70-74'"/>
    ...
    <xsl:variable name="bottom_margin" select="'all=7,5=54,48=34'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'31=46,35=24'"/>
    <xsl:variable name="inner_bottom_margin" select="'31=27,35=45'"/>
...
<xsl:template match="p[parent::body][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                <xsl:with-param name="inputString" select="$text"/>
                <xsl:with-param name="target" select="'n,g/'"/>
