...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/filer/vurdering/nasjonaleprover/nasjonale-prover-informasjon-til-foreldre-nordsamisk.pdf'"/>
	...
	<parallel_text xml:lang="nob" location="nasjonale-prover-informasjon-til-foreldre-bm.pdf"/></xsl:variable>
