...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/barnehage/rammeplan/rammeplan_nordsamisk.pdf'"/>
	...
	<parallel_text xml:lang="nob" location="rammeplan_bokmal_2011nett.pdf"/></xsl:variable>
    ...
    <xsl:variable name="top_margin" select="'2=27'"/>
    <xsl:variable name="bottom_margin" select="'35=67'"/>
