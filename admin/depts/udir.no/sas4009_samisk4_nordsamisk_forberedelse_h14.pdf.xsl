...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.udir.no/Filer/Vurdering/Eksamen-VGO/Forberedelse/H14/21-nov/SAS4009_Samisk4_nordsamisk_forberedelse_H14.pdf'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1,2,8'"/>
    ...
    <xsl:variable name="left_margin" select="'5=41,6=39'"/>
    <xsl:variable name="top_margin" select="''"/>
    <xsl:variable name="bottom_margin" select="'all=8,4=41'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'3=49'"/>
    <xsl:variable name="inner_bottom_margin" select="'3=44'"/>
