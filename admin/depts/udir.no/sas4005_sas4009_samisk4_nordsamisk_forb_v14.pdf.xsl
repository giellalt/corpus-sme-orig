...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/Upload/Eksamen/Videregaende/V14/Forberedelse/23%20mai/SAS4005_SAS4009_Samisk4_nordsamisk_Forb_V14.pdf'"/>
