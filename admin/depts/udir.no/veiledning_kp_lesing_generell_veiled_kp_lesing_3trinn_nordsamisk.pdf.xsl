...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/filer/vurdering/kartlegging/generell_veiled_kp_lesing_3trinn_nordsamisk.pdf'"/>
	...
	<parallel_text xml:lang="nob" location="veiledning_kp_lesing_kp_lesing_3_trinn_larerveiledning_2014_bm.pdf"/></xsl:variable>
