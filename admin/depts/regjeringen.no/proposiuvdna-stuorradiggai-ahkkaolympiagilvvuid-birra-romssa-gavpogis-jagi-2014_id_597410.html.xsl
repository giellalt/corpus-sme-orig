...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Proposiuvdna-Stuorradiggai-ahkkaolympiagilvvuid-birra-Romssa-gavpogis-jagi-2014.html?id=597410'"/>
...
<xsl:variable name="para_nno" select="'Proposisjon-til-Stortinget-om-sjakk-OL-i-Tromso-i-2014.html?id=597410'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="proposisjon-til-stortinget-om-sjakk-ol-i-tromso-i-2014_id_597410.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
