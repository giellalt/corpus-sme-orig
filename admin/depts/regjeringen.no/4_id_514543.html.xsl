...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/18/4.html?id=514543'"/>
<xsl:variable name="title" select="'18.4 Ipmilbálvalusat... - regjeringen.no'"/>
