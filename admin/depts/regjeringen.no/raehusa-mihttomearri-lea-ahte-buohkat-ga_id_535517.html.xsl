...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/Assan--ja-huksenpolitihkka/assansosiala-bargu-/raehusa-mihttomearri-lea-ahte-buohkat-ga.html?id=535517'"/>
...
<xsl:variable name="para_nob" select="'regjeringens-mal-om-at-alle-skal-bo-tryg.html?id=535517'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringens-mal-om-at-alle-skal-bo-tryg_id_535517.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
