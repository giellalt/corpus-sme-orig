...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/3/2.html?id=452515'"/>
<xsl:variable name="title" select="'4.3.2 Dásseárvu - regjeringen.no'"/>
