...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/proposiuvnnat-stuorradiggai.html?id=578471'"/>
...
<xsl:variable name="para_nob" select="'prop.html?id=578471'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="prop_id_578471.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
