...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/10/5/2.html?id=458521'"/>
<xsl:variable name="title" select="'10.5.2 Joatkkaoahpahusa... - regjeringen.no'"/>
