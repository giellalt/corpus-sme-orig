...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/same--og-minoritetspolitisk-avdeling.html?id=589401'"/>
