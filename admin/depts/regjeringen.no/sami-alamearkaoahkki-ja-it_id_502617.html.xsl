...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Raporttat-ja-planat/Raporttat-/2002/sami-alamearkaoahkki-ja-it.html?id=502617'"/>
...
<xsl:variable name="para_nob" select="'samisk-tegnsett-og-it.html?id=502617'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samisk-tegnsett-og-it_id_502617.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
