...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/hui-ollu-baikkala-joavkkut-ja-searvvit-v.html?id=709467'"/>
...
<xsl:variable name="para_nob" select="'rekordmange-lokale-lag-og-foreninger-mot.html_id=709467'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rekordmange-lokale-lag-og-foreninger-mot_id_709467.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
