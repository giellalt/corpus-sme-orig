...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Raporttat-ja-planat/Raporttat-/2001/sami-leavgga-geavaheapmi.html?id=105648'"/>
...
<xsl:variable name="para_nob" select="'bruk-av-det-samiske-flagget.html?id=105648'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bruk-av-det-samiske-flagget_id_105648.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
