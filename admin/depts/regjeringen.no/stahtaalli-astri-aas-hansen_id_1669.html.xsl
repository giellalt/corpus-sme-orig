...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/Justisdepartementta-birra/Eara-politihkala-njunnoat/Stahtaalli-Astri-Aas-Hansen.html?id=1669'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-astri-aas-hansen.html_id=1669" xml:lang="eng"/>
