...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2007/Oau-rua-ielggadit-eamialbmogiid-iemearri.html?id=481056'"/>
...
<xsl:variable name="para_nob" select="'far-midler-til-a-utrede-de-praktiske-kon.html?id=481056'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="far-midler-til-a-utrede-de-praktiske-kon_id_481056.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
