...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Departemeanta-birra/Daidda-gulleva-doaimmat/guolasteddjiid-dahkaduskassa-.html?id=163538'"/>
