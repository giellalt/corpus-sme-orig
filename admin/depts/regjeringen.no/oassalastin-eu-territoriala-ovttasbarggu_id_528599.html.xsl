...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/guovllu--ja-regionalapolitihkka/riikkaidgaskasa-ovttasbargu-guovllu--ja-/oassalastin-eu-territoriala-ovttasbarggu.html?id=528599'"/>
