...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/dok/hoeringer/hoeringsdok/2009/gulaskuddan---rammaplana-lahkaasahus-sam/adreassalistu.html?id=588788'"/>
...
<xsl:variable name="para_nob" select="'horingsinstanser.html?id=588788'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horingsinstanser_id_588788.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
