...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Departemeanta-birra/Daidda-gulleva-doaimmat/Norgga-Guolastus--og-mearradutkaninstituhtta-.html?id=163831'"/>
