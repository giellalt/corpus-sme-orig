...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dokumeanttat/horinger/horingsdokumenter/2012/gulaskuddan---samediggevalga---rievdadus.html?id=696948'"/>
...
<xsl:variable name="para_nob" select="'horing---sametingsvalget---endringer-i-f.html_id=696948'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horing---sametingsvalget---endringer-i-f_id_696948.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
