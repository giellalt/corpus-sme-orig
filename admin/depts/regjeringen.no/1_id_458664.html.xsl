...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/20/3/1.html?id=458664'"/>
<xsl:variable name="title" select="'1.3.1 Doarjagiid juogadeapmi - regjeringen.no'"/>
