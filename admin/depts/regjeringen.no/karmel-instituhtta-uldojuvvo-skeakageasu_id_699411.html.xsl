...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aigeguovdil/nyheter/2012/karmel-instituhtta-uldojuvvo-skeakageasu.html?id=699411'"/>
...
<xsl:variable name="para_nob" select="'karmel-instituttet-utelukkes-fra-gavefra.html_id=699411'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="karmel-instituttet-utelukkes-fra-gavefra_id_699411.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
