...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/lahka-norgga-kulturrai-harrai-doaibmagoa.html?id=729474'"/>
...
<xsl:variable name="para_nob" select="'lov-om-norsk-kulturrad-trer-i-kraft.html_id=729474'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lov-om-norsk-kulturrad-trer-i-kraft_id_729474.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
