...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Siviilaaittardeaddji-loahpaha-guorahallama.html?id=591125'"/>
...
<xsl:variable name="para_nob" select="'sivilombudsmannen-avslutter-granskning.html?id=591125'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sivilombudsmannen-avslutter-granskning_id_591125.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
