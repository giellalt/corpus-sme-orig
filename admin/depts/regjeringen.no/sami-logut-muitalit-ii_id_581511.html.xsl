...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Raporttat-ja-planat/Raporttat-/2009/sami-logut-muitalit-ii.html?id=581511'"/>
...
<xsl:variable name="para_nob" select="'samiske-tall-forteller-ii.html?id=581511'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samiske-tall-forteller-ii_id_581511.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
