...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2013/lahkaasahus-mearriduvvon-stahtarais-dgt-.html?id=731419'"/>
...
<xsl:variable name="para_nob" select="'forskrift-om-universell-utforming-av-ikt.html_id=731419'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-om-universell-utforming-av-ikt_id_731419.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
