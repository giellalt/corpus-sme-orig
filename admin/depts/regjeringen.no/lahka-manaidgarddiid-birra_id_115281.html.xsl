...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dok/lagat-ja-njuolggadusat-/lover/lahka-manaidgarddiid-birra.html?id=115281'"/>
...
<xsl:variable name="para_nob" select="'barnehageloven.html?id=115281'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barnehageloven_id_115281.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
