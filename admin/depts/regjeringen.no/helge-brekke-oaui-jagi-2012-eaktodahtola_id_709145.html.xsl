...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/aktuelt/nyheter/2012/helge-brekke-oaui-jagi-2012-eaktodahtola.html?id=709145'"/>
...
<xsl:variable name="para_nob" select="'frivillighetsprisen-2012-til-helge-brekk.html_id=709145'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="frivillighetsprisen-2012-til-helge-brekk_id_709145.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
...
=======
           <xsl:with-param name="target" select="'má��gasa/'"/>
           <xsl:with-param name="replacement" select="'máŋgasa/'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
