...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/pressesenter/pressemeldinger/2011/sihkkaris-biebmu-ja-buorre-elliidalgu-.html?id=665410'"/>
...
<xsl:variable name="para_nob" select="'trygg-mat-og-god-dyrevelferd-.html_id=665410'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="trygg-mat-og-god-dyrevelferd-_id_665410.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
