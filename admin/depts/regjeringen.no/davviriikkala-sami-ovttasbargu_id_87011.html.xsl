...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Samepolitihkka/Davviriikkala-sami-ovttasbargu/Davviriikkala-sami-ovttasbargu.html?id=87011'"/>
