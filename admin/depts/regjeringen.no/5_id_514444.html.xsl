...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/12/5.html?id=514444'"/>
<xsl:variable name="title" select="'12.5 Sámi oahpponeavvut - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'859'"/>
