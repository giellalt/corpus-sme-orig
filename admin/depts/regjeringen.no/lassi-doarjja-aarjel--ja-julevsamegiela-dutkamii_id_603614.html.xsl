...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2010/-Lassi-doarjja-aarjel--ja-julevsamegiela-dutkamii.html?id=603614'"/>
...
<xsl:variable name="para_nob" select="'forskning-sor-lulesamisk.html?id=603614'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskning-sor-lulesamisk_id_603614.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
