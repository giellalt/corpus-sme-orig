...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Oasat/2009/algoalbmotdoaibmabijut-davviguovlluagiru.html?id=549083'"/>
...
<xsl:variable name="para_nob" select="'urfolkstiltak-i-nordomradesatsingen.html?id=549083'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="urfolkstiltak-i-nordomradesatsingen_id_549083.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
