...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/1/4.html?id=458402'"/>
<xsl:variable name="title" select="'1.4 Sámedikki váldi ja... - regjeringen.no'"/>
