...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/5/4.html?id=452521'"/>
<xsl:variable name="title" select="'4.5.4 Sámi valáštallan - regjeringen.no'"/>
