...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Fadda/Preassaguovdda/2011/albmotmeahci-halddahus-asahuvvo-biergai.html?id=664712'"/>
...
<xsl:variable name="para_nob" select="'nasjonalparkforvalter-plasseres-i-kiberg.html_id=664712'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nasjonalparkforvalter-plasseres-i-kiberg_id_664712.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
