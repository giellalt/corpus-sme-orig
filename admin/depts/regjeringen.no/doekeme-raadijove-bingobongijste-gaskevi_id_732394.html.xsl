...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/doekeme-raadijove-bingobongijste-gaskevi.html?id=732394'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sal-av-radiobingobongar-pa-internett-til_id_732394.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
