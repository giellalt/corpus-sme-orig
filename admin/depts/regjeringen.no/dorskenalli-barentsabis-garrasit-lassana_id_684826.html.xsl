...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2012/dorskenalli-barentsabis-garrasit-lassana.html?id=684826'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="torskebestanden-i-barentshavet-til-himme_id_684826.html"/>
