...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/13.html?id=514452'"/>
<xsl:variable name="title" select="'12 Alit oahppu og dutkan - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'7852'"/>
