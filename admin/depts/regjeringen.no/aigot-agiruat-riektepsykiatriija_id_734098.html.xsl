...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/aktuelt/nyheter/2013/aigot-agiruat-riektepsykiatriija.html?id=734098'"/>
...
<xsl:variable name="para_nob" select="'vil-satse-pa-rettspsykiatrien.html_id=734098'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vil-satse-pa-rettspsykiatrien_id_734098.html" xml:lang="nob"/>
