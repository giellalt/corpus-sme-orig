...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/museaid-vuoruheapmi.html?id=701352'"/>
...
<xsl:variable name="para_nno" select="'satsing-pa-musea.html_id=701352'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="satsing-pa-musea_id_701352.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
