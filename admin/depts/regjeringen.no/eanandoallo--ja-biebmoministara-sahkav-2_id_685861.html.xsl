...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/svar_stortinget/sporretime/2012/eanandoallo--ja-biebmoministara-sahkav-2.html?id=685861'"/>
...
<xsl:variable name="para_nob" select="'landbruks--og-matministerens-innlegg-i-s.html_id=685861'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="landbruks--og-matministerens-innlegg-i-s_id_685861.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
