...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/Odeldiggeproposiuvnnat/20032004/od-prp-nr-26_2003-2004.html?id=176794'"/>
<xsl:variable name="title" select="'Od.prp. nr. 26 (2003-2004) - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="otprp-nr-26-2003-2004-_id_392931.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
