...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/valatallanossodat/Sekuvdna-VA-1.html?id=1485'"/>
...
<xsl:variable name="para_nob" select="'seksjon_id_1.html?id=1485'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon_id_1_id_1485.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
