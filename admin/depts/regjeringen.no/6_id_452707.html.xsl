...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20062007/Stdie-nr-7-2006-2007-/3/6.html?id=452707'"/>
<xsl:variable name="title" select="'3.6 Ovttadássásašvuohta - regjeringen.no'"/>
