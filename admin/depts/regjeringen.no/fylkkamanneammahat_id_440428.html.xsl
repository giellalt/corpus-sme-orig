...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/Fylkkamanneammahat.html?id=440428'"/>
...
<xsl:variable name="para_nob" select="'fylkesmannsembetene.html?id=440428'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fylkesmannsembetene_id_440428.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
