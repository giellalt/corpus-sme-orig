...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Departemeanta-birra/Organisauvdna/Departemeantta-ossodagat/resursa--ja-ahpeossodat/ekspediuvdnahoavda--ressursa--ja-mearrao.html?id=1583'"/>
