...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/smaavelaatterijen-raaste-lassene-200-000.html?id=732052'"/>
...
<xsl:variable name="para_nob" select="'grensen-for-smalotteri-oker-til-200-000-.html_id=732052'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="grensen-for-smalotteri-oker-til-200-000-_id_732052.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
