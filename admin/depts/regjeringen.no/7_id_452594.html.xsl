...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/2-2/7.html?id=452594'"/>
<xsl:variable name="title" select="'2.7 Ealáhus ja kultuvra - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'3379'"/>
