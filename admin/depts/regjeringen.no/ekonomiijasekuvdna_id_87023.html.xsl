...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Gelbbolavuoa--ja-resursaossodat/Ekonomiijasekuvdna.html?id=87023'"/>
...
<xsl:variable name="para_nob" select="'okonomiseksjonen.html?id=87023'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okonomiseksjonen_id_87023.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
