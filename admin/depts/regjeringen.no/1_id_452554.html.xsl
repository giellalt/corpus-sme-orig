...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/6/1.html?id=452554'"/>
<xsl:variable name="title" select="'1.1 Sámedikki rehketdoallu... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'3743'"/>
