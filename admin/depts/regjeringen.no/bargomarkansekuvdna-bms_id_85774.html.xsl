...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/Bargomarkanossodat-/Bargomarkansekuvdna-BMS.html?id=85774'"/>
...
<xsl:variable name="para_nob" select="'arbeidsmarkedsseksjonen.html?id=85774'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arbeidsmarkedsseksjonen_id_85774.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
