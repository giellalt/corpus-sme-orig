...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/davviriikkala-rai-oa-manaid--ja-nuoraidg.html?id=706770'"/>
...
<xsl:variable name="para_nno" select="'ny-nordisk-rads-pris-for-barne--og-ungdo.html_id=706770'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ny-nordisk-rads-pris-for-barne--og-ungdo_id_706770.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
