...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/3-2/9.html?id=452635'"/>
<xsl:variable name="title" select="'3.9 Biraspolitihkka ja... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'742'"/>
