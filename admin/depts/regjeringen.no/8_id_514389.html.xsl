...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/8/4/8.html?id=514389'"/>
<xsl:variable name="title" select="'8.4.8 Vuođđolágalaš ovddasvástádusdilálašvuođat - regjeringen.no'"/>
