...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Evttoha-eambbo-sorjjasmeahttun-Mediabearraigeahu.html?id=621736'"/>
...
<xsl:variable name="para_nob" select="'foreslar-et-mer-uavhengig-medietilsyn-.html?id=621736'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="foreslar-et-mer-uavhengig-medietilsyn-_id_621736.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
