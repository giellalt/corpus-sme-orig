...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/preassaguovdda/Preassadieahusat/2012/mearrideapmi-vaidagiidda-mat-gustojit-me.html?id=710331'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avgjorelse-av-klager-pa-vedtak-om-lisens_id_710331.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
