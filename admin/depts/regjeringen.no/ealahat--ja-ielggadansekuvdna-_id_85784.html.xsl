...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/Ealahatossodat/Ealahat--ja-ielggadansekuvdna-.html?id=85784'"/>
...
<xsl:variable name="para_nob" select="'pensjons-_og_utredningsseksjonen.html?id=85784'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pensjons-_og_utredningsseksjonen_id_85784.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
