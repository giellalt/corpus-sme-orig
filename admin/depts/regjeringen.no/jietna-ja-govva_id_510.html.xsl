...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/jietna-ja-govva.html?id=510'"/>
...
<xsl:variable name="para_nob" select="'lyd_bilde.html?id=510'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lyd_bilde_id_510.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
