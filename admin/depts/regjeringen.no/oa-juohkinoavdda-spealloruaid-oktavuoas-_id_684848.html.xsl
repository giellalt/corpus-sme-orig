...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/oa-juohkinoavdda-spealloruaid-oktavuoas-.html?id=684848'"/>
...
<xsl:variable name="para_nob" select="'ny-tippenokkel-vil-styrke-satsingen-pa-i.html_id=684848'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ny-tippenokkel-vil-styrke-satsingen-pa-i_id_684848.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
