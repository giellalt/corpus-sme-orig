...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2010/Eambbo-ruhta-jieka--ja-oljogahttenakuvdnii.html?id=604464'"/>
...
<xsl:variable name="para_nob" select="'Okte-midler-til-isbryting-og-oljevernaksjon.html?id=604464'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okte-midler-til-isbryting-og-oljevernaksjon_id_604464.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
