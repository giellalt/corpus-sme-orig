...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2010/stahtaministtar-bovde-raadallamii-ovttas.html?id=589515'"/>
...
<xsl:variable name="para_nob" select="'statsministeren-inviterer-til-radslag-sa.html?id=589515'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsministeren-inviterer-til-radslag-sa_id_589515.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
