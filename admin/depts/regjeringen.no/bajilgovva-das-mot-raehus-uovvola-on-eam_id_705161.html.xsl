...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/oasat/2012/bajilgovva-das-mot-raehus-uovvola-on-eam.html?id=705161'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="oppfolging-rettigheter_id_705161.html" xml:lang="nob"/>
<parallel_text location="321-kommunar-far-tilskot-til-den-kulture_id_705157.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
