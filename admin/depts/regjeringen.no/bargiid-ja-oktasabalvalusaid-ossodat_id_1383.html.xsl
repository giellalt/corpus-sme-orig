...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/departemeanta-birra/organisauvdna/Ossodagat/bargiid-ja-oktasabalvalusaid-ossodat.html?id=1383'"/>
