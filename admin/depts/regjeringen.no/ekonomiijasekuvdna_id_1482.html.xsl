...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/Halddahus--ja-ekonomiijaossodat-/Ekonomiijasekuvdna.html?id=1482'"/>
...
<xsl:variable name="para_nob" select="'okonomiseksjonen_.html?id=1482'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okonomiseksjonen_id_1482.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
