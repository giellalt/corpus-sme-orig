...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20062007/Stdie-nr-7-2006-2007-/3/9.html?id=452714'"/>
<xsl:variable name="title" select="'3.9 Kultuvra, giella,... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'896'"/>
