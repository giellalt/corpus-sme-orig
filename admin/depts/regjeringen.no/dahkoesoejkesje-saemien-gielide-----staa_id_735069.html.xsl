...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dokumeanttat/raporttat-ja-planat/planat/2013/dahkoesoejkesje-saemien-gielide-----staa.html?id=735069'"/>
...
<xsl:variable name="para_nob" select="'handlingsplan-for-samiske-sprak---status.html_id=735069'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="handlingsplan-for-samiske-sprak---status_id_735069.html" xml:lang="nob"/>
