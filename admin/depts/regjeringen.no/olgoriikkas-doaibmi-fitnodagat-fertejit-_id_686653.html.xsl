...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/preassaguovdda/pressemeldinger/2012/olgoriikkas-doaibmi-fitnodagat-fertejit-.html?id=686653'"/>
...
<xsl:variable name="para_nob" select="'selskaper-i-utlandet-ma-rapportere-om-sk.html_id=686653'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="selskaper-i-utlandet-ma-rapportere-om-sk_id_686653.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
