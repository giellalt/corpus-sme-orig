...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/pressesenter/pressemeldinger/2011/eanandoallu-ja-giliealahusat-miehta-riik.html?id=665405'"/>
...
<xsl:variable name="para_nob" select="'landbruk-og-bygdenaringer-over-hele-land.html_id=665405'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="landbruk-og-bygdenaringer-over-hele-land_id_665405.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
