...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/oa-juohkinoavdda.html?id=684849'"/>
...
<xsl:variable name="para_nob" select="'ny-tippenokkel.html_id=684849'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ny-tippenokkel_id_684849.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
