...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Samepolitihkka/Samegiela-geavaheapmi/Samegiella-ja-IT.html?id=86947'"/>
...
<xsl:variable name="para_nob" select="'samisk-sprak-og-it.html?id=86947'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samisk-sprak-og-it_id_86947.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
