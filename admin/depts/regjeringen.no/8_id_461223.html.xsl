...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/8.html?id=461223'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'8 Departemeantta árvvoštallamat - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'11930'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="8_id_446549.html"/>
