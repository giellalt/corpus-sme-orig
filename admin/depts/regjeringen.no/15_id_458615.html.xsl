...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/15.html?id=458615'"/>
<xsl:variable name="title" select="'15 Areálahálddaheapmi... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1432'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="15_id_326018.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
