...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/3-2/6/1.html?id=452622'"/>
<xsl:variable name="title" select="'3.6.1 Sámi vuođđooahpahus - regjeringen.no'"/>
