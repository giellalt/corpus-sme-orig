...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/5/4.html?id=458461'"/>
<xsl:variable name="title" select="'5.4 Sámepolitihka bargo-... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1018'"/>
