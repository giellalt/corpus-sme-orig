...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/2014/buoret-veahkki-go-manat-veagal-farrehuvv.html?id=750199'"/>
...
<xsl:variable name="para_nob" select="'bedre-hjelp-ved-barnebortforing.html_id=750199'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="bedre-hjelp-ved-barnebortforing_id_750199.html" xml:lang="nob"/>
