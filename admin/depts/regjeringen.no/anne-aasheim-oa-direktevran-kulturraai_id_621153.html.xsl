...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/anne-aasheim-oa-direktevran-kulturraai.html?id=621153'"/>
...
<xsl:variable name="para_nob" select="'Anne-Aasheim-ny-direktor-i-Kulturradet.html?id=621153'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="anne-aasheim-ny-direktor-i-kulturradet_id_621153.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
