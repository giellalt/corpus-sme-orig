...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/24/3/3.html?id=514633'"/>
<xsl:variable name="title" select="'1.3.3 Finnmárkkuláhka - regjeringen.no'"/>
