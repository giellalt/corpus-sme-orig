...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Raehusa-kulturagiruan-doaimmaide-lasihuvvo-780-miljovnna-.html?id=619712'"/>
...
<xsl:variable name="para_nob" select="'regjeringens-kultursatsing-oker-med-780-.html?id=619712'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringens-kultursatsing-oker-med-780-_id_619712.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
