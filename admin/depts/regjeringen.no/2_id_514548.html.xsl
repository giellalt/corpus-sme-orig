...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/19/2.html?id=514548'"/>
<xsl:variable name="title" select="'19.2 Filbma - regjeringen.no'"/>
