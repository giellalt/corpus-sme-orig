...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2008/hirbmat-ladje-vuoruha-suohkaniid-algobal.html?id=511409'"/>
...
<xsl:variable name="para_nob" select="'rekordsterk-satsing-pa-velferd-i-kommune.html?id=511409'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rekordsterk-satsing-pa-velferd-i-kommune_id_511409.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
