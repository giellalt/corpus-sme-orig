...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/preassaguovdda/pressemeldinger/2012/servodatekonomiija-analysaid-guorahallan.html?id=701024'"/>
