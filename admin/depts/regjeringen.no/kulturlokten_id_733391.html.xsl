...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/dokumeanttat/veiledninger_brosjyrer/2013/kulturlokten.html?id=733391'"/>
...
<xsl:variable name="para_nob" select="'kulturloftet.html_id=733391'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kulturloftet_id_733391.html" xml:lang="nob"/>
