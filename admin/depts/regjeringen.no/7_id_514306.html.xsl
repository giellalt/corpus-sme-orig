...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/2/3/7.html?id=514306'"/>
<xsl:variable name="title" select="'2.3.7 Davviriikkalaš... - regjeringen.no'"/>
