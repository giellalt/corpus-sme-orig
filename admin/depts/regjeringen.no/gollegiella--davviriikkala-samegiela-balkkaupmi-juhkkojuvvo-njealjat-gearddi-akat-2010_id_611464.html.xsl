...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/fad/oasat/nyheter/2010/Gollegiella--Davviriikkala-samegiela-balkkaupmi-juhkkojuvvo-njealjat-gearddi-akat-2010.html?id=611464'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/nyheter/2010/Gollegiella--Davviriikkala-samegiela-balkkaupmi-juhkkojuvvo-njealjat-gearddi-akat-2010.html?id=611464'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Gollegiella – Davviriikkalaš sámegiela bálkkašupmi juhkkojuvvo njealját gearddi čakčat 2010 - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'gollegiella--nordisk-samisk-sprakpris-de.html?id=611464'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gollegiella--nordisk-samisk-sprakpris-de_id_611464.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
