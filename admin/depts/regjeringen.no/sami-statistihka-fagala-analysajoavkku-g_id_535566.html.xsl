...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Samepolitihkka/midtspalte/sami-statistihka-fagala-analysajoavkku-g.html?id=535566'"/>
...
<xsl:variable name="para_nob" select="'faglig-analysegruppe-for-samisk-statisti.html?id=535566'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="faglig-analysegruppe-for-samisk-statisti_id_535566.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
