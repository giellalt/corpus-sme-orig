...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/preassa--ja-gulahallansekuvdna-.html?id=85803'"/>
