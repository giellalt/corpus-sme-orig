...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/9/2/2.html?id=458502'"/>
<xsl:variable name="title" select="'9.2.2 Sámi mánáidgárddiid... - regjeringen.no'"/>
