...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/2/21/6.html?id=610164'"/>
<xsl:variable name="title" select="'2.21.6 Kvalitehta ovddideapmi... - regjeringen.no'"/>
