...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/sd/pressesenter/pressemeldinger/pressemeldinger/stahtabueahtta-2012-12-miljardda-kruvnno.html?id=660082'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="statsbudsjettet-201212-milliardar-kroner_id_660082.html"/>
