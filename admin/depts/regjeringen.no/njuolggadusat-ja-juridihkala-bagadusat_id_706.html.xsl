...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/lagat-ja-lahkaasahusat/Njuolggadusat-ja-juridihkala-bagadusat.html?id=706'"/>
