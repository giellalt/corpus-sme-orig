...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/--Lihku-beivviin-buot-sapmelaat.html?id=499276'"/>
...
<xsl:variable name="para_nob" select="'--gratulerer-med-dagen-alle-samer.html?id=499276'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gratulerer-med-dagen-alle-samer_id_499276.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
