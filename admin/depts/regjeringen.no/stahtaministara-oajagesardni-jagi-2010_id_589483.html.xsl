...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2010/stahtaministara-oajagesardni-jagi-2010.html?id=589483'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2010/stahtaministara-oajagesardni-jagi-2010.html?id=589483'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="wordcount" select="'1826'"/>
