...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/lasihuvvon-doarjja-nationalamuseai-2013-.html?id=701348'"/>
...
<xsl:variable name="para_nno" select="'auka-tilskot-til-nasjonalmuseet-til-munc.html_id=701348'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="auka-tilskot-til-nasjonalmuseet-til-munc_id_701348.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
