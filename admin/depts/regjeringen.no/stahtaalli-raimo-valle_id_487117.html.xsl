...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dokumeantavuorka/stoltenberg-ii/bargo--ja-searvadahttindepartemeanta/personer-og-enheter/politisk-ledelse/2006/stahtaalli-raimo-valle.html?id=487117'"/>
