...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Kultuvrra-norggaoahpisteami-ja-protokollaossodat.html?id=1529'"/>
...
<xsl:variable name="para_nob" select="'avdeling_for_presse_kultur_og_informasjo.html?id=1529'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdeling_for_presse_kultur_og_informasjo_id_1529.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
