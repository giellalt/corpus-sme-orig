...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/oasat/2012/oa-neahttauskkadat-fylkkamanniide.html?id=708984'"/>
...
<xsl:variable name="para_nob" select="'ny-nettportal-for-fylkesmennene.html_id=708984'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ny-nettportal-for-fylkesmennene_id_708984.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
