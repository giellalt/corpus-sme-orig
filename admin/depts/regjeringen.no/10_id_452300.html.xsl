...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20022003/stdie-nr-10-2002-2003-samisk/2-2/2/10.html?id=452300'"/>
<xsl:variable name="title" select="'2.2.10 Sámedikki riikkaidgaskasaš... - regjeringen.no'"/>
