...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/Bodeaju-allaskuvla---1-600-000-ruvnno-.html?id=612731'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/Bodeaju-allaskuvla---1-600-000-ruvnno-.html?id=612731'"/>
<xsl:variable name="text_encoding" select="''"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Bodeaju allaskuvla - 1 600 000 ruvnno  - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'1-600-000-kroner-til-hogskolen-i-bodo.html?id=612731'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="1-600-000-kroner-til-hogskolen-i-bodo_id_612731.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
