...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/6/1.html?id=565839'"/>
<xsl:variable name="title" select="'2.1 Finnmárkkuláhka (Erenoamážit ... - regjeringen.no'"/>
