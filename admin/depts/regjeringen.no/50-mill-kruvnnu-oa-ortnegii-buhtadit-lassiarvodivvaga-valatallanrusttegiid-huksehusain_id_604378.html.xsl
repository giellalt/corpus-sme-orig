...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/50-mill-kruvnnu-oa-ortnegii-buhtadit-lassiarvodivvaga-valatallanrusttegiid-huksehusain.html?id=604378'"/>
...
<xsl:variable name="para_nob" select="'50-mill-kroner-til-ny-ordning-for-kompensasjon-av-merverdiavgift-ved-bygging-av-idrettsanlegg.html?id=604378'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="50-mill-kroner-til-ny-ordning-for-kompensasjon-av-merverdiavgift-ved-bygging-av-idrettsanlegg_id_604378.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
