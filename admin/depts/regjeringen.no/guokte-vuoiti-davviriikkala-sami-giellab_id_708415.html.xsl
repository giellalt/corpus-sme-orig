...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2012/guokte-vuoiti-davviriikkala-sami-giellab.html?id=708415'"/>
...
<xsl:variable name="para_nob" select="'to-vinnere-av-den-nordiske-samiske-sprak.html_id=708415'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="to-vinnere-av-den-nordiske-samiske-sprak_id_708415.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
