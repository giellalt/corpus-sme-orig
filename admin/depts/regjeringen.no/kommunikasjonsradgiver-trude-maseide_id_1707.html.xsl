...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/Stahtaministara-kantuvra/org/avdelinger/kommunikasjonsseksjonen/Kommunikasjonsradgiver-Trude-Maseide.html?id=1707'"/>
