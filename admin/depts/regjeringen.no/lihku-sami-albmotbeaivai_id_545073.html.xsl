...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/lihku-sami-albmotbeaivai.html?id=545073'"/>
...
<xsl:variable name="para_nob" select="'gratulerer-med-samefolkets-dag.html?id=545073'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gratulerer-med-samefolkets-dag_id_545073.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
