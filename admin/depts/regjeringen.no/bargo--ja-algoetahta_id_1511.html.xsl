...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/Vuollasa-asahusat/Bargo--ja-algoetahta.html?id=1511'"/>
...
<xsl:variable name="para_nob" select="'arbeids_og_velferdsetaten.html?id=1511'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arbeids_og_velferdsetaten_id_1511.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
