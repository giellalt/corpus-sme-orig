...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2012/feb-12/brekk-karajogas.html?id=673007'"/>
...
<xsl:variable name="para_nob" select="'presseinvitasjon-brekk-til-karasjok.html_id=673007'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="presseinvitasjon-brekk-til-karasjok_id_673007.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
