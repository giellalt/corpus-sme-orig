...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Regionala-gaaldagaid-ja-ovdaneami-ossodat/Latin-Amerihka-sekuvdna.html?id=86885'"/>
...
<xsl:variable name="para_nob" select="'latin-amerikaseksjonen.html?id=86885'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="latin-amerikaseksjonen_id_86885.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
