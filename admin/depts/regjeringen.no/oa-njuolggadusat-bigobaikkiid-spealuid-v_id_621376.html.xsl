...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/oa-njuolggadusat-bigobaikkiid-spealuid-v.html?id=621376'"/>
...
<xsl:variable name="para_nno" select="'nye-reglar-for-spel-i-bingolokale.html?id=621376'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nye-reglar-for-spel-i-bingolokale_id_621376.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
