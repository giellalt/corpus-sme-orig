...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/6/4.html?id=514708'"/>
<xsl:variable name="title" select="'2.6.4 Girku - regjeringen.no'"/>
