...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/12/4/3.html?id=514442'"/>
<xsl:variable name="title" select="'12.4.3 Sámi Máhttoloktema... - regjeringen.no'"/>
