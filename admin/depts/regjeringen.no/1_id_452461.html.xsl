...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/15/4/1.html?id=452461'"/>
<xsl:variable name="title" select="'1.4.1 Doaibmarehketdoallu - regjeringen.no'"/>
