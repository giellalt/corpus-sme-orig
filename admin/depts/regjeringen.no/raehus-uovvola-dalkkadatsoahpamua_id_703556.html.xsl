...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/preassaguovdda/Preassadieahusat/2012/raehus-uovvola-dalkkadatsoahpamua.html?id=703556'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringa-folgjer-opp-klimaforliket_id_703556.html" xml:lang="nno"/>
</xsl:variable>
