...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/5-Oppala-ielggadangaibadusat.html?id=571088'"/>
...
<xsl:variable name="para_nob" select="'5-generelle-utredningskrav.html?id=571088'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="5-generelle-utredningskrav_id_571088.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
