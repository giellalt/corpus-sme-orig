...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2012/norga--stuora-mearranauvdna.html?id=707139'"/>
...
<xsl:variable name="para_nob" select="'forskningsstrategi-for-en-havnasjon-av-f.html_id=707139'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskningsstrategi-for-en-havnasjon-av-f_id_707139.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
