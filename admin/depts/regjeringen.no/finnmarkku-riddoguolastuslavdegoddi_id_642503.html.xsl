...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2011/finnmarkku-riddoguolastuslavdegoddi.html?id=642503'"/>
...
<xsl:variable name="para_nob" select="'kystfiskeutvalget-for-finnmark-.html_id=642503'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kystfiskeutvalget-for-finnmark-_id_642503.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
