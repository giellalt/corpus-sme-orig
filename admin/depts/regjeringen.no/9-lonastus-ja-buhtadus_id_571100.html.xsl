...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/9-Lonastus-ja-buhtadus.html?id=571100'"/>
...
<xsl:variable name="para_nob" select="'9-innlosning-og-erstatning.html?id=571100'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="9-innlosning-og-erstatning_id_571100.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
