...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/Preassaguovdda/pressemeldinger/2010/Raporta-sierragessosa-birra-stuora-buohcangoluid-dihte.html?id=601439'"/>
...
<xsl:variable name="para_nob" select="'Rapport-om-sarfradrag-for-store-sykdomsutgifter.html?id=601439'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rapport-om-sarfradrag-for-store-sykdomsutgifter_id_601439.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
