...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/4/4/1.html?id=458446'"/>
<xsl:variable name="title" select="'4.4.1 Válddi ja dahkamušaid... - regjeringen.no'"/>
