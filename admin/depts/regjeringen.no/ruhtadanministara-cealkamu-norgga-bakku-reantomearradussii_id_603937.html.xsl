...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aktuelt/Nyheter/2010/Ruhtadanministara-cealkamu-Norgga-Bakku-reantomearradussii.html?id=603937'"/>
...
<xsl:variable name="para_nob" select="'Finansministerens-kommentar-til-Norges-Banks-rentebeslutning2.html?id=603937'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="finansministerens-kommentar-til-norges-banks-rentebeslutning2_id_603937.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
