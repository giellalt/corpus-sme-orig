...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/oed/pressesenter/pressemeldinger/2011/stuora-petroleagavnnus-barentsabis.html?id=637685'"/>
...
<xsl:variable name="para_nob" select="'stort-funn-i-barentshavet.html_id=637685'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stort-funn-i-barentshavet_id_637685.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
