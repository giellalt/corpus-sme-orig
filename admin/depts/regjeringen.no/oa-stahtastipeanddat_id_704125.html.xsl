...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/oa-stahtastipeanddat.html?id=704125'"/>
...
<xsl:variable name="para_nno" select="'nye-statsstipendiat.html_id=704125'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nye-statsstipendiat_id_704125.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
