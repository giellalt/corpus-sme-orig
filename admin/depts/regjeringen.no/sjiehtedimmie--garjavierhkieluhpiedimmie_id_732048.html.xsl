...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/sjiehtedimmie--garjavierhkieluhpiedimmie.html?id=732048'"/>
...
<xsl:variable name="para_nob" select="'traktat-om-tilgang-til-andsverk-for-blin.html_id=732048'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="traktat-om-tilgang-til-andsverk-for-blin_id_732048.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
