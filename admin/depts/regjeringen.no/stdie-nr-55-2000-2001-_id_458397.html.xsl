...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-.html?id=458397'"/>
<xsl:variable name="title" select="'St.dieđ. nr. 55 (2000-2001)  - regjeringen.no'"/>
