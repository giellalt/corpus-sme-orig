...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/hod/pressesenter/pressemeldinger/2013/nannejit-gielddaid-fuolahanbalvalusa.html?id=745218'"/>
...
<xsl:variable name="para_nob" select="'styrker-omsorgstjenestene-i-kommunene.html_id=745218'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="styrker-omsorgstjenestene-i-kommunene_id_745218.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
