...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/sd/pressesenter/pressemeldinger/2006/Buorit-fievrridan-ja-telebalvalusat-sihkkarastet-positiiva-ovdaneami-davveguovlluin-.html?id=437107'"/>
<xsl:variable name="title" select="'Buorit fievrridan- ja telebálvalusat sihkkarastet positiiva ovdáneami davveguovlluin    - regjeringen.no'"/>
