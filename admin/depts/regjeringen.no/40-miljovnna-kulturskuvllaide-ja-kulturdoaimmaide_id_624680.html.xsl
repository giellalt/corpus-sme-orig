...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/40-miljovnna-kulturskuvllaide-ja-kulturdoaimmaide.html?id=624680'"/>
...
<xsl:variable name="para_nob" select="'40-millioner-til-kulturskoler-og-kulturt.html?id=624680'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="40-millioner-til-kulturskoler-og-kulturt_id_624680.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
