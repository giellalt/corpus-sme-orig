...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/5/1.html?id=565835'"/>
<xsl:variable name="title" select="'1.1 Boađusrehketdoallu - regjeringen.no'"/>
