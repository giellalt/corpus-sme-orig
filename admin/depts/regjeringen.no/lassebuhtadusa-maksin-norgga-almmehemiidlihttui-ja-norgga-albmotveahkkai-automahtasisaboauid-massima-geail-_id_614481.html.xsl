...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Lassebuhtadusa-maksin-Norgga-almmehemiidlihttui-ja-Norgga-Albmotveahkkai-automahtasisaboauid-massima-geail-.html?id=614481'"/>
