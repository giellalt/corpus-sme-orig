...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/21/5/3.html?id=514611'"/>
<xsl:variable name="title" select="'21.5.3 Duodji - regjeringen.no'"/>
