...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Sartnit-ja-allosat/ministeren/landbruks--og-matminister-lars-peder-bre/2012/lihkku-sami-albmotbeivviin-.html?id=671233'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="liikku-sami-albmotbeaivviin-jeg-onsker-t_id_671233.html"/>
