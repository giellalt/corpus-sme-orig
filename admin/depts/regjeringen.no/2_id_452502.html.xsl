...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/1/2.html?id=452502'"/>
<xsl:variable name="title" select="'4.1.2 Sámi mánáid ja... - regjeringen.no'"/>
