...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/finnmarkku-allaskuvla.html?id=612835'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/finnmarkku-allaskuvla.html?id=612835'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Finnmárkku allaskuvla - 900 000 ruvnno  - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'900-000-kroner-til-hogskolen-i-finnmark.html?id=612835'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="900-000-kroner-til-hogskolen-i-finnmark_id_612835.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
