...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/stuorradikkediedadus-samedikke-dajma-gak.html?id=566383'"/>
...
<xsl:variable name="para_nob" select="'stortingsmelding-om-sametingets-virksomh.html?id=566383'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stortingsmelding-om-sametingets-virksomh_id_566383.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
