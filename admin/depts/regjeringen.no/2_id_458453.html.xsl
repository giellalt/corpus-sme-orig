...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/5/2.html?id=458453'"/>
<xsl:variable name="title" select="'5.2 Sámediggi ja gaskavuohta... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1377'"/>
