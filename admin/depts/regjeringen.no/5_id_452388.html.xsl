...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/5.html?id=452388'"/>
<xsl:variable name="title" select="'5 Oahpahus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1187'"/>
