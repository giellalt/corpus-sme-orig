...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/3/3/2.html?id=514328'"/>
<xsl:variable name="title" select="'3.3.2 Lullisámi regiovnnat ... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'862'"/>
