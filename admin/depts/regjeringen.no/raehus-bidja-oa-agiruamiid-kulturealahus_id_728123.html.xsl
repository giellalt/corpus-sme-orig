...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/raehus-bidja-oa-agiruamiid-kulturealahus.html?id=728123'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringen-satser-nytt-innen-kulturnari_id_728123.html" xml:lang="nob"/>
</xsl:variable>
