...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/nannoseabbo-manaid-suddjen-aibmomedialag.html?id=705436'"/>
...
<xsl:variable name="para_nob" select="'sterkere-beskyttelse-av-barn-i-kringkast.html_id=705436'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sterkere-beskyttelse-av-barn-i-kringkast_id_705436.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
