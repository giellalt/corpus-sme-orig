...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2010/sami-gielladoaibmabijuide-500-000-kruvnn.html?id=629706'"/>
...
<xsl:variable name="para_nob" select="'500-000-kroner-til-samiske-spraktiltak.html?id=629706'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="500-000-kroner-til-samiske-spraktiltak_id_629706.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
