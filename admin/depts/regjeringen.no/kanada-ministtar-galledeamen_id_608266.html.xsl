...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/nyheter/2010/Kanada-ministtar-galledeamen.html?id=608266'"/>
...
<xsl:variable name="para_nob" select="'Canadisk-minister-pa-besok.html?id=608266'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="canadisk-minister-pa-besok_id_608266.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
