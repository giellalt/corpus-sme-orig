...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2010/April-10/Eanandoalloiehtadus-Ovddida-gaibadusas.html?id=601344'"/>
...
<xsl:variable name="para_nob" select="'Jordbruksoppgjoret-Slik-er-timeplanen.html?id=601344'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jordbruksoppgjoret-slik-er-timeplanen_id_601344.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
