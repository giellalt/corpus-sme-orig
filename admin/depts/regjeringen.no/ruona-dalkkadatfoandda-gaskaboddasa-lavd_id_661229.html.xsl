...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aigeguovdil/nyheter/2011/ruona-dalkkadatfoandda-gaskaboddasa-lavd.html?id=661229'"/>
...
<xsl:variable name="para_nob" select="'siste-mote-i-overgangskomiteen-for-det-g.html_id=661229'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="siste-mote-i-overgangskomiteen-for-det-g_id_661229.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
