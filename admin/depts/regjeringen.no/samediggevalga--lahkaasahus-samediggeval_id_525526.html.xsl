...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Johtoallosat/Gulaskuddandokumeanta/2008/samediggevalga--lahkaasahus-samediggeval.html?id=525526'"/>
...
<xsl:variable name="para_nob" select="'sametingsvalget---forskrift-om-valg-til-.html?id=525526'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sametingsvalget---forskrift-om-valg-til-_id_525526.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
