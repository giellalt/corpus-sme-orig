...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Departemeanta/Organisauvdna/avdelinger/kommunikasjonsenheten/Seniorraeaddi-Ingvild-Dahl-Dornes.html?id=556003'"/>
