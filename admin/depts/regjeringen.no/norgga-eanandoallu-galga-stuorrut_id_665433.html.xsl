...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/pressesenter/pressemeldinger/2011/norgga-eanandoallu-galga-stuorrut.html?id=665433'"/>
...
<xsl:variable name="para_nob" select="'norsk-landbruk-skal-vokse.html_id=665433'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norsk-landbruk-skal-vokse_id_665433.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
