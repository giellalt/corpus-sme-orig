...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kmd/aigeguovdil/Sartnit-ja-allosat/politisk_ledelse/taler-og-artikler-av-statssekretar-ander/2014/dearvvahansardni-sami-albmotbeaivvi.html?id=750637'"/>
...
<xsl:variable name="para_nob" select="'hilsningstale-pa-samefolkets-dag-.html_id=750637'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hilsningstale-pa-samefolkets-dag-_id_750637.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
