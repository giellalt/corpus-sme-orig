...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/11/5.html?id=514736'"/>
<xsl:variable name="title" select="'2.11.5 Seminárat ja konferánssat - regjeringen.no'"/>
