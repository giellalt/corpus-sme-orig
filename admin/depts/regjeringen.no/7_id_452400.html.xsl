...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/7.html?id=452400'"/>
<xsl:variable name="title" select="'7 Sámi ealáhusat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1478'"/>
