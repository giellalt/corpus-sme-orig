...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2012/juni-12/slagsvold-vedum-nammaduvvon-oa-eanandoal.html?id=685949'"/>
...
<xsl:variable name="para_nob" select="'slagsvold-vedum-ny-landbruks--og-matmini.html_id=685949'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="slagsvold-vedum-ny-landbruks--og-matmini_id_685949.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
