...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/svar_stortinget/sporretime/2012/eanandoallo--ja-biebmoministara-sahkavuo.html?id=685869'"/>
...
<xsl:variable name="para_nob" select="'landbruks--og-matministerens-innlegg-i-2.html_id=685869'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="landbruks--og-matministerens-innlegg-i-2_id_685869.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
