...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/pressesenter/pressemeldinger/2011/opmodatpolitihkka.html?id=665431'"/>
...
<xsl:variable name="para_nob" select="'eiendomspolitikk.html_id=665431'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="eiendomspolitikk_id_665431.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
