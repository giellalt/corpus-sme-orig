...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/15/10.html?id=514502'"/>
<xsl:variable name="title" select="'15.10 Festiválat ja musihkka - regjeringen.no'"/>
