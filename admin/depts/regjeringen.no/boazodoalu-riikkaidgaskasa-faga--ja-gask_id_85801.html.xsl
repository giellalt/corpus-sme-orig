...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/boazodoalu-riikkaidgaskasa-faga--ja-gask.html?id=85801'"/>
...
<xsl:variable name="para_nob" select="'internasjonalt_fag-_og_formidlingssenter.html?id=85801'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="internasjonalt_fag-_og_formidlingssenter_id_85801.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
