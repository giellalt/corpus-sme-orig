...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/girjelaga-heaittihanevttohus.html?id=747915'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="regjeringen-vil-foresla-stotte-til-sykke.html_id=747976" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
