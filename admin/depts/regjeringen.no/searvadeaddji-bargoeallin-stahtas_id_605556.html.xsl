...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/fadd/Balka--ja-bargoveahkapolitihkka/Searvadeaddji-bargoeallin-stahtas.html?id=605556'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ia_staten_id_605556.html" xml:lang="nob"/>
</xsl:variable>
