...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/raehus-arvala-1-miljovnna-ruvnno-lassane.html?id=701353'"/>
...
<xsl:variable name="para_nno" select="'regjeringa-foreslar-ein-auke-pa-1-millio.html_id=701353'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringa-foreslar-ein-auke-pa-1-millio_id_701353.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
