...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/Departemeantta-birra/Organisauvdna/Ossodagat/Joiheaddjit--/Departemeanttarai-kantuvra.html?id=437454'"/>
...
<xsl:variable name="para_nob" select="'departementsradens-kontor.html?id=437454'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departementsradens-kontor_id_437454.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
