...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Paraolympiala-gudnebalkkaupmi-Nils-Erik-Ulsetii.html?id=600741'"/>
...
<xsl:variable name="para_nno" select="'Paralympisk-arespris-til-Nils-Erik-Ulset-.html?id=600741'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="paralympisk-arespris-til-nils-erik-ulset-_id_600741.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
