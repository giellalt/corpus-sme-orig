...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/ONa-rafi-ja-humanitara-gaaldagaid-ossodat/Olmmovuoigatvuoaid-ja-demokratiija-sekuvdna.html?id=87007'"/>
...
<xsl:variable name="para_nob" select="'seksjon-for-menneskerettigheter-og-demok.html?id=87007'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon-for-menneskerettigheter-og-demok_id_87007.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
