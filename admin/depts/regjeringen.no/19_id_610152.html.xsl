...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/2/19.html?id=610152'"/>
<xsl:variable name="title" select="'2.19 Hálddahuslaš dási... - regjeringen.no'"/>
