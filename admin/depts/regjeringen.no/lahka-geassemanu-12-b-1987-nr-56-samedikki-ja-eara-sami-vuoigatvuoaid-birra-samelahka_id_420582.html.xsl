...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Dokumeanttat/Lagat-ja-njuolggadusat/Njuolggadusat/2003/Lahka-geassemanu-12-b-1987-nr-56-Samedikki-ja-eara-sami-vuoigatvuoaid-birra-samelahka.html?id=420582'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Láhka geassemánu 12. b. 1987 nr. 56: Sámedikki ja eará sámi vuoigatvuođaid birra (sámeláhka) - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'2170'"/>
