...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/21/5/2.html?id=514610'"/>
<xsl:variable name="title" select="'21.5.2 Meahcceealáhusat... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'832'"/>
