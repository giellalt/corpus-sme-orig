...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2013/sameministtar-deaivvada-samedikki-presid.html?id=747417'"/>
...
<xsl:variable name="para_nob" select="'sameministeren-moter-sametingspresidente.html_id=747417'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sameministeren-moter-sametingspresidente_id_747417.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
