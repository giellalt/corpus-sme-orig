...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/diehtojuohkinovttadat-/diehtojuohkinhoavda-signe-bjorvik.html?id=446489'"/>
...
<xsl:variable name="para_nob" select="'informasjonssjef-signe-bjorvik.html?id=446489'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="informasjonssjef-signe-bjorvik_id_446489.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
