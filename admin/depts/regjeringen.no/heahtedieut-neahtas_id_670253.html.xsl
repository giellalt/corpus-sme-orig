...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/aigeguovdil/nyheter/2012/heahtedieut-neahtas.html?id=670253'"/>
...
<xsl:variable name="para_nob" select="'kriseinformasjon-pa-nett.html_id=670253'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kriseinformasjon-pa-nett_id_670253.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
