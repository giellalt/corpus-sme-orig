...
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/ad/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/21.html?id=634235'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'20 Resursaávkkástallan ja árvoháhkan sámi guovlluin'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="21_id_513100.html" xml:lang="nob"/>
</xsl:variable>
