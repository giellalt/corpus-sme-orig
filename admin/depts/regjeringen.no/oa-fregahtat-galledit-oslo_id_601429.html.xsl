...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/Aigeguovdil/Oasat/2010/Oa-fregahtat-galledit-Oslo.html?id=601429'"/>
...
<xsl:variable name="para_nno" select="'Fregatten-Fridtjof-Nansen-vitjar-Oslo.html?id=601429'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fregatten-fridtjof-nansen-vitjar-oslo_id_601429.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
