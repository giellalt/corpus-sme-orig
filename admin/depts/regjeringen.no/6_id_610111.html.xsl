...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/2/12/6.html?id=610111'"/>
<xsl:variable name="title" select="'2.12.6 Ovttasdoaibmanođastus - regjeringen.no'"/>
