...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/aktuelt/nyheter/2012/haliidat-oadjebas-astoaiggi-fanasjohtola.html?id=678261'"/>
...
<xsl:variable name="para_nob" select="'onsker-trygg-ferdsel-for-fritidsflaten.html_id=678261'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="onsker-trygg-ferdsel-for-fritidsflaten_id_678261.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
