...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Stivrrat-rait-ja-lavdegottit/Finnmarkkuopmodaga-darkkastuslavdegoddi.html?id=574629'"/>
...
<xsl:variable name="para_nob" select="'kontrollkomiteen-for-finnmarkseiendommen.html?id=574629'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kontrollkomiteen-for-finnmarkseiendommen_id_574629.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
