...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/8.html?id=514371'"/>
<xsl:variable name="title" select="'7 Sámediggi - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'16659'"/>
