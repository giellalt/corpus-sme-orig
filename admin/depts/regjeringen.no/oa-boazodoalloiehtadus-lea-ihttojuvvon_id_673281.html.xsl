...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2012/feb-12/oa-boazodoalloiehtadus-lea-ihttojuvvon.html?id=673281'"/>
...
<xsl:variable name="para_nob" select="'enighet-om-ny-reindriftsavtale.html_id=673281'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="enighet-om-ny-reindriftsavtale_id_673281.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
