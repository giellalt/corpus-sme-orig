...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/7/1/1.html?id=514367'"/>
<xsl:variable name="title" select="'7.1.1 Bearráigeahčču,... - regjeringen.no'"/>
