...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/fad/oasat/nyheter/2010/boazodoalu-riikkaidgaskasa-faga-ja-gaskk.html?id=611579'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/nyheter/2010/boazodoalu-riikkaidgaskasa-faga-ja-gaskk.html?id=611579'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Boazodoalu riikkaidgaskasaš fága-ja gaskkustanguovddáža ođđa stivra - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'nytt-styre-i-internasjonalt-reindriftsse.html?id=611579'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nytt-styre-i-internasjonalt-reindriftsse_id_611579.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
