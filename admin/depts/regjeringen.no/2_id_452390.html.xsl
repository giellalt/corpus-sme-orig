...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/5/2.html?id=452390'"/>
<xsl:variable name="title" select="'5.2 Skuvlaastoáiggeortnet - regjeringen.no'"/>
