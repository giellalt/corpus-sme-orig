...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/May-Helen-Molvar-Grimstad-Kringkastetrai-oa-joiheaddji.html?id=590011'"/>
...
<xsl:variable name="para_nob" select="'may-helen-molvar-grimstad-ny-leder-i-kri.html?id=590011'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="may-helen-molvar-grimstad-ny-leder-i-kri_id_590011.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
