...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/sd/Departemeantta-birra/Eara-politihkala-njunnoat/politihkala-raeaddi-sigrid-brattabo-hand.html?id=586858'"/>
