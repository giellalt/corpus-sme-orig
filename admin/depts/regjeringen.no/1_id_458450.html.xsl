...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/5/1.html?id=458450'"/>
<xsl:variable name="title" select="'5.1 Departemeanttaid... - regjeringen.no'"/>
