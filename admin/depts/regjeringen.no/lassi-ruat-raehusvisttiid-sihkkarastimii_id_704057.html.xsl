...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2012/lassi-ruat-raehusvisttiid-sihkkarastimii.html?id=704057'"/>
...
<xsl:variable name="para_nob" select="'okte-midler-til-sikring-av-regjeringsbyg.html_id=704057'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okte-midler-til-sikring-av-regjeringsbyg_id_704057.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
