...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Stivrrat-rait-ja-lavdegottit/Almmola-hahkamiid-vaiddanammagoddi-AHVN.html?id=444341'"/>
...
<xsl:variable name="para_nob" select="'klagenemnda-for-offentlige-anskaffelser-.html?id=444341'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="klagenemnda-for-offentlige-anskaffelser-_id_444341.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
