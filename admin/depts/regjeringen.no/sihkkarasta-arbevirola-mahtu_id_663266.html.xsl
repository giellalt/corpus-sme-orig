...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Fadda/Preassaguovdda/2011/sihkkarasta-arbevirola-mahtu.html?id=663266'"/>
...
<xsl:variable name="para_nob" select="'tittel.html_id=663266'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tittel_id_663266.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
