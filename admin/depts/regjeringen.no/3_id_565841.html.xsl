...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/6/3.html?id=565841'"/>
<xsl:variable name="title" select="'2.3 Stáhta čuovvoleapmi,... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1807'"/>
