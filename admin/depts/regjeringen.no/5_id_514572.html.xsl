...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/20/7/5.html?id=514572'"/>
<xsl:variable name="title" select="'20.7.5 Sámi giellalávdegoddi - regjeringen.no'"/>
