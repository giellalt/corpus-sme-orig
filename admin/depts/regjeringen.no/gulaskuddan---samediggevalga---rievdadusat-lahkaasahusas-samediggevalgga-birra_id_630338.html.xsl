...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/horinger/horingsdokumenter/2010/Gulaskuddan---Samediggevalga---rievdadusat-lahkaasahusas-samediggevalgga-birra.html?id=630338'"/>
...
<xsl:variable name="para_nob" select="'horing---sametingsvalget---endringer-i-f-2.html?id=630338'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horing---sametingsvalget---endringer-i-f-2_id_630338.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
