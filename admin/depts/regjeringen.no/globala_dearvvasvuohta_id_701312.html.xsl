...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/preassaguovdda/Preassadieahusat/2012/globala_dearvvasvuohta.html?id=701312'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="affordable_medicine.html_id=701312" xml:lang="eng"/>
