...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Departemeanta/Organisauvdna/avdelinger/kommunikasjonsenheten/Seniorraeaddi-Kjersti-Bjorgo.html?id=446505'"/>
