...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/lover_regler/forskrifter/2008/lahkaasahus-samediggevalgga-birra-.html?id=542923'"/>
...
<xsl:variable name="para_nob" select="'forskrift-om-valg-til-sametinget.html?id=542923'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-om-valg-til-sametinget_id_542923.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
