...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/aigeguovdil/oddasat/2013/vuoruhat-oahpaheddjiid-alit-oahpu-ja-dut.html?id=745410'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Vuoruhat oahpaheddjiid, alit oahpu ja dutkama - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'samiske-tall-forteller-6.html_id=745475'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samiske-tall-forteller-6.html_id=745475" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
