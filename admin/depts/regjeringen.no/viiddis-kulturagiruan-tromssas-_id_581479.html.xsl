...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2009/viiddis-kulturagiruan-tromssas-.html?id=581479'"/>
...
<xsl:variable name="para_nno" select="'brei-kultursatsing-i-troms.html?id=581479'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="brei-kultursatsing-i-troms_id_581479.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
