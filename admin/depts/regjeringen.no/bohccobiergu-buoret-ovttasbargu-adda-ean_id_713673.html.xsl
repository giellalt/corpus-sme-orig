...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Sartnit-ja-allosat/ministeren/taler-og-artikkler-av-landbruks--og-matm/2013/bohccobiergu-buoret-ovttasbargu-adda-ean.html?id=713673'"/>
...
<xsl:variable name="para_nob" select="'kronikk-reinkjott---bedre-samarbeid-gir-.html_id=713673'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kronikk-reinkjott---bedre-samarbeid-gir-_id_713673.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
