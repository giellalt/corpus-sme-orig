...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Kultuvrra-norggaoahpisteami-ja-protokollaossodat/Norggaoahpisteami-norggabeaggima-ja-web-sekuvdna.html?id=87019'"/>
...
<xsl:variable name="para_nob" select="'seksjon-for-norgesprofilering-og-webinfo.html?id=87019'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon-for-norgesprofilering-og-webinfo_id_87019.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
