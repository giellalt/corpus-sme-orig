...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/dehala-valatallamat-nuvtta-tvs.html?id=676355'"/>
...
<xsl:variable name="para_nob" select="'viktig-idrett-gratis-pa-tv.html_id=676355'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="viktig-idrett-gratis-pa-tv_id_676355.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
