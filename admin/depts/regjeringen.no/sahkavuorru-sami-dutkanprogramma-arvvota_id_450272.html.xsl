...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/tidligere_statssekretar_berit_oskal_eira/2006/sahkavuorru-sami-dutkanprogramma-arvvota.html?id=450272'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/tidligere_statssekretar_berit_oskal_eira/2006/sahkavuorru-sami-dutkanprogramma-arvvota.html?id=450272'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Sáhkavuorru Sámi dutkanprográmma árvvoštallankonferánssas guovvamánu 23. ja 24.b. 2006 Tromssas - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1694'"/>
