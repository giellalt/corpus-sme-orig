...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Kultuvrra-norggaoahpisteami-ja-protokollaossodat/Diplomahtasekuvdna.html?id=87020'"/>
