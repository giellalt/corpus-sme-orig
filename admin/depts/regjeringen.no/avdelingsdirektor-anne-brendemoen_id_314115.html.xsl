...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/sd/Departemeantta-birra/Organisauvdna/Ossodagat/fievrredanossodat/Luodda--ja-mearrajohtolatsekuvdna/Avdelingsdirektor-Anne-Brendemoen.html?id=314115'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="Avdelingsdirektor-Anne-Brendemoen.html?id=314115"/>
        <parallel_text xml:lang="nob" location="avdelingsdirektor-anne-brendemoen.html?id=314115"/>
