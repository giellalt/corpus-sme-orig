...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/6/4/1.html?id=458469'"/>
<xsl:variable name="title" select="'6.4.1 Oarjjevuonaprojeakta - regjeringen.no'"/>
