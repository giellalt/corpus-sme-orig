...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/9/1/1.html?id=514400'"/>
<xsl:variable name="title" select="'9.1.1 Láhkavuođđu  ja... - regjeringen.no'"/>
