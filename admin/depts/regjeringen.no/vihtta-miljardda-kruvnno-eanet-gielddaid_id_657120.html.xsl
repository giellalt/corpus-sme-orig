...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/Preassadieahusat/2011/vihtta-miljardda-kruvnno-eanet-gielddaid.html?id=657120'"/>
