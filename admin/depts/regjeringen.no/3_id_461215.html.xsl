...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/7/3.html?id=461215'"/>
<xsl:variable name="title" select="'7.3 Siidaoassi - regjeringen.no'"/>
