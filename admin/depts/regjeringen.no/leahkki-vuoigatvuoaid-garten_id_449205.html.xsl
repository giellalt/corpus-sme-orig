...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/Fattat/lovarbeid/Finnmarkkulahka/leahkki-vuoigatvuoaid-garten.html?id=449205'"/>
<xsl:variable name="title" select="'Leahkki vuoigatvuođaid gárten - regjeringen.no'"/>
