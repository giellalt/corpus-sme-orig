...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/24/6/4.html?id=514653'"/>
<xsl:variable name="title" select="'1.6.4 Terminologiijabargu - regjeringen.no'"/>
