...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/3-2/2/1.html?id=452470'"/>
<xsl:variable name="title" select="'3.2.1 Ráđđádallamat ... - regjeringen.no'"/>
