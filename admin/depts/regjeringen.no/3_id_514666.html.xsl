...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/24/9/3.html?id=514666'"/>
<xsl:variable name="title" select="'1.9.3 Eanadoallu - regjeringen.no'"/>
