...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/dokumeanttat/proposiuvnnat-ja-dieahusat/otprp/20012002/od-prp-nr-114_2001-2002/3.html?id=170404'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'3 Departemeantta árvvoštallamat... - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'754'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="3_id_170386.html"/>
