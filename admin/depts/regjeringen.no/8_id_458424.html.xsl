...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/2/8.html?id=458424'"/>
<xsl:variable name="title" select="'2.8 Maŋŋil 2. máilmmesoađi - regjeringen.no'"/>
