...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/nyheter/2011/goallos-samegillii-muid-fierpmadahkii.html?id=639977'"/>
...
<xsl:variable name="para_nob" select="'innlogging-pa-samisk.html_id=639977'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="innlogging-pa-samisk_id_639977.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
