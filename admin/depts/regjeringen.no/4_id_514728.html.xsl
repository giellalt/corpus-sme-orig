...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/10/4.html?id=514728'"/>
<xsl:variable name="title" select="'2.10.4 Anadroma ja meara... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'990'"/>
