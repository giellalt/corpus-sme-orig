...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/oasat/2013/stahta-bargit-galget-oahppat-sapmelaaid-.html?id=742430'"/>
...
<xsl:variable name="para_nob" select="'ansatte-i-staten-skal-lare-om-samer-og-n.html_id=742430'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ansatte-i-staten-skal-lare-om-samer-og-n_id_742430.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
