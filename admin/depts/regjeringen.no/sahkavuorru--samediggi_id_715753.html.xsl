...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/oed/aktuelt/taler_artikler/minister/olje--og-energiminister-ola-borten-moe/sahkavuorru--samediggi.html?id=715753'"/>
...
<xsl:variable name="para_nob" select="'hilsningstale-til-sametinget.html_id=715753'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hilsningstale-til-sametinget_id_715753.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
