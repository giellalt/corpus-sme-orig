...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/2008/finnmarkkukommiuvdna-lea-nammaduvvon.html?id=504139'"/>
<xsl:variable name="title" select="'Finnmárkkukommišuvdna lea nammaduvvon - regjeringen.no'"/>
