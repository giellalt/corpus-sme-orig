...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Lagat-ja-njuolggadusat-/Lahkaasahusat/2010/njuolggadus-boazodoalu-arrapenuvnna-birr.html?id=611863'"/>
...
<xsl:variable name="para_nob" select="'Forskrift-om-tidligpensjon-i-reindriften-.html?id=611863'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-om-tidligpensjon-i-reindriften-_id_611863.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
