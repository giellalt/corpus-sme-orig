...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/aktuelt/taler_og_artikler/ministeren/taler-og-artikler-av-grete-faremo/2012/manaid-galga-suddjet-veahkavalddalavuoai.html?id=706347'"/>
...
<xsl:variable name="para_nob" select="'barn-skal-beskyttes-mot-vold.html_id=706347'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barn-skal-beskyttes-mot-vold_id_706347.html" xml:lang="nob"/>
