...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/2.html?id=565701'"/>
<xsl:variable name="title" select="'2 Sámedikki 2008 jahkedieđáhus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'12078'"/>
