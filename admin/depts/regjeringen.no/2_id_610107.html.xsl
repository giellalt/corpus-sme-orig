...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/2/12/2.html?id=610107'"/>
<xsl:variable name="title" select="'2.12.2 Oassemihttomearri - regjeringen.no'"/>
