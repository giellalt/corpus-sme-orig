...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2013/stuoradiggedieahus-samedikki-doaimma-bir.html?id=737407'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stortingsmelding-om-sametinget-si-verkse_id_737407.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
