...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/preassadieahusat/2012/dieiha-garra-dienaslassaneami-suohkaniid/241-miljovnna-ruvnno-eanet-nordlandii-bo.html?id=682288'"/>
...
<xsl:variable name="para_nno" select="'nordland.html_id=682288'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nordland_id_682288.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
