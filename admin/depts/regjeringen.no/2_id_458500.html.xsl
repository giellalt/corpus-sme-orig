...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/9/2.html?id=458500'"/>
<xsl:variable name="title" select="'9.2 Mánáidgárdesuorgi - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1118'"/>
