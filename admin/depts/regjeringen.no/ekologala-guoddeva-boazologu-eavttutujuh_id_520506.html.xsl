...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2008/jul-08/ekologala-guoddeva-boazologu-eavttutujuh.html?id=520506'"/>
...
<xsl:variable name="para_nob" select="'reindrift-okologisk-barekraftig-reintall.html?id=520506'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reindrift-okologisk-barekraftig-reintall_id_520506.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
