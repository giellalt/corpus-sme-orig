...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/preassadieahusat/2012/dieiha-garra-dienaslassaneami-suohkaniid/72-miljovnna-ruvdno-eanet-finnmarkui-boa.html?id=682286'"/>
...
<xsl:variable name="para_nno" select="'finnmark.html_id=682286'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="finnmark_id_682286.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
