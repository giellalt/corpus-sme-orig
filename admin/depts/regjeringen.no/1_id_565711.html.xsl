...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/2/7/1.html?id=565711'"/>
<xsl:variable name="title" select="'2.7.1 Sámi parlamentáralaš... - regjeringen.no'"/>
...
=======
               <xsl:with-param name="target" select="'lea »/Delprogrammet Sápmis övergripande/  mål är/'"/>
               <xsl:with-param name="replacement" select="'lea «///'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
