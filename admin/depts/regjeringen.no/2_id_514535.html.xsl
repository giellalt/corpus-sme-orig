...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/16/2.html?id=514535'"/>
<xsl:variable name="title" select="'16.2 Eaktodáhttoguovddážat - regjeringen.no'"/>
