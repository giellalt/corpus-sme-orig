...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2007/Lassi-preassadoarjja-sami-aviissaide.html?id=485511'"/>
...
<xsl:variable name="para_nno" select="'aukar-pressestotta-til-samiske-aviser.html?id=485511'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="aukar-pressestotta-til-samiske-aviser_id_485511.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
