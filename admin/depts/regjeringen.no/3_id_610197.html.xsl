...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/3/15/3.html?id=610197'"/>
<xsl:variable name="title" select="'3.15.3 Minerálaláhka - regjeringen.no'"/>
