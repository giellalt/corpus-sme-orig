...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2007/Lassanan-doarjagat-sami-aviissaide.html?id=484685'"/>
...
<xsl:variable name="para_nob" select="'okte-tilskudd-til-samiske-aviser.html?id=484685'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okte-tilskudd-til-samiske-aviser_id_484685.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
