...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Lagat-ja-njuolggadusat-/Lahkaasahusat/2009/njuolggadus-doarjaga-birra-bargoveahkkai.html?id=571039'"/>
...
<xsl:variable name="para_nob" select="'forskrift-om-tilskudd-til-avlosning-ved-.html?id=571039'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-om-tilskudd-til-avlosning-ved-_id_571039.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
