...
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/doarjjaortnet-mii-galga-lasihit-dieuid-v.html?id=612629'"/>
<xsl:variable name="title" select="'Doarjjaortnet mii galgá lasihit dieđuid válggaid birra - regjeringen.no'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_nno" select="'tilskotsordning-for-a-fremja-kunnskap-om.html?id=612629'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tilskotsordning-for-a-fremja-kunnskap-om_id_612629.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
