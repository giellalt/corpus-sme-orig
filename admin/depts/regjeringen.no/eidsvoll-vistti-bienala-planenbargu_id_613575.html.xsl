...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Eidsvoll-vistti-bienala-planenbargu.html?id=613575'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Eidsvoll-vistti-bienala-planenbargu.html?id=613575'"/>
<xsl:variable name="text_encoding" select="''"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Eidsvoll-vistti bienalaš plánenbargu - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'detaljprosjektering-av-eidsvollsbygninge.html?id=613575'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="detaljprosjektering-av-eidsvollsbygninge_id_613575.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
