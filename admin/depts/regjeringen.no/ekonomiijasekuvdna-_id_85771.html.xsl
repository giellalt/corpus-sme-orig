...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/Bargomarkanossodat-/Ekonomiijasekuvdna-.html?id=85771'"/>
...
<xsl:variable name="para_nob" select="'okonomiseksjonen.html?id=85771'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okonomiseksjonen_id_85771.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
