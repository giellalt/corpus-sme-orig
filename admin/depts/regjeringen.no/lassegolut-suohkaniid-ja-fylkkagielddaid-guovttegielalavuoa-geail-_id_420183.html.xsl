...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Dokumeanttat/Raporttat-ja-planat/Raporttat/2002/Lassegolut-suohkaniid-ja-fylkkagielddaid-guovttegielalavuoa-geail-.html?id=420183'"/>
