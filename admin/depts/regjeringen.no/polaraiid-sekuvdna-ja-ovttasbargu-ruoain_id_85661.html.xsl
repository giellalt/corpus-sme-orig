...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Departemeanta-birra/Organisasvdna/Ossodagat-/Gaskariikkala-ovttasbargoossodat/polaraiid-sekuvdna-ja-ovttasbargu-ruoain.html?id=85661'"/>
