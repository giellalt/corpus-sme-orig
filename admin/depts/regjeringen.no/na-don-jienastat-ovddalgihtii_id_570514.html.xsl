...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valga-portal/stuorradiggevalga-2009/na-don-jienastat-ovddalgihtii.html?id=570514'"/>
...
<xsl:variable name="para_nob" select="'slik-forhandsstemmer-du.html?id=570514'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="slik-forhandsstemmer-du_id_570514.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
