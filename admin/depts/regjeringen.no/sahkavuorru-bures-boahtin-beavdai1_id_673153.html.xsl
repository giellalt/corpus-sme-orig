...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Sartnit-ja-allosat/ministeren/landbruks--og-matminister-lars-peder-bre/2012/sahkavuorru-bures-boahtin-beavdai1.html?id=673153'"/>
...
<xsl:variable name="para_nob" select="'tale-velkommen-til-bords-1.html_id=673153'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tale-velkommen-til-bords-1_id_673153.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
