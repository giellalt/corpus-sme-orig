...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/proeaktaruat-dan-vaste-ahte-rekrutteret-.html?id=727833'"/>
...
<xsl:variable name="para_nno" select="'prosjektmidlar-for-a-rekruttere-fleire-e.html_id=727833'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="prosjektmidlar-for-a-rekruttere-fleire-e_id_727833.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
