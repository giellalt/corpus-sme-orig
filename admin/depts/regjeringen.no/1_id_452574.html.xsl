...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/2-2/3/1.html?id=452574'"/>
<xsl:variable name="title" select="'2.3.1 Orrut sámi kultuvrras - regjeringen.no'"/>
