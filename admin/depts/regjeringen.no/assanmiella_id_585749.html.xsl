...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/guovllu--ja-regionalapolitihkka/ealli-ja-geasuheaddji-baikkala-servodaga/assanmiella.html?id=585749'"/>
...
<xsl:variable name="para_nno" select="'bulyst.html?id=585749'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bulyst_id_585749.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
