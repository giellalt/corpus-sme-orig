...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/aigeguovdil/oddasat/2012/ruossa_atomafapmorusttegat.html?id=696471'"/>
...
<xsl:variable name="para_nob" select="'kjernekraftverk.html_id=696471'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kjernekraftverk_id_696471.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
