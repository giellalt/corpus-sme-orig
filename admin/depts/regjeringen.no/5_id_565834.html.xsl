...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/5.html?id=565834'"/>
<xsl:variable name="title" select="'1 Rehketdoallu 2008 - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'4256'"/>
