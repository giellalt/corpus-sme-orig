...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Stivrrat-rait-ja-lavdegottit.html?id=440970'"/>
...
<xsl:variable name="para_nob" select="'styrer-rad-og-utvalg.html?id=440970'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="styrer-rad-og-utvalg_id_440970.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
