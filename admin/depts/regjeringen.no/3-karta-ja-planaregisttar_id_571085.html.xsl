...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/3-Karta-ja-planaregisttar.html?id=571085'"/>
...
<xsl:variable name="para_nob" select="'3-kart-og-planregister.html?id=571085'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="3-kart-og-planregister_id_571085.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
