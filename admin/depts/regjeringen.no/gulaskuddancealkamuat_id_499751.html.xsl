...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/dokumeanttat/hoeringer/hoeringsdok/2008/Gulaskuddan--rievdadanevttohusat-lahkaas/gulaskuddancealkamuat.html?id=499751'"/>
...
<xsl:variable name="para_nob" select="'horingsuttalelser.html?id=499751'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horingsuttalelser_id_499751.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
