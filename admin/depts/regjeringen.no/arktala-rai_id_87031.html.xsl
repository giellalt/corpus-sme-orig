...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Samepolitihkka/Riikkaidgaskasa-algoalbmotbargu/Arktala-rai.html?id=87031'"/>
...
<xsl:variable name="para_nob" select="'arktisk-rad.html?id=87031'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arktisk-rad_id_87031.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
