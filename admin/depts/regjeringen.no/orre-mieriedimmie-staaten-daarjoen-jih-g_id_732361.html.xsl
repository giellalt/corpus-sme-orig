...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/orre-mieriedimmie-staaten-daarjoen-jih-g.html?id=732361'"/>
...
<xsl:variable name="para_nob" select="'ny-forskrift-om-statens-stipend-og-garan.html_id=732361'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ny-forskrift-om-statens-stipend-og-garan_id_732361.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
