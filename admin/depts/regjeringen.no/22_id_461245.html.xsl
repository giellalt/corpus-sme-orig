...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/8/22.html?id=461245'"/>
<xsl:variable name="title" select="'8.22 Boazobearráigeahčču - regjeringen.no'"/>
