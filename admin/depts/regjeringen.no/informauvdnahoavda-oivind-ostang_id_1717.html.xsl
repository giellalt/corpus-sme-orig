...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/Stahtaministara-kantuvra/org/avdelinger/kommunikasjonsseksjonen/Informauvdnahoavda-Oivind-Ostang.html?id=1717'"/>
