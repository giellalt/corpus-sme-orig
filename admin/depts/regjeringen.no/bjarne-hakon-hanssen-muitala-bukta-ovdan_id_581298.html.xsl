...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Oasat/2009/bjarne-hakon-hanssen-muitala-bukta-ovdan.html?id=581298'"/>
...
<xsl:variable name="para_nob" select="'bjarne-hakon-hanssen-presenterer-statsbu.html?id=581298'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bjarne-hakon-hanssen-presenterer-statsbu_id_581298.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
