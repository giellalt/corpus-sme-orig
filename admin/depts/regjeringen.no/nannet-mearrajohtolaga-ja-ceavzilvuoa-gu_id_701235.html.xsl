...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2012/nannet-mearrajohtolaga-ja-ceavzilvuoa-gu.html?id=701235'"/>
...
<xsl:variable name="para_nob" select="'styrking-av-sjotransporten-og-barekraft-.html_id=701235'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="styrking-av-sjotransporten-og-barekraft-_id_701235.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
