...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2010/loahta-dahki-oasteapmi.html?id=619661'"/>
<xsl:variable name="title" select="'Šloahta dáhki ođasteapmi - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'rehabilitering-av-taket-pa-slottet.html?id=619661'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rehabilitering-av-taket-pa-slottet_id_619661.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
