...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/Eara-politihkala-njunnoat/stahtaalli-lubna-jaffery-fjell/Lubna-Jaffery-Fjella-govat.html?id=582640'"/>
...
<xsl:variable name="para_nob" select="'bilder-av-lubna-jaffery-fjell.html?id=582640'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bilder-av-lubna-jaffery-fjell_id_582640.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
