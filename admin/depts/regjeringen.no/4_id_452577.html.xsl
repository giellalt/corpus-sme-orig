...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/2-2/4.html?id=452577'"/>
<xsl:variable name="title" select="'2.4 Oahpahus ja dutkan - regjeringen.no'"/>
