...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/2719-miljovnna-ruvnno-guovlula-ovdaneapm.html?id=619650'"/>
...
<xsl:variable name="para_nno" select="'2719-millionar-kroner-til-regional-utvik.html?id=619650'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="2719-millionar-kroner-til-regional-utvik_id_619650.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
