...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/algopolitihkala-ossodat-/Buhcciidrua-ja-bargonavccahisvuoarua-sekuvdna-.html?id=85788'"/>
...
<xsl:variable name="para_nob" select="'sot.html?id=85788'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sot_id_85788.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
