...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/7/4.html?id=461216'"/>
<xsl:variable name="title" select="'7.4 Buohtalas álggahansiidaoassi - regjeringen.no'"/>
