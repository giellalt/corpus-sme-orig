...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2010/skuvlaalgin-2010-oa-joa-ny-giv--hehttet-.html?id=612778'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2010/skuvlaalgin-2010-oa-joa-ny-giv--hehttet-.html?id=612778'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Skuvlaálgin 2010: Ođđa JOAČ (Ny GIV)  hehttet skuvlaheaitima  - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'ny_giv.html?id=612778'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ny_giv_id_612778.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
