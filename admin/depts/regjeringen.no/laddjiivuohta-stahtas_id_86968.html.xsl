...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/fadd/Balka--ja-bargoveahkapolitihkka/laddjiivuohta-stahtas.html?id=86968'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="inkluderende-arbeidsliv-i-staten_id_86968.html" xml:lang="nob"/>
</xsl:variable>
