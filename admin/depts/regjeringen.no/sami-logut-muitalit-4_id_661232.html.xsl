...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dokumeanttat/raporttat-ja-planat/raporttat/2011/sami-logut-muitalit-4.html?id=661232'"/>
...
<xsl:variable name="para_nob" select="'samiske-tall-forteller-4.html_id=661232'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samiske-tall-forteller-4_id_661232.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
