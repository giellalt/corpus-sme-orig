...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/tidligere_statssekretar_berit_oskal_eira/2006/stahtaalli-berit-oskal-eira-sardni-vardo.html?id=450271'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/tidligere_statssekretar_berit_oskal_eira/2006/stahtaalli-berit-oskal-eira-sardni-vardo.html?id=450271'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Stahtačalli Berit Oskal Eira sárdni Várdobaiki sami guovddáš rahpandilalašvuođas - regjeringen.no'"/>
