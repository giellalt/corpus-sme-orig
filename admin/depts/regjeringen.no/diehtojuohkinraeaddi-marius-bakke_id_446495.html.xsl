...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/diehtojuohkinovttadat-/diehtojuohkinraeaddi-marius-bakke.html?id=446495'"/>
...
<xsl:variable name="para_nob" select="'informasjonsradgiver-marius-bakke.html?id=446495'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="informasjonsradgiver-marius-bakke_id_446495.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
