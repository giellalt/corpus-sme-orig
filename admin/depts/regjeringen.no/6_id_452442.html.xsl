...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/15/2/6.html?id=452442'"/>
<xsl:variable name="title" select="'1.2.6 Areála, biras-... - regjeringen.no'"/>
