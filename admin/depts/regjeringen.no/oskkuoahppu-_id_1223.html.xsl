...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Girku/Oskkuoahppu-.html?id=1223'"/>
...
<xsl:variable name="para_nob" select="'trosopplaring.html?id=1223'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="trosopplaring_id_1223.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
