...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/bld/tema/manat-ja-nuorat/julggatus-givssideami-vuosta-2009-2010.html?id=1028'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mobbing_id_1028.html" xml:lang="nob"/>
</xsl:variable>
