...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20022003/stdie-nr-10-2002-2003-samisk.html?id=196528'"/>
<xsl:variable name="title" select="'St.dieđ. nr. 10 (2002-2003)  - regjeringen.no'"/>
