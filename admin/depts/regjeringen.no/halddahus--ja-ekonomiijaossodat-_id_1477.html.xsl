...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/Halddahus--ja-ekonomiijaossodat-.html?id=1477'"/>
...
<xsl:variable name="para_nob" select="'administrasjons-_og_okonomiavdelingen2.html?id=1477'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="administrasjons-_og_okonomiavdelingen2_id_1477.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
