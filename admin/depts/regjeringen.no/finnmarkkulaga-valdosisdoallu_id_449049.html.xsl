...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/Fattat/lovarbeid/Finnmarkkulahka/finnmarkkulaga-valdosisdoallu.html?id=449049'"/>
<xsl:variable name="title" select="'Finnmárkkulága váldosisdoallu - regjeringen.no'"/>
