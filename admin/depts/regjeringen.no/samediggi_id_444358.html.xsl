...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Daidda-gulleva-doaimmat/Samediggi.html?id=444358'"/>
...
<xsl:variable name="para_nob" select="'sametinget.html?id=444358'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sametinget_id_444358.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
