...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/8/3.html?id=514379'"/>
<xsl:variable name="title" select="'8.3 Sámedikki ovttasbargu... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'954'"/>
