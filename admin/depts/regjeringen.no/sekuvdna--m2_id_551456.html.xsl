...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/Mediaossodat/Sekuvdna--M2.html?id=551456'"/>
...
<xsl:variable name="para_nob" select="'andre-medieseksjon-m2.html?id=551456'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="andre-medieseksjon-m2_id_551456.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
