...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/10-Sierralohpi-.html?id=571101'"/>
...
<xsl:variable name="para_nob" select="'10-dispensasjon.html?id=571101'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="10-dispensasjon_id_571101.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
