...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/lyd_bilde/video/video-lahkoeh-biejjine--vuorbbe-biejvijn.html?id=750446'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Video: Læhkoeh biejjine – Vuorbbe biejvijn – Lihkku beivviin – Gratulerer med dagen! - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'samefolkets-dag-6-februar-2014.html_id=750519'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samefolkets-dag-6-februar-2014.html_id=750519" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
