...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Departemeantta-birra/organisauvdna/Ossodagat/Diehtojuohkinovttadat.html?id=279755'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsenheten.html?id=279755'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonsenheten_id_279755.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
