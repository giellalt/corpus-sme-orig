...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/lagat-ja-lahkaasahusat/lahkaasahusat/2006/lahkaasahus-varnjargga-suodjalanplana-bi-3.html?id=489518'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Láhkaásahus Várnjárgga suodjalanplána birra. Biezavuona – Oarddovuona eanasuodjalanguovllu suodjaleapmi Báhcavuona ja Várggáid gielddain Finnmárkku. - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'1185'"/>
