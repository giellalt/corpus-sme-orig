...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/2/8.html?id=610077'"/>
<xsl:variable name="title" select="'2.8 Ealáhusat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2079'"/>
