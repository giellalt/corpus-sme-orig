...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/13/5.html?id=452430'"/>
<xsl:variable name="title" select="'13.5 Boazodoallu ja gaskariikkalaš... - regjeringen.no'"/>
