...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20062007/Stdie-nr-7-2006-2007-/2/8.html?id=452678'"/>
<xsl:variable name="title" select="'2.8 Oahpahus, oahppa... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1302'"/>
