...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2008/riddu-riu-festivala-lea-oon-knutepunktst.html?id=521663'"/>
...
<xsl:variable name="para_nob" select="'riddu-rioou-festivalen-har-fatt-knutepun.html?id=521663'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="riddu-rioou-festivalen-har-fatt-knutepun_id_521663.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
