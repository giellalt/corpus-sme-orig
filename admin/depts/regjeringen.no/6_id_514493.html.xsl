...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/15/6.html?id=514493'"/>
<xsl:variable name="title" select="'15.6 Sámi kulturviesuid... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1448'"/>
