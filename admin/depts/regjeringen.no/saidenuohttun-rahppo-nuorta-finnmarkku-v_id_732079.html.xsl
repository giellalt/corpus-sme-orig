...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2013/saidenuohttun-rahppo-nuorta-finnmarkku-v.html?id=732079'"/>
...
<xsl:variable name="para_nob" select="'tre-omrader-innenfor-fjordlinjene-i-ost-.html_id=732079'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tre-omrader-innenfor-fjordlinjene-i-ost-_id_732079.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
