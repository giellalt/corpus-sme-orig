...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/nanne-sami-doaimmaid-16-milj-ruvnnuin--s.html?id=521705'"/>
...
<xsl:variable name="para_nob" select="'styrker-det-samiske-med-16-millioner.html?id=521705'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="styrker-det-samiske-med-16-millioner_id_521705.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
