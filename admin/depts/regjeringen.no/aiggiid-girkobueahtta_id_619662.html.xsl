...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2010/Aiggiid-girkobueahtta.html?id=619662'"/>
<<<<<<< HEAD
=======
<xsl:variable name="text_encoding" select="''"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Áiggiid girkobušeahtta - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'tidenes-kirkebudsjett.html?id=619662'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tidenes-kirkebudsjett_id_619662.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
