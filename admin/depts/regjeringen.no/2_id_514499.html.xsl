...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/15/8/2.html?id=514499'"/>
<xsl:variable name="title" select="'15.8.2 Girjerájut - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1579'"/>
