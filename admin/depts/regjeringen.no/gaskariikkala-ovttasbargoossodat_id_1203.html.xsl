...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Departemeanta-birra/Organisasvdna/Ossodagat-/Gaskariikkala-ovttasbargoossodat.html?id=1203'"/>
