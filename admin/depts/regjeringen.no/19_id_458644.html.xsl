...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/19.html?id=458644'"/>
<xsl:variable name="title" select="'Ráva - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="19_id_326047.html" xml:lang="nob"/>
</xsl:variable>
