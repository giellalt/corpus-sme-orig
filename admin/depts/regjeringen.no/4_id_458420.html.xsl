...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/2/4.html?id=458420'"/>
<xsl:variable name="title" select="'2.4 Lappekodisilla 1800-logus - regjeringen.no'"/>
