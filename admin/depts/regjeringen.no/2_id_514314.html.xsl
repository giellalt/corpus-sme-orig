...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/2/5/2.html?id=514314'"/>
<xsl:variable name="title" select="'2.5.2 álgoálbmotovttasbargu... - regjeringen.no'"/>
