...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/preassaguovdda/pressemeldinger/2012/vearro--ja-divatrievdadusat.html?id=682402'"/>
...
<xsl:variable name="para_nno" select="'skatte--og-avgiftsendringar.html_id=682402'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skatte--og-avgiftsendringar_id_682402.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
