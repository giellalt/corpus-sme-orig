...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2010/des-10/lohpi-hukset-aiddi-deanus.html?id=628589'"/>
...
<xsl:variable name="para_nob" select="'byggetillatelse-for-sperregjerde-i-tana.html?id=628589'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="byggetillatelse-for-sperregjerde-i-tana_id_628589.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
