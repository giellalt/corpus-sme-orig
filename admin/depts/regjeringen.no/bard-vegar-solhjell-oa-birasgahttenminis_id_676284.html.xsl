...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Fadda/Preassaguovdda/2012/bard-vegar-solhjell-oa-birasgahttenminis.html?id=676284'"/>
...
<xsl:variable name="para_nob" select="'bard-vegar-solhjell-ny-miljovernminister.html_id=676284'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bard-vegar-solhjell-ny-miljovernminister_id_676284.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
