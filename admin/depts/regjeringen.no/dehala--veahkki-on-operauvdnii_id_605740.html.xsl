...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/Aigeguovdil/Oasat/2010/--Dehala--veahkki-ON-operauvdnii.html?id=605740'"/>
...
<xsl:variable name="para_nob" select="'--Viktig-bidrag-til-FN-operasjonen.html?id=605740'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="viktig-bidrag-til-fn-operasjonen_id_605740.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
