...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/Justisdepartementta-birra/Organisauvdna/Ossodagat/Plana--ja-halddahusossodat.html?id=1451'"/>
