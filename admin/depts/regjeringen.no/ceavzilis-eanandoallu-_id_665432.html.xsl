...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/pressesenter/pressemeldinger/2011/ceavzilis-eanandoallu-.html?id=665432'"/>
...
<xsl:variable name="para_nob" select="'barekraftig-landbruk.html_id=665432'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barekraftig-landbruk_id_665432.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
