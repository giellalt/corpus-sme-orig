...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2012/juni-12/2012-eanandoalloiehtadus-stuorradikkis.html?id=685880'"/>
...
<xsl:variable name="para_nob" select="'jordbruksoppgjoret-2012-i-stortinget.html_id=685880'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jordbruksoppgjoret-2012-i-stortinget_id_685880.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
