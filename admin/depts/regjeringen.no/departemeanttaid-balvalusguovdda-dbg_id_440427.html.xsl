...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/departemeanttaid-balvalusguovdda-dbg.html?id=440427'"/>
...
<xsl:variable name="para_nob" select="'departementenes-servicesenter-dss.html?id=440427'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departementenes-servicesenter-dss_id_440427.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
