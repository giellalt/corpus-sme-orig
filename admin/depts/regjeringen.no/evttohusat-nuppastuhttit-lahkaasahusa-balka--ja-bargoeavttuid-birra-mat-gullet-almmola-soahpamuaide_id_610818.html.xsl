...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/fad/oasat/nyheter/2010/Evttohusat-nuppastuhttit-lahkaasahusa-balka--ja-bargoeavttuid-birra-mat-gullet-almmola-soahpamuaide.html?id=610818'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/nyheter/2010/Evttohusat-nuppastuhttit-lahkaasahusa-balka--ja-bargoeavttuid-birra-mat-gullet-almmola-soahpamuaide.html?id=610818'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Evttohusat nuppástuhttit láhkaásahusa bálká- ja bargoeavttuid birra mat gullet almmolaš soahpamušaide - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'forslag-endringer-forskrift.html?id=610818'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forslag-endringer-forskrift_id_610818.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
