...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Eara-politihkala-njunnoat/stahtaalli-raimo-valle/stahtaalli-raimo-valle-sartnit-ja-artihk.html?id=583786'"/>
...
<xsl:variable name="para_nob" select="'taler_artikler.html?id=583786'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="taler_artikler_id_583786.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
