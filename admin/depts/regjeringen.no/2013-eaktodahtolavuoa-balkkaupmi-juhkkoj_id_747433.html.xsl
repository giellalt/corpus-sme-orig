...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/aigeguovdil/oasat/2013/2013-eaktodahtolavuoa-balkkaupmi-juhkkoj.html?id=747433'"/>
...
<xsl:variable name="para_nob" select="'frivillighetsprisen-2013-tildelt-de-friv.html_id=747433'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="frivillighetsprisen-2013-tildelt-de-friv_id_747433.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
