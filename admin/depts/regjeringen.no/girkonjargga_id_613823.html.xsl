...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2010/girkonjargga.html?id=613823'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2010/girkonjargga.html?id=613823'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Stáhtaministtar Jens Stoltenberg guossástallá Girkonjárgga - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'kirkenes.html?id=613823'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kirkenes_id_613823.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
