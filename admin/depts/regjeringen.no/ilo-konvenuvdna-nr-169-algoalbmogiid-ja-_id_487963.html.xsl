...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Samepolitihkka/Riikkaidgaskasa-algoalbmotbargu/ILO-konvenuvdna-nr-169-algoalbmogiid-ja-.html?id=487963'"/>
