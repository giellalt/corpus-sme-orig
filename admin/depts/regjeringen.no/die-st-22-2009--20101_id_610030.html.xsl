...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101.html?id=610030'"/>
<xsl:variable name="title" select="'Dieđ. St. 22 (2009 – 2010) - regjeringen.no'"/>
