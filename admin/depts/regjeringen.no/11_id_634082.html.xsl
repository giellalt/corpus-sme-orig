...
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/ad/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/11.html?id=634082'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'10 Mánáidgárddit'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="11_id_512947.html" xml:lang="nob"/>
</xsl:variable>
