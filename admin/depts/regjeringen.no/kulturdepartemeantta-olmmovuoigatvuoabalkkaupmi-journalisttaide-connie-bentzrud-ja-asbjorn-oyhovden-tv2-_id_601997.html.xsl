...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Kulturdepartemeantta-olmmovuoigatvuoabalkkaupmi-journalisttaide-Connie-Bentzrud-ja-Asbjorn-Oyhovden-TV2-.html?id=601997'"/>
...
<xsl:variable name="para_nob" select="'Kulturdepartementets-menneskerettspris-for-journalister-til-Connie-Bentzrud-og-Asbjorn-Oyhovden-TV2.html?id=601997'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kulturdepartementets-menneskerettspris-for-journalister-til-connie-bentzrud-og-asbjorn-oyhovden-tv2_id_601997.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
