...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/9/2.html?id=452413'"/>
<xsl:variable name="title" select="'9.2 Sámivuoigatvuođalávdegotti ... - regjeringen.no'"/>
