...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Lagat-ja-njuolggadusat-/Lahkaasahusat/2009/njuolggadus-bohccogorudiid-fievrridandoa.html?id=571036'"/>
...
<xsl:variable name="para_nob" select="'forskrift-om-tilskudd-ved-frakt-av-reins.html?id=571036'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-om-tilskudd-ved-frakt-av-reins_id_571036.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
