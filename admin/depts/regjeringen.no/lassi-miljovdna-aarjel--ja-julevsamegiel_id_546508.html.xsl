...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/lassi-miljovdna-aarjel--ja-julevsamegiel.html?id=546508'"/>
...
<xsl:variable name="para_nob" select="'ekstra-forskningsmillion-til-sor--og-lul.html?id=546508'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekstra-forskningsmillion-til-sor--og-lul_id_546508.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
