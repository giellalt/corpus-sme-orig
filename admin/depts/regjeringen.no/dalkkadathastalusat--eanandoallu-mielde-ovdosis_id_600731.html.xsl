...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Bagadusat-ja-gihppagat/2009/Dalkkadathastalusat--eanandoallu-mielde-ovdosis.html?id=600731'"/>
<xsl:variable name="title" select="'Dálkkádathástalusat – eanandoallu mielde čovdosis - regjeringen.no'"/>
