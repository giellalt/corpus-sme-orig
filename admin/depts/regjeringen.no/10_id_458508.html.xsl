...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/10.html?id=458508'"/>
<xsl:variable name="title" select="'10 Oahppu - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'3804'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="10_id_325913.html" xml:lang="nob"/>
</xsl:variable>
