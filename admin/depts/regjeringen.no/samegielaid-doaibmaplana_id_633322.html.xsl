...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/rapporter_planer/planer/2011/samegielaid-doaibmaplana.html?id=633322'"/>
...
<xsl:variable name="para_nob" select="'handlingsplan-for-samiske-sprak.html?id=633322'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="handlingsplan-for-samiske-sprak_id_633322.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
