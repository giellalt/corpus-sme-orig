...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/tidligere_statssekretar_berit_oskal_eira/2006/sami-giellalahka-omasvuonas.html?id=450275'"/>
<xsl:variable name="title" select="'Sami giellaláhka Omasvuonas - regjeringen.no'"/>
