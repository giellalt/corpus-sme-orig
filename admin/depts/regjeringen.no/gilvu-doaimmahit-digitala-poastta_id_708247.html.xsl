...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2012/gilvu-doaimmahit-digitala-poastta.html?id=708247'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="konkurranse-om-levering-av-digital-post_id_708247.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
