...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/Sisaboauid-vuoiggalat-juogadeapmi-gielddaid-gaskkas.html?id=604562'"/>
