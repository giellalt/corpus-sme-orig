...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Fadda/eanadoalu-biras--ja-eanapolitihkka/eanagahtten.html?id=503485'"/>
...
<xsl:variable name="para_nob" select="'jordvern.html?id=503485'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jordvern_id_503485.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
