...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Samepolitihkka/Davviriikkala-sami-ovttasbargu/Davviriikkala-samekonvenuvdna.html?id=86937'"/>
...
<xsl:variable name="para_nob" select="'nordisk-samekonvensjon.html?id=86937'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nordisk-samekonvensjon_id_86937.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
