...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/Departemeantta-birra/Organisauvdna/Ossodagat/Joiheaddjit--/Departemeanttarai-kantuvra/Vuosttakonsuleanta-Cecilie-Bjornskau.html?id=437457'"/>
...
<xsl:variable name="para_nob" select="'forstekonsulent-cecilie-bjornskau.html?id=437457'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forstekonsulent-cecilie-bjornskau_id_437457.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
