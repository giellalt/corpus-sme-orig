...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/24/10/6.html?id=514676'"/>
<xsl:variable name="title" select="'1.10.6 Dearvvašvuođa- ... - regjeringen.no'"/>
