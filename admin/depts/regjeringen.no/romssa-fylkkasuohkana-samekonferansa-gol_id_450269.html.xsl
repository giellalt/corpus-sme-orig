...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/tidligere_statssekretar_berit_oskal_eira/2006/romssa-fylkkasuohkana-samekonferansa-gol.html?id=450269'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/tidligere_statssekretar_berit_oskal_eira/2006/romssa-fylkkasuohkana-samekonferansa-gol.html?id=450269'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Romssa fylkkasuohkana sámekonferánsa golggotmánu 26. beaivvi 2006  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2081'"/>
