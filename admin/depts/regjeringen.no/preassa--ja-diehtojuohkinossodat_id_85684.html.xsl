...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Departemeanta-birra/Organisasvdna/Ossodagat-/Preassa--ja-diehtojuohkinossodat.html?id=85684'"/>
