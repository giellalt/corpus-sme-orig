...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/Assan--ja-huksenpolitihkka/huksenvierut-biras-ja-heivvola-habmen-.html?id=559391'"/>
...
<xsl:variable name="para_nob" select="'byggeskikk-miljo-og-universell-utforming.html?id=559391'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="byggeskikk-miljo-og-universell-utforming_id_559391.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
