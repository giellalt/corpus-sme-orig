...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/vuoruhit-vuoolagaavvudeami--eidsvoll-vis.html?id=701350'"/>
...
<xsl:variable name="para_nno" select="'satsing-pa-grunnlovsjubileet--eidsvollsb.html_id=701350'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="satsing-pa-grunnlovsjubileet--eidsvollsb_id_701350.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
