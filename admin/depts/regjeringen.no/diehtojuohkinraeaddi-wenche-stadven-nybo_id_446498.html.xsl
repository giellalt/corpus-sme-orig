...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/diehtojuohkinovttadat-/diehtojuohkinraeaddi-wenche-stadven-nybo.html?id=446498'"/>
...
<xsl:variable name="para_nob" select="'informasjonskonsulent-wenche-stadven-nyb.html?id=446498'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="informasjonskonsulent-wenche-stadven-nyb_id_446498.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
