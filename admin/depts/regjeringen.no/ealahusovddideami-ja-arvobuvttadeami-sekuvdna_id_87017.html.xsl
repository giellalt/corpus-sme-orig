...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Kultuvrra-norggaoahpisteami-ja-protokollaossodat/Ealahusovddideami-ja-arvobuvttadeami-sekuvdna.html?id=87017'"/>
...
<xsl:variable name="para_nob" select="'naeringslivsseksjonen.html?id=87017'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="naeringslivsseksjonen_id_87017.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
