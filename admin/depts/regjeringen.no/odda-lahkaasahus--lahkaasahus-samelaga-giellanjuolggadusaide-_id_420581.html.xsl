...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/dokumeanttat/lover_regler/reglement/2003/Odda-lahkaasahus--Lahkaasahus-samelaga-giellanjuolggadusaide-.html?id=420581'"/>
<xsl:variable name="title" select="'Odda láhkaásahus  Láhkaásahus sámelága giellanjuolggadusaide  - regjeringen.no'"/>
