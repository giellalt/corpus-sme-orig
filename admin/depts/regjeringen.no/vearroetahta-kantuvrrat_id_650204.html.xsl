...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aigeguovdil/sartnit-ja-artihkkalat/taler_og_artikler_av_ovrig_politisk_lede/statssekretaer_schjerva/2011/vearroetahta-kantuvrrat.html?id=650204'"/>
...
<xsl:variable name="para_nob" select="'skatteetatens-kontorstruktur.html_id=650204'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skatteetatens-kontorstruktur_id_650204.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
