...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/4/6.html?id=452385'"/>
<xsl:variable name="title" select="'4.6 Guottut ja diehtojuohkin - regjeringen.no'"/>
