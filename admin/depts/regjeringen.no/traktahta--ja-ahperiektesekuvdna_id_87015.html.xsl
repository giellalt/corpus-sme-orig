...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Riekteossodat/Traktahta--ja-ahperiektesekuvdna.html?id=87015'"/>
...
<xsl:variable name="para_nob" select="'traktat_havrett.html?id=87015'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="traktat_havrett_id_87015.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
