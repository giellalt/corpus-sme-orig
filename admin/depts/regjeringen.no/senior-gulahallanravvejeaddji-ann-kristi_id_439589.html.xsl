...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/gulahallanovttadat/senior-gulahallanravvejeaddji-ann-kristi.html?id=439589'"/>
