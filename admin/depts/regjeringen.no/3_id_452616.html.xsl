...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/3-2/3.html?id=452616'"/>
<xsl:variable name="title" select="'3.3 Sámedikki válgaortnet - regjeringen.no'"/>
