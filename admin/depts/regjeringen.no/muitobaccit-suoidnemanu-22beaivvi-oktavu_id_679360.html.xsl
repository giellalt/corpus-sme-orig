...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/muitobaccit-suoidnemanu-22beaivvi-oktavu.html?id=679360'"/>
...
<xsl:variable name="para_nob" select="'minnesmerker-22-juli.html_id=679360'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minnesmerker-22-juli_id_679360.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
