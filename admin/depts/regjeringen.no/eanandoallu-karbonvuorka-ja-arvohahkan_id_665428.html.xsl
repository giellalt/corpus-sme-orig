...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/pressesenter/pressemeldinger/2011/eanandoallu-karbonvuorka-ja-arvohahkan.html?id=665428'"/>
...
<xsl:variable name="para_nob" select="'skogbruket-karbonlager-og-verdiskaping.html_id=665428'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skogbruket-karbonlager-og-verdiskaping_id_665428.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
