...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Sartnit-ja-allosat/ministeren/landbruks--og-matminister-lars-peder-bre/2012/nissonat--oavdda-borramusihkarvuhtii-ja-.html?id=673241'"/>
...
<xsl:variable name="para_nob" select="'kronikk-kvinner--nokkel-til-matsikkerhet.html_id=673241'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kronikk-kvinner--nokkel-til-matsikkerhet_id_673241.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
