...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/raehus-rahkadahtta-samegiela-doaibmaplan.html?id=514922'"/>
...
<xsl:variable name="para_nob" select="'regjeringen-utarbeider-handlingsplan-for.html?id=514922'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringen-utarbeider-handlingsplan-for_id_514922.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
