...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/bld/Preassaguovdda/pressemeldinger/2008/heterofiila-ja-homofiila-paraid-oktasa-n.html?id=504116'"/>
...
<xsl:variable name="para_nob" select="'felles-ekteskapslov-for-heterofile-og-ho.html?id=504116'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="felles-ekteskapslov-for-heterofile-og-ho_id_504116.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
