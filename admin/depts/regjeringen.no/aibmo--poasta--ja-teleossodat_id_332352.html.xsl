...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/sd/Departemeantta-birra/Organisauvdna/Ossodagat/Aibmo--poasta--ja-teleossodat.html?id=332352'"/>
