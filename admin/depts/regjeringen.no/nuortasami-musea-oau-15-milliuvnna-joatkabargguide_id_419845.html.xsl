...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2006/-Nuortasami-musea-oau-15-milliuvnna-joatkabargguide.html?id=419845'"/>
<xsl:variable name="title" select="'Nuortasámi musea oažžu 1,5 milliuvnna joatkabargguide - regjeringen.no'"/>
