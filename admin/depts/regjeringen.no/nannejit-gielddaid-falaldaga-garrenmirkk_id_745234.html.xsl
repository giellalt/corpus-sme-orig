...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/hod/pressesenter/pressemeldinger/2013/nannejit-gielddaid-falaldaga-garrenmirkk.html?id=745234'"/>
...
<xsl:variable name="para_nob" select="'styrker-tilbudet-til-rusavhengige-i-komm.html_id=745234'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="styrker-tilbudet-til-rusavhengige-i-komm_id_745234.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
