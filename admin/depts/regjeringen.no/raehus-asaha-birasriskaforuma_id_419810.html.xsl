...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2006/Raehus-asaha-birasriskaforuma.html?id=419810'"/>
<xsl:variable name="title" select="'Ráđđehus ásaha birasriskaforuma - regjeringen.no'"/>
