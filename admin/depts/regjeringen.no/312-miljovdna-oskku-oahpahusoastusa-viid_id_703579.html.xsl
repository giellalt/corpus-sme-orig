...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2012/312-miljovdna-oskku-oahpahusoastusa-viid.html?id=703579'"/>
...
<xsl:variable name="para_nob" select="'312-millioner-til-opptrapping-av-trosopp.html_id=703579'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="312-millioner-til-opptrapping-av-trosopp_id_703579.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
