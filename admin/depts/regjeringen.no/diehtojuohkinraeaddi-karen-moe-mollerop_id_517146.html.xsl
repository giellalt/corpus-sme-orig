...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/diehtojuohkinovttadat-/diehtojuohkinraeaddi-karen-moe-mollerop.html?id=517146'"/>
...
<xsl:variable name="para_nob" select="'informasjonsradgiver-karen-moe-mollerop.html?id=517146'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="informasjonsradgiver-karen-moe-mollerop_id_517146.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
