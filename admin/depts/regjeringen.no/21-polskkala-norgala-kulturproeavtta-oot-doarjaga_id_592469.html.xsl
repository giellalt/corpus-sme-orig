...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/21-polskkala-norgala-kulturproeavtta-oot-doarjaga.html?id=592469'"/>
...
<xsl:variable name="para_nob" select="'21-polsk-norske-kulturprosjekter-far-stotte.html?id=592469'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="21-polsk-norske-kulturprosjekter-far-stotte_id_592469.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
