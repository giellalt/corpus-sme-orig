...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/minister/arbeids--og-inkluderingsminister-bjarne-/2006/historjjala-beaivi-finnmarkkus.html?id=450276'"/>
<xsl:variable name="title" select="'Historjjálaš beaivi Finnmárkkus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'717'"/>
