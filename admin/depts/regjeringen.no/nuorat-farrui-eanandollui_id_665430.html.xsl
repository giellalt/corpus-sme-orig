...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/pressesenter/pressemeldinger/2011/nuorat-farrui-eanandollui.html?id=665430'"/>
...
<xsl:variable name="para_nob" select="'ungdom-inn-i-landbruket-.html_id=665430'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ungdom-inn-i-landbruket-_id_665430.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
