...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/Departemeantta-birra/Organisauvdna/Ossodagat/halddahusossodat/Bueahtta-ja-ekonomiija.html?id=86862'"/>
