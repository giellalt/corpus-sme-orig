...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/preassaguovdda/pressemeldinger/2012/edag-alkidahtta-ealahusaid-barggu.html?id=682401'"/>
...
<xsl:variable name="para_nno" select="'enklare-for-naringslivet-med-edag.html_id=682401'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="enklare-for-naringslivet-med-edag_id_682401.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
