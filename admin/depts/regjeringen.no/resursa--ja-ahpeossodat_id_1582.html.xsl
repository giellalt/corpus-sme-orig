...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Departemeanta-birra/Organisauvdna/Departemeantta-ossodagat/resursa--ja-ahpeossodat.html?id=1582'"/>
