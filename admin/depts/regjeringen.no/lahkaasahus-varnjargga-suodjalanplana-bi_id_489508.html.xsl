...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/lagat-ja-lahkaasahusat/lahkaasahusat/2006/lahkaasahus-varnjargga-suodjalanplana-bi.html?id=489508'"/>
<xsl:variable name="title" select="'Láhkaásahus Várnjárgga suodjalanplána birra. Várnjárgga álbmotmeahci suodjaleapmi Báhcavuona, Unjárgga, Čáhcesullo ja Várggáid gielddain Finnmárkku fylkkas. - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1363'"/>
