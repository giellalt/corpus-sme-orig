...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/17/2/2.html?id=458641'"/>
<xsl:variable name="title" select="'17.2.2 Dagaldusat ráđđádallamii ... - regjeringen.no'"/>
