...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Riekteossodat.html?id=1528'"/>
...
<xsl:variable name="para_nob" select="'rettsavdelingen.html?id=1528'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rettsavdelingen_id_1528.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
