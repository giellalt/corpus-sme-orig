...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/2/10.html?id=565725'"/>
<xsl:variable name="title" select="'2.10 Areála- ja biraspolitihkka - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1942'"/>
