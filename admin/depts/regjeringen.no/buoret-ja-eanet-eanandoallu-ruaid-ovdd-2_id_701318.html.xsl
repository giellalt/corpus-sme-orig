...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/pressesenter/pressemeldinger/2012/buoret-ja-eanet-eanandoallu-ruaid-ovdd-2.html?id=701318'"/>
...
<xsl:variable name="para_nob" select="'mer-og-bedre-landbruk-for-pengene.html_id=701318'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mer-og-bedre-landbruk-for-pengene_id_701318.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
