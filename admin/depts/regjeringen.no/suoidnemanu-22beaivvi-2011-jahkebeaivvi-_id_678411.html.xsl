...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/suoidnemanu-22beaivvi-2011-jahkebeaivvi-.html?id=678411'"/>
...
<xsl:variable name="para_nob" select="'markering-av-ettarsdagen-for-22-juli-201.html_id=678411'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="markering-av-ettarsdagen-for-22-juli-201_id_678411.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
