...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2010/Sameministtar-galleda-Finnmarkku.html?id=592292'"/>
...
<xsl:variable name="para_nob" select="'Sameministeren-besoker-Finnmark.html?id=592292'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sameministeren-besoker-finnmark_id_592292.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
