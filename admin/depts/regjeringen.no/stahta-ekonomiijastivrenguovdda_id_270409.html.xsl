...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/Departemeantta-birra/Vuollasa-asahusat/Stahta-ekonomiijastivrenguovdda.html?id=270409'"/>
