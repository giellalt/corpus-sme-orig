...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/2-2/4/1.html?id=452578'"/>
<xsl:variable name="title" select="'2.4.1 Oahpponeavvoráhkadeapmi - regjeringen.no'"/>
