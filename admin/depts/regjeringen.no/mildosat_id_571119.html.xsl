...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/Mildosat.html?id=571119'"/>
...
<xsl:variable name="para_nob" select="'vedlegg.html?id=571119'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vedlegg_id_571119.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
