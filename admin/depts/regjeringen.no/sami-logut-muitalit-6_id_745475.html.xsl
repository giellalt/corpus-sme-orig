...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dokumeanttat/raporttat-ja-planat/raporttat/2013/sami-logut-muitalit-6.html?id=745475'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samiske-tall-forteller-6_id_745475.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
