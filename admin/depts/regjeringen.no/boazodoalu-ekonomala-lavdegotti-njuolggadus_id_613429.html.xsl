...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Lagat-ja-njuolggadusat-/retningslinjer/2006-2001/Boazodoalu-Ekonomala-Lavdegotti-njuolggadus.html?id=613429'"/>
...
<xsl:variable name="para_nno" select="'instruks-for-okonomisk-utvalg-for-reindr.html?id=613429'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="instruks-for-okonomisk-utvalg-for-reindr_id_613429.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
