...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/2.html?id=514682'"/>
<xsl:variable name="title" select="'2.2 Ovttasbargu - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1690'"/>
