...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Fadda-/Ealahagat-/uforepensjon/Bargonavccahisvuoaealahat-.html?id=85999'"/>
...
<xsl:variable name="para_nob" select="'uforepensjon.html?id=85999'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="uforepensjon_id_85999.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
