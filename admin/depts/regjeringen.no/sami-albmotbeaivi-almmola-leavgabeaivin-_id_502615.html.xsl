...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Raporttat-ja-planat/Raporttat-/2003/sami-albmotbeaivi-almmola-leavgabeaivin-.html?id=502615'"/>
...
<xsl:variable name="para_nob" select="'samefolkets-dag-som-offisiell-flaggdag.html?id=502615'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samefolkets-dag-som-offisiell-flaggdag_id_502615.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
