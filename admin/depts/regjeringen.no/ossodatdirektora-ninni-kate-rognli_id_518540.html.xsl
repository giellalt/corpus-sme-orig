...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/same--og-minoritetspolitisk-avdeling/ossodatdirektora-ninni-kate-rognli.html?id=518540'"/>
...
<xsl:variable name="para_nob" select="'ninni-kate-rognli.html?id=518540'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ninni-kate-rognli_id_518540.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
