...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Lavdegoddi-osko--ja-eallinoaidnopolitihkkii-vuouduvvon.html?id=610291'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Lavdegoddi-osko--ja-eallinoaidnopolitihkkii-vuouduvvon.html?id=610291'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Lávdegoddi osko- ja eallinoaidnopolitihkkii vuođđuduvvon - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'utvalg-for-tros--og-livssynspolitikken-n.html?id=610291'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utvalg-for-tros--og-livssynspolitikken-n_id_610291.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
