...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/6/7.html?id=565845'"/>
<xsl:variable name="title" select="'2.7 Sámi vuoigatvuođaid... - regjeringen.no'"/>
