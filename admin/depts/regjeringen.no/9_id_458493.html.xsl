...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/9.html?id=458493'"/>
<xsl:variable name="title" select="'9 Sámi mánáid ja nuoraid... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'3005'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="9_id_325898.html" xml:lang="nob"/>
</xsl:variable>
