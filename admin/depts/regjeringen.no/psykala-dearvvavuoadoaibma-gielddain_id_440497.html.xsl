...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/hod/tema/psykala-dearvvavuohta/psykala-dearvvavuoadoaibma-gielddain.html?id=440497'"/>
...
<xsl:variable name="para_nob" select="'psykisk-helsearbeid-i-kommunene-.html?id=440497'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="psykisk-helsearbeid-i-kommunene-_id_440497.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
