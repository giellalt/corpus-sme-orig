...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Aigecallagat-ja-odasreivvet/2007/Oasat-samepolitihkas-nr-1-2007-2.html?id=476362'"/>
...
<xsl:variable name="para_nob" select="'nytt-om-samepolitikken-nr-1-2007-2.html?id=476362'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nytt-om-samepolitikken-nr-1-2007-2_id_476362.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
