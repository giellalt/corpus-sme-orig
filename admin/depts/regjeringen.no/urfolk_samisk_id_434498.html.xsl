...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/fadda/mr_samisk/urfolk_samisk.html?id=434498'"/>
...
<xsl:variable name="para_nob" select="'menneskerettigheter-urfolk.html?id=434498'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="menneskerettigheter-urfolk_id_434498.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
