...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/atnaseaddji-doaimmahusat/norgga-ealahuseallima-fora.html?id=85821'"/>
...
<xsl:variable name="para_nob" select="'norsk_arbeidslivsforum.html?id=85821'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norsk_arbeidslivsforum_id_85821.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
