...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Departemeanta-birra/Vuollasa-asahusat/Mearraduktaninstituhtta-Havforskningsinstituttet-.html?id=115321'"/>
