...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2012/arvala-nannet-mearradoallobearraigeahu.html?id=701234'"/>
...
<xsl:variable name="para_nob" select="'foreslar-a-styrke-havbrukstilsynet.html_id=701234'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="foreslar-a-styrke-havbrukstilsynet_id_701234.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
