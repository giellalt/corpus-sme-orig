...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/9/2.html?id=452535'"/>
<xsl:variable name="title" select="'4.9.2 Dásseárvohástalusat - regjeringen.no'"/>
