...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/319-miljovnna-eanet-romsii-boahtte-jahka.html?id=619763'"/>
...
<xsl:variable name="para_nno" select="'319-millionar-meir-til-Troms-neste-ar.html?id=619763'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="319-millionar-meir-til-troms-neste-ar_id_619763.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
