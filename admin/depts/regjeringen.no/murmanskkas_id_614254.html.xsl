...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2010/murmanskkas.html?id=614254'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2010/murmanskkas.html?id=614254'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Šiehtadus rádjageassima ja ovttasbarggu birra Barentsábis ja Buollaábis lea vuolláičállojuvvon - regjeringen.no'"/>
