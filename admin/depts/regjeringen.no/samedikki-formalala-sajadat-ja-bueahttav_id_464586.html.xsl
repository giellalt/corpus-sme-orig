...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Raporttat-ja-planat/Raporttat-/2007/Samedikki-formalala-sajadat-ja-bueahttav.html?id=464586'"/>
...
<xsl:variable name="para_nob" select="'sametingets-formelle-stilling-og-budsjet.html?id=464586'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sametingets-formelle-stilling-og-budsjet_id_464586.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
