...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/hod/pressesenter/pressemeldinger/2014/nissonolbmo-vuoigatvuoat-lea-dehaleamos-.html?id=749551'"/>
...
<xsl:variable name="para_nob" select="'kvinnens-rettigheter-viktigst-i-reservas.html_id=749551'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kvinnens-rettigheter-viktigst-i-reservas_id_749551.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
