...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/ruhtaalmmuheapmi-ovttasbargoproeavttaide.html?id=732089'"/>
...
<xsl:variable name="para_nob" select="'utlysning-av-midler-til-samarbeidsprosje.html_id=732089'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utlysning-av-midler-til-samarbeidsprosje_id_732089.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
