...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/filbmaagiruan-joatkauvva-2013s.html?id=701347'"/>
...
<xsl:variable name="para_nno" select="'filmsatsinga-fortset-i-2013.html_id=701347'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="filmsatsinga-fortset-i-2013_id_701347.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
