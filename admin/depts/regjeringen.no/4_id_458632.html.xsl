...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/16/2/4.html?id=458632'"/>
<xsl:variable name="title" select="'16.2.4 Barentsovttasbargu - regjeringen.no'"/>
