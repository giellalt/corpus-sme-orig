...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/algopolitihkala-ossodat-/Barguiheivehansekuvdna.html?id=85787'"/>
...
<xsl:variable name="para_nob" select="'sau.html?id=85787'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sau_id_85787.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
