...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/aktuelt/nyheter/2012/kulturdepartemeanta-juohka-48-milj-ruvnn.html?id=708562'"/>
...
<xsl:variable name="para_nob" select="'kulturdepartementet-deler-ut-48-milll-kr.html_id=708562'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kulturdepartementet-deler-ut-48-milll-kr_id_708562.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
