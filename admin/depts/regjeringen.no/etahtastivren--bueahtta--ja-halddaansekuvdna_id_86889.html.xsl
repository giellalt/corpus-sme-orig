...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Regionala-gaaldagaid-ja-ovdaneami-ossodat/Etahtastivren--bueahtta--ja-halddaansekuvdna.html?id=86889'"/>
...
<xsl:variable name="para_nob" select="'etatsstyring.html?id=86889'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="etatsstyring_id_86889.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
