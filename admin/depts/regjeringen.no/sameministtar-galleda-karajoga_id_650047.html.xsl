...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2011/sameministtar-galleda-karajoga.html?id=650047'"/>
...
<xsl:variable name="para_nob" select="'sameministeren-besoker-karasjok1.html_id=650047'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sameministeren-besoker-karasjok1_id_650047.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
