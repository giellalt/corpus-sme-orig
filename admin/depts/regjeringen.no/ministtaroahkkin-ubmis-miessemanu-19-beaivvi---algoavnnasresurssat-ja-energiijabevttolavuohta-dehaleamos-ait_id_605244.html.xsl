...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/Aigeguovdil/nyheter/2009/Ministtaroahkkin-Ubmis-miessemanu-19-beaivvi---algoavnnasresurssat-ja-energiijabevttolavuohta-dehaleamos-ait.html?id=605244'"/>
...
<xsl:variable name="para_nob" select="'Ravareressurser-og-energieffektivitet-i-fokus.html?id=605244'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ravareressurser-og-energieffektivitet-i-fokus_id_605244.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
