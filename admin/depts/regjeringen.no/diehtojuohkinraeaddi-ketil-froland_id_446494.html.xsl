...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/diehtojuohkinovttadat-/diehtojuohkinraeaddi-ketil-froland.html?id=446494'"/>
...
<xsl:variable name="para_nob" select="'informasjonsradgiver-ketil-froland.html?id=446494'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="informasjonsradgiver-ketil-froland_id_446494.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
