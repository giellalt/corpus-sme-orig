...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/preassaguovdda/pressemeldinger/2012/preassakonferansa-2012-darkkistuvvon-nat.html?id=681969'"/>
...
<xsl:variable name="para_nob" select="'pressekonferanse-om-revidert-nasjonalbud.html_id=681969'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="pressekonferanse-om-revidert-nasjonalbud_id_681969.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
