...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Oskoservodagat-eai-galgga-adnojuvvot-friddjabaikin-Manaid-illasteapmi-galga-vaidojuvvot-politiijii.html?id=600861'"/>
...
<xsl:variable name="para_nob" select="'Trossamfunn-ingen-frisone-Overgrep-mot-barn-skal-politianmeldes-.html?id=600861'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="trossamfunn-ingen-frisone-overgrep-mot-barn-skal-politianmeldes-_id_600861.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
