...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2007/Raimo-Valle-same--ja-minoritehtaaiid-oa-.html?id=487114'"/>
...
<xsl:variable name="para_nob" select="'raimo-valle-ny-statssekretar-for-same--o.html?id=487114'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="raimo-valle-ny-statssekretar-for-same--o_id_487114.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
