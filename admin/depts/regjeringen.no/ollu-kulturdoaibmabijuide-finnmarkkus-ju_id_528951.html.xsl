...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2008/ollu-kulturdoaibmabijuide-finnmarkkus-ju.html?id=528951'"/>
...
<xsl:variable name="para_nno" select="'mange-kulturtiltak-i-finnmark-far-auka-s.html?id=528951'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mange-kulturtiltak-i-finnmark-far-auka-s_id_528951.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
