...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/aigeguovdil/Oasat/2012/gulahallanoahkkin-guskkola-suohkaniiguin.html?id=668232'"/>
...
<xsl:variable name="para_nob" select="'dialogmote-med-berorte-kommuner.html_id=668232'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dialogmote-med-berorte-kommuner_id_668232.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
