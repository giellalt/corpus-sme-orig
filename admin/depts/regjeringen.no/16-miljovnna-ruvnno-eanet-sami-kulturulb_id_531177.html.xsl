...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2008/16-miljovnna-ruvnno-eanet-sami-kulturulb.html?id=531177'"/>
...
<xsl:variable name="para_nob" select="'16-millioner-mer-til-samiske-kulturforma.html?id=531177'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="16-millioner-mer-til-samiske-kulturforma_id_531177.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
