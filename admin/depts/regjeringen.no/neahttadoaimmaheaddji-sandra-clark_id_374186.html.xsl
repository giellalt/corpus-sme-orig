...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/Departemeantta-birra/Organisauvdna/Ossodagat/Joiheaddjit--/Diehtojuohkinsekuvdna-/Neahttadoaimmaheaddji-Sandra-Clark.html?id=374186'"/>
...
<xsl:variable name="para_nob" select="'informasjonsradgiver-sandra-clark.html?id=374186'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="informasjonsradgiver-sandra-clark_id_374186.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
