...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/Preassaguovdda/pressemeldinger/2009/olbmuid-barggu-buorredilalavuoa-ja-birra.html?id=581554'"/>
...
<xsl:variable name="para_nob" select="'et-budsjett-for-arbeid-velferd-og-miljo.html?id=581554'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="et-budsjett-for-arbeid-velferd-og-miljo_id_581554.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
