...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/aigeguovdil/oddasat/2024/ohcamin-eanet-manaidgardeoahpaheddjiid-.html?id=751813'"/>
...
<xsl:variable name="para_nob" select="'jakten-pa-flere-barnehagelarere-fortsett.html_id=751813'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jakten-pa-flere-barnehagelarere-fortsett_id_751813.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
