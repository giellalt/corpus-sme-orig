...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/bld/Departemeantta-birra/Organisauvdna/Ossodagat/Ovttaseallin--ja-dassearvoossodat.html?id=82'"/>
