...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2011/Jan-11/Boazolohku-ferte-oasit-mearriduvvot.html?id=632195'"/>
...
<xsl:variable name="para_nob" select="'reintall-ma-fastsettes-pa-nytt.html?id=632195'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reintall-ma-fastsettes-pa-nytt_id_632195.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
