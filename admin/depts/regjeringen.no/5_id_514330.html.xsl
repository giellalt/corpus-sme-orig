...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/3/5.html?id=514330'"/>
<xsl:variable name="title" select="'3.5 Julevsápmelaččat - regjeringen.no'"/>
