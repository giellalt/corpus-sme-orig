...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Kultuvrra-norggaoahpisteami-ja-protokollaossodat/Galledansekuvdna.html?id=87021'"/>
...
<xsl:variable name="para_nob" select="'besoksseksjonen.html?id=87021'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="besoksseksjonen_id_87021.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
