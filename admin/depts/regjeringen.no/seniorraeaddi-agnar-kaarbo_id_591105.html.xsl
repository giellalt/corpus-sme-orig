...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Departemeanta/Organisauvdna/avdelinger/kommunikasjonsenheten/Seniorraeaddi-Agnar-Kaarbo.html?id=591105'"/>
...
<xsl:variable name="para_nob" select="'agnar-kaarbo.html?id=591105'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="agnar-kaarbo_id_591105.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
