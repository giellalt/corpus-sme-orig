...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/179-miljovdna-lassaneapmi-finnmarkui-boa.html?id=619779'"/>
...
<xsl:variable name="para_nno" select="'179-millionar-meir-til-Finnmark-neste-ar.html?id=619779'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="179-millionar-meir-til-finnmark-neste-ar_id_619779.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
