...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/9.html?id=452410'"/>
<xsl:variable name="title" select="'9 Sámi guovlluid riektedilli... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1084'"/>
