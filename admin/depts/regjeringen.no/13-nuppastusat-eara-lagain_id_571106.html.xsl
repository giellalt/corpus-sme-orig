...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/13-Nuppastusat-eara-lagain.html?id=571106'"/>
...
<xsl:variable name="para_nob" select="'13-endringer-i-andre-lover-35-1.html?id=571106'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="13-endringer-i-andre-lover-35-1_id_571106.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
