...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/IKT-politikka/Rabas-standarddat.html?id=1371'"/>
...
<xsl:variable name="para_nob" select="'apne-standarder.html?id=1371'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="apne-standarder_id_1371.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
