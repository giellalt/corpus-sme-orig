...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dokumeanttat/lagat-ja-njuolggadusat/njuolggadusat-/2011/lahkaasahus-2008-12-19-nr-1480-lahkaasah.html?id=646137'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Láhkaásahus 2008-12-19 nr 1480: Láhkaásahus sámediggeválgga birra  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'8029'"/>
...
<xsl:variable name="para_nob" select="'rundskriv-om-endringer-i-forskrift-om-va.html_id=646651'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rundskriv-om-endringer-i-forskrift-om-va.html_id=646651" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
