...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2009-2/oa-mahttoprogramma-geasuhan-dihtii-oa-as.html?id=555684'"/>
...
<xsl:variable name="para_nno" select="'nytt-kunnskapsprogram-for-auka-bulyst.html?id=555684'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nytt-kunnskapsprogram-for-auka-bulyst_id_555684.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
