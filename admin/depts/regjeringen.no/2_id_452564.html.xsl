...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/2-2/2.html?id=452564'"/>
<xsl:variable name="title" select="'2.2 Sámedikki rolla servodagas - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2062'"/>
...
=======
               ...
               <xsl:with-param name="replacement" select="'ŧ/'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
