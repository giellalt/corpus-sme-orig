...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/10/3.html?id=514727'"/>
<xsl:variable name="title" select="'2.10.3 Eanandoallu - regjeringen.no'"/>
