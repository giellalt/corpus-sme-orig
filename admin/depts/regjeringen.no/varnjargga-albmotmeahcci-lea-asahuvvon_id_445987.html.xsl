...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Preassaguovdda/Preassadieahusat/2006/-Varnjargga-albmotmeahcci-lea-asahuvvon.html?id=445987'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Várnjárgga álbmotmeahcci lea ásahuvvon - regjeringen.no'"/>
    <!--
