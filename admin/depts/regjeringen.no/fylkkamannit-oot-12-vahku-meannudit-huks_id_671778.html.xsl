...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/Preassadieahusat/2012/fylkkamannit-oot-12-vahku-meannudit-huks.html?id=671778'"/>
...
<xsl:variable name="para_nno" select="'fylkesmennene-far-12-veker-pa-a-handsame.html_id=671778'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fylkesmennene-far-12-veker-pa-a-handsame_id_671778.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
