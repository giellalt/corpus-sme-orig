...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/aktuelt/nyheter/nyheter-2008/mearraresursalahka-samegillii.html?id=535755'"/>
...
<xsl:variable name="para_nno" select="'havressurslova-omsett-til-samisk.html?id=535755'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="havressurslova-omsett-til-samisk_id_535755.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
