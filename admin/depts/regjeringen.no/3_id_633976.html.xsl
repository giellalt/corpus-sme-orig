...
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/ad/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/3.html?id=633976'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'2 Sámi servodaga máŋggabealatvuohta'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="3_id_512841.html" xml:lang="nob"/>
</xsl:variable>
