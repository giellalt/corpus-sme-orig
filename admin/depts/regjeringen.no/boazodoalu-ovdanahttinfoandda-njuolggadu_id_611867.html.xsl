...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Lagat-ja-njuolggadusat-/Lahkaasahusat/2010/boazodoalu-ovdanahttinfoandda-njuolggadu.html?id=611867'"/>
...
<xsl:variable name="para_nob" select="'forskrift-for-reindriftens-utviklingsfon.html?id=611867'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-for-reindriftens-utviklingsfon_id_611867.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
