...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/1.html?id=514291'"/>
<xsl:variable name="title" select="'Čoahkkáigeassu - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'4596'"/>
