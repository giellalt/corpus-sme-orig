...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/8/7.html?id=514393'"/>
<xsl:variable name="title" select="'8.7 Sámi kulturmuitohálddašeami... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1365'"/>
