...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/pressesenter/pressemeldinger/2007/Nuvtta-fruvttat-ja-ruotnasat.html?id=466736'"/>
...
<xsl:variable name="para_nob" select="'forsok-med-skolemat-pa-ungdomstrinnet-.html?id=466736'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forsok-med-skolemat-pa-ungdomstrinnet-_id_466736.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
