...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/it-politihkala-ossodat/Ekspediuvdnahoavda-Lars-Henrik-Myrmel-Johansen.html?id=450412'"/>
...
<xsl:variable name="para_nob" select="'konstituert-ekspedisjonssjef-lars-henrik.html?id=450412'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="konstituert-ekspedisjonssjef-lars-henrik_id_450412.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
