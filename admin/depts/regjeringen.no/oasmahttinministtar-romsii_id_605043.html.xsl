...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/nyheter/2010/Oasmahttinministtar-Romsii.html?id=605043'"/>
...
<xsl:variable name="para_nob" select="'Fornyingsministeren-besoker-Tromso.html?id=605043'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fornyingsministeren-besoker-tromso_id_605043.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
