...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2011/--dehala-oahppat-vai-sahtta-buoridit-boa/suoidnemanu-22beaivve-kommiuvdna--stahta.html?id=652339'"/>
...
<xsl:variable name="para_nob" select="'22-juli-kommisjonen---statsministerens-i.html_id=652339'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="22-juli-kommisjonen---statsministerens-i_id_652339.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
