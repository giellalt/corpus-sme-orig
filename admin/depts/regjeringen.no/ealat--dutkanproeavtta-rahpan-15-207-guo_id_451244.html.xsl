...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/tidligere_statssekretar_berit_oskal_eira/2007/EALAT--dutkanproeavtta-rahpan-15-207-Guo.html?id=451244'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/tidligere_statssekretar_berit_oskal_eira/2007/EALAT--dutkanproeavtta-rahpan-15-207-Guo.html?id=451244'"/>
...
<xsl:variable name="para_nob" select="'apningen-av-forskningsprosjektet-ealat--.html?id=451244'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="apningen-av-forskningsprosjektet-ealat--_id_451244.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
