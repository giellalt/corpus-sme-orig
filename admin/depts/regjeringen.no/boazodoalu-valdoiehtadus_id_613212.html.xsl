...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Lagat-ja-njuolggadusat-/retningslinjer/2006-2001/Boazodoalu-valdoiehtadus.html?id=613212'"/>
...
<xsl:variable name="para_nob" select="'hovedavtale-for-reindriften.html?id=613212'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hovedavtale-for-reindriften_id_613212.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
