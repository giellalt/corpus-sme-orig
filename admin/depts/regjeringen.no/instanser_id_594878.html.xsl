...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/horinger/horingsdokumenter/2009/Riikkaidgaskasa-boazodoalloguovdda--evttohus-rievdadit/Instanser.html?id=594878'"/>
...
<xsl:variable name="para_nob" select="'Horingsinstanser.html?id=594878'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horingsinstanser_id_594878.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
