...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/mo-lea-eallit-sapmelaan-gavpogis-.html?id=568012'"/>
...
<xsl:variable name="para_nob" select="'hvordan-er-det-a-vare-same-i-byen-.html?id=568012'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hvordan-er-det-a-vare-same-i-byen-_id_568012.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
