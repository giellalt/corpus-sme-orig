...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/ruhtaspealuid-ekspeartajoavku.html?id=731706'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekspertgruppe-pa-pengespel_id_731706.html" xml:lang="nno"/>
</xsl:variable>
