...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/710-miljovnna-navi.html?id=550442'"/>
...
<xsl:variable name="para_nob" select="'710-millioner-til-nav.html?id=550442'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="710-millioner-til-nav_id_550442.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
