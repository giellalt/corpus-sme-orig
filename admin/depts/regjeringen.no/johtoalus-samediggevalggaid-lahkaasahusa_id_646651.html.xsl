...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dokumeanttat/johtoallosat/2011/johtoalus-samediggevalggaid-lahkaasahusa.html?id=646651'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rundskriv-om-endringer-i-forskrift-om-va_id_646651.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
