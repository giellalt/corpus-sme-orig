...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/Bargomarkanossodat-/Juridihkala-ja-riikkaidgaskasa-sekuvdna-.html?id=85775'"/>
...
<xsl:variable name="para_nob" select="'juridisk_og_internasjonal_seksjon.html?id=85775'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="juridisk_og_internasjonal_seksjon_id_85775.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
