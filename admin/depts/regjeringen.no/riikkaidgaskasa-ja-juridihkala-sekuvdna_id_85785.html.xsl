...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/Ealahatossodat/Riikkaidgaskasa-ja-juridihkala-sekuvdna.html?id=85785'"/>
...
<xsl:variable name="para_nob" select="'internasjonal_og_juridisk_seksjon.html?id=85785'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="internasjonal_og_juridisk_seksjon_id_85785.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
