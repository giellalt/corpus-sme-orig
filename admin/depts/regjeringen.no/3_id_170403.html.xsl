...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/dokumeanttat/proposiuvnnat-ja-dieahusat/otprp/20012002/od-prp-nr-114_2001-2002/2/3/3.html?id=170403'"/>
<xsl:variable name="title" select="'2.3.3 Sámi gielat - regjeringen.no'"/>
