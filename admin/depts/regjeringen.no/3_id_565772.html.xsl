...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/2/17/3.html?id=565772'"/>
<xsl:variable name="title" select="'2.17.3 Duodji - regjeringen.no'"/>
