...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dokumeantavuorka/stoltenberg-ii/bargo--ja-searvadahttindepartemeanta/andre-dokumenter/personer/2005/bargo--ja-searvadahttinministtar-bjarne-.html?id=1326'"/>
    ...
    <xsl:variable name="author1_ln" select="'Bargo- ja searvadahttindepartemeanta'"/>
    <!-- m, f or unknown -->
