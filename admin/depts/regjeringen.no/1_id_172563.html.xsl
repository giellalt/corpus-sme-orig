...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/Odeldiggeproposiuvnnat/20022003/od-prp-nr-34_2002-2003/3/1.html?id=172563'"/>
<xsl:variable name="title" select="'Evttohus láhkii nuppástusa... - regjeringen.no'"/>
