...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/hod/pressesenter/pressemeldinger/2010/Galget-geahadit-njuolggadusaid-bakkoheami-birra-.html?id=606057'"/>
...
<xsl:variable name="para_nob" select="'Skal-gjennomga-regler-om-tvang.html?id=606057'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skal-gjennomga-regler-om-tvang_id_606057.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
