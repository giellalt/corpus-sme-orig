...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/girkoossodat.html?id=589414'"/>
...
<xsl:variable name="para_nob" select="'kirkeavdelingen.html?id=589414'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kirkeavdelingen_id_589414.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
