...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2013/falaldatgilvu-doaimmahit-digitala-poastt.html?id=728771'"/>
...
<xsl:variable name="para_nob" select="'anbudskonkurranse-digipost.html_id=728771'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="anbudskonkurranse-digipost_id_728771.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
