...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/halddahusossodat/Ekspediuvdnahoavda-Nils-A-Dugstad.html?id=450413'"/>
...
<xsl:variable name="para_nob" select="'fung-ekspedisjonssjef-kari-metliaas.html?id=450413'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fung-ekspedisjonssjef-kari-metliaas_id_450413.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
