...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/a-nameoverskrift1-milajon-ruvnnu-eanet-m.html?id=624689'"/>
...
<xsl:variable name="para_nob" select="'1-million-kroner-ekstra-til-ski-vms-friv.html?id=624689'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="1-million-kroner-ekstra-til-ski-vms-friv_id_624689.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
