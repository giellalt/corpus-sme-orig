...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/7-Darkileappot-planamearradusaid-birra.html?id=571096'"/>
...
<xsl:variable name="para_nob" select="'7-narmere-om-planbestemmelsene.html?id=571096'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="7-narmere-om-planbestemmelsene_id_571096.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
