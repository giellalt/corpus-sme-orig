...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2009/eanet-makidis-virgeluopmonjuolggadusat.html?id=550586'"/>
...
<xsl:variable name="para_nob" select="'mer-fleksible-permitteringsregler.html?id=550586'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mer-fleksible-permitteringsregler_id_550586.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
