...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valga-portal/stuorradiggevalga-2009/valgakoarta.html?id=570742'"/>
...
<xsl:variable name="para_nob" select="'valgkort.html?id=570742'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="valgkort_id_570742.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
