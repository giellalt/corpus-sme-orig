...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/10.html?id=452538'"/>
<xsl:variable name="title" select="'4.10 Riektedilit ja sámi... - regjeringen.no'"/>
