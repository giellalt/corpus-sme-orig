...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/21/4/7.html?id=514604'"/>
<xsl:variable name="title" select="'21.4.7 Guolástusaid davviguvllolaš... - regjeringen.no'"/>
