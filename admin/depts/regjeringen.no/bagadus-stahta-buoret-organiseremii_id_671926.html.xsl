...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/oasat/2012/bagadus-stahta-buoret-organiseremii.html?id=671926'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="veileder-organisering-staten_id_671926.html" xml:lang="nob"/>
</xsl:variable>
