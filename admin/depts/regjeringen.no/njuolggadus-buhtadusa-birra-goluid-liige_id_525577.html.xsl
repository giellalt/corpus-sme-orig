...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Lagat-ja-njuolggadusat-/Lahkaasahusat/2008/njuolggadus-buhtadusa-birra-goluid-liige.html?id=525577'"/>
...
<xsl:variable name="para_nob" select="'forskrift-om-kompensasjon-for-utgifter-m.html?id=525577'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-om-kompensasjon-for-utgifter-m_id_525577.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
