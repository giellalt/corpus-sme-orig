...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/guovllu--ja-regionalapolitihkka/Fitnodagaid-ja-ealahusdoaimmaid-ovdanahttin/Alggahit-fitnodagaidentreprenevravuohta-.html?id=530952'"/>
