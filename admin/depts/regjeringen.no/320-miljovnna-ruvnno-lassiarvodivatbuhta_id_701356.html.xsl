...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/320-miljovnna-ruvnno-lassiarvodivatbuhta.html?id=701356'"/>
...
<xsl:variable name="para_nno" select="'320-millionar-til-momskompensasjon-for-f.html_id=701356'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="320-millionar-til-momskompensasjon-for-f_id_701356.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
