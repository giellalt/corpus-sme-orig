...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/oed/pressesenter/pressemeldinger/2012/ielga-rammat-energiijapolitihkas.html?id=701228'"/>
...
<xsl:variable name="para_nob" select="'klare-rammer-for-energipolitikken.html_id=701228'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="klare-rammer-for-energipolitikken_id_701228.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
