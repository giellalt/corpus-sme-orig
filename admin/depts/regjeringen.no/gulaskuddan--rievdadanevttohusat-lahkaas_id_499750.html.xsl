...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/dokumeanttat/hoeringer/hoeringsdok/2008/Gulaskuddan--rievdadanevttohusat-lahkaas.html?id=499750'"/>
...
<xsl:variable name="para_nob" select="'horing---utkast-til-endringer-i-forskrif.html?id=499750'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horing---utkast-til-endringer-i-forskrif_id_499750.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
