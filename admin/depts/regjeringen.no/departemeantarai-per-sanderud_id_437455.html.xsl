...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/Departemeantta-birra/Organisauvdna/Ossodagat/Joiheaddjit--/Departemeanttarai-kantuvra/Departemeantarai-Per-Sanderud.html?id=437455'"/>
...
<xsl:variable name="para_nob" select="'departementsrad-per-sanderud.html?id=437455'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departementsrad-per-sanderud_id_437455.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
