...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/harta-allaskuvla---29-milj-ruvnno-.html?id=612737'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/harta-allaskuvla---29-milj-ruvnno-.html?id=612737'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Hárštá allaskuvla - 2,9 milj. ruvnno  - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'29-millioner-kroner-til-hogskolen-i-hars.html?id=612737'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="29-millioner-kroner-til-hogskolen-i-hars_id_612737.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
