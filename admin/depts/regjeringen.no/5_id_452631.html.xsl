...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/3-2/7/5.html?id=452631'"/>
<xsl:variable name="title" select="'3.7.5 Sámi media - regjeringen.no'"/>
