...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/aktuelt/nyheter/2014/nannejuvvon-ovttasbargguin-eastadit-dope.html?id=750447'"/>
...
<xsl:variable name="para_nob" select="'styrket-samarbeid-mot-doping.html_id=750447'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="styrket-samarbeid-mot-doping_id_750447.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
