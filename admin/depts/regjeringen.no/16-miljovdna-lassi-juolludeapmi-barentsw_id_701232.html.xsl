...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2012/16-miljovdna-lassi-juolludeapmi-barentsw.html?id=701232'"/>
...
<xsl:variable name="para_nob" select="'16-millionar-kroner-i-auka-loyving-til-b.html_id=701232'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="16-millionar-kroner-i-auka-loyving-til-b_id_701232.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
