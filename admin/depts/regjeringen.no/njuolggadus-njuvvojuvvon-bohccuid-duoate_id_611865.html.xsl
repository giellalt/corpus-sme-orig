...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Lagat-ja-njuolggadusat-/Lahkaasahusat/2010/njuolggadus-njuvvojuvvon-bohccuid-duoate.html?id=611865'"/>
...
<xsl:variable name="para_nob" select="'forskrift-om-rapportering-av-slaktet-rei.html?id=611865'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-om-rapportering-av-slaktet-rei_id_611865.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
