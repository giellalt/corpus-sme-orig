...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/preassaguovdda/Preassadieahusat/2012/badjel-logi-proseantta-lassaneapmi-biras.html?id=704168'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Badjel logi proseantta lassáneapmi Birasgáhttendepartemeantta bušeahtas - regjeringen.no'"/>
