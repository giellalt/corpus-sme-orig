...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Stahta-stipeanddaid-juohkin-vuorrasat-anssaeaddji-daiddariidda.html?id=599483'"/>
...
<xsl:variable name="para_nob" select="'Tildeling-av-statens-stipend-for-eldre-fortjente-kunstnere.html?id=599483'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tildeling-av-statens-stipend-for-eldre-fortjente-kunstnere_id_599483.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
