...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/3/15/4.html?id=565827'"/>
<xsl:variable name="title" select="'3.15.4 Areálagažaldagat ... - regjeringen.no'"/>
