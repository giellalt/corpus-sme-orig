...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/sd/pressesenter/pressemeldinger/2012/dalkkadatdieahus-fievrridansuorggi-dalkk.html?id=679414'"/>
...
<xsl:variable name="para_nob" select="'klimameldingen-reduserte-klimagassutslip.html_id=679414'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="klimameldingen-reduserte-klimagassutslip_id_679414.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
