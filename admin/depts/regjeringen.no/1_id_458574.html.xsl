...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/13/1.html?id=458574'"/>
<xsl:variable name="title" select="'13.1 Riikkaidgaskasaš... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1067'"/>
