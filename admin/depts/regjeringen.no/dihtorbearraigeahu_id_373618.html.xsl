...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/dihtorbearraigeahu.html?id=373618'"/>
...
<xsl:variable name="para_nob" select="'datatilsynet.html?id=373618'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="datatilsynet_id_373618.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
