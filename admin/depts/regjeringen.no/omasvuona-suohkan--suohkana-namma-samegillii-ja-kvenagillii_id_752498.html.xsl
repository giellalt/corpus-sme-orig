...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kmd/aigeguovdil/Oasat/2014/Omasvuona-suohkan--suohkana-namma-samegillii-ja-kvenagillii.html?id=752498'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="storfjord-kommune--samisk-og-kvensk-navn-pa-kommunen-_id_752498.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
