...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/9/2/1.html?id=514403'"/>
<xsl:variable name="title" select="'9.2.1 Doaibmabijut maiguin... - regjeringen.no'"/>
