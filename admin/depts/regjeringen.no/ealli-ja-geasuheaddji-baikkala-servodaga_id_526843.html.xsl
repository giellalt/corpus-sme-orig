...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/guovllu--ja-regionalapolitihkka/ealli-ja-geasuheaddji-baikkala-servodaga.html?id=526843'"/>
...
<xsl:variable name="para_nob" select="'levende-og-attraktive-lokalsamfunn.html?id=526843'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="levende-og-attraktive-lokalsamfunn_id_526843.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
