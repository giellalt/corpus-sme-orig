...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2009-2/nannejuvvon-gielddat-servodatovddideaddj.html?id=555685'"/>
...
<xsl:variable name="para_nno" select="'forsterka-kommunar-som-samfunnsutviklar-.html?id=555685'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forsterka-kommunar-som-samfunnsutviklar-_id_555685.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
