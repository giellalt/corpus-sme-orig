...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/24/10/3.html?id=514673'"/>
<xsl:variable name="title" select="'1.10.3 Spesialistadearvvašvuođabálvalus - regjeringen.no'"/>
