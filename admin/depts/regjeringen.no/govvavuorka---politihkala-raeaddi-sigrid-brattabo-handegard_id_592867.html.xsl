...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/sd/Departemeantta-birra/Eara-politihkala-njunnoat/politihkala-raeaddi-sigrid-brattabo-hand/Govvavuorka---Politihkala-raeaddi-Sigrid-Brattabo-Handegard.html?id=592867'"/>
