...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/12/5/3.html?id=458559'"/>
<xsl:variable name="title" select="'12.5.3 Riddu Riđđu festivála - regjeringen.no'"/>
