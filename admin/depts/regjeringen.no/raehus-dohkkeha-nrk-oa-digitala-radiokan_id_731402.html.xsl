...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/raehus-dohkkeha-nrk-oa-digitala-radiokan.html?id=731402'"/>
...
<xsl:variable name="para_nob" select="'regjeringen-godkjenner-nrks-nye-digitale.html_id=731402'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringen-godkjenner-nrks-nye-digitale_id_731402.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
