...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/aigeguovdil/oasat/2014/kulturministtar-widvey-finai-romssas-guo.html?id=750659'"/>
...
<xsl:variable name="para_nob" select="'kulturministeren-besokte-troms-1-3-febru.html_id=750659'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kulturministeren-besokte-troms-1-3-febru_id_750659.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
