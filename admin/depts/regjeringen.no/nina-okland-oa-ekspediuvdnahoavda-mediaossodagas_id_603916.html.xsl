...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Nina-Okland-oa-ekspediuvdnahoavda-Mediaossodagas.html?id=603916'"/>
...
<xsl:variable name="para_nob" select="'Nina-Okland-ny-ekspedisjonssjef-i-Medieavdelingen.html?id=603916'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nina-okland-ny-ekspedisjonssjef-i-medieavdelingen_id_603916.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
