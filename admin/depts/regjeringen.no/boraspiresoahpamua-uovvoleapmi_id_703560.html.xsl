...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/preassaguovdda/Preassadieahusat/2012/boraspiresoahpamua-uovvoleapmi.html?id=703560'"/>
...
<xsl:variable name="para_nno" select="'oppfolging-av-rovviltforliket.html_id=703560'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="oppfolging-av-rovviltforliket_id_703560.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
