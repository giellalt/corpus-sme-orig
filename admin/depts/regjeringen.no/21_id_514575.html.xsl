...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/21.html?id=514575'"/>
<xsl:variable name="title" select="'20 Resursaávkkástallan ... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'29214'"/>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               ...
               <xsl:with-param name="target" select="'oa��žut/vejola��/árvoháhkanprogr��mmas/'"/>
               <xsl:with-param name="replacement" select="'oažžut/vejolaš/árvoháhkanprográmmas/'"/>
