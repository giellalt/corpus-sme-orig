...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Halddahusla-joihangoddi/-Departemeantarai-Karin-Moe-Roisland.html?id=450407'"/>
...
<xsl:variable name="para_nob" select="'departementsrad-karin-moe-roisland.html?id=450407'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departementsrad-karin-moe-roisland_id_450407.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
