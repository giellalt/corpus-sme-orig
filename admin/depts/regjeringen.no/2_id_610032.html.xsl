...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/2.html?id=610032'"/>
<xsl:variable name="title" select="'2 Sámedikki 2009 jahkedieđáhus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'18067'"/>
