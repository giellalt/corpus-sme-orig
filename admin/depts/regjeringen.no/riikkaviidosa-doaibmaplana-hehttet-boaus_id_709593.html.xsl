...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/riikkaviidosa-doaibmaplana-hehttet-boaus.html?id=709593'"/>
...
<xsl:variable name="para_nob" select="'nasjonal-handlingsplan-mot-kampfiksing-i.html_id=709593'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nasjonal-handlingsplan-mot-kampfiksing-i_id_709593.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
