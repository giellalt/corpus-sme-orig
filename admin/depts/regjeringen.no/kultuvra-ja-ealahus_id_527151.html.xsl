...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/guovllu--ja-regionalapolitihkka/ealli-ja-geasuheaddji-baikkala-servodaga/kultuvra-ja-ealahus.html?id=527151'"/>
...
<xsl:variable name="para_nob" select="'kultur-og-naring.html?id=527151'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kultur-og-naring_id_527151.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
