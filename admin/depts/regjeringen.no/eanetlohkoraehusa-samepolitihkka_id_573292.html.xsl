...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Raporttat-ja-planat/Raporttat-/2009/eanetlohkoraehusa-samepolitihkka.html?id=573292'"/>
...
<xsl:variable name="para_nob" select="'flertallsregjeringens-samepolitikk.html?id=573292'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="flertallsregjeringens-samepolitikk_id_573292.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
