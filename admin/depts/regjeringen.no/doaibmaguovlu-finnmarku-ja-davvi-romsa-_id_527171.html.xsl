...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/guovllu--ja-regionalapolitihkka/doaibmaguovlu-ja-njuolggadusat-/doaibmaguovlu-finnmarku-ja-davvi-romsa-.html?id=527171'"/>
