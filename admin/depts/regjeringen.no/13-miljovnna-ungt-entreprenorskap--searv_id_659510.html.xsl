...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/Preassadieahusat/2011/13-miljovnna-ungt-entreprenorskap--searv.html?id=659510'"/>
...
<xsl:variable name="para_nno" select="'13-millionar-til-ungt-entreprenorskap-.html_id=659510'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="13-millionar-til-ungt-entreprenorskap-_id_659510.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
