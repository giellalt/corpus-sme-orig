...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/IKT-politikka/uggabaddi/Mii-lea-uggabaddi.html?id=446965'"/>
...
<xsl:variable name="para_nob" select="'hva-er-bredband.html?id=446965'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hva-er-bredband_id_446965.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
