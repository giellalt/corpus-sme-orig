...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/--lihkku-loabat-suohkanii.html?id=578597'"/>
...
<xsl:variable name="para_nno" select="'--gratulerer-lavangen-kommune.html?id=578597'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gratulerer-lavangen-kommune_id_578597.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
