...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/6/3.html?id=458467'"/>
<xsl:variable name="title" select="'6.3 Nuortasámit/goltásámit - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'963'"/>
