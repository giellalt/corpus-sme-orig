...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/aktuelt/nyheter/2013/davviriikkat-nannejit-oktasa-heahtegearg.html?id=730716'"/>
...
<xsl:variable name="para_nob" select="'de-nordiske-landene-de-nordiske-landene-.html_id=730716'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="de-nordiske-landene-de-nordiske-landene-_id_730716.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
