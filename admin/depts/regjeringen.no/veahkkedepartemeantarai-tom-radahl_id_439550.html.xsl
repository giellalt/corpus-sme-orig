...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/Halddahusnjunugoddi-/Veahkkedepartemeantarai-Tom-Radahl.html?id=439550'"/>
