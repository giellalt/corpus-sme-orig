...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/same--og-minoritetspolitisk-avdeling/-Ekspediuvdnahoavda-Petter-Drefvelin.html?id=1454'"/>
