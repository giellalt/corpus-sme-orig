...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/halddahus--ja-dgt-direktorahta.html?id=440429'"/>
...
<xsl:variable name="para_nob" select="'difi.html?id=440429'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="difi_id_440429.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
