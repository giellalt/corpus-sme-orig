...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/24/2/1.html?id=514627'"/>
<xsl:variable name="title" select="'1.2.1 Guovllulaš ovttasbargu - regjeringen.no'"/>
