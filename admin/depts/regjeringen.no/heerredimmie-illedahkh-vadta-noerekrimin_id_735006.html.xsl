...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/20131/heerredimmie-illedahkh-vadta-noerekrimin.html?id=735006'"/>
...
<xsl:variable name="para_nob" select="'forebygging-gir-resultater-ungdomskrimin.html_id=735006'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forebygging-gir-resultater-ungdomskrimin_id_735006.html" xml:lang="nob"/>
