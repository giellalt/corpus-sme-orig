...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/Justisdepartementta-birra/Eara-politihkala-njunnoat/Stahtaalli-Terje-Moland-Pedersen.html?id=1695'"/>
    ...
    <xsl:variable name="author1_ln" select="'Justis- ja politidepartemeanta'"/>
    <!-- m, f or unknown -->
