...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/preassadoarjja-nuppastuvvo-mediadoarjjan.html?id=677308'"/>
...
<xsl:variable name="para_nob" select="'pressestotte-blir-mediestotte.html_id=677308'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pressestotte-blir-mediestotte_id_677308.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
