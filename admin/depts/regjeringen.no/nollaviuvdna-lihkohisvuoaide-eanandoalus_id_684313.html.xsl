...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2012/juni-12/nollaviuvdna-lihkohisvuoaide-eanandoalus.html?id=684313'"/>
...
<xsl:variable name="para_nno" select="'nullvisjon-for-ulukker-i-landbruket.html_id=684313'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nullvisjon-for-ulukker-i-landbruket_id_684313.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
