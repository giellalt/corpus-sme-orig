...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valga-portal/stuorradiggevalga-2009/legitimauvdna.html?id=570741'"/>
...
<xsl:variable name="para_nob" select="'legitimasjon.html?id=570741'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="legitimasjon_id_570741.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
