...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/6-2.html?id=452656'"/>
<xsl:variable name="title" select="'2 Sámediggi bargoaddin - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1514'"/>
