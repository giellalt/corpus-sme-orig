...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/5-miljovdna-ruvdno-loaktimii-bargosajiin.html?id=607299'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/5-miljovdna-ruvdno-loaktimii-bargosajiin.html?id=607299'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'5 miljovdna ruvdno loaktimii bargosajiin - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'5-millioner-kroner-til-okt-trivsel-pa-arbeidsplasser.html?id=607299'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="5-millioner-kroner-til-okt-trivsel-pa-arbeidsplasser_id_607299.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
