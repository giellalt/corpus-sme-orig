...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2009/logi-miljovnna-eambbo-sami-kulturulbmili.html?id=581351'"/>
...
<xsl:variable name="para_nob" select="'10-millioner-mer-til-samiske-kulturforma.html?id=581351'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="10-millioner-mer-til-samiske-kulturforma_id_581351.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
