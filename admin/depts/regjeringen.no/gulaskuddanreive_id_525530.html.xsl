...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Johtoallosat/Gulaskuddandokumeanta/2008/samediggevalga--lahkaasahus-samediggeval/gulaskuddanreive.html?id=525530'"/>
...
<xsl:variable name="para_nob" select="'horingsbrev.html?id=525530'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horingsbrev_id_525530.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
