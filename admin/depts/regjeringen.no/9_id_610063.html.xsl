...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/2/7/9.html?id=610063'"/>
<xsl:variable name="title" select="'2.7.9 Sámi museat - regjeringen.no'"/>
