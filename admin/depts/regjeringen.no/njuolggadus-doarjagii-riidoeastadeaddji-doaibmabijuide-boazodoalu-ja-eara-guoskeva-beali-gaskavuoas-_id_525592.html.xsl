...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Lagat-ja-njuolggadusat-/Lahkaasahusat/2008/Njuolggadus-doarjagii-riidoeastadeaddji-doaibmabijuide-boazodoalu-ja-eara-guoskeva-beali-gaskavuoas-.html?id=525592'"/>
...
<xsl:variable name="para_nob" select="'-forskrift-om-tilskudd-til-konfliktforeb.html?id=525592'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-om-tilskudd-til-konfliktforeb_id_525592.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
