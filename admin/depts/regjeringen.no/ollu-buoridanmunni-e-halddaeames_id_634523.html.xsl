...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2011/--ollu-buoridanmunni-e-halddaeames.html?id=634523'"/>
...
<xsl:variable name="para_nob" select="'--stort-rom-for-forbedringer-innen-e-for.html_id=634523'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stort-rom-for-forbedringer-innen-e-for_id_634523.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
