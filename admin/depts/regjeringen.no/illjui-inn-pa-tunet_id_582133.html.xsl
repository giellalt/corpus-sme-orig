...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Fadda/eanadoallu-ja-ealahusovddideapmi/illjui-inn-pa-tunet.html?id=582133'"/>
...
<xsl:variable name="para_nob" select="'inn-pa-tunet-2.html?id=582133'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="inn-pa-tunet-2_id_582133.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
