...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/6/7.html?id=514711'"/>
<xsl:variable name="title" select="'2.6.7 Rádjaofelaččat - regjeringen.no'"/>
