...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2011/Lavdegoddi-galga-guorahallat-raehusa-karantena-mearradusaid.html?id=631947'"/>
...
<xsl:variable name="para_nob" select="'utvalg-skal-gjennomga-regjeringens-karan.html?id=631947'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utvalg-skal-gjennomga-regjeringens-karan_id_631947.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
