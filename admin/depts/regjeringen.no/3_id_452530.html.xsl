...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/8/3.html?id=452530'"/>
<xsl:variable name="title" select="'4.8.3 Riddodorskebivdu Geahča... - regjeringen.no'"/>
