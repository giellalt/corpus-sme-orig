...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/12.html?id=461252'"/>
<xsl:variable name="title" select="'Evttohus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'7977'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="12_id_446578.html" xml:lang="nob"/>
</xsl:variable>
