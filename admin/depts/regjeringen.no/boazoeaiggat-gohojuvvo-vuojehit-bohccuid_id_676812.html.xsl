...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2012/mars-12/boazoeaiggat-gohojuvvo-vuojehit-bohccuid.html?id=676812'"/>
...
<xsl:variable name="para_nob" select="'reineier-palegges-a-drive-ut-reinen-fra-.html_id=676812'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reineier-palegges-a-drive-ut-reinen-fra-_id_676812.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
