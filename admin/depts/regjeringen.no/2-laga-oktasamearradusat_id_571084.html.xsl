...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/2-Laga-oktasamearradusat.html?id=571084'"/>
...
<xsl:variable name="para_nob" select="'2-lovens-fellesbestemmelser.html?id=571084'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="2-lovens-fellesbestemmelser_id_571084.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
