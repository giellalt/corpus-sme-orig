...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2012/bidja-arjjaid-sami-kultur--ja-gielladoai.html?id=703581'"/>
...
<xsl:variable name="para_nob" select="'stor-satsing-pa-samiske-kultur--og-sprak.html_id=703581'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stor-satsing-pa-samiske-kultur--og-sprak_id_703581.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
