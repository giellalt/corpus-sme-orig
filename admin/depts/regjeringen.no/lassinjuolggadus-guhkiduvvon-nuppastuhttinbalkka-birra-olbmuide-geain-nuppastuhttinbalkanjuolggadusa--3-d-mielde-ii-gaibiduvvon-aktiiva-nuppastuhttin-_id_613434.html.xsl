...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Lagat-ja-njuolggadusat-/retningslinjer/2006-2001/Lassinjuolggadus-guhkiduvvon-nuppastuhttinbalkka-birra-olbmuide-geain-nuppastuhttinbalkanjuolggadusa--3-d-mielde-ii-gaibiduvvon-aktiiva-nuppastuhttin-.html?id=613434'"/>
...
<xsl:variable name="para_nob" select="'tilleggsforskrift-vedrorende-forlenget-o.html?id=613434'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tilleggsforskrift-vedrorende-forlenget-o_id_613434.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
