...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/arvalus-samedikki-valgaortnega-rievdadus.html?id=505115'"/>
...
<xsl:variable name="para_nob" select="'forslag-om-endringer-i-sametingets-valgo.html?id=505115'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forslag-om-endringer-i-sametingets-valgo_id_505115.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
