...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/samedikki-iehanas-sajadat.html?id=514924'"/>
...
<xsl:variable name="para_nob" select="'sametingets-selvstendige-stilling.html?id=514924'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sametingets-selvstendige-stilling_id_514924.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
