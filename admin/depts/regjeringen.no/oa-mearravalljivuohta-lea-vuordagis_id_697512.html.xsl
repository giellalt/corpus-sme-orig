...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/aktuelt/nyheter/2012/-oa-mearravalljivuohta-lea-vuordagis.html?id=697512'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="vi-star-pa-terskelen-til-eit-nytt-havev_id_697512.html"/>
