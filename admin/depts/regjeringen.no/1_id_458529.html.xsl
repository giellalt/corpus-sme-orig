...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/10/7/1.html?id=458529'"/>
<xsl:variable name="title" select="'10.7.1 Dilli ja strategiijat - regjeringen.no'"/>
