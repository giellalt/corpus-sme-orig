...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/guovllu--ja-regionalapolitihkka/doaibmaguovlu-ja-njuolggadusat-.html?id=526844'"/>
...
<xsl:variable name="para_nob" select="'virkeomrader-retningslinjer-og-regler.html?id=526844'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="virkeomrader-retningslinjer-og-regler_id_526844.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
