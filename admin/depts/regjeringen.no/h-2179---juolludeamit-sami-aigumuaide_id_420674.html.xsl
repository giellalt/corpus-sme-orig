...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Dokumeanttat/Johtoallosat/2005/h-2179---juolludeamit-sami-aigumuaide.html?id=420674'"/>
<xsl:variable name="title" select="'H-2179 - Juolludeamit sámi áigumušaide - regjeringen.no'"/>
