...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/20/1/3.html?id=458649'"/>
<xsl:variable name="title" select="'1.1.3 Boahtteáiggi hástalusat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'4406'"/>
