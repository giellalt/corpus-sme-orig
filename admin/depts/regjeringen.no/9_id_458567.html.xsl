...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/12/9.html?id=458567'"/>
<xsl:variable name="title" select="'12.9 Sámi huksenvierru - regjeringen.no'"/>
