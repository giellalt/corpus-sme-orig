...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Gielddus-gaskkustit-mavssu-ruhtaspealuide-Norgga-lobiaddima-haga.html?id=593821'"/>
...
<xsl:variable name="para_nob" select="'Forbud-mot-betalingsformidling-til-pengespill-uten-norsk-tillatelse.html?id=593821'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forbud-mot-betalingsformidling-til-pengespill-uten-norsk-tillatelse_id_593821.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
