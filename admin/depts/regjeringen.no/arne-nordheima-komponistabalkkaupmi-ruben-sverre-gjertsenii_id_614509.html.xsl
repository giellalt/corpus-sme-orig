...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Arne-Nordheima-komponistabalkkaupmi-Ruben-Sverre-Gjertsenii.html?id=614509'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Arne-Nordheima-komponistabalkkaupmi-Ruben-Sverre-Gjertsenii.html?id=614509'"/>
<xsl:variable name="text_encoding" select="''"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Arne Nordheima komponistabálkkašupmi Ruben Sverre Gjertsenii - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'arne-nordheims-komponistpris-til-ruben-s.html?id=614509'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arne-nordheims-komponistpris-til-ruben-s_id_614509.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
