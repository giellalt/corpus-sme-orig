...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Fadda-/Bargomarkanpolitihkka/midtspalte/Ovddasvastadussuorggit-ja-vaikkuhangaskaoamit.html?id=86901'"/>
