...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20022003/stdie-nr-10-2002-2003-samisk/4/5/3.html?id=452329'"/>
<xsl:variable name="title" select="'4.5.3 Vuoigatvuođalaš... - regjeringen.no'"/>
