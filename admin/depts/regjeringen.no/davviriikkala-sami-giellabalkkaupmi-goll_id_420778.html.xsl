...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/minister/arbeids--og-inkluderingsminister-bjarne-/2006/davviriikkala-sami-giellabalkkaupmi-goll.html?id=420778'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/minister/arbeids--og-inkluderingsminister-bjarne-/2006/davviriikkala-sami-giellabalkkaupmi-goll.html?id=420778'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Davviriikkalaš sámi giellabálkkašupmi - Gollegiella  2006 - regjeringen.no'"/>
