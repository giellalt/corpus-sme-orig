...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Regionala-gaaldagaid-ja-ovdaneami-ossodat/Lulli-Asia-sekuvdna.html?id=86883'"/>
...
<xsl:variable name="para_nob" select="'asia_ii.html?id=86883'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="asia_ii_id_86883.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
