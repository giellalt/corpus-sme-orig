...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/tidligere_statssekretar_berit_oskal_eira/2005/oa-raehusa-samepolitihkka-tromssa-fylka-.html?id=420683'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ođđa ráđđehusa sámepolitihkka, Tromssa fylka ja Tromssa gávpot riikkaidgaskasaš eamiálbmotgávpogin - muhtun perspektiivvat - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'1756'"/>
