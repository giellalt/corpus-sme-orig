...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2010/Norga--digitala-riika-mailmmenjunnois.html?id=610574'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2010/Norga--digitala-riika-mailmmenjunnois.html?id=610574'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Norga – digitála riika máilmmenjunnošis - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'norge--en-digital-nasjon-i-verdenstoppen.html?id=610574'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norge--en-digital-nasjon-i-verdenstoppen_id_610574.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
