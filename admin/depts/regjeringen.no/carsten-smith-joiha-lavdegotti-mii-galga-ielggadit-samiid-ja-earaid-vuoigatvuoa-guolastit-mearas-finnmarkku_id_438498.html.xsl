...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2006/Carsten-Smith-joiha-lavdegotti-mii-galga-ielggadit-samiid-ja-earaid-vuoigatvuoa-guolastit-mearas-Finnmarkku.html?id=438498'"/>
<xsl:variable name="title" select="'Carsten Smith jođiha lávdegotti mii galgá čielggadit sámiid ja earáid vuoigatvuođa guolástit mearas Finnmárkku olggobealde - regjeringen.no'"/>
