...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/11-Gaddeavadat-huksengielddus-ja-earuheaddji-gaddeavadathalddaeapmi.html?id=571102'"/>
...
<xsl:variable name="para_nob" select="'11-strandsonen-byggeforbud-og-differensi.html?id=571102'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="11-strandsonen-byggeforbud-og-differensi_id_571102.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
