...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/Aigeguovdil/Oasat/2010/16-suodjalusministara-deaivvadit-Berliinnas.html?id=604389'"/>
...
<xsl:variable name="para_nob" select="'16-forsvarsministre-motes-i-Berlin.html?id=604389'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="16-forsvarsministre-motes-i-berlin_id_604389.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
...
=======
               <xsl:with-param name="target" select="'ovdddi/'"/>
               <xsl:with-param name="replacement" select="'ovddi/'"/>
            </xsl:call-template>
</xsl:element>
</xsl:template>
