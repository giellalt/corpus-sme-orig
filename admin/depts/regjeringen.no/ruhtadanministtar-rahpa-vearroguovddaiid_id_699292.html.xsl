...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aigeguovdil/nyheter/2012/ruhtadanministtar-rahpa-vearroguovddaiid.html?id=699292'"/>
...
<xsl:variable name="para_nob" select="'finansministeren-apner-skattesentre.html_id=699292'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="finansministeren-apner-skattesentre_id_699292.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
