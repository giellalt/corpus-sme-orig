...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/3/11/3.html?id=565819'"/>
<xsl:variable name="title" select="'3.11.3 Sámelága giellanjuolggadusat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'467'"/>
