...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/preassaguovdda/pressemeldinger/2012/arvala-doaimmaid-olgoriikka-petrovlahahk.html?id=685830'"/>
...
<xsl:variable name="para_nob" select="'foreslar-tiltak-mot-skattesubsidiering-a.html_id=685830'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="foreslar-tiltak-mot-skattesubsidiering-a_id_685830.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
