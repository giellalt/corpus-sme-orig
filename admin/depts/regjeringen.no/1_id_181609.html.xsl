...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/dokumeanttat/proposiuvnnat-ja-dieahusat/otprp/20042005/od-prp-nr-38_2004-2005/1.html?id=181609'"/>
<xsl:variable name="title" select="'1 Láhkaárvalusa duogáš - regjeringen.no'"/>
