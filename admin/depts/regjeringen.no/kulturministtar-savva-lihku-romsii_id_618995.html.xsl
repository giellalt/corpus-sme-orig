...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/kulturministtar-savva-lihku-romsii.html?id=618995'"/>
<xsl:variable name="title" select="'Kulturministtar sávvá lihku Romsii - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'kulturministeren-gratulerer-tromso.html?id=618995'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kulturministeren-gratulerer-tromso_id_618995.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
