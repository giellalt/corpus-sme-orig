...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/oasat/2012/veahkkalasbargu-diehtosihkarvuoa-vaste.html?id=700760'"/>
...
<xsl:variable name="para_nob" select="'dugnad-for-informasjonssikkerhet.html_id=700760'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="dugnad-for-informasjonssikkerhet_id_700760.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
