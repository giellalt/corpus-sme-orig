...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/3/2.html?id=461197'"/>
<xsl:variable name="title" select="'3.2 Ráđđádallamat - regjeringen.no'"/>
