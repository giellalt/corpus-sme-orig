...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/preassadieahusat/2011/oa-raporta-govdaoalli-viidu.html?id=654332'"/>
...
<xsl:variable name="para_nob" select="'bredt-bredband-brer-om-seg-.html_id=654332'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bredt-bredband-brer-om-seg-_id_654332.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
