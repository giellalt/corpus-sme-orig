...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/Preassadieahusat/2011/212-miljovnna-mohtorboaldamua-doaimmahea.html?id=659513'"/>
...
<xsl:variable name="para_nno" select="'212-millionar-til-drivstofftilgangen-i-d.html_id=659513'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="212-millionar-til-drivstofftilgangen-i-d_id_659513.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
