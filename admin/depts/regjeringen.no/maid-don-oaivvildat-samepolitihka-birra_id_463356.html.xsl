...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2007/Maid-don-oaivvildat-samepolitihka-birra.html?id=463356'"/>
...
<xsl:variable name="para_nob" select="'36.html?id=463356'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="36_id_463356.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
