...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/lihkkosavaldagat-the-blacksheepsii.html?id=537796'"/>
...
<xsl:variable name="para_nob" select="'gratulerer-til-the-blacksheeps.html?id=537796'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gratulerer-til-the-blacksheeps_id_537796.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
