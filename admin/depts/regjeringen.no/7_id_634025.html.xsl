...
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/ad/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/7.html?id=634025'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'6 Suohkaniid ja fylkkasuohkaniid sámepolitihkka'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="7_id_512889.html" xml:lang="nob"/>
</xsl:variable>
