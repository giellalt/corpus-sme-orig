...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2012/davviriikkaid-sameministarat-ja-samedigg.html?id=708331'"/>
...
<xsl:variable name="para_nob" select="'nordiske-sameministre-og-sametingspresid.html_id=708331'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nordiske-sameministre-og-sametingspresid_id_708331.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
