...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/bld/Departemeantta-birra/tilknyttede-virksomheter/Sisafarrejeaddjiid-ja-eisevalddiid-gulahallanlavdegoddi-SEG-.html?id=85805'"/>
...
<xsl:variable name="para_nob" select="'kontaktutvalget_mellom_innvandrerbefolkn.html?id=85805'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kontaktutvalget_mellom_innvandrerbefolkn_id_85805.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
