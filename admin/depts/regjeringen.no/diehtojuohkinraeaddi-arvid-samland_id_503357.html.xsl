...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/Stahtaministara-kantuvra/org/avdelinger/kommunikasjonsseksjonen/diehtojuohkinraeaddi-arvid-samland.html?id=503357'"/>
