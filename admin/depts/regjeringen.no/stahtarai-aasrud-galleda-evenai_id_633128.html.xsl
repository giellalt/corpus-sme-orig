...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2011/stahtarai-aasrud-galleda-evenai.html?id=633128'"/>
...
<xsl:variable name="para_nob" select="'statsrad-aasrud-besoker-evenes.html?id=633128'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsrad-aasrud-besoker-evenes_id_633128.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
