...
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/fd/Aigeguovdil/Oasat/2010/lasiha-doaimma-suodjalusas.html?id=615764'"/>
<xsl:variable name="title" select="'Lasiha doaimma Suodjalusas - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'oker-aktiviteten-i-forsvaret.html?id=615764'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="oker-aktiviteten-i-forsvaret_id_615764.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
