...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/aigeguovdil/oddasat/2024/avvudit-vuoolaga-neahttasajiin-minstemme.html?id=748957'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="feirer-grunnloven-pa-minstemmeno-_id_748957.html"/>
