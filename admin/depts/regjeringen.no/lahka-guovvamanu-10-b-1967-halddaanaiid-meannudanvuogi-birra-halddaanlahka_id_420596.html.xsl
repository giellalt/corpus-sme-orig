...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/dok/lover_regler/reglement/2004/Lahka-guovvamanu-10-b-1967-halddaanaiid-meannudanvuogi-birra-halddaanlahka.html?id=420596'"/>
...
<xsl:variable name="wordcount" select="'7505'"/>
