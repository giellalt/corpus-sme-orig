...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2008/beaivvala-sami-aviissat-.html?id=531175'"/>
...
<xsl:variable name="para_nob" select="'samiske-aviser-hver-dag--tilskudd-okes-m.html?id=531175'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samiske-aviser-hver-dag--tilskudd-okes-m_id_531175.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
