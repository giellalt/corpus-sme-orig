...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/Bargomarkanossodat-/Analysa--ja-sisaboahtopolitihkala-sekuvdna-AS.html?id=85772'"/>
...
<xsl:variable name="para_nob" select="'analyse-_og_inntektspolitisk_seksjon.html?id=85772'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="analyse-_og_inntektspolitisk_seksjon_id_85772.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
