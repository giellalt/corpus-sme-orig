...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/20/7.html?id=514567'"/>
<xsl:variable name="title" select="'20.7 Sámedikki váikkuhangaskaoamit... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1234'"/>
