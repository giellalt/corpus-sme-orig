...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2008/jan_08/Boazodoallu-Boazoguohtuniehtadusa-soabad.html?id=496155'"/>
...
<xsl:variable name="para_nob" select="'reindrift-enighet-om-reinbeiteavtale.html?id=496155'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reindrift-enighet-om-reinbeiteavtale_id_496155.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
