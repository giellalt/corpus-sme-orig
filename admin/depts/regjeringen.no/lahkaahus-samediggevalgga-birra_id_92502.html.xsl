...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Dokumeanttat/Lagat-ja-njuolggadusat/Lahkaasahusat/2005/Lahkaahus-samediggevalgga-birra.html?id=92502'"/>
...
<xsl:variable name="para_nob" select="'forskrift-om-valg-til-sametinget.html?id=92502'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-om-valg-til-sametinget_id_92502.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
