...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/taler_og_artikler/av_ovrig_politisk_ledelse/taler-og-artikler-av-statssekretar-raimo/2011/raehusa-dearvvasardni-uarctic-ealat-inst.html?id=637687'"/>
...
<xsl:variable name="para_nob" select="'hilsningstale-fra-regjeringen-ved-apning.html_id=637687'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hilsningstale-fra-regjeringen-ved-apning_id_637687.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
