...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valga-portal/stuorradiggevalga-2009/na-don-jienastat-valgabeaivvi.html?id=570160'"/>
...
<xsl:variable name="para_nob" select="'slik-stemmer-du-pa-valgdagen.html?id=570160'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="slik-stemmer-du-pa-valgdagen_id_570160.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
