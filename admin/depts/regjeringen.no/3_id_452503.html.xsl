...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/1/3.html?id=452503'"/>
<xsl:variable name="title" select="'4.1.3 Mánáidsuodjalus... - regjeringen.no'"/>
