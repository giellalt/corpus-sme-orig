...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ad/Aigeguovdil/Oasat/2013/robert-eriksson-orre-barkoe--jih-sosijaa.html?id=743007'"/>
...
<xsl:variable name="para_nob" select="'robert-eriksson-ny-arbeids--og-sosialmin.html_id=743007'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="robert-eriksson-ny-arbeids--og-sosialmin_id_743007.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
