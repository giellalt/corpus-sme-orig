...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/doarjja-sami-gielladoaibmabijuide.html?id=568112'"/>
...
<xsl:variable name="para_nob" select="'stotte-til-samiske-spraktiltak.html?id=568112'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stotte-til-samiske-spraktiltak_id_568112.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
