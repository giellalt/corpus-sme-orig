...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/12/2/2.html?id=514434'"/>
<xsl:variable name="title" select="'12.2.2 Sámi joatkkaoahpahus - regjeringen.no'"/>
