...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2012/stivrenjoavku-nammaduvvo-arvalit-muitoba.html?id=669328'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="styringsgruppe-for-oppforing-av-minnesme_id_669328.html" xml:lang="nno"/>
</xsl:variable>
