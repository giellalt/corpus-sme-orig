...
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/ad/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/23.html?id=634282'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ráva'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="23_id_513147.html" xml:lang="nob"/>
</xsl:variable>
