...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aigeguovdil/nyheter/2012/norggas-lea-ovdagoddi-oecd-ministtarraeo.html?id=700120'"/>
...
<xsl:variable name="para_nob" select="'norsk-formannskap-for-oecds-ministerrads.html_id=700120'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="norsk-formannskap-for-oecds-ministerrads_id_700120.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
