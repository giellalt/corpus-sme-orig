...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/aigeguovdil/sartnit-ja-artihkkalat/statsministeren/statsminister_jens_stoltenberg/2011/stahtaministara-sardni-muitoalmmusteami-.html?id=651931'"/>
...
<xsl:variable name="para_nob" select="'statsministerens-tale-til-minnemarkering.html_id=651931'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsministerens-tale-til-minnemarkering_id_651931.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
