...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/preassaguovdda/Preassadieahusat/2006/Olgoriikaministtar-Jagis-davveguovllut-leat-addan-norgala-olgoriikapolitihka-oa-viidodahkan.html?id=436873'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Olgoriikaministtar: - Jagis davveguovllut leat šaddan norgalaš olgoriikapolitihka ođđa viidodahkan - regjeringen.no'"/>
    <!--
