...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/Nanne-balvalusfalaldaga-sami-geavaheaddj.html?id=498207'"/>
...
<xsl:variable name="para_nob" select="'styrker-tjenestetilbudet-for-samiske-bru.html?id=498207'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="styrker-tjenestetilbudet-for-samiske-bru_id_498207.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
