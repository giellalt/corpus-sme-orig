...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/same--og-minoritetspolitisk-avdeling/ossodatdirektora-bjorn-olav-megard.html?id=484727'"/>
...
<xsl:variable name="para_nob" select="'avdelingsdirektor-bjorn-olav-megard.html?id=484727'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdelingsdirektor-bjorn-olav-megard_id_484727.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
