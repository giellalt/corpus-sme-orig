...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/servodat--ja-eaktodahtolaossodaga.html?id=495694'"/>
