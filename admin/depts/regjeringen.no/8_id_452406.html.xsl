...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/8.html?id=452406'"/>
<xsl:variable name="title" select="'8 Areála-, biras ja kultursuodjaleapmi - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'910'"/>
