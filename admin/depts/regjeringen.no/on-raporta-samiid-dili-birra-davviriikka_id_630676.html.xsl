...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2010/on-raporta-samiid-dili-birra-davviriikka.html?id=630676'"/>
...
<xsl:variable name="para_nob" select="'fn-rapport-om-samenes-situasjon-i-nordis.html?id=630676'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fn-rapport-om-samenes-situasjon-i-nordis_id_630676.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
