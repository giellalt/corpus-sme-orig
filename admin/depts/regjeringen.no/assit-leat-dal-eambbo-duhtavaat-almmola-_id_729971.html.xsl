...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2013/assit-leat-dal-eambbo-duhtavaat-almmola-.html?id=729971'"/>
...
<xsl:variable name="para_nob" select="'innbyggerne-mer-tilfreds-med-offentlige-.html_id=729971'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="innbyggerne-mer-tilfreds-med-offentlige-_id_729971.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
