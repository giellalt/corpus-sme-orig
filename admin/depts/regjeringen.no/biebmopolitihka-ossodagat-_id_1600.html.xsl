...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Departemeantta-birra/organisauvdna/Ossodagat/Biebmopolitihka-ossodagat-.html?id=1600'"/>
...
<xsl:variable name="para_nob" select="'avdeling_for_matpolitikk.html?id=1600'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdeling_for_matpolitikk_id_1600.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
