...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/persunsuodjaluslavdegoddi-.html?id=373619'"/>
...
<xsl:variable name="para_nob" select="'personvernnemnda.html?id=373619'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="personvernnemnda_id_373619.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
