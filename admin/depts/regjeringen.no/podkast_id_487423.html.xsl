...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dokumentarkiv/stoltenberg-ii/krd/personer-og-enheter/minister/2006/kommunal--og-regionalminister-magnhild-m/podkast.html?id=487423'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="podkast.html?id=487423"/>
