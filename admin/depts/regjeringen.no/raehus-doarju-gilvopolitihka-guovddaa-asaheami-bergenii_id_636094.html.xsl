...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2011/Raehus-doarju-gilvopolitihka-guovddaa-asaheami-Bergenii.html?id=636094'"/>
...
<xsl:variable name="para_nob" select="'regjeringen-stotter-etableringen-av-sent.html_id=636094'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringen-stotter-etableringen-av-sent_id_636094.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
