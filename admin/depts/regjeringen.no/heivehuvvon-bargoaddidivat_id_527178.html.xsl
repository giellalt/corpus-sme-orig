...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/guovllu--ja-regionalapolitihkka/doaibmaguovlu-ja-njuolggadusat-/heivehuvvon-bargoaddidivat.html?id=527178'"/>
...
<xsl:variable name="para_nob" select="'differensiert-arbeidsgiveravgift.html?id=527178'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="differensiert-arbeidsgiveravgift_id_527178.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
