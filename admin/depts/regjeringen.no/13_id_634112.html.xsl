...
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/ad/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/13.html?id=634112'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'12 Alit oahppu og dutkan'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="13_id_512977.html" xml:lang="nob"/>
</xsl:variable>
