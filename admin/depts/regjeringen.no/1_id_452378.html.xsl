...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/4/2/1.html?id=452378'"/>
<xsl:variable name="title" select="'4.2.1 Sámeláhka - regjeringen.no'"/>
