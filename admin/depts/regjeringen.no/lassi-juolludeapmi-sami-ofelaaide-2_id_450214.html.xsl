...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2007/Lassi-juolludeapmi-sami-ofelaaide-2.html?id=450214'"/>
...
<xsl:variable name="para_nob" select="'11.html?id=450214'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="11_id_450214.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
