...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/juolludeamit-sami-ulbmiliidda-2009-staht.html?id=531235'"/>
...
<xsl:variable name="para_nob" select="'bevilgninger-til-samiske-formal-i-statsb.html?id=531235'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bevilgninger-til-samiske-formal-i-statsb_id_531235.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
