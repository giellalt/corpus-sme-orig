...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2012/12-miljovdna-diehtojuohkinsihkarvuhtii.html?id=704053'"/>
...
<xsl:variable name="para_nob" select="'12-millioner-til-informasjonssikkerhet.html_id=704053'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="12-millioner-til-informasjonssikkerhet_id_704053.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
