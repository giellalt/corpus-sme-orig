...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/fadda/vuooskuvla/Konsultauvdnageatnegasvuohta-sami-aiin.html?id=592559'"/>
...
<xsl:variable name="para_nob" select="'Konsultasjonsplikt-i-samiske-saker.html?id=592559'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="konsultasjonsplikt-i-samiske-saker_id_592559.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
