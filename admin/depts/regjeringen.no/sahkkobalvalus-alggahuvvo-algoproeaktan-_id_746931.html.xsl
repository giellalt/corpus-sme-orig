...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/20131/sahkkobalvalus-alggahuvvo-algoproeaktan-.html?id=746931'"/>
...
<xsl:variable name="para_nob" select="'pilotprosjekt-om-botetjeneste-i-troms.html_id=746931'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="pilotprosjekt-om-botetjeneste-i-troms_id_746931.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
