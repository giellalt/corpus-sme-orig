...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/2/1.html?id=514293'"/>
<xsl:variable name="title" select="'2.1 Ráđđehusa sámepolitihka ... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1839'"/>
