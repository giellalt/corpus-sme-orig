...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/Preassaguovdda/pressemeldinger/2007/--Bueahtta-mas-leat-ielga-rukses-ruona-v.html?id=484792'"/>
...
<xsl:variable name="para_nob" select="'--et-budsjett-med-klare-rod-gronne-prior.html?id=484792'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="et-budsjett-med-klare-rod-gronne-prior_id_484792.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
