...
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/ad/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/15.html?id=634143'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'14 Sámi kulturpolitihkka'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="15_id_513008.html" xml:lang="nob"/>
</xsl:variable>
