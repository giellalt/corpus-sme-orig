...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/adda-800-000-ruvnno-samekonferansii--2.html?id=509548'"/>
...
<xsl:variable name="para_nob" select="'gir-800-000-kroner-til-samekonferanse.html?id=509548'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gir-800-000-kroner-til-samekonferanse_id_509548.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
