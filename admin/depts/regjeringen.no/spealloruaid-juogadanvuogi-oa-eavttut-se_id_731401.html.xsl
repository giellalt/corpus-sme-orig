...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/spealloruaid-juogadanvuogi-oa-eavttut-se.html?id=731401'"/>
...
<xsl:variable name="para_nob" select="'nye-kriterier-for-tildeling-av-spillemid.html_id=731401'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nye-kriterier-for-tildeling-av-spillemid_id_731401.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
