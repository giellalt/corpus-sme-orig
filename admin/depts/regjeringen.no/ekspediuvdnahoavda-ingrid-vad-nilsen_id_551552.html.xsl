...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/girkoossodat/Ekspediuvdnahoavda-Ingrid-Vad-Nilsen.html?id=551552'"/>
...
<xsl:variable name="para_nob" select="'ekspedisjonssjef-ingrid-vad-nilsen.html?id=551552'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekspedisjonssjef-ingrid-vad-nilsen_id_551552.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
