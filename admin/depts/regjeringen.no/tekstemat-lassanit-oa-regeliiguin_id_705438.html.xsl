...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/tekstemat-lassanit-oa-regeliiguin.html?id=705438'"/>
...
<xsl:variable name="para_nob" select="'mer-teksting-med-nye-regler.html_id=705438'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mer-teksting-med-nye-regler_id_705438.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
