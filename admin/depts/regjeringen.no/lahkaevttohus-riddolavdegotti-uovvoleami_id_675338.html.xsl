...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2012/lahkaevttohus-riddolavdegotti-uovvoleami.html?id=675338'"/>
...
<xsl:variable name="para_nob" select="'lovforslag-om-oppfolging-av-kystfiskeutv.html_id=675338'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lovforslag-om-oppfolging-av-kystfiskeutv_id_675338.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
