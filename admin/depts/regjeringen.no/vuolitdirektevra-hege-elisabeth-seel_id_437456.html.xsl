...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/Departemeantta-birra/Organisauvdna/Ossodagat/Joiheaddjit--/Departemeanttarai-kantuvra/Vuolitdirektevra-Hege-Elisabeth-Seel.html?id=437456'"/>
...
<xsl:variable name="para_nob" select="'underdirektor-hege-elisabeth-seel.html?id=437456'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="underdirektor-hege-elisabeth-seel_id_437456.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
