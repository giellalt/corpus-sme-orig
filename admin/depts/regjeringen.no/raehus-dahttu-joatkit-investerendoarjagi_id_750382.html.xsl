...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kmd/preassaguovdda/preassadieahusat/2014/raehus-dahttu-joatkit-investerendoarjagi.html?id=750382'"/>
...
<xsl:variable name="para_nob" select="'regjeringen-vil-viderefore-et-stort-virk.html_id=750382'"/>
