...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Historihkka.html?id=193'"/>
...
<xsl:variable name="para_nob" select="'historikk.html?id=193'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="historikk_id_193.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
