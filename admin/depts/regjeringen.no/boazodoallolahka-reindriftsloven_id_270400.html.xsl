...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dok/lagat-ja-njuolggadusat-/lover/Boazodoallolahka-Reindriftsloven.html?id=270400'"/>
...
<xsl:variable name="para_nob" select="'reindriftsloven.html?id=270400'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reindriftsloven_id_270400.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
