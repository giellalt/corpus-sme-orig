...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/17.html?id=458637'"/>
<xsl:variable name="title" select="'17 Sámepolitihka bálddalastin - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="17_id_326040.html" xml:lang="nob"/>
</xsl:variable>
