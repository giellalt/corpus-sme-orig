...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2012/mai-12/eanandoalloiehtadus-2012.html?id=683672'"/>
...
<xsl:variable name="para_nno" select="'jordbruksoppgjeret-2012.html_id=683672'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jordbruksoppgjeret-2012_id_683672.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
