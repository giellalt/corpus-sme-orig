...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/Odeldiggeproposiuvnnat/20022003/od-prp-nr-34_2002-2003/2/2.html?id=172559'"/>
<xsl:variable name="title" select="'2.2 Bargojoavkku neavva - regjeringen.no'"/>
