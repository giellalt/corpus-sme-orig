...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/3-2/6/2.html?id=452623'"/>
<xsl:variable name="title" select="'3.6.2 Sámi instituhtta/Sámi... - regjeringen.no'"/>
