...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/1.html?id=458398'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'1 Láidehus ja oktiigeassu - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'2876'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="1_id_195309.html"/>
