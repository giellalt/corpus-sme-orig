...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/4-Bargamuat-ja-valdi-planemis.html?id=571087'"/>
...
<xsl:variable name="para_nob" select="'4-oppgaver-og-myndighet-i-planleggingen-.html?id=571087'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="4-oppgaver-og-myndighet-i-planleggingen-_id_571087.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
