...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aigeguovdil/nyheter/2011/seg-oa-namma-lea-ekonomiijastivrema-dire.html?id=663214'"/>
...
<xsl:variable name="para_nob" select="'fra-sso-til-direktoratet-for-okonomistyr.html_id=663214'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fra-sso-til-direktoratet-for-okonomistyr_id_663214.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
