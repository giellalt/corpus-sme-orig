...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/oa-miellahtuid-ja-varrelahtuid-nammadeap.html?id=747853'"/>
...
<xsl:variable name="para_nob" select="'oppnevning-av-nye-medlemmer-og-varamedle.html_id=747853'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="oppnevning-av-nye-medlemmer-og-varamedle_id_747853.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
