...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2012/vuoruheames-guolastanhapmaniid-ja-fanasj.html?id=701230'"/>
...
<xsl:variable name="para_nob" select="'satsing-pa-fiskerihavner-og-farleier.html_id=701230'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="satsing-pa-fiskerihavner-og-farleier_id_701230.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
