...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/lagat-ja-lahkaasahusat/lahkaasahusat/2007/lahkaasahus-finnmarkku-laddjes-lastavuvd.html?id=491618'"/>
<xsl:variable name="title" select="'Láhkaásahus Finnmárkku šláddjes lastavuvddiid suodjalanplána birra. Fiervuona álbmotmeahci suodjaleapmi Álttá suohkanis, Finnmárkku fylkkas. - regjeringen.no'"/>
