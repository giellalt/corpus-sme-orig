...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/15/3/5.html?id=452452'"/>
<xsl:variable name="title" select="'1.3.5 Giella, gulahallan... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'936'"/>
