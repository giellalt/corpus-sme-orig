...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/3/17/2.html?id=610205'"/>
<xsl:variable name="title" select="'3.17.2 Geavaheaddjiidiskkadallama ... - regjeringen.no'"/>
