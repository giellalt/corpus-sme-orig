...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2007/juni-07/Boazodoallu-Oa-boazodoallolahka.html?id=475620'"/>
...
<xsl:variable name="para_nob" select="'reindrift-ny-reindriftslov--2.html?id=475620'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reindrift-ny-reindriftslov--2_id_475620.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
