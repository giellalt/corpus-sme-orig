...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/3/9/1.html?id=610185'"/>
<xsl:variable name="title" select="'3.9.1 Doaibmaplána sámegielaid... - regjeringen.no'"/>
