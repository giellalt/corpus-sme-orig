...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Sartnit-ja-allosat/ministeren/landbruks--og-matminister-lars-peder-bre/boazodoallopolitihkka-adda-ealahussii-ov/boazodoallopolitihkka-adda-ealahussii-ov.html?id=675396'"/>
...
<xsl:variable name="para_nob" select="'kronikk-reindriftspolitikken-gir-naringe.html_id=675396'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kronikk-reindriftspolitikken-gir-naringe_id_675396.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
