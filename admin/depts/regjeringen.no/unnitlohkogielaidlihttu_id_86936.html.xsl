...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Nationala-unnitlogut/midtspalte/Unnitlohkogielaidlihttu.html?id=86936'"/>
...
<xsl:variable name="para_nob" select="'minoritetssprakpakta.html?id=86936'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minoritetssprakpakta_id_86936.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
