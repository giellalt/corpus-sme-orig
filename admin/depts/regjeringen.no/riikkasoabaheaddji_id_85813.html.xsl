...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/Vuollasa-asahusat/Riikkasoabaheaddji.html?id=85813'"/>
...
<xsl:variable name="para_nob" select="'riksmeklingsmannen.html?id=85813'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="riksmeklingsmannen_id_85813.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
