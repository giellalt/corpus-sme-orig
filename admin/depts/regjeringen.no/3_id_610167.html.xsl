...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/3.html?id=610167'"/>
<xsl:variable name="title" select="'3 Ráđđehus  bargu sámepolitihkalaš... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'7651'"/>
