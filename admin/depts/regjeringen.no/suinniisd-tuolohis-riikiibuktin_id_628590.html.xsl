...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2010/des-10/suinniisd-tuolohis-riikiibuktin.html?id=628590'"/>
...
<xsl:variable name="para_nob" select="'tollfri-import-av-hoy.html?id=628590'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tollfri-import-av-hoy_id_628590.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
