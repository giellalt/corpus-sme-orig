...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/valatallanossodat/ekspediuvdnahoavda-per-kristian-aasmunds.html?id=551554'"/>
