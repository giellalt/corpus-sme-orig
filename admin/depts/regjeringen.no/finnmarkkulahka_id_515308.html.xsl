...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dok/lagat-ja-njuolggadusat-/lover/finnmarkkulahka.html?id=515308'"/>
...
<xsl:variable name="para_nob" select="'finnmarksloven.html?id=515308'"/>
