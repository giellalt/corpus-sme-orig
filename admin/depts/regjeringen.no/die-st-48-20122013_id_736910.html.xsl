...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dokumeanttat/proposiuvnnat-ja-dieahusat/dieahusat-stuorradiggai/2012-2013/die-st-48-20122013.html?id=736910'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Dieđ St. 48 (2012–2013) - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'stortingsmelding-om-sametinget-si-verkse.html_id=737407'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stortingsmelding-om-sametinget-si-verkse.html_id=737407" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
