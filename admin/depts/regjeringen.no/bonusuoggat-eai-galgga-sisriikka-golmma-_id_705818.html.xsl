...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2012/bonusuoggat-eai-galgga-sisriikka-golmma-.html?id=705818'"/>
...
<xsl:variable name="para_nob" select="'ikke-bonusopptjening-pa-de-tre-storste-i.html_id=705818'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ikke-bonusopptjening-pa-de-tre-storste-i_id_705818.html" xml:lang="nob"/>
