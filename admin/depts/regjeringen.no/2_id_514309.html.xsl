...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/2/4/2.html?id=514309'"/>
<xsl:variable name="title" select="'2.4.2 ONa álgoálbmotáššiid ... - regjeringen.no'"/>
