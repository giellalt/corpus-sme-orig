...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Bisova-vuoohaddi-appagirjjalavuoa-ja-aeprosa-ektui.html?id=609524'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Bisova-vuoohaddi-appagirjjalavuoa-ja-aeprosa-ektui.html?id=609524'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Bisovaš vuođđohaddi čáppagirjjálašvuođa ja áššeprosa ektui - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'Fortsatt-fastpris-pa-skjonnlitteratur-og-sakprosa.html?id=609524'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fortsatt-fastpris-pa-skjonnlitteratur-og-sakprosa_id_609524.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
