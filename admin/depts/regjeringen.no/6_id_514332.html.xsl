...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/3/6.html?id=514332'"/>
<xsl:variable name="title" select="'3.6 Romssa ja Nordlándda... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'918'"/>
