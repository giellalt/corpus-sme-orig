...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2011/Jan-11/boazodoalloiehtadus-20112012--nbr-gaibad.html?id=630250'"/>
...
<xsl:variable name="para_nob" select="'reindriftsavtalen-20112012---kravet-fra-.html?id=630250'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reindriftsavtalen-20112012---kravet-fra-_id_630250.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
