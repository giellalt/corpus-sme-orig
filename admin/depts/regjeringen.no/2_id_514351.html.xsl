...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/6/2.html?id=514351'"/>
<xsl:variable name="title" select="'6.2 Sámegielmáhttu ... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2506'"/>
