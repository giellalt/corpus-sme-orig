...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/6/1/2.html?id=452556'"/>
<xsl:variable name="title" select="'1.1.2 Departemeanttaid... - regjeringen.no'"/>
