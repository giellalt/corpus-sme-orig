...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/praktihkala-teologala-seminara.html?id=449033'"/>
...
<xsl:variable name="para_nob" select="'det-praktisk-teologiske-seminar.html?id=449033'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="det-praktisk-teologiske-seminar_id_449033.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
