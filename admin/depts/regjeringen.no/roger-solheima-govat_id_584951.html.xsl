...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/Eara-politihkala-njunnoat/politihkala-raeaddi-roger-remme-solheim/roger-solheima-govat.html?id=584951'"/>
...
<xsl:variable name="para_nob" select="'bilder-av-roger-remme-solheim.html?id=584951'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bilder-av-roger-remme-solheim_id_584951.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
