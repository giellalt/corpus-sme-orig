...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/17/2.html?id=458639'"/>
<xsl:variable name="title" select="'17.2 Gielda- ja guovlodepartemeantta... - regjeringen.no'"/>
