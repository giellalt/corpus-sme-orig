...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2007/Mailmmi-algoalbmotbeaivi.html?id=477242'"/>
...
<xsl:variable name="para_nob" select="'90.html?id=477242'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="90_id_477242.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
