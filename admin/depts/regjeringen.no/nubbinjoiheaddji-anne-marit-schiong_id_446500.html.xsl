...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Departemeanta/Organisauvdna/avdelinger/kommunikasjonsenheten/Nubbinjoiheaddji-Anne-Marit-Schiong.html?id=446500'"/>
