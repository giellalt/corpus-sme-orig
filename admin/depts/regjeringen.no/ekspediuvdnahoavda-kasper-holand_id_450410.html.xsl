...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/stahtahalddahusossodat/Ekspediuvdnahoavda-Kasper-Holand.html?id=450410'"/>
...
<xsl:variable name="para_nob" select="'ekspedisjonssjef-kasper-holand.html?id=450410'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekspedisjonssjef-kasper-holand_id_450410.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
