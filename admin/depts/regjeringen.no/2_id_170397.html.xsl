...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/dokumeanttat/proposiuvnnat-ja-dieahusat/otprp/20012002/od-prp-nr-114_2001-2002/2.html?id=170397'"/>
<xsl:variable name="title" select="'2 Departemeantta árvvoštallamat... - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="2_id_170379.html" xml:lang="nno"/>
</xsl:variable>
