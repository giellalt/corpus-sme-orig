...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2010/oa-doaibmaplana-radikaliserema-ja-veahka.html?id=626612'"/>
...
<xsl:variable name="para_nob" select="'handlingsplan.html?id=626612'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="handlingsplan_id_626612.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
