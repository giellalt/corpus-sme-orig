...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/dok/hoeringer/hoeringsdok/2009/gulaskuddan---rammaplana-lahkaasahus-sam.html?id=588785'"/>
...
<xsl:variable name="para_nob" select="'horing--forskrift-om-rammeplan-for-samis.html?id=588785'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horing--forskrift-om-rammeplan-for-samis_id_588785.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
