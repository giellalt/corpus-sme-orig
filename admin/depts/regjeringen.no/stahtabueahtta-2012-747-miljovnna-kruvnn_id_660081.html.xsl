...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/sd/pressesenter/pressemeldinger/pressemeldinger/stahtabueahtta-2012-747-miljovnna-kruvnn.html?id=660081'"/>
...
<xsl:variable name="para_nob" select="'statsbudsjettet-2012-747-millioner-krone.html_id=660081'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsbudsjettet-2012-747-millioner-krone_id_660081.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
