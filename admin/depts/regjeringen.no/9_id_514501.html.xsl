...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/15/9.html?id=514501'"/>
<xsl:variable name="title" select="'15.9 Girjjálašvuohta ... - regjeringen.no'"/>
