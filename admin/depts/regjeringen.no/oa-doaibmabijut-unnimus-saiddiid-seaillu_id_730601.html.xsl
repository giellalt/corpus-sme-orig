...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2013/oa-doaibmabijut-unnimus-saiddiid-seaillu.html?id=730601'"/>
...
<xsl:variable name="para_nob" select="'nye-tiltak-for-a-spare-den-minste-seien.html_id=730601'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nye-tiltak-for-a-spare-den-minste-seien_id_730601.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
