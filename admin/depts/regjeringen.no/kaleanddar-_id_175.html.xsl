...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/kaleanddar-.html?id=175'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kalender.html_id=175" xml:lang="nno"/>
	<parallel_text location="kalender.html_id=175" xml:lang="nob"/>
</xsl:variable>
