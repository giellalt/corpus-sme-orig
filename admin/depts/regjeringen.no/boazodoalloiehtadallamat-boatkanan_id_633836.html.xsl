...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2011/feb-11/boazodoalloiehtadallamat-boatkanan.html?id=633836'"/>
...
<xsl:variable name="para_nob" select="'brudd-i-reindriftsavtaleforhandlingene.html_id=633836'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="brudd-i-reindriftsavtaleforhandlingene_id_633836.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
