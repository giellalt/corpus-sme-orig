...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2007/Samediggi-ja-guollefanas--veaga-struktuv.html?id=458172'"/>
...
<xsl:variable name="para_nob" select="'sametinget-og-strukturpolitikk-for-fiske.html?id=458172'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sametinget-og-strukturpolitikk-for-fiske_id_458172.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
