...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2008/aigu-sihkkarastit-samiid-vuoigatvuoaid.html?id=514911'"/>
...
<xsl:variable name="para_nob" select="'skal-sikre-samers-rettigheter.html?id=514911'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skal-sikre-samers-rettigheter_id_514911.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
