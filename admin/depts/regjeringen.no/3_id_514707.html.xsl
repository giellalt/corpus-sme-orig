...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/6/3.html?id=514707'"/>
<xsl:variable name="title" select="'2.6.3 Valáštallan - regjeringen.no'"/>
