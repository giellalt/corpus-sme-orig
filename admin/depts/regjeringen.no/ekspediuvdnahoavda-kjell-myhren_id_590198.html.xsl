...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/daiddaossodat/ekspediuvdnahoavda-kjell-myhren.html?id=590198'"/>
