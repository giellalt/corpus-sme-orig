...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/24/5/1.html?id=514642'"/>
<xsl:variable name="title" select="'1.5.1 Kulturovdanbuktimat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'594'"/>
