...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/15/11/3.html?id=514510'"/>
<xsl:variable name="title" select="'15.11.3 Riikkateáhter - regjeringen.no'"/>
