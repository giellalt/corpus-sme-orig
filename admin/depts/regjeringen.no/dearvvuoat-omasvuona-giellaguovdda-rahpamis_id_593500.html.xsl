...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/fad/oasat/taler_og_artikler/av_ovrig_politisk_ledelse/taler-og-artikler-av-statssekretar-raimo/2010/Dearvvuoat-Omasvuona-giellaguovdda-rahpamis.html?id=593500'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/taler_og_artikler/av_ovrig_politisk_ledelse/taler-og-artikler-av-statssekretar-raimo/2010/Dearvvuoat-Omasvuona-giellaguovdda-rahpamis.html?id=593500'"/>
...
<xsl:variable name="para_nob" select="'Apning-av-Storfjord-spraksenter.html?id=593500'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="apning-av-storfjord-spraksenter_id_593500.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
