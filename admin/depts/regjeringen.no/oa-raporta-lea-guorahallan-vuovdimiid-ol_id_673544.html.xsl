...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/Preassadieahusat/2012/oa-raporta-lea-guorahallan-vuovdimiid-ol.html?id=673544'"/>
