...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/jagi-2012-lassiarvovearu-buhtadusa-ohcan.html?id=674431'"/>
...
<xsl:variable name="para_nob" select="'forenkling-i-soknad-om-momskompensasjon-.html_id=674431'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forenkling-i-soknad-om-momskompensasjon-_id_674431.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
