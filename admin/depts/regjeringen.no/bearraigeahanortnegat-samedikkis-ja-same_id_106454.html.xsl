...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Raporttat-ja-planat/Raporttat-/2005/bearraigeahanortnegat-samedikkis-ja-same.html?id=106454'"/>
...
<xsl:variable name="para_nob" select="'kontrollordninger-i-og-for-sametinget.html?id=106454'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kontrollordninger-i-og-for-sametinget_id_106454.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
