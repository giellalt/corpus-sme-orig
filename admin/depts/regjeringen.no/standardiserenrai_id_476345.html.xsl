...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Stivrrat-rait-ja-lavdegottit/standardiserenrai.html?id=476345'"/>
...
<xsl:variable name="para_nob" select="'standardiseringsradet.html?id=476345'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="standardiseringsradet_id_476345.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
