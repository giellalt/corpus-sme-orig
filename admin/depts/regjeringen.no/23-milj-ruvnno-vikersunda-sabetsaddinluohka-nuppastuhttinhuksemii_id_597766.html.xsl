...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/23-milj-ruvnno-Vikersunda-sabetsaddinluohka-nuppastuhttinhuksemii.html?id=597766'"/>
...
<xsl:variable name="para_nob" select="'23-millioner-til-ombygging-av-Vikersund-skiflygingsbakke.html?id=597766'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="23-millioner-til-ombygging-av-vikersund-skiflygingsbakke_id_597766.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
