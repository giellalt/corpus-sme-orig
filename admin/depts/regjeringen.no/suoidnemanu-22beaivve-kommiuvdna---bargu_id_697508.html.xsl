...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/aktuelt/nyheter/2012/suoidnemanu-22beaivve-kommiuvdna---bargu.html?id=697508'"/>
...
<xsl:variable name="para_nob" select="'-en-jobb-ma-gjores.html_id=697508'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="en-jobb-ma-gjores_id_697508.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
