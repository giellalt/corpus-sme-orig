...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/15/2/3.html?id=452438'"/>
<xsl:variable name="title" select="'1.2.3 Sámi jienastuslohku... - regjeringen.no'"/>
