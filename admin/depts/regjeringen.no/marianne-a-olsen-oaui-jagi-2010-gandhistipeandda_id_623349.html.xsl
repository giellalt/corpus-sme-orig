...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Marianne-A-Olsen-oaui-jagi-2010-Gandhistipeandda.html?id=623349'"/>
...
<xsl:variable name="para_nno" select="'marianne-a-olsen-mottok-gandhistipendet-.html?id=623349'"/>
