...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20062007/Stdie-nr-7-2006-2007-/2/13.html?id=452691'"/>
<xsl:variable name="title" select="'2.13 Kulturmuitohálddašeapmi - regjeringen.no'"/>
