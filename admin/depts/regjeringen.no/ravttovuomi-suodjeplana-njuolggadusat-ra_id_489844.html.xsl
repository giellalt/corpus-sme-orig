...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/lagat-ja-lahkaasahusat/lahkaasahusat/2002/ravttovuomi-suodjeplana-njuolggadusat-ra.html?id=489844'"/>
<xsl:variable name="title" select="'Rávttošvuomi suodjeplána njuolggadusat. Rávttošvuomi Álbmotmeahci suodjaleapmi Porsáŋggu ja Fálesnuori gielddain Finnmárkku fylkkas. - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1021'"/>
