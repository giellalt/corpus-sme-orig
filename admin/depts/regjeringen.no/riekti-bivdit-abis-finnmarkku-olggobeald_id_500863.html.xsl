...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2008/Riekti-bivdit-abis-Finnmarkku-olggobeald.html?id=500863'"/>
...
<xsl:variable name="para_nob" select="'retten-til-fiske-i-havet-utenfor-finnmar.html?id=500863'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="retten-til-fiske-i-havet-utenfor-finnmar_id_500863.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
