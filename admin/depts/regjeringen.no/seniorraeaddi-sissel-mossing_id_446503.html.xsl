...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Departemeanta/Organisauvdna/avdelinger/kommunikasjonsenheten/Seniorraeaddi-Sissel-Mossing.html?id=446503'"/>
