...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/nyheter/2010/Telemedisiidna-Buorre-pasientii--halbbibun-stahtii.html?id=605463'"/>
...
<xsl:variable name="para_nob" select="'Telemedisin-Bra-for-pasienten--billigere-for-staten-.html?id=605463'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="telemedisin-bra-for-pasienten--billigere-for-staten-_id_605463.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
