...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/12.html?id=514430'"/>
<xsl:variable name="title" select="'11 Vuođđooahpahus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'14446'"/>
