...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2007/Doarjja-golmmagielat-proektii-Omasvuona-.html?id=495184'"/>
...
<xsl:variable name="para_nob" select="'stotte-til-trespraklig-prosjekt-i-storfj.html?id=495184'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stotte-til-trespraklig-prosjekt-i-storfj_id_495184.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
