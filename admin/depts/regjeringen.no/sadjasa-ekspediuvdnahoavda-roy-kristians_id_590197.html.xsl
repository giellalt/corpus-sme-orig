...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/kultursuodjalusossodat/sadjasa-ekspediuvdnahoavda-roy-kristians.html?id=590197'"/>
