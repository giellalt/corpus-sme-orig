...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/505-miljovnna-ruvnno-eanet-nordlandii-bo.html?id=619775'"/>
...
<xsl:variable name="para_nno" select="'505-millionar-meir-til-Nordland-neste-ar.html?id=619775'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="505-millionar-meir-til-nordland-neste-ar_id_619775.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
