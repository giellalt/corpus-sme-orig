...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/oasat/2012/india-berota-norgga-eamitalbmotpolitihka.html?id=698912'"/>
...
<xsl:variable name="para_nob" select="'indisk-interesse-for-norsk-urfolkspoliti.html_id=698912'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="indisk-interesse-for-norsk-urfolkspoliti_id_698912.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
