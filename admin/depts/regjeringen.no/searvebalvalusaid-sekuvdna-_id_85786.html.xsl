...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/algopolitihkala-ossodat-/Searvebalvalusaid-sekuvdna-.html?id=85786'"/>
...
<xsl:variable name="para_nob" select="'seksjon_for_fellestjenester.html?id=85786'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon_for_fellestjenester_id_85786.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
