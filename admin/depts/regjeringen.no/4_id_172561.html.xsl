...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/Odeldiggeproposiuvnnat/20022003/od-prp-nr-34_2002-2003/2/4.html?id=172561'"/>
<xsl:variable name="title" select="'2.4 Departemeantta árvvoštallan - regjeringen.no'"/>
