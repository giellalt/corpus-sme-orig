...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Girku/Stahta-ja-girku.html?id=1218'"/>
...
<xsl:variable name="para_nob" select="'stat_og_kirke.html?id=1218'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stat_og_kirke_id_1218.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
