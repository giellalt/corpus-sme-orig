...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Stahta-daiddariid-vastesa-stipeanddaid-ja-dahkiduvvon-sisaboauid-juohkin-jagi-2010.html?id=599480'"/>
...
<xsl:variable name="para_nob" select="'Tildeling-av-statens-stipend-og-garantiinntekter-for-kunstnere-2010.html?id=599480'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tildeling-av-statens-stipend-og-garantiinntekter-for-kunstnere-2010_id_599480.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
