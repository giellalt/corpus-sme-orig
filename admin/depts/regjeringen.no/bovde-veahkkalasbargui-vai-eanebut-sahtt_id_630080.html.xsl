...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2011/bovde-veahkkalasbargui-vai-eanebut-sahtt.html?id=630080'"/>
...
<xsl:variable name="para_nob" select="'inviterer-til-dugnad-for-at-flere-kan-st.html?id=630080'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="inviterer-til-dugnad-for-at-flere-kan-st_id_630080.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
