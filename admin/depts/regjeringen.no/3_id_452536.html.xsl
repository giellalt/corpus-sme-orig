...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/9/3.html?id=452536'"/>
<xsl:variable name="title" select="'4.9.3 Kultuvra ja ealáhuseallin - regjeringen.no'"/>
