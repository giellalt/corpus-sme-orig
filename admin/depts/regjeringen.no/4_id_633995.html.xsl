...
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/ad/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/4.html?id=633995'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'3 Sámi identitehta lea nuppástuvvamin'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="4.html_id=512860" xml:lang="nob"/>
</xsl:variable>
