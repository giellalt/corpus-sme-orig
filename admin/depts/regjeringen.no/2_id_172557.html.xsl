...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/Odeldiggeproposiuvnnat/20022003/od-prp-nr-34_2002-2003/2.html?id=172557'"/>
<xsl:variable name="title" select="'2 Evttohusa duogáš ja... - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="2_id_172548.html" xml:lang="nno"/>
</xsl:variable>
