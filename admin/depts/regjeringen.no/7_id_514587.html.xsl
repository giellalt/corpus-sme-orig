...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/21/2/7.html?id=514587'"/>
<xsl:variable name="title" select="'21.2.7 Boraspirehálddašeapmi - regjeringen.no'"/>
