...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kmd/preassaguovdda/preassadieahusat/2014/alkit-gulahallan-assiiguin-ja-ealahuseal.html?id=750734'"/>
...
<xsl:variable name="para_nob" select="'forenkler-kommunikasjonen-med-innbyggere.html_id=750734'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="forenkler-kommunikasjonen-med-innbyggere_id_750734.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
