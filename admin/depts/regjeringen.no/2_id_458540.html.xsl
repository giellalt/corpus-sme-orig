...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/11/2.html?id=458540'"/>
<xsl:variable name="title" select="'11.2 Sámi váikkuhanfápmu... - regjeringen.no'"/>
