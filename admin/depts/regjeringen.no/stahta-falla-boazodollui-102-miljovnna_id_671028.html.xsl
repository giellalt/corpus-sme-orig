...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2012/feb-12/stahta-falla-boazodollui-102-miljovnna.html?id=671028'"/>
...
<xsl:variable name="para_nob" select="'staten-tilbyr-reindriften-102-millioner.html_id=671028'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="staten-tilbyr-reindriften-102-millioner_id_671028.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
