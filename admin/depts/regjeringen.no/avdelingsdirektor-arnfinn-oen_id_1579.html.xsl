...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/sd/Departemeantta-birra/Organisauvdna/Ossodagat/fievrredanossodat/Biras--ja-farrolasjohtolatsekuvdna/Avdelingsdirektor-Arnfinn-Oen.html?id=1579'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="Avdelingsdirektor-Arnfinn-Oen.html?id=1579"/>
        <parallel_text xml:lang="nob" location="avdelingsdirektor_arnfinn_oen.html?id=1579"/>
