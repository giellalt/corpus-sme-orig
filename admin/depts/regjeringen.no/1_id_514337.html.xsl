...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/4/1.html?id=514337'"/>
<xsl:variable name="title" select="'4.1 Organiseren ja našuvdnahuksen - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'762'"/>
