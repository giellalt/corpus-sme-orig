...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/3/13.html?id=610192'"/>
<xsl:variable name="title" select="'3.13 Alit oahpahus - regjeringen.no'"/>
