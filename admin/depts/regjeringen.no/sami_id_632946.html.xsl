...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2011/sami.html?id=632946'"/>
...
<xsl:variable name="para_nob" select="'samefolketsdag.html?id=632946'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samefolketsdag_id_632946.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
