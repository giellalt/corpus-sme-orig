...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Fadda/eanadoalu-biras--ja-eanapolitihkka/eanadoalu-kultureanadat.html?id=503486'"/>
...
<xsl:variable name="para_nob" select="'landbrukets-kulturlandskap.html?id=503486'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="landbrukets-kulturlandskap_id_503486.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
