...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/dok/hoeringer/hoeringsdok/2009/gulaskuddan---rammaplana-lahkaasahus-sam/gulaskuddancealkamuat.html?id=588786'"/>
...
<xsl:variable name="para_nob" select="'horingsuttalelser.html?id=588786'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horingsuttalelser_id_588786.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
