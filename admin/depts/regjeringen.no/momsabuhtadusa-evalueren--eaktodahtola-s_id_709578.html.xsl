...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/momsabuhtadusa-evalueren--eaktodahtola-s.html?id=709578'"/>
...
<xsl:variable name="para_nob" select="'evaluering-av-momskompensasjonsordningen.html_id=709578'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="evaluering-av-momskompensasjonsordningen_id_709578.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
