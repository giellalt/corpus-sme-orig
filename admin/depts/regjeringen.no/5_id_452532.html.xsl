...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/8/5.html?id=452532'"/>
<xsl:variable name="title" select="'4.8.5 Regulerenráđđái ... - regjeringen.no'"/>
