...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/Vuollasa-asahusat/Mearraolbmuid-penuvdnaoadju.html?id=85807'"/>
...
<xsl:variable name="para_nob" select="'pensjonstrygden_for_sjomenn.html?id=85807'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pensjonstrygden_for_sjomenn_id_85807.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
