...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/15/8/3.html?id=514500'"/>
<xsl:variable name="title" select="'15.8.3 Museat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1749'"/>
