...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/badjel-60-miljovnna-musihkkasuorgai-lass.html?id=701354'"/>
...
<xsl:variable name="para_nno" select="'over-60-millionar-til-musikkfeltet-opptr.html_id=701354'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="over-60-millionar-til-musikkfeltet-opptr_id_701354.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
