...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aigeguovdil/sartnit-ja-artihkkalat/ministeren/taler-og-artikler-av-finansminister/2011/2012-stahtabueahtta-lea-bueahtta-barggu-.html?id=660119'"/>
...
<xsl:variable name="para_nob" select="'finanstale-nasjonalbudsjettet-2012.html_id=660119'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="finanstale-nasjonalbudsjettet-2012_id_660119.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
