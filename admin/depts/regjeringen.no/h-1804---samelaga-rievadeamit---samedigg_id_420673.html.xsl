...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Dokumeanttat/Johtoallosat/2004/h-1804---samelaga-rievadeamit---samedigg.html?id=420673'"/>
...
<xsl:variable name="para_nob" select="'Rundskriv-H-1804.html?id=420673'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rundskriv-h-1804_id_420673.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
