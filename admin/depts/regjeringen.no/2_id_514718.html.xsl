...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/9/2.html?id=514718'"/>
<xsl:variable name="title" select="'2.9.2 Máhttolokten –... - regjeringen.no'"/>
