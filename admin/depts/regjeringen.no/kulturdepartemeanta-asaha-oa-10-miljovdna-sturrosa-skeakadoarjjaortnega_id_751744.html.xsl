...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2014/Kulturdepartemeanta-asaha-oa-10-miljovdna-sturrosa-skeakadoarjjaortnega.html?id=751744'"/>
...
<xsl:variable name="para_nno" select="'kulturdepartementet-innforer-ny-gavefors.html_id=751744'"/>
