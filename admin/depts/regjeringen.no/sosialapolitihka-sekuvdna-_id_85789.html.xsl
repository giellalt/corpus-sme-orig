...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/algopolitihkala-ossodat-/Sosialapolitihka-sekuvdna-.html?id=85789'"/>
...
<xsl:variable name="para_nob" select="'seksjon_for_sosialpolitikk.html?id=85789'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon_for_sosialpolitikk_id_85789.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
