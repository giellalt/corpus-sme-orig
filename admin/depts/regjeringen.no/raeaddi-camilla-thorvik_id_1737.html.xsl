...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/Departemeantta-birra/Organisauvdna/Ossodagat/Joiheaddjit--/Diehtojuohkinsekuvdna-/Raeaddi-Camilla-Thorvik.html?id=1737'"/>
...
<xsl:variable name="para_nob" select="'radgiver_camilla_thorvik.html?id=1737'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="radgiver_camilla_thorvik_id_1737.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
