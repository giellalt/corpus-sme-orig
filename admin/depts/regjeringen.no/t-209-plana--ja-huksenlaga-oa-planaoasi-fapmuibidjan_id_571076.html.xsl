...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan.html?id=571076'"/>
...
<xsl:variable name="para_nob" select="'ikraftsetting-plandel-plan-bygningslov.html?id=571076'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ikraftsetting-plandel-plan-bygningslov_id_571076.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
