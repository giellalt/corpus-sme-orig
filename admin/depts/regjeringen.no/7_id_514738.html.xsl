...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/11/7.html?id=514738'"/>
<xsl:variable name="title" select="'2.11.7 Sámi buhcciid... - regjeringen.no'"/>
