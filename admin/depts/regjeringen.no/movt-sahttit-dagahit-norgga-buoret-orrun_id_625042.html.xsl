...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/nyheter/2010/movt-sahttit-dagahit-norgga-buoret-orrun.html?id=625042'"/>
...
<xsl:variable name="para_nob" select="'hvordan-kan-vi-gjore-norge-til-et-bedre-.html?id=625042'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="hvordan-kan-vi-gjore-norge-til-et-bedre-_id_625042.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
