...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/aigeguovdil/Oasat/2012/mis-galga-leat-buorre-suodjalus-heivehuv.html?id=685751'"/>
...
<xsl:variable name="para_nob" select="'--vi-skal-ha-et-godt-forsvar-for-var-tid.html_id=685751'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vi-skal-ha-et-godt-forsvar-for-var-tid_id_685751.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
