...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/pressesenter/pressemeldinger/2014/Oahpaheaddjifitnu-eanet-bivnnut.html?id=752534'"/>
...
<xsl:variable name="para_nob" select="'Lareryrket-mer-attraktivt.html_id=752534'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lareryrket-mer-attraktivt_id_752534.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
