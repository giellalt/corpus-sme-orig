...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/preassadieahusat/2012/50-miljovnna-ruvnno-meloy-suohkanii.html?id=682350'"/>
...
<xsl:variable name="para_nno" select="'50-millionar-kroner-til-meloy-kommune.html_id=682350'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="50-millionar-kroner-til-meloy-kommune_id_682350.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
