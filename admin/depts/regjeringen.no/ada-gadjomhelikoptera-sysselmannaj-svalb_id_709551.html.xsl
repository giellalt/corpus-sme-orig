...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/2012/ada-gadjomhelikoptera-sysselmannaj-svalb.html?id=709551'"/>
...
<xsl:variable name="para_nob" select="'nye-redningshelikoptre-til-sysselmannen-.html_id=709551'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nye-redningshelikoptre-til-sysselmannen-_id_709551.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
