...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/aigeguovdil/oddasat/2012/oa-raporta-sami-dutkama-ja-alit-oahpahus.html?id=686289'"/>
...
<xsl:variable name="para_nob" select="'ny-rapport-om-samisk-forskning-og-hoyere.html_id=686289'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ny-rapport-om-samisk-forskning-og-hoyere_id_686289.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
