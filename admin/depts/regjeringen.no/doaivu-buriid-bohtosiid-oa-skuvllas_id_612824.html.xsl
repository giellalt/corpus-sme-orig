...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/smk/aktuelt/nyheter/2010/doaivu-buriid-bohtosiid-oa-skuvllas.html?id=612824'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/aktuelt/nyheter/2010/doaivu-buriid-bohtosiid-oa-skuvllas.html?id=612824'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Doaivu buriid bohtosiid ođđa skuvllas - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'f21.html?id=612824'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="f21_id_612824.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
