...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/aigeguovdil/Oasat/2012/giittii-mood-syria-barggu-ovddas.html?id=697002'"/>
...
<xsl:variable name="para_nob" select="'takket-mood-for-innsatsen-i-syria.html_id=697002'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="takket-mood-for-innsatsen-i-syria_id_697002.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
