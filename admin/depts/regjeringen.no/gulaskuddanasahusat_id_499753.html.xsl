...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/dokumeanttat/hoeringer/hoeringsdok/2008/Gulaskuddan--rievdadanevttohusat-lahkaas/Gulaskuddanasahusat.html?id=499753'"/>
...
<xsl:variable name="para_nob" select="'-3.html?id=499753'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="3_id_499753.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
