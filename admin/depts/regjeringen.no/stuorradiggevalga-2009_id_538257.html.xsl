...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valga-portal/stuorradiggevalga-2009.html?id=538257'"/>
...
<xsl:variable name="para_nob" select="'sametingsvalg.html?id=538257'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sametingsvalg_id_538257.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
