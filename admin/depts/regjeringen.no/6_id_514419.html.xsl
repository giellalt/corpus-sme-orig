...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/10/6.html?id=514419'"/>
<xsl:variable name="title" select="'10.6 Mánáidsuodjalus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1723'"/>
