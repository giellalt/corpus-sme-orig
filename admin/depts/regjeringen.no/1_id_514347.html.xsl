...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/5/3/1.html?id=514347'"/>
<xsl:variable name="title" select="'5.3.1 Dásseárvobargu... - regjeringen.no'"/>
