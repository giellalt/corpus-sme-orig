...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/oed/aktuelt/nyheter/2012/galledii-samedikki.html?id=684080'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Galledii Sámedikki - regjeringen.no'"/>
