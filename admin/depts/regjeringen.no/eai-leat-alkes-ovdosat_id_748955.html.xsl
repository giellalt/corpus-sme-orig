...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/aigeguovdil/taler_artikler/ministeren/taler-og-artikler-av-forsvarsminister-in/2014/eai-leat-alkes-ovdosat.html?id=748955'"/>
...
<xsl:variable name="para_nob" select="'ingen-enkle-losninger.html_id=748955'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ingen-enkle-losninger_id_748955.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
