...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/12-Sirdasannjuolggadusat.html?id=571104'"/>
...
<xsl:variable name="para_nob" select="'12-overgangsbestemmelser--34-2.html?id=571104'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="12-overgangsbestemmelser--34-2_id_571104.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
