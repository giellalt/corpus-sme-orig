...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Referansajoavku-lobihis-fiilajuogadeami-birra.html?id=594102'"/>
...
<xsl:variable name="para_nob" select="'Referansegruppe-om-ulovlig-fildeling.html?id=594102'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="referansegruppe-om-ulovlig-fildeling_id_594102.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
