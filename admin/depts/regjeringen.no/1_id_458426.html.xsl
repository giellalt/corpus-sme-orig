...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/3/1.html?id=458426'"/>
<xsl:variable name="title" select="'3.1 Riektevuođus – manne... - regjeringen.no'"/>
