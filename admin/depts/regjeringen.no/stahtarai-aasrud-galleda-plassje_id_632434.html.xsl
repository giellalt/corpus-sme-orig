...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2011/stahtarai-aasrud-galleda-plassje.html?id=632434'"/>
...
<xsl:variable name="para_nob" select="'statsrad-aasrud-besoker-roros1.html?id=632434'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsrad-aasrud-besoker-roros1_id_632434.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
