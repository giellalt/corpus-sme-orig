...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aigeguovdil/nyheter/2012/lahkaasahus-ruhtadanportala-dieihangeatn.html?id=700259'"/>
...
<xsl:variable name="para_nob" select="'forskrift-om-opplysningsplikt-til-finans.html_id=700259'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="forskrift-om-opplysningsplikt-til-finans_id_700259.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
