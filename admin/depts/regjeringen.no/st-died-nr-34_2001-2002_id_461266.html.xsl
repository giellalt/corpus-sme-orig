...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/dok/regpubl/stmeld/20012002/st-died-nr-34_2001-2002.html?id=461266'"/>
<xsl:variable name="title" select="'St.died. nr. 34 (2001-2002) - regjeringen.no'"/>
