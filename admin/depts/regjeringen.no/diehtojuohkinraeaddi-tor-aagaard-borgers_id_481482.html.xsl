...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/Stahtaministara-kantuvra/org/avdelinger/kommunikasjonsseksjonen/diehtojuohkinraeaddi-tor-aagaard-borgers.html?id=481482'"/>
