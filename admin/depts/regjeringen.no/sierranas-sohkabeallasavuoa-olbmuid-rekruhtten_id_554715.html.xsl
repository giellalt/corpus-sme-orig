...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/fadd/Balka--ja-bargoveahkapolitihkka/laddjiivuohta-stahtas/Sierranas-sohkabeallasavuoa-olbmuid-rekruhtten.html?id=554715'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rekruttering-av-personer-med-ulik-seksue_id_554715.html" xml:lang="nob"/>
</xsl:variable>
