...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/gulahallanovttadat/Gulahallanhoavda-Frode-Jacobsen.html?id=450403'"/>
