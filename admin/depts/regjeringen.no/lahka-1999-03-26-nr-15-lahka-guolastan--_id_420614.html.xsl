...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Dokumeanttat/Lagat-ja-lahkaasahusat/lagat-/lahka-1999-03-26-nr-15-lahka-guolastan--.html?id=420614'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'LÁHKA 1999-03-26 nr 15: Láhka guolástan- ja bivdinvuoigatvuođa birra (oassálastinláhka). - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'2500'"/>
