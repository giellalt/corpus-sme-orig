...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/dok/hoeringer/hoeringsdok/2009/gulaskuddan---rammaplana-lahkaasahus-sam/gulaskuddannotahtta.html?id=588787'"/>
...
<xsl:variable name="para_nob" select="'horingsnotat.html?id=588787'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horingsnotat_id_588787.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
