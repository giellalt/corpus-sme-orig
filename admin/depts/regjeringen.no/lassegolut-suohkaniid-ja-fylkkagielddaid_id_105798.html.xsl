...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Raporttat-ja-planat/Raporttat-/2002/lassegolut-suohkaniid-ja-fylkkagielddaid.html?id=105798'"/>
...
<xsl:variable name="para_nob" select="'utgifter-knyttet-til-tospraklighet-i-kom.html?id=105798'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utgifter-knyttet-til-tospraklighet-i-kom_id_105798.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
