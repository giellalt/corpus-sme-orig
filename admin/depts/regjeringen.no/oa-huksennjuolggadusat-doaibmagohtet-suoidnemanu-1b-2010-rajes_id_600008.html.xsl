...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/aktuelt/Oasat/2010/Oa-huksennjuolggadusat-doaibmagohtet-suoidnemanu-1b-2010-rajes.html?id=600008'"/>
...
<xsl:variable name="para_nob" select="'nye-byggeregler-fra-1-juli-2010.html?id=600008'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nye-byggeregler-fra-1-juli-2010_id_600008.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
