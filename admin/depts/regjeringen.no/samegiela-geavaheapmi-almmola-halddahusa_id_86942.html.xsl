...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Samepolitihkka/Samegiela-geavaheapmi/Samegiela-geavaheapmi-almmola-halddahusa.html?id=86942'"/>
