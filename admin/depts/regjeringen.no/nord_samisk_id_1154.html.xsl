...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/fadda/nord_samisk.html?id=1154'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="high-north_id_1154.html" xml:lang="eng"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
