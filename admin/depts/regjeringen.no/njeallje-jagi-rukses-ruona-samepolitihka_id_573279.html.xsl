...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/njeallje-jagi-rukses-ruona-samepolitihka.html?id=573279'"/>
...
<xsl:variable name="para_nob" select="'fire-ar-med-rod-gronn-samepolitikk.html?id=573279'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fire-ar-med-rod-gronn-samepolitikk_id_573279.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
