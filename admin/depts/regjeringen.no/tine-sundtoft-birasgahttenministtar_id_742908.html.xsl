...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/preassaguovdda/Preassadieahusat/2013/tine-sundtoft-birasgahttenministtar.html?id=742908'"/>
