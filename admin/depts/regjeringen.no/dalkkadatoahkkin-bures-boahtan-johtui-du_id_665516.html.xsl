...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Fadda/Preassaguovdda/2011/dalkkadatoahkkin-bures-boahtan-johtui-du.html?id=665516'"/>
...
<xsl:variable name="para_nob" select="'klimamotet-i-durban-er-kommet-godt-i-gan.html_id=665516'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="klimamotet-i-durban-er-kommet-godt-i-gan_id_665516.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
