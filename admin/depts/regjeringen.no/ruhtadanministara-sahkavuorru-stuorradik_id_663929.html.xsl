...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aigeguovdil/sartnit-ja-artihkkalat/ministeren/taler-og-artikler-av-finansminister/2011/ruhtadanministara-sahkavuorru-stuorradik.html?id=663929'"/>
...
<xsl:variable name="para_nob" select="'finansministerens-innlegg-i-stortinget-o.html_id=663929'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="finansministerens-innlegg-i-stortinget-o_id_663929.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
