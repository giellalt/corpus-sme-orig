...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/Preassadieahusat/2012/ealahusfoanda-nanne-baikkala-ealahus--ja.html?id=671750'"/>
...
<xsl:variable name="para_nno" select="'naringsfond-styrker-lokal-narings--og-sa.html_id=671750'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="naringsfond-styrker-lokal-narings--og-sa_id_671750.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
