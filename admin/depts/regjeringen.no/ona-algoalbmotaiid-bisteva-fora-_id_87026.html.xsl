...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Samepolitihkka/Riikkaidgaskasa-algoalbmotbargu/ONa-algoalbmotaiid-bisteva-fora-.html?id=87026'"/>
