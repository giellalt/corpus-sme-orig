...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/16/2/5.html?id=458633'"/>
<xsl:variable name="title" select="'16.2.5 Arktalaš Ráđđi - regjeringen.no'"/>
