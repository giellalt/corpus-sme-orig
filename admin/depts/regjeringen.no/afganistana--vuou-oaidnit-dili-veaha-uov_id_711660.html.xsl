...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/aigeguovdil/taler_artikler/ministeren/taler-og-artikler-av-forsvarsminister-an/2013/afganistana--vuou-oaidnit-dili-veaha-uov.html?id=711660'"/>
...
<xsl:variable name="para_nob" select="'afghanistan---grunn-til-forsiktig-optimi.html_id=711660'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="afghanistan---grunn-til-forsiktig-optimi_id_711660.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
