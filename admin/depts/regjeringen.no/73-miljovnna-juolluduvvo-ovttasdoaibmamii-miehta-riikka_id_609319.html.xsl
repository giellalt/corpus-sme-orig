...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/hod/pressesenter/pressemeldinger/2010/73-miljovnna-juolluduvvo-ovttasdoaibmamii-miehta-riikka.html?id=609319'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/hod/pressesenter/pressemeldinger/2010/73-miljovnna-juolluduvvo-ovttasdoaibmamii-miehta-riikka.html?id=609319'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'73 miljovnna juolluduvvo ovttasdoaibmamii miehtá riikka - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'73-millioner-til-samhandling-landet-rundt.html?id=609319'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="73-millioner-til-samhandling-landet-rundt_id_609319.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
