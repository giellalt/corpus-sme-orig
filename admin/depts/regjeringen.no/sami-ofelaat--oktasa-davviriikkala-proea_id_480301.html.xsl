...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2007/Sami-ofelaat--oktasa-davviriikkala-proea.html?id=480301'"/>
...
<xsl:variable name="para_nob" select="'108.html?id=480301'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="108_id_480301.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
