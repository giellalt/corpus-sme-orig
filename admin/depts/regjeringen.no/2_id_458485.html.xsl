...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/7/8/2.html?id=458485'"/>
<xsl:variable name="title" select="'7.8.2 Sámegiela almmolaš... - regjeringen.no'"/>
