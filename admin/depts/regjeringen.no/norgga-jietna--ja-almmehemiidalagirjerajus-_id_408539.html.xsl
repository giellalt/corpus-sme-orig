...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/Vuollasa-asahusat/Norgga-jietna--ja-almmehemiidalagirjerajus-.html?id=408539'"/>
