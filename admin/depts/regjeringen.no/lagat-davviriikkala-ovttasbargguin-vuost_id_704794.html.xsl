...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/2012/lagat-davviriikkala-ovttasbargguin-vuost.html?id=704794'"/>
...
<xsl:variable name="para_nob" select="'tettere-nordisk-samarbeid-i-kampen-mot-k.html_id=704794'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tettere-nordisk-samarbeid-i-kampen-mot-k_id_704794.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
