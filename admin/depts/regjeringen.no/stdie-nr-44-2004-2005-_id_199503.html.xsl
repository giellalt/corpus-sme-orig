...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-.html?id=199503'"/>
<xsl:variable name="title" select="'St.dieđ. nr. 44 (2004-2005)  - regjeringen.no'"/>
