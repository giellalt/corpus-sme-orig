...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/Justisdepartementta-birra/underliggende-etater/Olgoriikkalaaidnammagoddi-ONA.html?id=85818'"/>
...
<xsl:variable name="para_nob" select="'utlendingsnemda_une.html?id=85818'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utlendingsnemda_une_id_85818.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
