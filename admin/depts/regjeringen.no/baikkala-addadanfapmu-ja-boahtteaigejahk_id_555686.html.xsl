...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2009-2/baikkala-addadanfapmu-ja-boahtteaigejahk.html?id=555686'"/>
...
<xsl:variable name="para_nno" select="'lokal-vekstkraft-og-framtidstru.html?id=555686'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lokal-vekstkraft-og-framtidstru_id_555686.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
