...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/valatallanossodat/Sekuvdna-VA-2.html?id=1486'"/>
...
<xsl:variable name="para_nob" select="'seksjon_id_2.html?id=1486'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon_id_2_id_1486.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
