...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2012/20122013-gonagasreappa-bivddu-muddemat.html?id=696191'"/>
...
<xsl:variable name="para_nob" select="'reguleringer-for-fangst-av-kongekrabbe-i.html_id=696191'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reguleringer-for-fangst-av-kongekrabbe-i_id_696191.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
