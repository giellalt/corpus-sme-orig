...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/infoteam/diehtojuohkinhoavda.html?id=445146'"/>
