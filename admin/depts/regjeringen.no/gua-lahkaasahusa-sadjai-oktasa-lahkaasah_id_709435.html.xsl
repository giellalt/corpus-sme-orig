...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2012/gua-lahkaasahusa-sadjai-oktasa-lahkaasah.html?id=709435'"/>
...
<xsl:variable name="para_nob" select="'erstatter-seks-forskrifter-med-en-felles.html_id=709435'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="erstatter-seks-forskrifter-med-en-felles_id_709435.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
