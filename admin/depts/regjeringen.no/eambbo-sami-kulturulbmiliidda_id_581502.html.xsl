...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2009/eambbo-sami-kulturulbmiliidda.html?id=581502'"/>
...
<xsl:variable name="para_nno" select="'meir-til-samiske-kulturformal.html?id=581502'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="meir-til-samiske-kulturformal_id_581502.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
