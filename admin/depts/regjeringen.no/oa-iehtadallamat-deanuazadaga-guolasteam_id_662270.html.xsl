...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Fadda/Preassaguovdda/2011/oa-iehtadallamat-deanuazadaga-guolasteam.html?id=662270'"/>
...
<xsl:variable name="para_nob" select="'solheim-til-finland-for-a-diskutere-laks.html_id=662270'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="solheim-til-finland-for-a-diskutere-laks_id_662270.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
