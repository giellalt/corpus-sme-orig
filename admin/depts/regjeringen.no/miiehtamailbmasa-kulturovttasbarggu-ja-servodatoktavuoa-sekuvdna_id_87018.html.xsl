...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Kultuvrra-norggaoahpisteami-ja-protokollaossodat/Miiehtamailbmasa-kulturovttasbarggu-ja-servodatoktavuoa-sekuvdna.html?id=87018'"/>
...
<xsl:variable name="para_nob" select="'seksjon-for-globalt-kultursamarbeid.html?id=87018'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon-for-globalt-kultursamarbeid_id_87018.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
