...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2010/Norgga-ruoa-ovttasbargu-nannejuvvo-vel-eambbo.html?id=601912'"/>
...
<xsl:variable name="para_nob" select="'Norsk-russisk-samarbeid-ytterligere-styrket.html?id=601912'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norsk-russisk-samarbeid-ytterligere-styrket_id_601912.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
