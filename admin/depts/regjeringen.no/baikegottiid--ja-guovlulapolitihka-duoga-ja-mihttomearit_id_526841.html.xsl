...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/guovllu--ja-regionalapolitihkka/Baikegottiid--ja-guovlulapolitihka-duoga-ja-mihttomearit.html?id=526841'"/>
...
<xsl:variable name="para_nob" select="'bakgrunn-og-malsettinger-i-distrikts--og.html?id=526841'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bakgrunn-og-malsettinger-i-distrikts--og_id_526841.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
