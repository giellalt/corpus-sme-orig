...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/275-suohkana-oot-ruaid-kultuvrrala-vazzinsoappis.html?id=620465'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'275 suohkana ožžot ruđaid kultuvrralaš vázzinsoappis - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1495'"/>
...
<xsl:variable name="para_nob" select="'275-kommuner-far-midler-fra-den-kulturel.html?id=620465'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="275-kommuner-far-midler-fra-den-kulturel_id_620465.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
