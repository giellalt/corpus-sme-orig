...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/oa-sami-ofelaat.html?id=522263'"/>
...
<xsl:variable name="para_nob" select="'nye-samiske-veivisere.html?id=522263'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nye-samiske-veivisere_id_522263.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
