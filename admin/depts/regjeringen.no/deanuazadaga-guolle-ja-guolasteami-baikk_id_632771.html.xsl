...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/dokumeanttat/lagat-ja-lahkaasahusat/lahkaasahusat/2011/deanuazadaga-guolle-ja-guolasteami-baikk.html?id=632771'"/>
...
<xsl:variable name="para_nob" select="'forskrift-om-lokal-forvaltning-av-fisk-o.html_id=632771'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-om-lokal-forvaltning-av-fisk-o_id_632771.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
