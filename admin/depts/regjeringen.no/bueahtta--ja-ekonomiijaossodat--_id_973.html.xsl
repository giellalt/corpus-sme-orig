...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/Bueahtta--ja-ekonomiijaossodat--.html?id=973'"/>
