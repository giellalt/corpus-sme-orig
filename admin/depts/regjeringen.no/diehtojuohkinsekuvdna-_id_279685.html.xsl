...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/Departemeantta-birra/Organisauvdna/Ossodagat/Joiheaddjit--/Diehtojuohkinsekuvdna-.html?id=279685'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsseksjonen.html?id=279685'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonsseksjonen_id_279685.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
