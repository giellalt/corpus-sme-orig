...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/dokumeanttat/hoeringer/hoeringsdok/2008/Gulaskuddan--rievdadanevttohusat-lahkaas/horingsnotat.html?id=499752'"/>
...
<xsl:variable name="para_nob" select="'-2.html?id=499752'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="2_id_499752.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
