...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/Preassadieahusat/2011/25-miljovnna-ruvdno-orrunmiellaruat-davv.html?id=653875'"/>
...
<xsl:variable name="para_nno" select="'25-millionar-kroner-i-bulystmidlar-til-o.html_id=653875'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="25-millionar-kroner-i-bulystmidlar-til-o_id_653875.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
