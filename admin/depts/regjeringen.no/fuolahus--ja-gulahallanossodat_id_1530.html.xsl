...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Fuolahus--ja-gulahallanossodat.html?id=1530'"/>
...
<xsl:variable name="para_nob" select="'serviceavdelingen.html?id=1530'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="serviceavdelingen_id_1530.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
