...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2011/mars-11/mearradus-finnmarkku-boazologuid-birra.html?id=635550'"/>
...
<xsl:variable name="para_nob" select="'reintallvedtak.html_id=635550'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reintallvedtak_id_635550.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
