...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/oasat/2012/bisan-jurdil-deaddel.html?id=701000'"/>
...
<xsl:variable name="para_nob" select="'stopp-tenk-klikk-.html_id=701000'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="stopp-tenk-klikk-_id_701000.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
