...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/13/3.html?id=514461'"/>
<xsl:variable name="title" select="'13.3 Eará ásahusaid ... - regjeringen.no'"/>
