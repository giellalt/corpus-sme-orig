...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2008/stahtaministtar-dieiha-oa-doaibmabijuid-.html?id=537467'"/>
...
<xsl:variable name="para_nob" select="'statsministeren-varsler-nye-tiltak-mot-f.html?id=537467'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsministeren-varsler-nye-tiltak-mot-f_id_537467.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
