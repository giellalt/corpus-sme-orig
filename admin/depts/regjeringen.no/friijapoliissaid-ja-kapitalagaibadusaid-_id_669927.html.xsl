...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/preassaguovdda/pressemeldinger/2012/friijapoliissaid-ja-kapitalagaibadusaid-.html?id=669927'"/>
