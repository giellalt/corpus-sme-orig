...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/Odeldiggeproposiuvnnat/20032004/od-prp-nr-26_2003-2004/2/3.html?id=176799'"/>
<xsl:variable name="title" select="'2.3 Lagabut departemeantta evttohusa... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'661'"/>
