...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Gelbbolavuoa--ja-resursaossodat.html?id=1531'"/>
...
<xsl:variable name="para_nob" select="'kompetanse_ressurser.html?id=1531'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kompetanse_ressurser_id_1531.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
