...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/2.html?id=458416'"/>
<xsl:variable name="title" select="'2 Sámi ja dáža historjá... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'4603'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="2_id_195310.html" xml:lang="nob"/>
</xsl:variable>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               ...
               <xsl:with-param name="target" select="'seailluheami,  dahje «/'"/>
               <xsl:with-param name="replacement" select="'seailluheami,  dahje /'"/>
