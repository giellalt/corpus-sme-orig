...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dok/lagat-ja-njuolggadusat-/lover/Mineralalahka.html?id=597815'"/>
...
<xsl:variable name="para_nob" select="'Mineralloven.html?id=597815'"/>
