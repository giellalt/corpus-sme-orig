...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2012/loahpaha-riddodivada.html?id=701239'"/>
...
<xsl:variable name="para_nob" select="'avvikler-kystavgiften.html_id=701239'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avvikler-kystavgiften_id_701239.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
