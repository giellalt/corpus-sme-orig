...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2010/norga-ja-ruoa-vuollaialliba-iehtadusa.html?id=613684'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2010/norga-ja-ruoa-vuollaialliba-iehtadusa.html?id=613684'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
