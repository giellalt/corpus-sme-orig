...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/aigeguovdil/nyheter/2014/lahkoeh-biejjine--vuorbbe-biejvijn--lihk.html?id=750445'"/>
...
<xsl:variable name="para_nob" select="'lahkoeh-biejjine--vuorbbe-biejvijn--lihk.html_id=750445'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lahkoeh-biejjine--vuorbbe-biejvijn--lihk_id_750445.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
