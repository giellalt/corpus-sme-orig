...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2011/stais-ja-vuollegis-bargguhisvuohta-norgg.html?id=659396'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stabil-og-lav-arbeidsledighet-i-norge_id_659396.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
