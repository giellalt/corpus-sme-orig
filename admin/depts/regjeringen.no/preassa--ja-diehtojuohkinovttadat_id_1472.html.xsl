...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/Justisdepartementta-birra/Organisauvdna/Ossodagat/preassa--ja-diehtojuohkinovttadat.html?id=1472'"/>
