...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Regionala-gaaldagaid-ja-ovdaneami-ossodat/Lulli--ja-Oarje-Afrihka-sekuvdna.html?id=1519'"/>
...
<xsl:variable name="para_nob" select="'afrikai.html?id=1519'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="afrikai_id_1519.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
