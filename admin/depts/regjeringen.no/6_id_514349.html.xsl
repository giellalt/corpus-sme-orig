...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/6.html?id=514349'"/>
<xsl:variable name="title" select="'5 Čálgoservodat  sámiid... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'10221'"/>
