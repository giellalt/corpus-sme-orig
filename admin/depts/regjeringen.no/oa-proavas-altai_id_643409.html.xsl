...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2011/oa-proavas-altai.html?id=643409'"/>
...
<xsl:variable name="para_nob" select="'ny-prost-i-alta.html_id=643409'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ny-prost-i-alta_id_643409.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
