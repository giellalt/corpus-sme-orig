...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/8-Gaskaboddasa-doaibmabidjogielddus.html?id=571099'"/>
...
<xsl:variable name="para_nob" select="'8-midlertidig-forbud-mot-tiltak.html?id=571099'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="8-midlertidig-forbud-mot-tiltak_id_571099.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
