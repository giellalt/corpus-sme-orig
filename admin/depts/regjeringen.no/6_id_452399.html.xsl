...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/6.html?id=452399'"/>
<xsl:variable name="title" select="'6 Sámi dearvvašvuođa- ... - regjeringen.no'"/>
