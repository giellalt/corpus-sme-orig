...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/Preassadieahusat/2011/40-miljovnna-kruvnno-oa-ealahusgardeprog.html?id=659546'"/>
...
<xsl:variable name="para_nno" select="'40-millionar-kroner-til-nytt-naringshage.html_id=659546'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="40-millionar-kroner-til-nytt-naringshage_id_659546.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
