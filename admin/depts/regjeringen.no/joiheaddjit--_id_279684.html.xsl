...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/Departemeantta-birra/Organisauvdna/Ossodagat/Joiheaddjit--.html?id=279684'"/>
...
<xsl:variable name="para_nob" select="'ledelse.html?id=279684'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ledelse_id_279684.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
