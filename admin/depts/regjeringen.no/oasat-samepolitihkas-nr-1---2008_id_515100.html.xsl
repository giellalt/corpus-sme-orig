...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Aigecallagat-ja-odasreivvet/2008/oasat-samepolitihkas-nr-1---2008.html?id=515100'"/>
...
<xsl:variable name="para_nob" select="'nytt-om-samepolitikken-nr-1---2008.html?id=515100'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nytt-om-samepolitikken-nr-1---2008_id_515100.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
