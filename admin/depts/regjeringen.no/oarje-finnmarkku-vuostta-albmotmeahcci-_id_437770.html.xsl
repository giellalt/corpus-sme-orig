...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Preassaguovdda/Preassadieahusat/2006/-Oarje-Finnmarkku-vuostta-albmotmeahcci-.html?id=437770'"/>
<xsl:variable name="title" select="'Oarje-Finnmárkku vuosttaš álbmotmeahcci lea ásahuvvon - regjeringen.no'"/>
