...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/Aigeguovdil/Oasat/2010/Arvvotallet-doaimmaid-dieuid-suddjema-varas.html?id=601338'"/>
...
<xsl:variable name="para_nno" select="'Sett-inn-tiltak-for-skjerming-av-informasjon.html?id=601338'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sett-inn-tiltak-for-skjerming-av-informasjon_id_601338.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
