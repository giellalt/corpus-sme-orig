...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2011/finnmarkkus-ja-oslos-lea-buozalmasjavkan.html?id=667571'"/>
...
<xsl:variable name="para_nob" select="'finnmark-og-oslo-har-redusert-sykefravar.html_id=667571'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="finnmark-og-oslo-har-redusert-sykefravar_id_667571.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
