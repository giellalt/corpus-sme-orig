...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/aktuelt/nyheter/2012/evttoha-muddejuvvon-pd-strategiija.html?id=696583'"/>
...
<xsl:variable name="para_nob" select="'foreslar-justert-pd-strategi.html_id=696583'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="foreslar-justert-pd-strategi_id_696583.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
