...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/2/5.html?id=452509'"/>
<xsl:variable name="title" select="'4.2.5 Sámelága giellanjuolggadusaid... - regjeringen.no'"/>
