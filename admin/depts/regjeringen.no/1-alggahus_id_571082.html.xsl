...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/1-Alggahus.html?id=571082'"/>
...
<xsl:variable name="para_nob" select="'1-innledning.html?id=571082'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="1-innledning_id_571082.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
