...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/8/15.html?id=461238'"/>
<xsl:variable name="title" select="'8.15 Orohat ja orohatstivren - regjeringen.no'"/>
