...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/8/1/3.html?id=514375'"/>
<xsl:variable name="title" select="'8.1.3 Sámedikki hálddašanbargamušat ... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'671'"/>
