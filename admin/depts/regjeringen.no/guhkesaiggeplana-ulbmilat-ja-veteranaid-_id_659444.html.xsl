...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/pressesenter/pressemeldinger/2011/guhkesaiggeplana-ulbmilat-ja-veteranaid-.html?id=659444'"/>
...
<xsl:variable name="para_nob" select="'nar-malene-for-langtidsplanen-og-veteran.html_id=659444'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nar-malene-for-langtidsplanen-og-veteran_id_659444.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
