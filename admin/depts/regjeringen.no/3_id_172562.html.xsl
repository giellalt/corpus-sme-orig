...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/Odeldiggeproposiuvnnat/20022003/od-prp-nr-34_2002-2003/3.html?id=172562'"/>
<xsl:variable name="title" select="'3 Hálddahuslaš ja ekonomalaš... - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="3_id_172553.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
