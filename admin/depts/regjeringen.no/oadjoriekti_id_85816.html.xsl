...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/Vuollasa-asahusat/oadjoriekti.html?id=85816'"/>
...
<xsl:variable name="para_nob" select="'trygderetten.html?id=85816'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="trygderetten_id_85816.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
