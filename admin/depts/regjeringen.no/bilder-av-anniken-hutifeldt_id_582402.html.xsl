...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/kulturministtar-anniken-huitfeldt/bilder-av-anniken-hutifeldt.html?id=582402'"/>
...
<xsl:variable name="para_nob" select="'bilder-av-anniken-huitfeldt.html?id=582402'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bilder-av-anniken-huitfeldt_id_582402.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
