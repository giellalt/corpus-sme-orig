...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/1866-miljovnna-ruvdno-guovlula-ovdaneapm.html?id=619637'"/>
...
<xsl:variable name="para_nno" select="'xx-millionar-kroner-til-regional-utvikli.html?id=619637'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="xx-millionar-kroner-til-regional-utvikli_id_619637.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
