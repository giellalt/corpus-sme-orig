...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/Eara-politihkala-njunnoat/politihkala-raeaddi-jon-reidar-oyan.html?id=583178'"/>
