...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/statsbygg.html?id=440426'"/>
...
<xsl:variable name="para_nob" select="'statsbygg.html?id=440426'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsbygg_id_440426.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
