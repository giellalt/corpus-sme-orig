...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/Halddahusla-joihus-/departemeantarai-helge-m-sonneland.html?id=380702'"/>
