...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/5/1.html?id=452518'"/>
<xsl:variable name="title" select="'4.5.1 Ráđđehusa  ja... - regjeringen.no'"/>
