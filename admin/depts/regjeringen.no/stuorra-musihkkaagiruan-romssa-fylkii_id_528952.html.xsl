...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2008/stuorra-musihkkaagiruan-romssa-fylkii.html?id=528952'"/>
...
<xsl:variable name="para_nno" select="'stort-musikkloft-for-troms.html?id=528952'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stort-musikkloft-for-troms_id_528952.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
