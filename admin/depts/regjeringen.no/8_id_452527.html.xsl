...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/8.html?id=452527'"/>
<xsl:variable name="title" select="'4.8 Guolástusgažaldagat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'759'"/>
