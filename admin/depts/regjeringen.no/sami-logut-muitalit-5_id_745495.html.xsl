...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dokumeanttat/raporttat-ja-planat/raporttat/2012/sami-logut-muitalit-5.html?id=745495'"/>
...
<xsl:variable name="para_nob" select="'samiske-tall-forteller-5.html_id=745495'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samiske-tall-forteller-5_id_745495.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
