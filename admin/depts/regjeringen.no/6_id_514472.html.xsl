...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/13/6.html?id=514472'"/>
<xsl:variable name="title" select="'13.6 Strategiijat ja... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'598'"/>
