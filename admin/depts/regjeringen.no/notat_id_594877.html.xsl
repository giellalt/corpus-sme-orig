...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/horinger/horingsdokumenter/2009/Riikkaidgaskasa-boazodoalloguovdda--evttohus-rievdadit/notat.html?id=594877'"/>
...
<xsl:variable name="para_nob" select="'Horingsnotat.html?id=594877'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horingsnotat_id_594877.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
