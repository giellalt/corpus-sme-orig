...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/27-miljovnna-ruvnno-lassaneapmi-national.html?id=701343'"/>
...
<xsl:variable name="para_nno" select="'auke-til-nasjonale-kulturbygg-pa-27-mill.html_id=701343'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="auke-til-nasjonale-kulturbygg-pa-27-mill_id_701343.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
