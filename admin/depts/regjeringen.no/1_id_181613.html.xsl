...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/dokumeanttat/proposiuvnnat-ja-dieahusat/otprp/20042005/od-prp-nr-38_2004-2005/3/1/1.html?id=181613'"/>
<xsl:variable name="title" select="'3.1.1 Gulaskuddanevttohusa evttohusat - regjeringen.no'"/>
