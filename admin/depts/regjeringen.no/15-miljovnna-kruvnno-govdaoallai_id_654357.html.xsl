...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/preassadieahusat/2011/15-miljovnna-kruvnno-govdaoallai.html?id=654357'"/>
...
<xsl:variable name="para_nob" select="'15-millioner-kroner-til-bredband.html_id=654357'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="15-millioner-kroner-til-bredband_id_654357.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
