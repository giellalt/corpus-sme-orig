...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Fadda/vuovdedoallu-ja-bioenergiija/riikkaidgaskasa-vuovdepolitihkka.html?id=473276'"/>
...
<xsl:variable name="para_nob" select="'internasjonal-skogpolitikk.html?id=473276'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="internasjonal-skogpolitikk_id_473276.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
