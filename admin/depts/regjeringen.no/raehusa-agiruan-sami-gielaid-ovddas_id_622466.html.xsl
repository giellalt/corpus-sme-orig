...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/taler_og_artikler/av_ovrig_politisk_ledelse/taler-og-artikler-av-statssekretar-raimo/2010/raehusa-agiruan-sami-gielaid-ovddas.html?id=622466'"/>
...
<xsl:variable name="para_nob" select="'regjeringens-innsats-for-samiske-sprak.html?id=622466'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringens-innsats-for-samiske-sprak_id_622466.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
