...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/hod/pressesenter/pressemeldinger/2010/Alggaha-ehtala-njuolggadusaid-dearvvavuoadoaimmahagaid-stivramiellahtuid-varas.html?id=612730'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/hod/pressesenter/pressemeldinger/2010/Alggaha-ehtala-njuolggadusaid-dearvvavuoadoaimmahagaid-stivramiellahtuid-varas.html?id=612730'"/>
<xsl:variable name="text_encoding" select="''"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Álggaha ehtalaš njuolggadusaid dearvvašvuođadoaimmahagaid stivramiellahtuid várás - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'innforer-etiske-retningslinjer-for-styre.html?id=612730'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="innforer-etiske-retningslinjer-for-styre_id_612730.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
