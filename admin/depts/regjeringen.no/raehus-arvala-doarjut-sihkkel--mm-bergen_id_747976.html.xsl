...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/raehus-arvala-doarjut-sihkkel--mm-bergen.html?id=747976'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="fjordfiskenemnda-blir-oppretta.html_id=747988" xml:lang="nno"/>
