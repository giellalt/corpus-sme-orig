...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/pressesenter/pressemeldinger/2011/ceavzilis-boazodoallu.html?id=665411'"/>
...
<xsl:variable name="para_nob" select="'barekraftig-reindrift-.html_id=665411'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barekraftig-reindrift-_id_665411.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
