...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/aktuelt/nyheter/2012/gulaskuddan-ovddasvastadusdilalavuoaid-j.html?id=705611'"/>
...
<xsl:variable name="para_nob" select="'horing-om-eksplosiver.html_id=705611'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horing-om-eksplosiver_id_705611.html" xml:lang="nob"/>
