...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Regionala-gaaldagaid-ja-ovdaneami-ossodat/Ovddidanpolitihka-sekuvdna.html?id=86888'"/>
...
<xsl:variable name="para_nob" select="'seksjon-for-utviklingspolitikk.html?id=86888'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon-for-utviklingspolitikk_id_86888.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
