...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Fadda/vuovdedoallu-ja-bioenergiija/bioenergija.html?id=473274'"/>
...
<xsl:variable name="para_nob" select="'bioenergi.html?id=473274'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bioenergi_id_473274.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
