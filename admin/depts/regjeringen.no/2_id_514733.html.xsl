...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/11/2.html?id=514733'"/>
<xsl:variable name="title" select="'2.11.2 Stuorradiggedieđáhus... - regjeringen.no'"/>
