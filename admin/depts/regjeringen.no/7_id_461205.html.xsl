...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/4/7.html?id=461205'"/>
<xsl:variable name="title" select="'4.7 Boazodoallu kulturguoddin - regjeringen.no'"/>
