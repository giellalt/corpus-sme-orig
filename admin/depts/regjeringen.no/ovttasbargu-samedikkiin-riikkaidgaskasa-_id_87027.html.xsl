...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Samepolitihkka/Riikkaidgaskasa-algoalbmotbargu/Ovttasbargu-Samedikkiin-riikkaidgaskasa-.html?id=87027'"/>
