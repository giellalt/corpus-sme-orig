...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/2/14/5.html?id=610127'"/>
<xsl:variable name="title" select="'2.14.5 Ásahusdieđáhusa... - regjeringen.no'"/>
