...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/15/2/5.html?id=452440'"/>
<xsl:variable name="title" select="'1.2.5 Mánáidgárddit,... - regjeringen.no'"/>
