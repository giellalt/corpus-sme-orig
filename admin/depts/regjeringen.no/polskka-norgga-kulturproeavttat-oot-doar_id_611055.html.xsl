...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/polskka-norgga-kulturproeavttat-oot-doar.html?id=611055'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/polskka-norgga-kulturproeavttat-oot-doar.html?id=611055'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Polskka-Norgga kulturprošeavttat ožžot doarjaga - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'polsk-norske-kulturprosjekter-far-stotte.html?id=611055'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="polsk-norske-kulturprosjekter-far-stotte_id_611055.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
