...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/3/1/2.html?id=514320'"/>
<xsl:variable name="title" select="'3.1.2 Sami statistihkalaš... - regjeringen.no'"/>
