...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/20/2/9.html?id=458659'"/>
<xsl:variable name="title" select="'1.2.9 Sámedikki riikkaidgaskasaš... - regjeringen.no'"/>
