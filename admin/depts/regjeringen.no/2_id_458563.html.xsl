...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/12/6/2.html?id=458563'"/>
<xsl:variable name="title" select="'12.6.2 Ealligovat - regjeringen.no'"/>
