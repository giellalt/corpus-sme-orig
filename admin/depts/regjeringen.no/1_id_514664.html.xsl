...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/24/9/1.html?id=514664'"/>
<xsl:variable name="title" select="'1.9.1 Duodji - regjeringen.no'"/>
