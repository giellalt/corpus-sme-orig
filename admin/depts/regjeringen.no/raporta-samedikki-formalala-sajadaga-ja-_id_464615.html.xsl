...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2007/Raporta-Samedikki-formalala-sajadaga-ja-.html?id=464615'"/>
...
<xsl:variable name="para_nob" select="'41.html?id=464615'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="41_id_464615.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
