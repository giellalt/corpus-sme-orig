...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/statssekretar-raimo-valle/2008/sahkavuorru-davvila-albmogiid-beaivvi-ra.html?id=521648'"/>
=======
...
<xsl:variable name="para_nob" select="'apning-av-nordlige-folk-dag-under-den-17.html?id=521648'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="apning-av-nordlige-folk-dag-under-den-17_id_521648.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
