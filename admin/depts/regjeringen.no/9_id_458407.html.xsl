...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/1/9.html?id=458407'"/>
<xsl:variable name="title" select="'1.9 Sámi mánáid ja nuoraid... - regjeringen.no'"/>
