...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Giellarai-direktevravirgi-almmuhuvvo-oasit.html?id=621216'"/>
...
<xsl:variable name="para_nob" select="'stillingen-som-direktor-i-sprakradet-utl.html?id=621216'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stillingen-som-direktor-i-sprakradet-utl_id_621216.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
