...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/lagat-ja-lahkaasahusat/Njuolggadusat-ja-juridihkala-bagadusat/2007/iehtadus-Samedikki-ja-Birasgahttendepart.html?id=481195'"/>
...
<xsl:variable name="para_nob" select="'avtale-mellom-sametinget-og-miljoverndep.html?id=481195'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avtale-mellom-sametinget-og-miljoverndep_id_481195.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
