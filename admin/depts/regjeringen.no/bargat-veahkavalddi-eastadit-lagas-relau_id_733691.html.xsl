...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/20131/bargat-veahkavalddi-eastadit-lagas-relau.html?id=733691'"/>
...
<xsl:variable name="para_nob" select="'forsterket-innsats-mot-vold-i-nare-relas.html_id=733691'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forsterket-innsats-mot-vold-i-nare-relas_id_733691.html" xml:lang="nob"/>
