...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Riekteossodat/EES--gavpe--ja-birasriektesekuvdna-.html?id=87016'"/>
...
<xsl:variable name="para_nob" select="'seksjon-for-eos--handels--og-miljorett-.html?id=87016'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon-for-eos--handels--og-miljorett-_id_87016.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
