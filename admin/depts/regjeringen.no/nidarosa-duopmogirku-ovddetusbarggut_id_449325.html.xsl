...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/nidarosa-duopmogirku-ovddetusbarggut.html?id=449325'"/>
...
<xsl:variable name="para_nob" select="'nidaros-domkirkes-restaureringsarbeider.html?id=449325'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nidaros-domkirkes-restaureringsarbeider_id_449325.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
