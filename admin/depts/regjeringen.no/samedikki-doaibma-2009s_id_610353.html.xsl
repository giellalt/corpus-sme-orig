...
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/fad/oasat/nyheter/2010/samedikki-doaibma-2009s.html?id=610353'"/>
<xsl:variable name="title" select="'Sámedikki doaibma 2009:s - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'sametingets-virksomhet-i-2009.html?id=610353'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sametingets-virksomhet-i-2009_id_610353.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
