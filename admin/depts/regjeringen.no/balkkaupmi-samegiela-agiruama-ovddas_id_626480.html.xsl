...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/nyheter/2010/Balkkaupmi-samegiela-agiruama-ovddas.html?id=626480'"/>
...
<xsl:variable name="para_nno" select="'hedret-for-samisk-sprakinnsats.html?id=626480'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hedret-for-samisk-sprakinnsats_id_626480.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
