...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/laha-diliid-ealahusovddideapmai-ja-arvoh.html?id=514923'"/>
...
<xsl:variable name="para_nob" select="'legger-til-rette-for-naringsutvikling-og.html?id=514923'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="legger-til-rette-for-naringsutvikling-og_id_514923.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
