...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/asaha-sierra-jorgalanbalvalusa-regjering.html?id=562577'"/>
...
<xsl:variable name="para_nob" select="'etablerer-egen-samisk-oversettingstjenes.html?id=562577'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="etablerer-egen-samisk-oversettingstjenes_id_562577.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
