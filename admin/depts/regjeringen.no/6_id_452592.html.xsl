...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/2-2/6.html?id=452592'"/>
<xsl:variable name="title" select="'2.6 Dearvvašvuohta ja... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'725'"/>
