...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/pressesenter/pressemeldinger/2010/---buorre-muhto-avgadis-suodjalusbueahtt.html?id=619069'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="a-good-but-tight-defence-budget_id_619069.html"/>
        ...
        <parallel_text xml:lang="nob" location="et-godt-men-stramt-forsvarsbudsjett_id_619069.html"/>
