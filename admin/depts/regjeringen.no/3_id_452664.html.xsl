...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20062007/Stdie-nr-7-2006-2007-/2/3.html?id=452664'"/>
<xsl:variable name="title" select="'2.3 Ráđđádallamat - regjeringen.no'"/>
