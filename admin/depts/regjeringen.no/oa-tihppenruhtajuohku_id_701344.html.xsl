...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/oa-tihppenruhtajuohku.html?id=701344'"/>
...
<xsl:variable name="para_nno" select="'den-nye-tippenokkelen.html_id=701344'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="den-nye-tippenokkelen_id_701344.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
