...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Bagadusat-ja-gihppagat/2008/Diehtu-BOAZODOALLOLAGA-BIRRA-geassemanu-.html?id=495991'"/>
...
<xsl:variable name="para_nob" select="'orientering-om-reindriftsloven-av-15-jun.html?id=495991'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="orientering-om-reindriftsloven-av-15-jun_id_495991.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
