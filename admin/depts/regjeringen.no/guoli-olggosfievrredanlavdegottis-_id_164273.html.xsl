...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Departemeanta-birra/Daidda-gulleva-doaimmat/Guoli-olggosfievrredanlavdegottis-.html?id=164273'"/>
