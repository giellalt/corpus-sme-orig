...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/sartnit-ja-allosat/taler-og-artikler-av-landbruks--og-matmi/2014/sami-albmotbeaivi-guovvamanu-6-b-2014.html?id=750519'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samefolkets-dag-6-februar-2014_id_750519.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
