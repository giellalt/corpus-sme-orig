...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/gulahallanovttadat/Gulahallanravvejeaddji-Tor-Audun-Gram.html?id=592722'"/>
