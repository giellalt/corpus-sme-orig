...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/lahkarievdadus-sahtta-vaikkuhit-dasa-aht.html?id=520235'"/>
...
<xsl:variable name="para_nob" select="'lovendringer-kan-bidra-til-okt-deltakels.html?id=520235'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lovendringer-kan-bidra-til-okt-deltakels_id_520235.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
