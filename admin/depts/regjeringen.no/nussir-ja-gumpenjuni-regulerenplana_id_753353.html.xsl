...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kmd/preassaguovdda/preassadieahusat/2014/Nussir-ja-Gumpenjuni-regulerenplana.html?id=753353'"/>
...
<xsl:variable name="para_nob" select="'Reguleringsplan-for-Nussir-og-Ulveryggen.html_id=753353'"/>
