...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/aigeguovdil/oddasat/2013/haliida-guhkesaiggeplana-dutkama-ja-alit.html?id=745050'"/>
...
<xsl:variable name="para_nob" select="'vil-ha-en-langtidsplan-for-forskning-og-.html_id=745050'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="vil-ha-en-langtidsplan-for-forskning-og-_id_745050.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
