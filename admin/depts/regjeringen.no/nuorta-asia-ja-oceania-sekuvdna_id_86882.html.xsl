...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Regionala-gaaldagaid-ja-ovdaneami-ossodat/Nuorta-Asia-ja-Oceania-sekuvdna.html?id=86882'"/>
...
<xsl:variable name="para_nob" select="'asia_i.html?id=86882'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="asia_i_id_86882.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
