...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/hod/pressesenter/pressemeldinger/2010/Oaut-friddjakoartta-ohcama-haga-.html?id=606068'"/>
...
<xsl:variable name="para_nob" select="'Far-frikort-uten-a-soke-.html?id=606068'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="far-frikort-uten-a-soke-_id_606068.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
