...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/2/1.html?id=514683'"/>
<xsl:variable name="title" select="'2.2.1 Guovllulaš ovttasbargu - regjeringen.no'"/>
