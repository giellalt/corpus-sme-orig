...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/bismagodderait.html?id=449030'"/>
...
<xsl:variable name="para_nob" select="'bispedommeradene.html?id=449030'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bispedommeradene_id_449030.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
