...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/10.html?id=461250'"/>
<xsl:variable name="title" select="'10 Mearkkašumit iešguđet... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'12626'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="10_id_446576.html" xml:lang="nob"/>
</xsl:variable>
