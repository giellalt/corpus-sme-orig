...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Departemeanta-birra/Organisauvdna/Departemeantta-ossodagat/Gulahallanovttadat/Diehtojuohkinraeaddi.html?id=439360'"/>
