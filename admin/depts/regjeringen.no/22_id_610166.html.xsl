...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/2/22.html?id=610166'"/>
<xsl:variable name="title" select="'2.22 Hástalusat - regjeringen.no'"/>
