...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/Departemeantta-birra/Organisauvdna/Ossodagat/Joiheaddjit--/Diehtojuohkinsekuvdna-/Diehtojuohkinhoavda-Mette-Fossum-Beyer.html?id=374185'"/>
...
<xsl:variable name="para_nob" select="'prosjektleder-mette-fossum-beyer.html?id=374185'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="prosjektleder-mette-fossum-beyer_id_374185.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
