...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/fad/oasat/taler_og_artikler/av_ovrig_politisk_ledelse/taler-og-artikler-av-statssekretar-raimo/2009/diehtosiidda-rahpan-guovdageainnus.html?id=583864'"/>
=======
...
<xsl:variable name="para_nob" select="'apningen-av-diehtosiida-i-kautokeino.html?id=583864'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="apningen-av-diehtosiida-i-kautokeino_id_583864.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
