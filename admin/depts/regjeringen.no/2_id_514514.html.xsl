...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/15/12/2.html?id=514514'"/>
<xsl:variable name="title" select="'15.12.2 Dáidaga, arkitektuvrra ... - regjeringen.no'"/>
