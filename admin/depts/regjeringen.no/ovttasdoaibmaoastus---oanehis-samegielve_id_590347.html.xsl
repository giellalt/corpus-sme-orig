...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/hod/kampanjer/ovttasdoaibmanoastus-/ovttasdoaibmaoastus---oanehis-samegielve.html?id=590347'"/>
...
<xsl:variable name="para_nob" select="'samhandlingsreformen-pa-samisk.html?id=590347'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samhandlingsreformen-pa-samisk_id_590347.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
