...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Stuorit-valljivuoa-resursajoavku-nammaduvvon.html?id=607462'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Stuorit-valljivuoa-resursajoavku-nammaduvvon.html?id=607462'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Stuorit valljivuođa resursajoavku nammaduvvon - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'507'"/>
...
<xsl:variable name="para_nob" select="'Ressursgruppe-for-storre-mangfold-oppnevnt.html?id=607462'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ressursgruppe-for-storre-mangfold-oppnevnt_id_607462.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
