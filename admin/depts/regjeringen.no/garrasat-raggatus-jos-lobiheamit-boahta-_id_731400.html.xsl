...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/20131/garrasat-raggatus-jos-lobiheamit-boahta-.html?id=731400'"/>
...
<xsl:variable name="para_nob" select="'skjerpet-straff-for-ulovlig-retur-til-no.html_id=731400'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skjerpet-straff-for-ulovlig-retur-til-no_id_731400.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
