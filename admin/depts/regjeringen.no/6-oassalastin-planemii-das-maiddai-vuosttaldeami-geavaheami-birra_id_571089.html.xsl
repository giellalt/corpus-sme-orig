...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/Johtocalus/2009/T-209-Plana--ja-huksenlaga-oa-planaoasi-fapmuibidjan/6-Oassalastin-planemii-das-maiddai-vuosttaldeami-geavaheami-birra.html?id=571089'"/>
...
<xsl:variable name="para_nob" select="'6-medvirkning-i-planleggingen-herunder-o.html?id=571089'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="6-medvirkning-i-planleggingen-herunder-o_id_571089.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
