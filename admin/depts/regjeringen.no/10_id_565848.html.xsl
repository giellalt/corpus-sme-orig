...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/6/10.html?id=565848'"/>
<xsl:variable name="title" select="'2.10 álgoálbmotbuhtadus, ... - regjeringen.no'"/>
