...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Departemeantta-birra/underliggende-etater/Boazodoallohalddahus.html?id=85966'"/>
...
<xsl:variable name="para_nob" select="'reindriftsforvaltningen.html?id=85966'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reindriftsforvaltningen_id_85966.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
