...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/8/3.html?id=461226'"/>
<xsl:variable name="title" select="'8.3 Lága oppalaš vuolggasadji - regjeringen.no'"/>
