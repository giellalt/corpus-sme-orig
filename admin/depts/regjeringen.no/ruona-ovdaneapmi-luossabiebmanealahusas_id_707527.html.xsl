...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2012/ruona-ovdaneapmi-luossabiebmanealahusas.html?id=707527'"/>
...
<xsl:variable name="para_nob" select="'gronn-vekst-i-lakseoppdrett.html_id=707527'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gronn-vekst-i-lakseoppdrett_id_707527.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
