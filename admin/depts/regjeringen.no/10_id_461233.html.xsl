...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/8/10.html?id=461233'"/>
<xsl:variable name="title" select="'8.10 Buohtalas álggahansiidaoassi - regjeringen.no'"/>
