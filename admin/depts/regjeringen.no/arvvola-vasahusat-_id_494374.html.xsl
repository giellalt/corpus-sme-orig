...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/preassaguovdda/preassadieahusat/2007/Arvvola-vasahusat-.html?id=494374'"/>
...
<xsl:variable name="para_nob" select="'verdifulle-opplevelser-.html?id=494374'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="verdifulle-opplevelser-_id_494374.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
