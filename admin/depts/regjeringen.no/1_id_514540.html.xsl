...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/18/1/1.html?id=514540'"/>
<xsl:variable name="title" select="'18.1.1 Sámi girkoráđđi - regjeringen.no'"/>
