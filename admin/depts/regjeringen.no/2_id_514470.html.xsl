...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/13/5/2.html?id=514470'"/>
<xsl:variable name="title" select="'13.5.2 Eará prográmmadoaimmaid... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'652'"/>
