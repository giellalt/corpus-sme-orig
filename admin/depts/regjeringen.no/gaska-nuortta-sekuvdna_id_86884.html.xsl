...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Regionala-gaaldagaid-ja-ovdaneami-ossodat/Gaska-Nuortta-sekuvdna.html?id=86884'"/>
...
<xsl:variable name="para_nob" select="'midtostenseksjonen.html?id=86884'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="midtostenseksjonen_id_86884.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
