...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/eanet-arkiivaulbmiliidda.html?id=701346'"/>
...
<xsl:variable name="para_nno" select="'meir-til-arkivformal.html_id=701346'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="meir-til-arkivformal_id_701346.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
