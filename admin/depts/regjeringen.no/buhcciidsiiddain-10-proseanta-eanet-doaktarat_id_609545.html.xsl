...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/hod/pressesenter/pressemeldinger/2010/Buhcciidsiiddain-10-proseanta-eanet-doaktarat.html?id=609545'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/hod/pressesenter/pressemeldinger/2010/Buhcciidsiiddain-10-proseanta-eanet-doaktarat.html?id=609545'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Buhcciidsiiddain 10 proseanta eanet doaktárat - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'10-prosent-flere-leger-i-sykehjemmene.html?id=609545'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="10-prosent-flere-leger-i-sykehjemmene_id_609545.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
