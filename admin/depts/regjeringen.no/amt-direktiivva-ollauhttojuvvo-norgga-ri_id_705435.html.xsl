...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/amt-direktiivva-ollauhttojuvvo-norgga-ri.html?id=705435'"/>
...
<xsl:variable name="para_nob" select="'amt-direktivet-gjennomfores-i-norsk-rett.html_id=705435'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="amt-direktivet-gjennomfores-i-norsk-rett_id_705435.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
