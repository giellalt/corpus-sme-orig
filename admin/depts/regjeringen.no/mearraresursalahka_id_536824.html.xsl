...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dok/lagat-ja-njuolggadusat-/lover/mearraresursalahka.html?id=536824'"/>
...
<xsl:variable name="para_nob" select="'havressurslova.html?id=536824'"/>
