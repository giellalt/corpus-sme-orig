...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/Vuollasa-asahusat/Petroleabearraigeahu.html?id=85809'"/>
...
<xsl:variable name="para_nob" select="'petroleumstilsynet.html?id=85809'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="petroleumstilsynet_id_85809.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
