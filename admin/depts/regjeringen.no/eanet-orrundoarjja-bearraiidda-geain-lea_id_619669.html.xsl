...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/eanet-orrundoarjja-bearraiidda-geain-lea.html?id=619669'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="more-housing-support-for-families-with-c_id_619669.html" xml:lang="eng"/>
