...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/halddahusossodat.html?id=1591'"/>
...
<xsl:variable name="para_nob" select="'administrasjonsavdelingen.html?id=1591'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="administrasjonsavdelingen_id_1591.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
