...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/24/2.html?id=514626'"/>
<xsl:variable name="title" select="'1.2 Ovttasbargu - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2130'"/>
