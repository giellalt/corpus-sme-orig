...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/500-000-ruvnnu-sami-iemearrideami-proekt.html?id=573280'"/>
...
<xsl:variable name="para_nob" select="'500-000-kroner-til-prosjekt-om-samisk-se.html?id=573280'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="500-000-kroner-til-prosjekt-om-samisk-se_id_573280.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
