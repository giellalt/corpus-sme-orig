...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Dokumeanttat/Gulaskuddamat/SE_Horingsdokumenter/2003/Gulaskuddan-Samelaga-Oasteapmi-Ovtta-sad.html?id=419602'"/>
<xsl:variable name="title" select="'Gulaskuddan - Sámelága Ođasteapmi - Ovtta sadjái čohkket sámi jienastuslogu čáliheami - regjeringen.no'"/>
