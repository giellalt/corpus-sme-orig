...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/aktuelt/taler_og_artikler/ministeren/taler-og-artikler-av-grete-faremo/2012/suoidnemanu-22beaivve-kommiuvnna-raporta.html?id=697509'"/>
...
<xsl:variable name="para_nob" select="'22-juli-kommisjonens-rapport-.html_id=697509'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="22-juli-kommisjonens-rapport-_id_697509.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
