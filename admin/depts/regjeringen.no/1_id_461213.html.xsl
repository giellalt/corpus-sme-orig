...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/7/1.html?id=461213'"/>
<xsl:variable name="title" select="'7.1 Lávdegotti oppalaš... - regjeringen.no'"/>
