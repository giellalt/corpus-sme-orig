...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/13/2.html?id=514460'"/>
<xsl:variable name="title" select="'13.2 Romssa universitehta - regjeringen.no'"/>
