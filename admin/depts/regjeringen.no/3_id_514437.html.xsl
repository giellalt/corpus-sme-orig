...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/12/3.html?id=514437'"/>
<xsl:variable name="title" select="'12.3 Gáiddusoahpahus - regjeringen.no'"/>
