...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/Odeldiggeproposiuvnnat/2007-2008/odprp-nr-43-2007-2008-/4/1/5.html?id=504699'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'4.1.5 Áirrasjuohkin - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'822'"/>
