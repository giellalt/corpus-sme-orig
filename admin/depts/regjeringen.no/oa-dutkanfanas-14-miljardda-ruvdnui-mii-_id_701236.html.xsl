...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2012/oa-dutkanfanas-14-miljardda-ruvdnui-mii-.html?id=701236'"/>
...
<xsl:variable name="para_nob" select="'nytt-isgaande-forskingsfartoy-til-14-mil.html_id=701236'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nytt-isgaande-forskingsfartoy-til-14-mil_id_701236.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
