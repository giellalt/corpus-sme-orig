...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2011/--lihkku-sami-albmotbeivviin.html?id=632943'"/>
...
<xsl:variable name="para_nob" select="'--gratulerer-med-samefolkets-dag.html_id=632943'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gratulerer-med-samefolkets-dag_id_632943.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
