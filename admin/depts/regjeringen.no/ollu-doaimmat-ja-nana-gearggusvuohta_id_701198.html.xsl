...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/pressesenter/pressemeldinger/2012/ollu-doaimmat-ja-nana-gearggusvuohta.html?id=701198'"/>
...
<xsl:variable name="para_nob" select="'hoyere-aktivitet-og-forsterket-beredskap.html_id=701198'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hoyere-aktivitet-og-forsterket-beredskap_id_701198.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
