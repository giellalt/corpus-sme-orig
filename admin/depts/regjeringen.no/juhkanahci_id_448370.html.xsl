...
<xsl:variable name="para_nob" select="'mattrygghet-og-drikkevann.html?id=448370'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mattrygghet-og-drikkevann_id_448370.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
