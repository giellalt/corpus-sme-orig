...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/11/3.html?id=514425'"/>
<xsl:variable name="title" select="'11.3 Gelbbolašvuohta... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1250'"/>
