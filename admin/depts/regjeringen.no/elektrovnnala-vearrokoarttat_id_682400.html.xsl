...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/preassaguovdda/pressemeldinger/2012/elektrovnnala-vearrokoarttat.html?id=682400'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="elektroniske-skattekort_id_682400.html" xml:lang="nno"/>
</xsl:variable>
