...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/lagat-ja-lahkaasahusat/lahkaasahusat/2006/lahkaasahus-varnjargga-suodjalanplana-bi-2.html?id=489513'"/>
<xsl:variable name="title" select="'Láhkaásahus Várnjárgga suodjalanplána birra. Oarddu luonddumeahci ráfáiduhttin Báhcavuona gielddas Finnmárkku fylkkas. - regjeringen.no'"/>
