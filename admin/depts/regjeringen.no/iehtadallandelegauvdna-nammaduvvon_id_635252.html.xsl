...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2011/iehtadallandelegauvdna-nammaduvvon.html?id=635252'"/>
...
<xsl:variable name="para_nob" select="'forhandlingsdelegasjonen-oppnevnt.html_id=635252'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forhandlingsdelegasjonen-oppnevnt_id_635252.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
