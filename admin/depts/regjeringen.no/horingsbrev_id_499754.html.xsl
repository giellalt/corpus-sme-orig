...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/dokumeanttat/hoeringer/hoeringsdok/2008/Gulaskuddan--rievdadanevttohusat-lahkaas/horingsbrev.html?id=499754'"/>
...
<xsl:variable name="para_nob" select="'-4.html?id=499754'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="4_id_499754.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
...
=======
               ...
               <xsl:with-param name="replacement" select="'đđ/'"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
