...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/organisauvdna/Ossodagat/valatallanossodat/Sekuvdna-ID-3.html?id=551448'"/>
...
<xsl:variable name="para_nob" select="'seksjon-id-3.html?id=551448'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon-id-3_id_551448.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
