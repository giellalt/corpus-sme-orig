...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Departemeantta-birra/organisauvdna/Ossodagat/Vuovde--ja-resurssapolitihkala-ossodat-.html?id=1599'"/>
...
<xsl:variable name="para_nob" select="'avdeling_for_skog-_og_ressurspolitikk_.html?id=1599'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdeling_for_skog-_og_ressurspolitikk_id_1599.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
