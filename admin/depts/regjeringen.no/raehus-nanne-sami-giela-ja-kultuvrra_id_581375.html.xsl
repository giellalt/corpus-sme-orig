...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/raehus-nanne-sami-giela-ja-kultuvrra.html?id=581375'"/>
...
<xsl:variable name="para_nno" select="'regjeringa-styrker-samisk-sprak-og-kultu.html?id=581375'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringa-styrker-samisk-sprak-og-kultu_id_581375.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
