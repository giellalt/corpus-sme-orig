...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/dokumeanttat/proposiuvnnat-ja-dieahusat/otprp/20042005/od-prp-nr-38_2004-2005/4/1.html?id=181617'"/>
<xsl:variable name="title" select="'Árvalus Láhka Geassemánu 12.... - regjeringen.no'"/>
