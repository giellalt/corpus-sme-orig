...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/3.html?id=461195'"/>
<xsl:variable name="title" select="'3 Gulaskuddan ja ráđđádallamat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1099'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="3_id_446521.html" xml:lang="nob"/>
</xsl:variable>
