...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Marit-Wiig-oa-ekspediuvdnahoavdan-Valatallanossodahkii.html?id=593397'"/>
...
<xsl:variable name="para_nob" select="'Marit-Wiig-ny-ekspedisjonssjef-i-Idrettsavdelingen.html?id=593397'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="marit-wiig-ny-ekspedisjonssjef-i-idrettsavdelingen_id_593397.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
