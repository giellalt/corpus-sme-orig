...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/aigeguovdil/taler_artikler/ministeren/taler-og-artikler-av-forsvarsminister-gr/2011/logaldallan-oslo-militare-samfund-baikki.html?id=630454'"/>
...
<xsl:variable name="para_nob" select="'foredrag-i-oslo-militare-samfund-10-janu.html?id=630454'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="foredrag-i-oslo-militare-samfund-10-janu_id_630454.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
