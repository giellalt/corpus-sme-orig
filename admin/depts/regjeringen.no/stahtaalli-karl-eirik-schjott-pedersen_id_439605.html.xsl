...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/stahtaministtar/Politihkala-mieldebargit/stahtaalli-karl-eirik-schjott-pedersen.html?id=439605'"/>
