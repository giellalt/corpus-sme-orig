...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/aktuelt/nyheter/2013/haliidat-addat-eahpibun-eastadit-radikal.html?id=746829'"/>
...
<xsl:variable name="para_nob" select="'vil-bli-bedre-pa-forebygging-mot-radikal.html_id=746829'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="vil-bli-bedre-pa-forebygging-mot-radikal_id_746829.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
