...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/IKT-politikka/e-gavpi.html?id=1368'"/>
...
<xsl:variable name="para_nob" select="'ehandel.html?id=1368'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ehandel_id_1368.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
