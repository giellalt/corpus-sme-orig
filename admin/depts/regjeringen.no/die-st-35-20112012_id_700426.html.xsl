...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dokumeanttat/regpubl/stmeld/2011-2012/die-st-35-20112012.html?id=700426'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Dieđ. St. 35 (2011–2012) - regjeringen.no'"/>
