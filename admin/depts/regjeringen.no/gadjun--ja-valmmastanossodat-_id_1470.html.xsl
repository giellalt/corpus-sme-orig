...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/Justisdepartementta-birra/Organisauvdna/Ossodagat/Gadjun--ja-valmmastanossodat-.html?id=1470'"/>
