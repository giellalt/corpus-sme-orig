...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20022003/stdie-nr-10-2002-2003-samisk/4/8.html?id=452336'"/>
<xsl:variable name="title" select="'4.8 Sámi ealáhusat - regjeringen.no'"/>
