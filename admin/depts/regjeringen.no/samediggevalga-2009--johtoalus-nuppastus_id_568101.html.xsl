...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Gulaskuddamat/2009/samediggevalga-2009--johtoalus-nuppastus.html?id=568101'"/>
...
<xsl:variable name="para_nob" select="'sametingsvalget-2009--rundskriv-om-endri.html?id=568101'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sametingsvalget-2009--rundskriv-om-endri_id_568101.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
