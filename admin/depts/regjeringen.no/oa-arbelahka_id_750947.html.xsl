...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/2014/oa-arbelahka.html?id=750947'"/>
...
<xsl:variable name="para_nob" select="'ny-arvelov.html_id=750947'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="ny-arvelov_id_750947.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
