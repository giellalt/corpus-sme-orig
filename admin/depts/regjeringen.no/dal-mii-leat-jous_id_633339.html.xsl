...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/nyheter/2011/--dal-mii-leat-jous.html?id=633339'"/>
...
<xsl:variable name="para_nob" select="'--na-er-vi-i-gang.html?id=633339'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="na-er-vi-i-gang_id_633339.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
