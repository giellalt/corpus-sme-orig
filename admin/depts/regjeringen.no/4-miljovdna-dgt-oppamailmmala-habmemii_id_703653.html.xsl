...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2012/4-miljovdna-dgt-oppamailmmala-habmemii.html?id=703653'"/>
...
<xsl:variable name="para_nob" select="'4-millioner-til-universell-utforming-av-.html_id=703653'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="4-millioner-til-universell-utforming-av-_id_703653.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
