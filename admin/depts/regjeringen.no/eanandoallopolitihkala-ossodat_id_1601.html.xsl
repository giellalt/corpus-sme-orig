...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Departemeantta-birra/organisauvdna/Ossodagat/Eanandoallopolitihkala-ossodat.html?id=1601'"/>
...
<xsl:variable name="para_nob" select="'landbrukspolitisk_avdeling_.html?id=1601'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="landbrukspolitisk_avdeling_id_1601.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
