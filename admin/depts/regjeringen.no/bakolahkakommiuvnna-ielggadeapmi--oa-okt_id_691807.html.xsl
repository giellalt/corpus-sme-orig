...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/preassaguovdda/pressemeldinger/2012/bakolahkakommiuvnna-ielggadeapmi--oa-okt.html?id=691807'"/>
...
<xsl:variable name="para_nob" select="'utredning-fra-banklovkommisjonen---ny-ko.html_id=691807'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utredning-fra-banklovkommisjonen---ny-ko_id_691807.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
