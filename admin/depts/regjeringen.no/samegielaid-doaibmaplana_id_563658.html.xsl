...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Samepolitihkka/Samegiela-geavaheapmi/samegielaid-doaibmaplana.html?id=563658'"/>
...
<xsl:variable name="para_nob" select="'handlingsplan-for-samiske-sprak-.html?id=563658'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="handlingsplan-for-samiske-sprak-_id_563658.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
