...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2011/almmola-oktavuoain-galga-addat-alkit-gea.html?id=650229'"/>
...
<xsl:variable name="para_nob" select="'enklere-a-bruke-samisk-i-kommunikasjon-m.html_id=650229'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="enklere-a-bruke-samisk-i-kommunikasjon-m_id_650229.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
