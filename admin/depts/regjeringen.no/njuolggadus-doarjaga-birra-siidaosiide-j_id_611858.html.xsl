...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Lagat-ja-njuolggadusat-/Lahkaasahusat/2010/njuolggadus-doarjaga-birra-siidaosiide-j.html?id=611858'"/>
...
<xsl:variable name="para_nob" select="'forskrift-om-tilskudd-til-siidaandeler-o.html?id=611858'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-om-tilskudd-til-siidaandeler-o_id_611858.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
