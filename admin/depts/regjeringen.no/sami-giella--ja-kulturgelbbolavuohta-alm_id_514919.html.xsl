...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/sami-giella--ja-kulturgelbbolavuohta-alm.html?id=514919'"/>
...
<xsl:variable name="para_nob" select="'samisk-sprak--og-kulturkompetanse-i-det-.html?id=514919'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samisk-sprak--og-kulturkompetanse-i-det-_id_514919.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
