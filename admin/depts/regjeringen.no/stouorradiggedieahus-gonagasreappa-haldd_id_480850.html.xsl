...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2007/Stouorradiggedieahus-gonagasreappa-haldd.html?id=480850'"/>
...
<xsl:variable name="para_nob" select="'stortingsmelding-om-forvaltning-av-konge.html?id=480850'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stortingsmelding-om-forvaltning-av-konge_id_480850.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
