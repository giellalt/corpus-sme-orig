...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/golloramma-oa-naunalamuseii.html?id=729282'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kostnadsramme-for-nytt-nasjonalmuseum_id_729282.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
