...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/organisauvdna/Ossodagat/Halddahus--ja-bueahttaossodat-/IT--ja-dokumentauvdnasekuvdna-.html?id=85768'"/>
...
<xsl:variable name="para_nob" select="'dokumentasjonsseksjonen.html?id=85768'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dokumentasjonsseksjonen_id_85768.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
