...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2011/stuorradiggediedahusa.html?id=633237'"/>
...
<xsl:variable name="para_nob" select="'pasientsikkerhet.html_id=633237'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pasientsikkerhet_id_633237.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
