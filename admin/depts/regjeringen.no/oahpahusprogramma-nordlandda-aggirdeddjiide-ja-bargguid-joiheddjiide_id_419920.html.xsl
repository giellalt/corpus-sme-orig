...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2006/Oahpahusprogramma-Nordlandda-aggirdeddjiide-ja-bargguid-joiheddjiide.html?id=419920'"/>
<xsl:variable name="title" select="'Oahpahusprográmma Nordlándda áŋggirdeddjiide ja bargguid jođiheddjiide - regjeringen.no'"/>
