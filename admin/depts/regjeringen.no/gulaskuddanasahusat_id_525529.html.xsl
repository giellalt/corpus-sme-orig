...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Johtoallosat/Gulaskuddandokumeanta/2008/samediggevalga--lahkaasahus-samediggeval/gulaskuddanasahusat.html?id=525529'"/>
...
<xsl:variable name="para_nob" select="'horingsinstanser.html?id=525529'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horingsinstanser_id_525529.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
