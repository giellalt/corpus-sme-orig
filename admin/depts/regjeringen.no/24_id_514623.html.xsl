...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/24.html?id=514623'"/>
<xsl:variable name="title" select="'1 Sámedikki jahkedieđáhus ... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'25314'"/>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               ...
               <xsl:with-param name="target" select="'dea��alaš/ča��amanni/'"/>
               <xsl:with-param name="replacement" select="'deaŧalaš/čađamanni/'"/>
