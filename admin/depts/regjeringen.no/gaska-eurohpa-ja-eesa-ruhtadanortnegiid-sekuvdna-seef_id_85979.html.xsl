...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Eurohpa-ja-gavpeossodat/Gaska-Eurohpa-ja-EESa-ruhtadanortnegiid-sekuvdna-SEEF.html?id=85979'"/>
