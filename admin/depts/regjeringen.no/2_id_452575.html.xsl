...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/stdie-nr-44-2004-2005-/2-2/3/2.html?id=452575'"/>
<xsl:variable name="title" select="'2.3.2 Nuoraidpolitihkalaš... - regjeringen.no'"/>
