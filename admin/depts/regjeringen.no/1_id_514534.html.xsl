...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/16/1.html?id=514534'"/>
<xsl:variable name="title" select="'16.1 Sámi organisašuvnnat - regjeringen.no'"/>
