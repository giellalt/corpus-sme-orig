...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/7.html?id=458471'"/>
<xsl:variable name="title" select="'7 Sámegiella - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'4184'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="7_id_325876.html" xml:lang="nob"/>
</xsl:variable>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               ...
               <xsl:with-param name="replacement" select="'šš/ %/'"/>
