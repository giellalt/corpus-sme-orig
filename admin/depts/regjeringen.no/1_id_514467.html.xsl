...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/13/4/1.html?id=514467'"/>
<xsl:variable name="title" select="'13.4.1 árktalaš universitehta - regjeringen.no'"/>
