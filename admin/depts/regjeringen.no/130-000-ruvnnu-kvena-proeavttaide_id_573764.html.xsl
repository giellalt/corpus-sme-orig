...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/130-000-ruvnnu-kvena-proeavttaide.html?id=573764'"/>
...
<xsl:variable name="para_nob" select="'130-000-kroner-til-kvenske-prosjekter.html?id=573764'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="130-000-kroner-til-kvenske-prosjekter_id_573764.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
