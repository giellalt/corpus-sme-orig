...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/9/3/2.html?id=458506'"/>
<xsl:variable name="title" select="'9.3.2 Boahttevaš hástalusat... - regjeringen.no'"/>
