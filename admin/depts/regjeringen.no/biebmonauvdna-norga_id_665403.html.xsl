...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/pressesenter/pressemeldinger/2011/biebmonauvdna-norga.html?id=665403'"/>
...
<xsl:variable name="para_nob" select="'matnasjonen-norge.html_id=665403'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="matnasjonen-norge_id_665403.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
