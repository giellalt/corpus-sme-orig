...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/aigeguovdil/oddasat/2013/eanet-rabasvuohta-nationala-geahalemiin.html?id=744713'"/>
...
<xsl:variable name="para_nob" select="'-mer-apenhet-om-nasjonale-prover.html_id=744713'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mer-apenhet-om-nasjonale-prover_id_744713.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
