...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/nyheter/2011/njunuoahkkin-ielga-giela-birra.html?id=636041'"/>
...
<xsl:variable name="para_nob" select="'toppmote-om-klarsprak.html_id=636041'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="toppmote-om-klarsprak_id_636041.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
