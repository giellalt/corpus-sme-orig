...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/eanet-valatallanrusttegiidda-ja-olggusta.html?id=680307'"/>
...
<xsl:variable name="para_nob" select="'mer-til-idrettsanlegg-og-friluftsliv.html_id=680307'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mer-til-idrettsanlegg-og-friluftsliv_id_680307.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
