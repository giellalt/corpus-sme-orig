...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/Aigeguovdil/Oasat/2010/Haliida-joatkit-doarjaga-Bosnia-Hercegovinai.html?id=606516'"/>
...
<xsl:variable name="para_nob" select="'Onsker-videre-stotte-til-Bosnia-Herzegovina.html?id=606516'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="onsker-videre-stotte-til-bosnia-herzegovina_id_606516.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
