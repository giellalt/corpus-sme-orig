...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Girku/Girkovisttit.html?id=1221'"/>
...
<xsl:variable name="para_nob" select="'kirkebygg.html?id=1221'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kirkebygg_id_1221.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
