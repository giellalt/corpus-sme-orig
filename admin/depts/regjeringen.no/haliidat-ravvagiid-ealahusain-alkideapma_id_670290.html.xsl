...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/Aigeguovdil/nyheter/nyheter-2012/haliidat-ravvagiid-ealahusain-alkideapma.html?id=670290'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Háliidat rávvagiid ealáhusain álkideapmái - regjeringen.no'"/>
