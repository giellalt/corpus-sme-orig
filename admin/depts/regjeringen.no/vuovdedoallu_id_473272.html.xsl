...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Fadda/vuovdedoallu-ja-bioenergiija/vuovdedoallu.html?id=473272'"/>
...
<xsl:variable name="para_nob" select="'skogbruk.html?id=473272'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skogbruk_id_473272.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
