...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/24/3/5.html?id=514635'"/>
<xsl:variable name="title" select="'1.3.5 Olju ja gássa - regjeringen.no'"/>
