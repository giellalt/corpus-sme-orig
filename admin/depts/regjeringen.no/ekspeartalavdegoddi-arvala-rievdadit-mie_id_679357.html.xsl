...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/ekspeartalavdegoddi-arvala-rievdadit-mie.html?id=679357'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekspertutval-foreslar-endringar-i-regule_id_679357.html" xml:lang="nno"/>
</xsl:variable>
