...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/gulahallanovttadat/Senior-gulahallanravvejeaddji-Ragnvald-Berggrav.html?id=439586'"/>
