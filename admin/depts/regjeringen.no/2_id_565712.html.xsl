...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/2/7/2.html?id=565712'"/>
<xsl:variable name="title" select="'2.7.2 Sámi parlamentarihkárkonferánsa... - regjeringen.no'"/>
