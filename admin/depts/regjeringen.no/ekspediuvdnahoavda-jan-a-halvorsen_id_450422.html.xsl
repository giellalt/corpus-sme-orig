...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/organisauvdna/Ossodagat/gilvopolitihkala-ossodat/ekspediuvdnahoavda-jan-a-halvorsen.html?id=450422'"/>
...
<xsl:variable name="para_nob" select="'ekspedisjonssjef-jan-a-halvorsen.html?id=450422'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekspedisjonssjef-jan-a-halvorsen_id_450422.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
