...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Dokumeanttat/lagat-ja-lahkaasahusat/lahkaasahusat/2006/lahkaasahus-sievjju-albmotmeahci-birra-a.html?id=489472'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Láhkaásahus Sievjju álbmotmeahci birra Álttá, Hámmarfeastta ja Fálesnuori. - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'1275'"/>
