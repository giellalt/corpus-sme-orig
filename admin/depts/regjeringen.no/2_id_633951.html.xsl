...
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/ad/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/2.html?id=633951'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'1 Ráđđehusa sámepolitihka vuođđu'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="2_id_512816.html" xml:lang="nob"/>
</xsl:variable>
