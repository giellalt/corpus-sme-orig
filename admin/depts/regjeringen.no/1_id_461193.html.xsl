...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/otprp/2006-2007/Odprp-nr-25-2006-2007-/1.html?id=461193'"/>
<xsl:variable name="title" select="'1 Proposišuvnna váldosisdoallu - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="1_id_446519.html" xml:lang="nob"/>
</xsl:variable>
