...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2007/sami-ofelaproeakta--buorre-menestus.html?id=478725'"/>
...
<xsl:variable name="para_nob" select="'95.html?id=478725'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="95_id_478725.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
