...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/pressesenter/pressemeldinger/2010/Krovdnaprinsa-Haakon-lea-nammaduvvon-leavgakommandevran.html?id=604295'"/>
...
<xsl:variable name="para_nob" select="'Utnevninger-i-statsrad-7-mai-2010.html?id=604295'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utnevninger-i-statsrad-7-mai-2010_id_604295.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
