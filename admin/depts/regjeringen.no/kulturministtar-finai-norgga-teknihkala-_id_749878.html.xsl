...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/aigeguovdil/oasat/2014/kulturministtar-finai-norgga-teknihkala-.html?id=749878'"/>
...
<xsl:variable name="para_nob" select="'kulturministeren-besokte-norsk-teknisk-m.html_id=749878'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kulturministeren-besokte-norsk-teknisk-m_id_749878.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
