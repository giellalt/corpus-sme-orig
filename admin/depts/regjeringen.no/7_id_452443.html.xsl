...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/15/2/7.html?id=452443'"/>
<xsl:variable name="title" select="'1.2.7 Kultuvra ja ealáhusat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'942'"/>
