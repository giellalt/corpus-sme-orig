...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/ONa-rafi-ja-humanitara-gaaldagaid-ossodat.html?id=87006'"/>
...
<xsl:variable name="para_nob" select="'avdeling_fn.html?id=87006'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdeling_fn_id_87006.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
