...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/4/9.html?id=514702'"/>
<xsl:variable name="title" select="'2.4.9 Kulturmuitosuodjaleapmi - regjeringen.no'"/>
