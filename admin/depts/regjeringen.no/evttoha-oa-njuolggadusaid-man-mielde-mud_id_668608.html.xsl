...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Oasat/2012/evttoha-oa-njuolggadusaid-man-mielde-mud.html?id=668608'"/>
...
<xsl:variable name="para_nob" select="'foreslar-nye-regler-for-regulering-av-fo.html_id=668608'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="foreslar-nye-regler-for-regulering-av-fo_id_668608.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
