...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/preassadoarjaga-divusteamit-gulaskuddami.html?id=747028'"/>
...
<xsl:variable name="para_nob" select="'justeringer-i-pressestotten-pa-horing.html_id=747028'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="justeringer-i-pressestotten-pa-horing_id_747028.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
