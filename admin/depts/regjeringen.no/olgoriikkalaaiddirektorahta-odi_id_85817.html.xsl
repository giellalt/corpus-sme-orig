...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/Justisdepartementta-birra/underliggende-etater/Olgoriikkalaaiddirektorahta-ODI.html?id=85817'"/>
...
<xsl:variable name="para_nob" select="'utlendingsdirektoratet_udi.html?id=85817'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utlendingsdirektoratet_udi_id_85817.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
