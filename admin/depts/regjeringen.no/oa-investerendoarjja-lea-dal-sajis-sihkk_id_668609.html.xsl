...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/Preassadieahusat/2012/oa-investerendoarjja-lea-dal-sajis-sihkk.html?id=668609'"/>
...
<xsl:variable name="para_nno" select="'det-nye-investeringstilskotet-for-a-sikr.html_id=668609'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="det-nye-investeringstilskotet-for-a-sikr_id_668609.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
