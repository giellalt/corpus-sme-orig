...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/guovllu--ja-regionalapolitihkka/Fitnodagaid-ja-ealahusdoaimmaid-ovdanahttin.html?id=526842'"/>
