...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/9/7.html?id=514408'"/>
<xsl:variable name="title" select="'9.7 Nationála strategiija... - regjeringen.no'"/>
