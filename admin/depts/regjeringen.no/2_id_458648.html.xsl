...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/20/1/2.html?id=458648'"/>
<xsl:variable name="title" select="'1.1.2 Sámedikki ja guovddáš... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1007'"/>
