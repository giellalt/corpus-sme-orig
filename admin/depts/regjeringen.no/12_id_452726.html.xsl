...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20062007/Stdie-nr-7-2006-2007-/3/12.html?id=452726'"/>
<xsl:variable name="title" select="'3.12 Eanandoallu - regjeringen.no'"/>
