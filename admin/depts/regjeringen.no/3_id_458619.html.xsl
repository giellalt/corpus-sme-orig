...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/15/3.html?id=458619'"/>
<xsl:variable name="title" select="'15.3 Ekologalaš guoddinnákca... - regjeringen.no'"/>
