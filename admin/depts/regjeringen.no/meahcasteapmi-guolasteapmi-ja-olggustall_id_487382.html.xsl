...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Fadda/vuovdedoallu-ja-bioenergiija/meahcasteapmi-guolasteapmi-ja-olggustall.html?id=487382'"/>
...
<xsl:variable name="para_nob" select="'jakt-fiske-og-friluftsliv.html?id=487382'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jakt-fiske-og-friluftsliv_id_487382.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
