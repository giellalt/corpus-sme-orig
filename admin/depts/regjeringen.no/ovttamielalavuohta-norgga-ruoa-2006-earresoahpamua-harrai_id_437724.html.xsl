...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/Preassaguovdda/Preassadieahusat/2005/Ovttamielalavuohta-norgga-ruoa-2006-earresoahpamua-harrai.html?id=437724'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ovttamielalašvuohta norgga-ruošša 2006 earresoahpamuša hárrái - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'1004'"/>
