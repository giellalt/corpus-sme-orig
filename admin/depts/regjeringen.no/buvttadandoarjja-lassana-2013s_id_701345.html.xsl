...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/buvttadandoarjja-lassana-2013s.html?id=701345'"/>
...
<xsl:variable name="para_nno" select="'auke-i-produksjonstilskotet-i-2013.html_id=701345'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="auke-i-produksjonstilskotet-i-2013_id_701345.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
