...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2012/juni-12/20122013-boazodoalloiehtadus-stuorradikk.html?id=685882'"/>
...
<xsl:variable name="para_nob" select="'reindriftsavtalen-20122013-i-stortinget.html_id=685882'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reindriftsavtalen-20122013-i-stortinget_id_685882.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
