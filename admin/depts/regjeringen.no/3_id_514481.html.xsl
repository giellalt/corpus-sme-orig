...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/14/3.html?id=514481'"/>
<xsl:variable name="title" select="'14.3 Hástalusat sámi... - regjeringen.no'"/>
