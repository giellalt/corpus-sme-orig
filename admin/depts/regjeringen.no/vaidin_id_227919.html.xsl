...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/hod/tema/divohasdiehtojuohkin/vaidin.html?id=227919'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="klage-pa-behandling_id_227919.html" xml:lang="nob"/>
</xsl:variable>
