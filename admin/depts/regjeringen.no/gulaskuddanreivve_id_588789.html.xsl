...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kd/dok/hoeringer/hoeringsdok/2009/gulaskuddan---rammaplana-lahkaasahus-sam/gulaskuddanreivve.html?id=588789'"/>
...
<xsl:variable name="para_nob" select="'horingsbrev.html?id=588789'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horingsbrev_id_588789.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
