...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2005/iea-milliovnna-lassi-sami-kulturulbmiliidda.html?id=419754'"/>
<xsl:variable name="title" select="'Čieža milliovnna lassi sámi kulturulbmiliidda - regjeringen.no'"/>
