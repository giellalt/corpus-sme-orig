...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/preassadieahusat/2012/dieiha-garra-dienaslassaneami-suohkaniid/150-miljovdna-ruvdno-eanet-romsii-boahtt.html?id=682287'"/>
...
<xsl:variable name="para_nno" select="'troms.html_id=682287'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="troms_id_682287.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
