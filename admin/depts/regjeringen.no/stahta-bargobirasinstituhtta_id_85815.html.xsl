...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/Vuollasa-asahusat/Stahta-bargobirasinstituhtta.html?id=85815'"/>
...
<xsl:variable name="para_nob" select="'statens_arbeidsmiljoinstitutt.html?id=85815'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statens_arbeidsmiljoinstitutt_id_85815.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
