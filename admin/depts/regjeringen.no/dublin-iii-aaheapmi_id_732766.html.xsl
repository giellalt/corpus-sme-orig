...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/aktuelt/nyheter/2013/dublin-iii-aaheapmi.html?id=732766'"/>
...
<xsl:variable name="para_nob" select="'gjennomforing-av-dublin-iii.html_id=732766'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gjennomforing-av-dublin-iii_id_732766.html" xml:lang="nob"/>
