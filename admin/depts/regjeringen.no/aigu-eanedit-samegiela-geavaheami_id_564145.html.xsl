...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/aigu-eanedit-samegiela-geavaheami.html?id=564145'"/>
...
<xsl:variable name="para_nob" select="'vil-oke-bruken-av-samiske-sprak.html?id=564145'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vil-oke-bruken-av-samiske-sprak_id_564145.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
