...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/20/5/2.html?id=514563'"/>
<xsl:variable name="title" select="'20.5.2 Sámegiela divvunprográmma - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'490'"/>
