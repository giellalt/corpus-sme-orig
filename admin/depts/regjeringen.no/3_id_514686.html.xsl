...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/25/3.html?id=514686'"/>
<xsl:variable name="title" select="'2.3 Vuoigatvuođat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2820'"/>
