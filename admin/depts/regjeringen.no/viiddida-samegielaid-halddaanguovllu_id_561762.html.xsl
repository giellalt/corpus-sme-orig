...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/viiddida-samegielaid-halddaanguovllu.html?id=561762'"/>
...
<xsl:variable name="para_nob" select="'utvider-forvaltningsomradet-for-samiske-.html?id=561762'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utvider-forvaltningsomradet-for-samiske-_id_561762.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
