...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2011/viessohuksensearvvit-ja-privahtat-besset.html?id=631719'"/>
...
<xsl:variable name="para_nob" select="'omsorgsplasser.html?id=631719'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="omsorgsplasser_id_631719.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
