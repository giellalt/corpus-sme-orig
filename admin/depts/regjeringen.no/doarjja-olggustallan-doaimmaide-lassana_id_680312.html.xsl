...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/doarjja-olggustallan-doaimmaide-lassana.html?id=680312'"/>
...
<xsl:variable name="para_nob" select="'fortsatt-okning-til-friluftsliv.html_id=680312'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fortsatt-okning-til-friluftsliv_id_680312.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
