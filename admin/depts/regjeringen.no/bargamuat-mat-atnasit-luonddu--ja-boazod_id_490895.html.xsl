...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2007/Bargamuat-mat-atnasit-Luonddu--ja-boazod.html?id=490895'"/>
...
<xsl:variable name="para_nob" select="'oppgaver-knyttet-til-ressurssenter-for-n.html?id=490895'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="oppgaver-knyttet-til-ressurssenter-for-n_id_490895.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
