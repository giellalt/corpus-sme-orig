...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/departemeantta-birra/Eara-politihkala-njunnoat/stahtaalli-lotte-grepp-knutsen/Lotte-Grepp-Knudsena-govat.html?id=582409'"/>
...
<xsl:variable name="para_nob" select="'bilder-av-lotte-grepp-knutsen.html?id=582409'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bilder-av-lotte-grepp-knutsen_id_582409.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
