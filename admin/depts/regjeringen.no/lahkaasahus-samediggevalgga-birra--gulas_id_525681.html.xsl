...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Johtoallosat/Gulaskuddandokumeanta/2008/samediggevalga--lahkaasahus-samediggeval/lahkaasahus-samediggevalgga-birra--gulas.html?id=525681'"/>
...
<xsl:variable name="para_nob" select="'horingsnotat-2.html?id=525681'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horingsnotat-2_id_525681.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
