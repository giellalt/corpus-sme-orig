...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/oasat/2014/feb-14/lahkoeh-biejjine--vuorbbe-biejvijn--lihk.html?id=750520'"/>
...
<xsl:variable name="para_nob" select="'lahkoeh-biejjine--vuorbbe-biejvijn--lihk.html_id=750520'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lahkoeh-biejjine--vuorbbe-biejvijn--lihk_id_750520.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
