...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2009/eambbo-nordlandda-kulturdoaimmaide-.html?id=581497'"/>
...
<xsl:variable name="para_nob" select="'mer-til-kultur-i-nordland.html?id=581497'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mer-til-kultur-i-nordland_id_581497.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
