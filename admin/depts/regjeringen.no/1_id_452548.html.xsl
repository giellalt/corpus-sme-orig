...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/15/1.html?id=452548'"/>
<xsl:variable name="title" select="'4.15.1 ON’ eamiálbmotáššiid... - regjeringen.no'"/>
