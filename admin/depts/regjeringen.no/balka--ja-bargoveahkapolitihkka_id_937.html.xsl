...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/fadd/Balka--ja-bargoveahkapolitihkka.html?id=937'"/>
...
<xsl:variable name="para_eng" select="'wage-and-personnel-policy-.html?id=937'"/>
