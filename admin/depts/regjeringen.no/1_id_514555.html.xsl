...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/20/3/1.html?id=514555'"/>
<xsl:variable name="title" select="'20.3.1 Eurohpa regiovdna-... - regjeringen.no'"/>
