...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aigeguovdil/sartnit-ja-artihkkalat/ministeren/taler-og-artikler-av-finansminister/2012/norwegian-center-for-taxation-nocet-ja-o.html?id=699295'"/>
...
<xsl:variable name="para_nob" select="'apningen-av-norwegian-center-for-taxatio.html_id=699295'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="apningen-av-norwegian-center-for-taxatio_id_699295.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
