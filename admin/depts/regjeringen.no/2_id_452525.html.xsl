...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/6/2.html?id=452525'"/>
<xsl:variable name="title" select="'4.6.2 Sámediggái njeallje... - regjeringen.no'"/>
