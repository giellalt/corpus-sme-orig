...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2012/stahta-dahka-iehtadusa-bankidin-.html?id=707695'"/>
...
<xsl:variable name="para_nob" select="'staten-inngar-avtale-med-bankid.html_id=707695'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="staten-inngar-avtale-med-bankid_id_707695.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
