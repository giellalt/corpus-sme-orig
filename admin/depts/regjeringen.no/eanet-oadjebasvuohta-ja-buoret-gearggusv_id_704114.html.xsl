...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/2012/eanet-oadjebasvuohta-ja-buoret-gearggusv.html?id=704114'"/>
...
<xsl:variable name="para_nob" select="'mer-trygghet-og-bedre-beredskap.html_id=704114'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mer-trygghet-og-bedre-beredskap_id_704114.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
