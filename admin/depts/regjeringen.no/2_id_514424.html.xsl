...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/11/2.html?id=514424'"/>
<xsl:variable name="title" select="'11.2 Sámedikki rolla - regjeringen.no'"/>
