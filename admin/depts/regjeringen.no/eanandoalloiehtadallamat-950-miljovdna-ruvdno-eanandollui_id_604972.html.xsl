...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2010/Mai-10/Eanandoalloiehtadallamat-950-miljovdna-ruvdno-eanandollui.html?id=604972'"/>
...
<xsl:variable name="para_nob" select="'Jordbruksoppgjoret1.html?id=604972'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jordbruksoppgjoret1_id_604972.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
