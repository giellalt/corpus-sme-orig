...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/statssekretar-raimo-valle/2008/Lihkku-Sami-albmotbeivviin--Lihkku-beivv.html?id=499287'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/statssekretar-raimo-valle/2008/Lihkku-Sami-albmotbeivviin--Lihkku-beivv.html?id=499287'"/>
...
<xsl:variable name="para_nob" select="'lihku-samealbmot-beiviin---gratulerer-me.html?id=499287'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lihku-samealbmot-beiviin---gratulerer-me_id_499287.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
