...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/preassaguovdda/pressemeldinger/2011/--norgga-bargu-lea-vaikkuhan-heakkaid-su.html?id=636943'"/>
...
<xsl:variable name="para_nob" select="'--norsk-innsats-har-bidratt-til-a-redde-.html_id=636943'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norsk-innsats-har-bidratt-til-a-redde-_id_636943.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
