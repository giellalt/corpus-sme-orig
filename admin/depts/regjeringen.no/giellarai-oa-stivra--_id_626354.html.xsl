...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Giellarai-oa-stivra--.html?id=626354'"/>
...
<xsl:variable name="para_nno" select="'Nytt-styre-i-Sprakradet.html?id=626354'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nytt-styre-i-sprakradet_id_626354.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
