...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/guovllu--ja-regionalapolitihkka/riikkaidgaskasa-ovttasbargu-guovllu--ja-/davviriikkala-ovttasbargu.html?id=528602'"/>
...
<xsl:variable name="para_nob" select="'nordisk-samarbeid.html?id=528602'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nordisk-samarbeid_id_528602.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
