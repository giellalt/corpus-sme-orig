...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Samepolitihkka/Samegiela-geavaheapmi/gollegiella.html?id=86929'"/>
...
<xsl:variable name="para_nob" select="'gollegiella.html?id=86929'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gollegiella_id_86929.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
