...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/uvgehuslagadusa-foanda-.html?id=408533'"/>
...
<xsl:variable name="para_nob" select="'opplysningsvesenets-fond.html?id=408533'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="opplysningsvesenets-fond_id_408533.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
