...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Departemeanta-birra/Organisasvdna/Ossodagat-/Nuoskkidanaiid-ossodat/Ossodatallingoddi.html?id=85646'"/>
