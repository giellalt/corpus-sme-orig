...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Oasat/2009/eanetlohkoraehusa-samepolitihkala-doaibm.html?id=573227'"/>
...
<xsl:variable name="para_nob" select="'flertallsregjeringens-samepolitiske-tilt.html?id=573227'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="flertallsregjeringens-samepolitiske-tilt_id_573227.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
