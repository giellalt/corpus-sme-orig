...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/algoalbmotvuoigatvuoaid-gelbbolavuoaguov.html?id=85802'"/>
...
<xsl:variable name="para_nob" select="'kompetansesenter_for_urfolks_rettigheter.html?id=85802'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kompetansesenter_for_urfolks_rettigheter_id_85802.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
