...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/preassaguovdda/pressemeldinger/2012/ahppes-barggu-hehttegohtet-bargiid-bakko.html?id=686769'"/>
...
<xsl:variable name="para_nob" select="'tiltak-mot-svart-arbeid--krav-om-foring-.html_id=686769'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tiltak-mot-svart-arbeid--krav-om-foring-_id_686769.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
