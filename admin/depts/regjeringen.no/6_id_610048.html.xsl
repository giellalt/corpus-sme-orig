...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/regpubl/stmeld/2009-2010/die-st-22-2009--20101/2/6.html?id=610048'"/>
<xsl:variable name="title" select="'2.6 Giella - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1539'"/>
