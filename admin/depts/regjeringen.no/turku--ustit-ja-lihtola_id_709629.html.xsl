...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/aigeguovdil/Oasat/2012/turku--ustit-ja-lihtola.html?id=709629'"/>
...
<xsl:variable name="para_nob" select="'tyrkia--venn-og-alliert.html_id=709629'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tyrkia--venn-og-alliert_id_709629.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
