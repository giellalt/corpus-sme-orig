...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/8/4/5.html?id=514386'"/>
<xsl:variable name="title" select="'8.4.5 áššečuoččaldahtttingelbbolašvuohta - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'561'"/>
