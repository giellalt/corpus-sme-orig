...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/dokumeanttat/lagat-ja-lahkaasahusat/lahkaasahusat/2012/lagu-albmotmeahci-suodjaleami-birra.html?id=710548'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Láhkaásahus Lágu álbmotmeahci suodjaleami birra Oarjelih-Báidára, Meløy ja Báidár gielddain Nordlándda fylkkas - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1552'"/>
...
<xsl:variable name="para_nob" select="'avgjorelse-av-klager-pa-vedtak-om-lisens.html_id=710331'"/>
