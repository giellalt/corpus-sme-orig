...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Fadda/vuovdedoallu-ja-bioenergiija/muorrageavaheapmi.html?id=473275'"/>
...
<xsl:variable name="para_nob" select="'bruk-av-tre.html?id=473275'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bruk-av-tre_id_473275.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
