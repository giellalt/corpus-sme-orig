...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2011/daidda-ja-kultuvra-galga-buohkaide-avkin.html?id=666271'"/>
...
<xsl:variable name="para_nno" select="'kunst-og-kultur-ma-kome-fleire-til-gode.html_id=666271'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kunst-og-kultur-ma-kome-fleire-til-gode_id_666271.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
