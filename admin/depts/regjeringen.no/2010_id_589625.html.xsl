...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aktuelt/Nyheter/2010.html?id=589625'"/>
...
<xsl:variable name="para_nob" select="'2010.html?id=589625'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="2010_id_589625.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
