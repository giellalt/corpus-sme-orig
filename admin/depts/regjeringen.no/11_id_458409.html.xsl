...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/1/11.html?id=458409'"/>
<xsl:variable name="title" select="'1.11 Dearvvasvuođa- ja... - regjeringen.no'"/>
