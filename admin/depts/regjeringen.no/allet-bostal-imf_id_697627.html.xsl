...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/aigeguovdil/sartnit-ja-artihkkalat/ministeren/taler-og-artikler-av-finansminister/2012/allet-bostal-imf.html?id=697627'"/>
...
<xsl:variable name="para_nob" select="'ikke-svartmal-imf.html_id=697627'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ikke-svartmal-imf_id_697627.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
