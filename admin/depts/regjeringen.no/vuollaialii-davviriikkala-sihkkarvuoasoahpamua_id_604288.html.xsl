...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/Aigeguovdil/Oasat/2010/Vuollaialii-davviriikkala-sihkkarvuoasoahpamua.html?id=604288'"/>
...
<xsl:variable name="para_nob" select="'Inngikk-nordisk-sikkerhetsavtale.html?id=604288'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="inngikk-nordisk-sikkerhetsavtale_id_604288.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
