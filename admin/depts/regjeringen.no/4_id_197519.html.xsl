...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/4.html?id=197519'"/>
<xsl:variable name="title" select="'4 Sámi kultuvra ja giella - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1613'"/>
