...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/aktuelt/nyheter/2012/almmuhus--geahalanortnet-mas-dorjot-kult.html?id=698048'"/>
...
<xsl:variable name="para_nob" select="'utlysning---proveordning-med-tilskudd-ti.html_id=698048'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="utlysning---proveordning-med-tilskudd-ti_id_698048.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
