...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/Odeldiggeproposiuvnnat/20032004/od-prp-nr-21_2004-2005/2/5.html?id=180676'"/>
<xsl:variable name="title" select="'2.5 Departemeantta árvvoštallan - regjeringen.no'"/>
