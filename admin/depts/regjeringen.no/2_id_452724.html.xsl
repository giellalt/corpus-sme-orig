...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20062007/Stdie-nr-7-2006-2007-/3/11/2.html?id=452724'"/>
<xsl:variable name="title" select="'3.11.2 Resursalágat/vuoigatvuođat - regjeringen.no'"/>
