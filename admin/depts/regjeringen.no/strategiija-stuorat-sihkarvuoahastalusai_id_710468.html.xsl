...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2012/strategiija-stuorat-sihkarvuoahastalusai.html?id=710468'"/>
...
<xsl:variable name="para_nob" select="'strategi-mot-voksende-sikkerhetsutfordri.html_id=710468'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="strategi-mot-voksende-sikkerhetsutfordri_id_710468.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
