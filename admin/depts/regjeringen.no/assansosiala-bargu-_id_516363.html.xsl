...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/Assan--ja-huksenpolitihkka/assansosiala-bargu-.html?id=516363'"/>
...
<xsl:variable name="para_nob" select="'boligsosialt_arbeid.html?id=516363'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="boligsosialt_arbeid_id_516363.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
