...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/24/4.html?id=514637'"/>
<xsl:variable name="title" select="'1.4 Ceavzilis birashálddašeapmi - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1938'"/>
