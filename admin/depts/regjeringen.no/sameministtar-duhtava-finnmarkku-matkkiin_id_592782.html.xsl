...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/nyheter/2010/Sameministtar-duhtava-Finnmarkku-matkkiin.html?id=592782'"/>
...
<xsl:variable name="para_nob" select="'Sameministeren-fornoyd-med-Finnmarksbesok.html?id=592782'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sameministeren-fornoyd-med-finnmarksbesok_id_592782.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
