...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Aigecallagat-ja-odasreivvet/2007/Oasat-samepolitihkas-nr-2---2007.html?id=482118'"/>
...
<xsl:variable name="para_nob" select="'nytt-om-samepolitikken-nr-2---2007.html?id=482118'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nytt-om-samepolitikken-nr-2---2007_id_482118.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
