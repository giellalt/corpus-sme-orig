...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/lasihuvvon-doarjja-daiddasuorgai.html?id=701349'"/>
...
<xsl:variable name="para_nno" select="'auka-tilskot-til-kunstomradet.html_id=701349'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="auka-tilskot-til-kunstomradet_id_701349.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
