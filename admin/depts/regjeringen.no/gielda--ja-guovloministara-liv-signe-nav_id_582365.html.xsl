...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Departemeanta/gielda--ja-guovloministtar-liv-signe-nav/gielda--ja-guovloministara-liv-signe-nav.html?id=582365'"/>
