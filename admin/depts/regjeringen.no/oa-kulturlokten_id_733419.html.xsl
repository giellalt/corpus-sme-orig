...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/oa-kulturlokten.html?id=733419'"/>
...
<xsl:variable name="para_nob" select="'nytt-kulturloft.html_id=733419'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nytt-kulturloft_id_733419.html" xml:lang="nob"/>
