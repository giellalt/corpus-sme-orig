...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2010/Roy-Kristiansen-galga-joihit-Kulturdepatemeanttas-oa-ossodaga.html?id=593396'"/>
...
<xsl:variable name="para_nno" select="'Roy-Kristiansen-skal-leie-nyoppretta-avdeling-i-Kulturdepartementet.html?id=593396'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="roy-kristiansen-skal-leie-nyoppretta-avdeling-i-kulturdepartementet_id_593396.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
