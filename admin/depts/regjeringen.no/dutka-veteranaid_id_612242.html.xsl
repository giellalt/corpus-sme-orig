...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/fd/pressesenter/pressemeldinger/2010/Dutka-veteranaid.html?id=612242'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/pressesenter/pressemeldinger/2010/Dutka-veteranaid.html?id=612242'"/>
<xsl:variable name="text_encoding" select="''"/>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Dutká veteránaid - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'forsker-pa-veteraner.html?id=612242'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forsker-pa-veteraner_id_612242.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
