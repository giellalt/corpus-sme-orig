...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/-lihkku-beivviin-samediggi.html?id=579411'"/>
...
<xsl:variable name="para_nno" select="'-gratulerer-med-dagen-sametinget.html?id=579411'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gratulerer-med-dagen-sametinget_id_579411.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
