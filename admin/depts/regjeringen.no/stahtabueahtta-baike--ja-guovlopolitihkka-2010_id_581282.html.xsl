...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/fadda/guovllu--ja-regionalapolitihkka/Baikegottiid--ja-guovlulapolitihka-duoga-ja-mihttomearit/Stahtabueahtta-baike--ja-guovlopolitihkka-2010.html?id=581282'"/>
...
<xsl:variable name="para_nob" select="'statsbudsjettet-2010-2.html?id=581282'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsbudsjettet-2010-2_id_581282.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
