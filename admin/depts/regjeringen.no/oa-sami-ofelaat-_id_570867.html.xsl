...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/oa-sami-ofelaat-.html?id=570867'"/>
...
<xsl:variable name="para_nob" select="'nye-samiske-veivisere-.html?id=570867'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nye-samiske-veivisere-_id_570867.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
