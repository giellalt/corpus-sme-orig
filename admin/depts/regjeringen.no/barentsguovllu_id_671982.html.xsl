...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/aigeguovdil/oddasat/2012/barentsguovllu.html?id=671982'"/>
...
<xsl:variable name="para_nob" select="'kirkenes_erklaering.html_id=671982'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kirkenes_erklaering_id_671982.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
