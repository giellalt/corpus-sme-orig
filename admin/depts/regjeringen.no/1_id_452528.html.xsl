...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2004-2005/Stdie-nr-11-2004-2005-/4-2/8/1.html?id=452528'"/>
<xsl:variable name="title" select="'4.8.1 Guolástus- ja riddodepartemeantta... - regjeringen.no'"/>
