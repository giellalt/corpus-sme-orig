...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/2012/nannejuvvon-gearggusvuohta-svalbarddas.html?id=704121'"/>
...
<xsl:variable name="para_nob" select="'styrket-beredskap-pa-svalbard.html_id=704121'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="styrket-beredskap-pa-svalbard_id_704121.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
