...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Gelbbolavuoa--ja-resursaossodat/Bargiidsekuvdna.html?id=87022'"/>
...
<xsl:variable name="para_nob" select="'personalseksjonen.html?id=87022'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="personalseksjonen_id_87022.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
