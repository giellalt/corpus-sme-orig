...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/Preassaguovdda/pressemeldinger/2007/Norgga-ekonomiija-nana-allakonjunktuvrra.html?id=466727'"/>
...
<xsl:variable name="para_nob" select="'norsk-okonomi-inne-i-en-sterk-hoykonjunk.html?id=466727'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norsk-okonomi-inne-i-en-sterk-hoykonjunk_id_466727.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
