...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/17/1.html?id=458638'"/>
<xsl:variable name="title" select="'17.1 Bálddalastin váikkuhangaskaoapmin - regjeringen.no'"/>
