...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/Departemeantta-birra/Organisauvdna/Ossodagat/Riekteossodat/Humanitara--ja-raggatusriektesekuvdna---.html?id=87014'"/>
...
<xsl:variable name="para_nob" select="'seksjon-for-humanitar--og-strafferett-.html?id=87014'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon-for-humanitar--og-strafferett-_id_87014.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
