...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/14/3/3.html?id=458596'"/>
<xsl:variable name="title" select="'14.3.3 Báikkálaš hálddaheapmi - regjeringen.no'"/>
