...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Sartnit-ja-artihkkalat/politisk_ledelse/tidligere_statssekretar_berit_oskal_eira/2006/raehusa-samepolitihkka.html?id=450273'"/>
<xsl:variable name="title" select="'Ráđđehusa sámepolitihkka - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2041'"/>
