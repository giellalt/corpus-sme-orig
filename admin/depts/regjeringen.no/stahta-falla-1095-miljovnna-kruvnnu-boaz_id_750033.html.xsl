...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/oasat/2014/jan-14/stahta-falla-1095-miljovnna-kruvnnu-boaz.html?id=750033'"/>
...
<xsl:variable name="para_nob" select="'staten-tilbyr-reindriften-1095-millioner.html_id=750033'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="staten-tilbyr-reindriften-1095-millioner_id_750033.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
