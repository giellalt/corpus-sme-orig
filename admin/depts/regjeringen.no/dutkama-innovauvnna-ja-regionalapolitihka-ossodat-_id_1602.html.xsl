...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Departemeantta-birra/organisauvdna/Ossodagat/Dutkama-innovauvnna-ja-regionalapolitihka-ossodat-.html?id=1602'"/>
...
<xsl:variable name="para_nob" select="'avdeling_for_forskning_innovasjon_og_reg.html?id=1602'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdeling_for_forskning_innovasjon_og_reg_id_1602.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
