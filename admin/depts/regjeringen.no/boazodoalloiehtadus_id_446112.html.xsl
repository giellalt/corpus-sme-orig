...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Fadda/boazodoallu/boazodoalloiehtadus.html?id=446112'"/>
<xsl:variable name="title" select="'Boazodoallošiehtadus - regjeringen.no'"/>
