...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/6/3/5.html?id=514360'"/>
<xsl:variable name="title" select="'6.3.5 Sámegielalaš veahkkeduopmárat - regjeringen.no'"/>
