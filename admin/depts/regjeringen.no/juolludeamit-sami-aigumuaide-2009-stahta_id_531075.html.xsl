...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Raporttat-ja-planat/Raporttat-/2008/juolludeamit-sami-aigumuaide-2009-stahta.html?id=531075'"/>
...
<xsl:variable name="para_nob" select="'bevilgninger-til-samiske-formal.html?id=531075'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bevilgninger-til-samiske-formal_id_531075.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
