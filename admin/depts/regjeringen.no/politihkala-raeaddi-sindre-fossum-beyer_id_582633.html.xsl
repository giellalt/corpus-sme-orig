...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/stahtaministtar/Politihkala-mieldebargit/politihkala-raeaddi-sindre-fossum-beyer.html?id=582633'"/>
