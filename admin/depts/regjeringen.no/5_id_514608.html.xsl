...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/21/5.html?id=514608'"/>
<xsl:variable name="title" select="'21.5 Eanadoallu, meahcceealáhusat, ... - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'3727'"/>
