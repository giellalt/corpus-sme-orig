...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/aktuelt/nyheter/2012/raporta-girjjalavuoapolitihkala-gaskaomi.html?id=667979'"/>
...
<xsl:variable name="para_nob" select="'rapport-om-litteraturpolitiske-virkemidl.html_id=667979'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rapport-om-litteraturpolitiske-virkemidl_id_667979.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
