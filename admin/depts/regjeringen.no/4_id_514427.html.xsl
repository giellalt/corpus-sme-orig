...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/11/4.html?id=514427'"/>
<xsl:variable name="title" select="'11.4 Oahpponeavvuid ráhkadeapmi - regjeringen.no'"/>
