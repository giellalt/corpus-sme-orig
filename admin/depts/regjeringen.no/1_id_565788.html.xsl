...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2008-2009/stdie-nr-43-2008-2009-/3/1/1.html?id=565788'"/>
<xsl:variable name="title" select="'3.1.1 Bušeahttaprosedyrat ... - regjeringen.no'"/>
