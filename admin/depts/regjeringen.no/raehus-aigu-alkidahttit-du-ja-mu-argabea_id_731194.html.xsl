...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2013/raehus-aigu-alkidahttit-du-ja-mu-argabea.html?id=731194'"/>
...
<xsl:variable name="para_nob" select="'enkler-hverdag.html_id=731194'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="enkler-hverdag_id_731194.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
