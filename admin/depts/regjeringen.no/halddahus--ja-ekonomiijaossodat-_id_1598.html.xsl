...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Departemeantta-birra/organisauvdna/Ossodagat/Halddahus--ja-ekonomiijaossodat-.html?id=1598'"/>
...
<xsl:variable name="para_nob" select="'administrasjons-_og_okonomiavdeling_.html?id=1598'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="administrasjons-_og_okonomiavdeling_id_1598.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
