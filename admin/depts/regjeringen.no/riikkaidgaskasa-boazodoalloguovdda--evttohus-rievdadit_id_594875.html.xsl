...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/horinger/horingsdokumenter/2009/Riikkaidgaskasa-boazodoalloguovdda--evttohus-rievdadit.html?id=594875'"/>
...
<xsl:variable name="para_nob" select="'Horing---forslag-om-endring-av-vedtektene-til-Internasjonalt-reindriftssenter.html?id=594875'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horing---forslag-om-endring-av-vedtektene-til-internasjonalt-reindriftssenter_id_594875.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
