...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/Vuollasa-asahusat/Bargoriekti-.html?id=85819'"/>
...
<xsl:variable name="para_nob" select="'arbeidsretten.html?id=85819'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arbeidsretten_id_85819.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
