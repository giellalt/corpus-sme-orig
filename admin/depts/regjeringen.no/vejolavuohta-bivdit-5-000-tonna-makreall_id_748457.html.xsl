...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nfd/preassaguovdda/preassadieahusat/2013/vejolavuohta-bivdit-5-000-tonna-makreall.html?id=748457'"/>
...
<xsl:variable name="para_nob" select="'apner-for-fiske-av-5-000-tonn-makrell-i-.html_id=748457'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="apner-for-fiske-av-5-000-tonn-makrell-i-_id_748457.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
