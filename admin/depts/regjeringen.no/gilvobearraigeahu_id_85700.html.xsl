...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/departemeanta/Vuollasa-asahusat/gilvobearraigeahu.html?id=85700'"/>
...
<xsl:variable name="para_nob" select="'konkurransetilsynet.html?id=85700'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="konkurransetilsynet_id_85700.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
