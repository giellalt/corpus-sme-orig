...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Depatemeantta-birra/Vuollasa-asahusat/Bargobearraigeahu.html?id=85796'"/>
...
<xsl:variable name="para_nob" select="'arbeidstilsynet.html?id=85796'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arbeidstilsynet_id_85796.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
