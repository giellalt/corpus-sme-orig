...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://www.regjeringen.no/se/dep/fd/Aigeguovdil/taler_artikler/ministeren/taler-og-artikler-av-forsvarsminister-gr/2010/Haliida-arvalusaid.html?id=603993'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/Aigeguovdil/taler_artikler/ministeren/taler-og-artikler-av-forsvarsminister-gr/2010/Haliida-arvalusaid.html?id=603993'"/>
...
<xsl:variable name="wordcount" select="'665'"/>
...
<xsl:variable name="para_nob" select="'Onsker-innspill.html?id=603993'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="onsker-innspill_id_603993.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
