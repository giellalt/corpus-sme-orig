...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2008/gollegiella---davviriikkala-sami-giellab.html?id=506114'"/>
...
<xsl:variable name="para_nob" select="'gollegiella---nordisk-samisk-sprakpris-d.html?id=506114'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gollegiella---nordisk-samisk-sprakpris-d_id_506114.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
