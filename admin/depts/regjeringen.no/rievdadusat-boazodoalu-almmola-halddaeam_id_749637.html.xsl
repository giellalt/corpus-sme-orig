...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/oasat/2014/jan-14/rievdadusat-boazodoalu-almmola-halddaeam.html?id=749637'"/>
...
<xsl:variable name="para_nob" select="'endringer-i-organiseringen-av-den-offent.html_id=749637'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="endringer-i-organiseringen-av-den-offent_id_749637.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
