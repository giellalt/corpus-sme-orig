...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Preassaguovdda/Preassadieahusat/2010/Fylkkadiggevalga-ja-suohkan-gielddastivravalga-2011--valgabeaivvi-mearrideapmi.html?id=600716'"/>
...
<xsl:variable name="para_nno" select="'Fylkestingsvalet-og-kommunestyrevalet-2011---fastsetjing-av-valdag.html?id=600716'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fylkestingsvalet-og-kommunestyrevalet-2011---fastsetjing-av-valdag_id_600716.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
