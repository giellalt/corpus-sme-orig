...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2007-2008/stdie-nr-28-2007-2008-/18/2.html?id=514541'"/>
<xsl:variable name="title" select="'18.2 Bismagottit - regjeringen.no'"/>
