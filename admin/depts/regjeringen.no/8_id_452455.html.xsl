...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/2003-2004/stdie-nr-10-2003-2004-/15/3/8.html?id=452455'"/>
<xsl:variable name="title" select="'1.3.8 Kultuvra ja ealáhusat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1371'"/>
