...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/preassaguovdda/Preassadieahusat/2012/eanet-ruhta-luonddudiehtojuohkimii-ja-ha.html?id=703559'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="meir-til-naturinformasjon-og-forvalting_id_703559.html"/>
