...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/Lagat-ja-njuolggadusat-/Lahkaasahusat/2010/njuolggadus-doarjaga-birra-orohagaide-ja.html?id=611859'"/>
...
<xsl:variable name="para_nob" select="'Forskrift-om-tilskudd-til-reinbeitedistrikter-og-tamreinlag-.html?id=611859'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrift-om-tilskudd-til-reinbeitedistrikter-og-tamreinlag-_id_611859.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
