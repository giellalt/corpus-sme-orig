...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/preassaguovdda/preassadieahusat/2009/doarjja-radjerasttildeaddji-gielladoaimm.html?id=574210'"/>
...
<xsl:variable name="para_nob" select="'stotte-til-grenseoverskridende-spraktilt.html?id=574210'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stotte-til-grenseoverskridende-spraktilt_id_574210.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
