...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fd/Aigeguovdil/Oasat/2010/Oktasa-ovdosat-oktasa-hastalusaide.html?id=605450'"/>
...
<xsl:variable name="para_nob" select="'--Felles-losninger-pa-felles-utfordringer.html?id=605450'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="felles-losninger-pa-felles-utfordringer_id_605450.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
