...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2012/vuoruheames-vuoolagaavvudeami.html?id=701351'"/>
...
<xsl:variable name="para_nno" select="'satsing-pa-grunnlovsjubileet.html_id=701351'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="satsing-pa-grunnlovsjubileet_id_701351.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
