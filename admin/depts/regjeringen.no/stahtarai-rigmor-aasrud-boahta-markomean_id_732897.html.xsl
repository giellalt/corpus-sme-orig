...
<xsl:variable name="filename" select="'wget http://www.regjeringen.no/se/dep/fad/oasat/oasat/2013/stahtarai-rigmor-aasrud-boahta-markomean.html?id=732897'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsrad-rigmor-aasrud-besoker-markomean_id_732897.html" xml:lang="nob"/>
</xsl:variable>
