...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/Dokumeanttat/Lagat-ja-njuolggadusat/Njuolggadusat/2004/Lahka-guovvamanu-10-b-1967-halddaanaiid-meannudanvuogi-birra-halddaanlahka.html?id=420602'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Láhka guovvamánu 10. b. 1967 hálddašanáššiid meannudanvuogi birra (hálddašanláhka) - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'7531'"/>
