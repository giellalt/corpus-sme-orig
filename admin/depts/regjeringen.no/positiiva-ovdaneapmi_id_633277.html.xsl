...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2011/positiiva-ovdaneapmi.html?id=633277'"/>
...
<xsl:variable name="para_nob" select="'positiv-utvikling.html?id=633277'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="positiv-utvikling_id_633277.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
