...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/preassaguovdda/pressemeldinger/2012/preassabovdehus-2013-stahtabueahtta.html?id=701126'"/>
...
<xsl:variable name="para_nob" select="'presseinvitasjon-statsbudsjettet-for-201.html_id=701126'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="presseinvitasjon-statsbudsjettet-for-201_id_701126.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
