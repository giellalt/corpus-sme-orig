...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/preassaguovdda/Preassadieahus/2013/haliida-alkit-argabeaivvi-manaid--ja-nuo.html?id=728487'"/>
...
<xsl:variable name="para_nob" select="'onsker-enklere-hverdag-for-barne--og-ung.html_id=728487'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="onsker-enklere-hverdag-for-barne--og-ung_id_728487.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
