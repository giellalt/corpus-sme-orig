...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/stuorradiggedieahusat/20002001/Stdie-nr-55-2000-2001-/9/1/2.html?id=458496'"/>
<xsl:variable name="title" select="'9.1.2 Mánáidáittardeaddji - regjeringen.no'"/>
