...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/proposiuvnnat-ja-dieahusat-/Odeldiggeproposiuvnnat/20032004/od-prp-nr-21_2004-2005/2/4.html?id=180675'"/>
<xsl:variable name="title" select="'2.4 Eará gulaskuddancealkámušat - regjeringen.no'"/>
