...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2009/mars-09/kultureanadat-20-buorahis-eanadaga-vallj.html?id=551175'"/>
...
<xsl:variable name="para_nob" select="'kulturlandskap-20-utvalgte-landskap-pekt.html?id=551175'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kulturlandskap-20-utvalgte-landskap-pekt_id_551175.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
