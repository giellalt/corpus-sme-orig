...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Aigeguovdil/Oasat/2009/feb-09/boazodoallu-oa-iehtadusa-soahpan.html?id=546231'"/>
...
<xsl:variable name="para_nob" select="'reindrift-enighet-om-ny-avtale.html?id=546231'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reindrift-enighet-om-ny-avtale_id_546231.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
