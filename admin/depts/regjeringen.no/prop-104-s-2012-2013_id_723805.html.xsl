...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/Dokumeanttat-/regpubl/proposiuvnnat-stuorradiggai/2012-2013/prop-104-s-2012-2013.html?id=723805'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Prop. 104 S (2012-2013) - regjeringen.no'"/>
