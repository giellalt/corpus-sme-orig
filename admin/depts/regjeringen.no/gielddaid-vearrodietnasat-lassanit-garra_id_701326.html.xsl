...
<xsl:variable name="parallels">
	<parallel_text location="municipal-tax-revenues-saw-strong-growth_id_701326.html" xml:lang="eng"/>
	<parallel_text location="auka-skatteinntekter-til-kommunane-i-201_id_701326.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
