...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/preassadieahusat/2012/gielddaid-vearrodietnasat-lassanit-garra.html?id=701326'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="municipal-tax-revenues-saw-strong-growth_id_701326.html"/>
        ...
        <parallel_text xml:lang="nno" location="auka-skatteinntekter-til-kommunane-i-201_id_701326.html"/>
