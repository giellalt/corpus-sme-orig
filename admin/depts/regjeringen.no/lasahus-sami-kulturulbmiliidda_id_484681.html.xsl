...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kkd/preassaguovdda/Preassadieahus/2007/Lasahus-sami-kulturulbmiliidda.html?id=484681'"/>
...
<xsl:variable name="para_nob" select="'mer-til-samiske-kulturformal.html?id=484681'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mer-til-samiske-kulturformal_id_484681.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
