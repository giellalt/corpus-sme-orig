...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/oed/pressesenter/pressemeldinger/2013/konseuvdna-oa-el-fapmolinjjaide-huksemii.html?id=734428'"/>
...
<xsl:variable name="para_nob" select="'konsesjon-til-ny-kraftledning-fra-ofoten.html_id=734428'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="konsesjon-til-ny-kraftledning-fra-ofoten_id_734428.html" xml:lang="nob"/>
