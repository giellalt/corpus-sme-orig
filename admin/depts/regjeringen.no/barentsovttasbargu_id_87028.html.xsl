...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/tema/Samepolitihkka/Riikkaidgaskasa-algoalbmotbargu/Barentsovttasbargu.html?id=87028'"/>
...
<xsl:variable name="para_nob" select="'barentssamarbeidet.html?id=87028'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barentssamarbeidet_id_87028.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> bdeda3968b (Northern Saami regjeringen.no docs renamed, metadata updated in parallel files)
