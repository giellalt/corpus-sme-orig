...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/FAD/Vedlegg/SAMI/HP_2009_samisk_sprak_nordsam.pdf'"/>
<xsl:variable name="title" select="'Sámegielaid doaibmaplána'"/>
