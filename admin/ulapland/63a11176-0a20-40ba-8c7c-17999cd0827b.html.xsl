...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.ulapland.fi/news/O%C4%91%C4%91a-pro%C5%A1eakta-ovddida-s%C3%A1pmela%C4%8D%C4%8Daid-ekolog%C3%A1la%C5%A1-%C3%A1rbedie%C4%91u-seailuma-Suoma-S%C3%A1mis/sji5ylm3/63a11176-0a20-40ba-8c7c-17999cd0827b'"/>
