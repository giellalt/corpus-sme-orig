...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.ulapland.fi/news/N%C3%A1kkus-S%C3%A1meservo%C5%A1ii-boahtti-d%C3%A1rbba%C5%A1a-sosi%C3%A1la-ja-kultuvrrala%C5%A1-oaiveopmodaga/sji5ylm3/1da7cd33-284e-4702-9c96-6de1d59c20e1'"/>
