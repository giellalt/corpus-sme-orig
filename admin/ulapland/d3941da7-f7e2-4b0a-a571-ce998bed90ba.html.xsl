...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.ulapland.fi/news/Skuvlenideologiijat-ja-margin%C3%A1la-oahppijoavkkut-%E2%80%93-skuvlenhistorjj%C3%A1-oaidninvuogit-veh%C3%A1dagaid-deaivvadeapm%C3%A1i---/sji5ylm3/d3941da7-f7e2-4b0a-a571-ce998bed90ba'"/>
