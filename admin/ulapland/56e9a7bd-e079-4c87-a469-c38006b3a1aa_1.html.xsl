...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.ulapland.fi/news/N%C3%A1kkus-S%C3%A1meoahpahusa-ovddideapmi-oktasga%C5%A1-oahpaheaddji-duohken-/v3jb0v5k/56e9a7bd-e079-4c87-a469-c38006b3a1aa'"/>
