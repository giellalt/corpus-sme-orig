...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.ulapland.fi/news/S%C3%A1pmela%C4%8D%C4%8Daid-buresbirgemis-riikaviidosa%C5%A1-dutkamu%C5%A1/sji5ylm3/b0506ca6-591e-45ab-8287-29ee5e8ac347'"/>
