...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.ulapland.fi/news/Eami%C3%A1lbmoga-nupp%C3%A1tuvvi-saj%C3%A1dat/v3jb0v5k/8afe77ca-823b-4dbf-a143-5466a8fbe79e'"/>
