...
<xsl:variable name="filename" select="'http://www.tromsfylke.no/Portals/0/Vedlegg/Publikasjoner/Rapporter/Fylkersrapport06sam0000.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'JAHKEDIEĐÁHUS 06'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fylkersrapport060000.pdf" xml:lang="nob"/>
</xsl:variable>
