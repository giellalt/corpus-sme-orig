...
<!-- Format query results for display --><xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'2005sadibeavdegirjiskabma.doc'"/>
  ...
  <xsl:variable name="publisher" select="'The finnish sami parliament'"/>
  ...
  <xsl:variable name="wordcount" select="'3495'"/>
