...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://samisklegeforening.no/wp-content/uploads/2019/01/Dearvvasvuodaseminara-Romssas-2019_sam-1.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dearvvašvuođaseminára sámi mánáid ja nuoraid dearvvašvuođa- ja eallineavttut'"/>
    <!--
    ...
    <xsl:variable name="left_margin" select="'1=35, 3=33'"/>
    <xsl:variable name="top_margin" select="'all=20'"/>
