...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.manskligarattigheter.se/Media/Get/601/nordsamiska-pdf'"/>
    ...
    <xsl:template match="p[parent::body][not(./em | ./span)][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                ...
                <xsl:with-param name="target" select="'Ruo…a/Ruo……a/Ruo…as/Dea…álaš/dea…álaš/'"/>
                <xsl:with-param name="replacement" select="'Ruoŧa/Ruoŧŧa/Ruoŧas/Deaŧálaš/deaŧálaš/'"/>
