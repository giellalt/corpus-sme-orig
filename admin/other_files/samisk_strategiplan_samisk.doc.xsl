...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="translator_fn" select="'Berit Merete'"/>
    <xsl:variable name="translator_ln" select="'Nystad'"/>
    ...
    <xsl:variable name="wordcount" select="'12440'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="samisk_strategiplan_norsk_uten_vedlegg.doc"/>
