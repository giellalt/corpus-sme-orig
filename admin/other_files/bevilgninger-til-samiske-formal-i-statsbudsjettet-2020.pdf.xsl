...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Juolludeamit sámi ulbmiliidda jagi 2020 stáhtabušeahtas'"/>
    <!--
    ...
    <xsl:variable name="publisher" select="'Gielda- ja ođasmahttindepartemeanta'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="bevilgninger-til-samiske-formal-i-statsbudsjettet-2020.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-25, 48'"/>
    ...
    <xsl:variable name="bottom_margin" select="'all=10, 26=60'"/>
