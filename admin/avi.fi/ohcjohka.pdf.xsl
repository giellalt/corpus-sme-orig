...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.avi.fi/documents/10191/601734/Ohcjohka.pdf/047ab332-1fe2-4473-b676-3bb14241cca6'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="vuoden-rajakunnaksi-valittu-utsjoki-nayttaa-esimerkkia-hyvasta-yhteistoiminnasta-lappi-_.wr6_d8yvhnq.html"/>
