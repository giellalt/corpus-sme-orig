...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="strategiplan_for_samisk_kirkeliv_2011.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-5, 7-8, 10-37, 44, 53, 110, 119'"/>
    ...
    <xsl:variable name="top_margin" select="'69=79'"/>
    <xsl:variable name="bottom_margin" select="'68=75'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'94=7, 38=7, 42=7'"/>
    <xsl:variable name="inner_left_margin" select="'94=7, 38=50, 42=50'"/>
    <xsl:variable name="inner_top_margin" select="'94=40, 38=26, 42=7'"/>
    <xsl:variable name="inner_bottom_margin" select="'94=27, 38=45, 42=53'"/>
