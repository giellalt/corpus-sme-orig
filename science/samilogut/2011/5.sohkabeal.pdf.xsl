...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/5._sohkabeal.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sohkabealperspektiiva sámi statistihkas'"/>
    <!--
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Torunn'"/>
    <xsl:variable name="author2_ln" select="'Pettersen'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author4_fn" select="'Øyvind'"/>
    <xsl:variable name="author4_ln" select="'Rustad'"/>
    ...
    <xsl:variable name="author6_fn" select="'Yngve'"/>
    <xsl:variable name="author6_ln" select="'Johansen'"/>
    <xsl:variable name="author6_gender" select="'m'"/>
    <xsl:variable name="author6_nat" select="''"/>
    <xsl:variable name="author6_born" select="''"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="4_gender_perspective.pdf"/>
        ...
        <parallel_text xml:lang="nob" location="5.kjonn.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'4=70, 10=42, 15=30, 24=47, 25=75, 26=50'"/>
    <xsl:variable name="bottom_margin" select="'6=50, 7=32, 10=20, 13=50, 14=20, 16=31, 18=29, 21=55, 22=80, 26=29'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'5=7, 7=7, 17=7'"/>
    <xsl:variable name="inner_left_margin" select="'5=7, 7=7, 17=7'"/>
    <xsl:variable name="inner_top_margin" select="'5=20, 7=35, 17=37'"/>
    <xsl:variable name="inner_bottom_margin" select="'5=60, 7=49, 17=39'"/>
