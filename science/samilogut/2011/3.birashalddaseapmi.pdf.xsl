...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="author1_fn" select="'Ole-Bjørn'"/>
    <xsl:variable name="author1_ln" select="'Fossbakk'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="3.miljoforvaltning.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'8=47, 16=42, 17=42'"/>
    <xsl:variable name="bottom_margin" select="'all=12, 2=14, 4=20, 8=25, 12=25, 14=40, 15=25, 17=7, 23=58, 24=7'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'6=33, 7=14, 22=12'"/>
    <xsl:variable name="inner_bottom_margin" select="'6=30, 7=48, 22=60'"/>
