...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/2.samegiella_skuvllas.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Duođalaš njiedjan fágas sámegiella nubbingiella'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="2.alvorleg_nedgang_for_faget_samisk_som_andresprak.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'5, 14, 21'"/>
    ...
    <xsl:variable name="top_margin" select="'4=75, 8=37, 9=37, 10=25, 13=33'"/>
    <xsl:variable name="bottom_margin" select="'all=15, 15=20, 19=20, 6=62, 9=12, 13=36, 20=79'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'2=7, 3=7, 7=7, 11=7'"/>
    <xsl:variable name="inner_left_margin" select="'2=7, 3=7, 7=7, 11=7'"/>
    <xsl:variable name="inner_top_margin" select="'2=31, 3=12, 7=26, 11=37'"/>
    <xsl:variable name="inner_bottom_margin" select="'2=45, 3=62, 7=53, 11=24'"/>
