...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/4.kapihttal.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámi-guoski doavttergrádabuvttadeapmi Romssa universitehtas'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Ann Ragnhild'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Else Grete'"/>
    <xsl:variable name="author2_ln" select="'Broderstad'"/>
    <xsl:variable name="author2_gender" select="'f'"/>
    <xsl:variable name="author2_nat" select="'NO'"/>
    <xsl:variable name="author2_born" select="'19611122'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="4.doktorgradsproduksjonen.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'all=12, 2=17, 3=19, 4=22, 5=47, 7=20, 10=84, 12=16'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'6=7, 9=7'"/>
    <xsl:variable name="inner_left_margin" select="'6=7, 9=7'"/>
    <xsl:variable name="inner_top_margin" select="'6=24, 9=36'"/>
    <xsl:variable name="inner_bottom_margin" select="'6=26, 9=26'"/>
