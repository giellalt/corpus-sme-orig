...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/4.ufor_soshjelp_samegilli.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bargonávccahisvuođaoadju ja sosiálaveahkki'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="4_uforetrygd_og_sosialhjelp.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'9=50, 12=55, 14=68, 15=66, 18=50'"/>
    <xsl:variable name="bottom_margin" select="'7=71, 8=53, 10=85, 16=86, 17=69, 19=37'"/>
    ...
    <xsl:variable name="inner_left_margin" select="'6=7'"/>
    <xsl:variable name="inner_top_margin" select="'6=18'"/>
