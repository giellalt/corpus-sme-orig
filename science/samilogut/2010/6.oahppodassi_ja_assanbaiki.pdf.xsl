...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/6.oahppodassi_ja_assanbaiki.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oahppodássi ja ássanbáiki'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Yngve'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="6_utdanningsniva_og_bosted.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'3=74, 5=72'"/>
    <xsl:variable name="bottom_margin" select="'9=72, 11=80'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'8=7'"/>
    <xsl:variable name="inner_left_margin" select="'8=7'"/>
    <xsl:variable name="inner_top_margin" select="'8=12'"/>
    <xsl:variable name="inner_bottom_margin" select="'8=27'"/>
