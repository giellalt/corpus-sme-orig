...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/7.samegiella_manaidgarddiin_ja_skuvllain_0.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámegiella mánáidgárddiin ja skuvllain'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="7.samisk_sprak_i_barnehage_og_skule.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'8, 5-6, 3'"/>
    ...
    <xsl:variable name="bottom_margin" select="'2=36, 7=80'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'2=33'"/>
    <xsl:variable name="inner_bottom_margin" select="'2=47'"/>
