...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Boallobeavddi bokte'"/>
    <!--
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Trond'"/>
    <xsl:variable name="author2_ln" select="'Trosterud'"/>
    ...
    <xsl:variable name="publisher" select="'Sámi allaskuvla'"/>
    ...
    <xsl:variable name="collection" select="'Sami logut muitalit'"/>
    <!--
    ...
    <xsl:variable name="translator_born" select="'1962'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="digiartikkelnob.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'11=40, 14=30'"/>
    <xsl:variable name="bottom_margin" select="'7;16;20=15, 8;10=25, 9=28, 11;13;14;15;23;24=20, 12;17=40, 27=45'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'18;20;22=7'"/>
    <xsl:variable name="inner_left_margin" select="'18;20;22=7'"/>
    <xsl:variable name="inner_top_margin" select="'18=45, 20=40, 22=32'"/>
    <xsl:variable name="inner_bottom_margin" select="'18=30, 20=45, 22=30'"/>
