...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/samegielfalaldat_manaidgarddis_-_2020.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'4 Sámegielfálaldat mánáidgárddis'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="4barnehager.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'5=12, 6;7s=15, 8=20, 17=63'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'11=16'"/>
