...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'5 Sámi girjealmmuheamit Norggas – Norgga sámepolitihka ovdanbuktin?'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="5samiske_bokutgjevingar.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'18'"/>
    ...
    <xsl:variable name="top_margin" select="'1=60'"/>
    <xsl:variable name="bottom_margin" select="'2=25, 6=23, 4;12=12, 10=14, 7;14=18, 8=30, 17=30'"/>
