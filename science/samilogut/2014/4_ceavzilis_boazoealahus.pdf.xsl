...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/4_ceavzilis_boazoealahus_0.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ceavzilis boazoealáhus?'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Jan Åge'"/>
    <xsl:variable name="author1_ln" select="'Riseth'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="6_sustainable_reindeer_herding.pdf"/>
        ...
        <parallel_text xml:lang="nob" location="4_barekraftig_reindrift.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'14-35, 50-51, 9-11'"/>
    ...
    <xsl:variable name="top_margin" select="'7=47'"/>
    <xsl:variable name="bottom_margin" select="'3=20, 6=20, 8=20, 12=20, 13=15, 49=40, 43=17, 36=18'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'36=7, 3=7'"/>
    <xsl:variable name="inner_left_margin" select="'36=7, 3=7'"/>
    <xsl:variable name="inner_top_margin" select="'36=40, 3=55'"/>
    <xsl:variable name="inner_bottom_margin" select="'36=36, 3=33'"/>
