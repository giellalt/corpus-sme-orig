...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/2_sed-guovllu_ealahusovdaneapmi_1.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'SED-guovllu ealáhusovdáneapmi 2000-logus'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Sigrid'"/>
    <xsl:variable name="author1_ln" select="'Skålnes'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="2_naeringsutvikling_innanfor_stn.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'8, 26-27'"/>
    ...
    <xsl:variable name="top_margin" select="'7=30, 15=46, 17=37, 20=62, 21=37, 24=40'"/>
    <xsl:variable name="bottom_margin" select="'2=18, 3=26, 5=26, 6=49, 7=20, 11=12, 16=14, 18=14, 19=20, 21=14'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'10=7, 12=7'"/>
    <xsl:variable name="inner_left_margin" select="'10=7, 12=7'"/>
    <xsl:variable name="inner_top_margin" select="'10=17, 12=35'"/>
    <xsl:variable name="inner_bottom_margin" select="'10=36, 12=35'"/>
