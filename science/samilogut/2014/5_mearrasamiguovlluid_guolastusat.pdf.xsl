...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="author1_born" select="'19611122'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="5_fiskeriene_i_sjosamiske.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'11, 20, 15-16'"/>
    ...
    <xsl:variable name="top_margin" select="'7=40, 8=42'"/>
    <xsl:variable name="bottom_margin" select="'1=14, 2=12, 3=17, 8=20, 10=50, 18=20'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'4=7, 9=7, 12=7, 13=7, 14=7'"/>
    <xsl:variable name="inner_left_margin" select="'4=7, 9=7, 12=7, 13=7, 14=7'"/>
    <xsl:variable name="inner_top_margin" select="'4=30, 9=50, 12=40, 13=48, 14=22'"/>
    <xsl:variable name="inner_bottom_margin" select="'4=47, 9=20, 12=20, 13=20, 14=40'"/>
