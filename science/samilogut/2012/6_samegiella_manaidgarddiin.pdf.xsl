...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/6giellakap14.09.12.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámegiella mánáidgárddiin ja skuvllain 2011/12'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="6_samisk_sprak_i_barnehage.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'15, 6, 13'"/>
    ...
    <xsl:variable name="top_margin" select="'3=80, 7=47, 8=35, 11=60, 12=57, 14=30'"/>
    <xsl:variable name="bottom_margin" select="'2=13, 4=50, 5=80, 8=42'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'9=7, 14=7'"/>
    <xsl:variable name="inner_left_margin" select="'9=7, 14=7'"/>
    <xsl:variable name="inner_top_margin" select="'9=46, 14=55'"/>
    <xsl:variable name="inner_bottom_margin" select="'9=24, 14=30'"/>
