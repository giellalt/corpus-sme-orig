...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Kjetil'"/>
    <xsl:variable name="author2_ln" select="'Sørlie'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="4.bo_og_flyttetrender.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'6-7, 14, 27'"/>
    ...
    <xsl:variable name="left_margin" select="'4=30'"/>
    <xsl:variable name="top_margin" select="'4=18, 10=40, 12=45, 13=55, 21=33'"/>
    <xsl:variable name="bottom_margin" select="'5=53, 19=55, 20=36, 22=63'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'8=7, 9=7'"/>
    <xsl:variable name="inner_left_margin" select="'8=7, 9=7'"/>
    <xsl:variable name="inner_top_margin" select="'8=41, 9=19'"/>
    <xsl:variable name="inner_bottom_margin" select="'8=22, 9=50'"/>
