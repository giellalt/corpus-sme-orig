...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/3.stor_befolkningsvekst_samegillii.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Álbmotlohku lassána ollu, muhto movt dat juohkása?'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Paul Inge'"/>
    <xsl:variable name="author1_ln" select="'Severeide'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="3.stor_befolkningsvekst.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'9=50, 15=34'"/>
    <xsl:variable name="bottom_margin" select="'21=65'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'3=7, 15=7, 16=7, 17=7'"/>
    <xsl:variable name="inner_left_margin" select="'3=7, 15=7, 16=7, 17=7'"/>
    <xsl:variable name="inner_top_margin" select="'3=15, 15=52, 16=13, 17=29'"/>
    <xsl:variable name="inner_bottom_margin" select="'3=48, 15=27, 16=60, 17=45'"/>
