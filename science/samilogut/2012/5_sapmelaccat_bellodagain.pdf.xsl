...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="author1_ln" select="'Selle'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Kristin'"/>
    <xsl:variable name="author2_ln" select="'Strømsnes'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="5_samer_i_parti.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'17, 21-22, 25, 27, 33'"/>
    ...
    <xsl:variable name="top_margin" select="'13=69, 29=75'"/>
    <xsl:variable name="bottom_margin" select="'4=25, 5=13, 6=30, 8=55, 9=33, 10=22, 11=37, 12=22, 16=25, 19=15, 20=25, 23=57, 28=25, 30=20'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'15=38, 19=16'"/>
    <xsl:variable name="inner_bottom_margin" select="'15=16, 19=47'"/>
