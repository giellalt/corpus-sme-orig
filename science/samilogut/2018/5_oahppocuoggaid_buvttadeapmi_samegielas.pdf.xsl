...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="5_studiepoengproduksjon_i_samiske_sprak.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'4=25, 6=77, 8=70, 10=70, 12=45'"/>
    <xsl:variable name="bottom_margin" select="'2=19, 3=16, 4=15, 5=20, 6=15, 8=17, 9=20, 11=79, 12=14, 14=20, 15=16, 16=78'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'13=18'"/>
    <xsl:variable name="inner_bottom_margin" select="'13=24'"/>
