...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/6._samegillii_6_samisk_filmbolge_baner_vei.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámi filbmabárru láidesta'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="6_samisk_filmbolge_baner_vei.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'4, 6, 11, 13, 15, 21'"/>
    ...
    <xsl:variable name="top_margin" select="'7=39, 8=27'"/>
    <xsl:variable name="bottom_margin" select="'all=13, 2=18, 3=18, 5=20, 8=6, 14=74, 16=7, 17=15, 19=47, 20=28'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'9=7, 16=7, 17=7'"/>
    <xsl:variable name="inner_left_margin" select="'9=7, 16=7, 17=7'"/>
    <xsl:variable name="inner_top_margin" select="'9=17, 16=17, 17=30'"/>
    <xsl:variable name="inner_bottom_margin" select="'9=29, 16=51, 17=36'"/>
