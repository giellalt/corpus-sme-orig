...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/3.arvohahkan_sed-guovllus.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Árvoháhkan SED-guovllus'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="3_verdiskapning_i_stn_omradet.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'5=35, 8=50, 10=78'"/>
    <xsl:variable name="bottom_margin" select="'1=15, 2=13, 4=20, 6=80'"/>
