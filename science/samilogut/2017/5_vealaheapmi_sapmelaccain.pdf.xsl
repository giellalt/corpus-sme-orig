...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/5._vealaheapmi_sapmelaccain_geain_leat_hedjonan_doaibmanavccat_0.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vealaheapmi sápmelaččain geain leat hedjonan doaibmanávccat'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Ketil Lenert'"/>
    ...
    <xsl:variable name="author1_born" select="'19750728'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="5_diskriminering_av_samer.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'20-21'"/>
    ...
    <xsl:variable name="top_margin" select="'16=72'"/>
    <xsl:variable name="bottom_margin" select="'4=12, 7=15, 9=15, 10=17, 13=53, 19=68'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'17=7'"/>
    <xsl:variable name="inner_left_margin" select="'17=7'"/>
    <xsl:variable name="inner_top_margin" select="'17=30'"/>
    <xsl:variable name="inner_bottom_margin" select="'17=29'"/>
