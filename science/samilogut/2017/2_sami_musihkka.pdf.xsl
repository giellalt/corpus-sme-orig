...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/2.samegillii_2samisk_musikk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámi musihkka – nanu árbevierru ja gelddolaš ođasteapmi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="2_samisk_musikk.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'4-8, 12, 21'"/>
    ...
    <xsl:variable name="bottom_margin" select="'1=22, 2=16, 3=18, 9=13, 11=18, 13=11, 14=13, 15=13, 17=16'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'14=7, 15=7, 16=7, 17=7, 18=7'"/>
    <xsl:variable name="inner_left_margin" select="'14=7, 15=7, 16=7, 17=7, 18=7'"/>
    <xsl:variable name="inner_top_margin" select="'14=19, 15=32, 16=47, 17=35, 18=13'"/>
    <xsl:variable name="inner_bottom_margin" select="'14=48, 15=28, 16=20, 17=25, 18=55'"/>
