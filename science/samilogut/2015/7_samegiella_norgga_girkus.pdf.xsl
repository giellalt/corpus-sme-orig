...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/7.samegiella_norgga_girkus.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámegiella Norgga girkus'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Tore'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="7_samisk_i_den_norskekirke.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'13=57, 22=72'"/>
    <xsl:variable name="bottom_margin" select="'2=20, 3=14, 5=20, 6=13, 9=18, 11=18, 15=15, 16=65, 20=12, 22=12, 23=34, 26=20'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'15=7'"/>
    <xsl:variable name="inner_left_margin" select="'15=7'"/>
    <xsl:variable name="inner_top_margin" select="'15=20'"/>
    <xsl:variable name="inner_bottom_margin" select="'15=60'"/>
