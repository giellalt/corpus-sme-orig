...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Torill H.'"/>
    <xsl:variable name="author2_ln" select="'Lauritsen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="8_tannhelse_i_samisk_befolkning.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'5=50, 6=50, 7=47, 8=45'"/>
    <xsl:variable name="bottom_margin" select="'9=12, 10=11'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'9=19'"/>
    <xsl:variable name="inner_bottom_margin" select="'9=45'"/>
