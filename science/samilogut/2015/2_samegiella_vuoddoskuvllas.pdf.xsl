...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/2.samegiella_skuvllas_2015.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámegiella vuođđoskuvllas ja joatkkaoahpahusas'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="7_sami_language_in_primary.pdf"/>
        ...
        <parallel_text xml:lang="nob" location="2_samisk_sprak_i_grunnskolen.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'13-14, 17, 28-29'"/>
    ...
    <xsl:variable name="top_margin" select="'4=31, 6=22, 8=45, 9=37, 10=45, 11=52, 12=60, 18=57'"/>
    <xsl:variable name="bottom_margin" select="'2=12, 11=18, 16=83, 27=80, 6=67'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'4=7, 5=7, 6=7, 7=7, 19=7'"/>
    <xsl:variable name="inner_left_margin" select="'4=7, 5=7, 6=7, 7=7, 19=7'"/>
    <xsl:variable name="inner_top_margin" select="'4=70, 5=22, 6=44, 7=25, 19=54'"/>
    <xsl:variable name="inner_bottom_margin" select="'4=19, 5=53, 6=30, 7=43, 19=28'"/>
