...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/6.samegillii_6_forskningsradene_1.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dutkanráđit – 40 jagi sámi dutkamii'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Kari'"/>
    <xsl:variable name="author1_ln" select="'Morthensen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="6_forskningsradene_40_ar.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'5, 13-16, 19-20'"/>
    ...
    <xsl:variable name="top_margin" select="'6=76, 17=35, 21=70, 29=41, 30=47'"/>
    <xsl:variable name="bottom_margin" select="'2=20, 3=23, 4=25, 6=14, 7=14, 9=18, 10=20, 11=12, 12=20, 17=11, 21=12, 22=45, 23=22, 25=20, 27=12, 29=20, 30=20, 31=12, 32=12, 34=20, 35=33'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'8=7, 23=7'"/>
    <xsl:variable name="inner_left_margin" select="'8=7, 23=7'"/>
    <xsl:variable name="inner_top_margin" select="'8=14, 23=30'"/>
    <xsl:variable name="inner_bottom_margin" select="'8=25, 23=50'"/>
