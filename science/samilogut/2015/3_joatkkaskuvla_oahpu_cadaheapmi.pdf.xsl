...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/3.joatkkaskuvla_oahpu_cadaheapmi.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Joatkkaskuvla oahpu čađaheapmi'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Tom'"/>
    <xsl:variable name="author1_ln" select="'Granseth'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="3_gjennomstromning_i_videregaende_opplaering.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'4, 6, 8, 13'"/>
    ...
    <xsl:variable name="top_margin" select="'13=40, 14=20'"/>
    <xsl:variable name="bottom_margin" select="'1=17, 9=63, 10=74, 13=25, 15=83'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'3=7, 5=7, 7=7, 12=7, 11=7, 14=7'"/>
    <xsl:variable name="inner_left_margin" select="'3=7, 5=7, 7=7, 12=7, 11=7, 14=7'"/>
    <xsl:variable name="inner_top_margin" select="'3=47, 5=22, 7=22, 12=33, 11=27, 14=40'"/>
    <xsl:variable name="inner_bottom_margin" select="'3=20, 5=43, 7=48, 12=33, 11=66, 14=47'"/>
