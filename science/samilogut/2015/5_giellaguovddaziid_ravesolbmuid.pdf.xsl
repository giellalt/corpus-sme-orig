...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/5.giellaguovddaziid_ravisolbmuide_oahpahus.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Giellaguovddážiid rávesolbmuid oahpahus'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="5_spraksentrenes_voksenopplaering.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'14-15'"/>
    ...
    <xsl:variable name="top_margin" select="'8=70'"/>
    <xsl:variable name="bottom_margin" select="'2=19, 4=69, 6=15, 7=25, 8=15, 9=15, 10=17'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'2=7, 9=7'"/>
    <xsl:variable name="inner_left_margin" select="'2=7, 9=7'"/>
    <xsl:variable name="inner_top_margin" select="'2=22, 9=51'"/>
    <xsl:variable name="inner_bottom_margin" select="'2=45, 9=25'"/>
