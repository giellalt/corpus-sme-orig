...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/3.samegillii_vold_og_overgrep_og_helseplager_blant_samer_i_norge.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Veahkaválddálašvuohta ja illasteapmi sápmelaččaid gaskkas Norggas'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="3_vold_overgrep_og_helseplager.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'26-28'"/>
    ...
    <xsl:variable name="top_margin" select="'14=41'"/>
    <xsl:variable name="bottom_margin" select="'1=16, 10=80, 11=46, 12=47, 22=67, 25=80'"/>
