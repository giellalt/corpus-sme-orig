...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/2._sami_logut_lohkkojit_samegiella.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámi logut lohkkojit. Matematihkka ja matematihkka oahpahus kultuvrralaš konteavsttas'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="2_samiske_tall_teller.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'4=14, 5=17, 6=58, 8=15, 9=15'"/>
