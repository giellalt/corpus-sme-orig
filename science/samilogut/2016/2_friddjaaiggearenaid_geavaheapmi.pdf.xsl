...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="author1_fn" select="'Kolbjørn'"/>
    <xsl:variable name="author1_ln" select="'Rafoss'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Kjell'"/>
    <xsl:variable name="author2_ln" select="'Hines'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="2_bruk_av_fritidsarenaer.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'11-12, 17, 20, 25'"/>
    ...
    <xsl:variable name="top_margin" select="'14=25, 15=28, 16=38, 17=40, 18=30, 21=44'"/>
    <xsl:variable name="bottom_margin" select="'5=17, 7=40, 8=48, 10=80, 13=56, 18=33, 24=45'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'14=7, 15=7, 16=7, 17=7, 19=7'"/>
    <xsl:variable name="inner_left_margin" select="'14=7, 15=7, 16=7, 17=7, 19=7'"/>
    <xsl:variable name="inner_top_margin" select="'14=50, 15=57, 16=50, 17=52, 19=33'"/>
    <xsl:variable name="inner_bottom_margin" select="'14=27, 15=20, 16=26, 17=26, 19=40'"/>
