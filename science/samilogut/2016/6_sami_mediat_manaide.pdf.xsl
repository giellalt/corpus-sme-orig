...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="6_samiske_medier_for_barn.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'21, 24-27'"/>
    ...
    <xsl:variable name="top_margin" select="'7=28, 9=30, 20=30, 22=50'"/>
    <xsl:variable name="bottom_margin" select="'2=13, 3=20, 4=32, 6=20, 18=53'"/>
    ...
    <xsl:variable name="inner_left_margin" select="'19=7'"/>
    <xsl:variable name="inner_top_margin" select="'19=26'"/>
    <xsl:variable name="inner_bottom_margin" select="'19=55'"/>
