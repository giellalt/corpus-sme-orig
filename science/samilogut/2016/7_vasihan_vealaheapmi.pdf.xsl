...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kap_7.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sápmelaččaid vásihan vealaheapmi Norggas'"/>
    <!--
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'8, 13, 19, 24-25'"/>
    ...
    <xsl:variable name="top_margin" select="'5=60, 9=55, 11=82, 14=50, 17=45, 21=60'"/>
    <xsl:variable name="bottom_margin" select="'16=71, 23=80'"/>
