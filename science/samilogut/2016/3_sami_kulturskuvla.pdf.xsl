...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kap_3._kulturskuvla_jorgaluvvon.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámi kulturskuvla'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Dag'"/>
    <xsl:variable name="author1_ln" select="'Broch'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="3_den_samiske_kulturskolen.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'3-4, 7, 19'"/>
    ...
    <xsl:variable name="top_margin" select="'5=63'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'8=21'"/>
    <xsl:variable name="inner_bottom_margin" select="'8=42'"/>
