...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="author1_fn" select="'Bente Ovedie'"/>
    <xsl:variable name="author1_ln" select="'Skogvang'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="4_festivaler_med_samisk_innhold.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'10, 19-21'"/>
    ...
    <xsl:variable name="top_margin" select="'4=42, 5=50, 6=43'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'7=7, 9=7'"/>
    <xsl:variable name="inner_left_margin" select="'7=7, 9=7'"/>
    <xsl:variable name="inner_top_margin" select="'7=30, 9=14'"/>
    <xsl:variable name="inner_bottom_margin" select="'7=36, 9=48'"/>
