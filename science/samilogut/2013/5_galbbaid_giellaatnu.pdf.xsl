...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/5_krh_manjimus_galbbaid_giellaatnu-14-10_loahpalas.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Galbbaid giellaatnu muitala'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Kaisa Rautio'"/>
    ...
    <xsl:variable name="author1_born" select="'1960'"/>
    <!--
        Information of the second author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Yngve'"/>
    <xsl:variable name="author2_ln" select="'Johansen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="5_sprakvalg_pa_skilt.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'34, 42'"/>
    ...
    <xsl:variable name="top_margin" select="'11=63, 20=35, 26=53, 28=35, 33=48, 35=40'"/>
    <xsl:variable name="bottom_margin" select="'10=53, 12=29, 13=36, 15=36, 18=20, 22=37, 28=30, 29=50, 31=53, 41=77'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'14=7, 24=7, 30=7'"/>
    <xsl:variable name="inner_left_margin" select="'14=7, 24=7, 30=7'"/>
    <xsl:variable name="inner_top_margin" select="'14=65, 24=40, 30=55'"/>
    <xsl:variable name="inner_bottom_margin" select="'14=20, 24=38, 30=18'"/>
