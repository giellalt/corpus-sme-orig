...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/6.biebmodovrrolaavuohta_davvin.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Biebmodorvvolašvuohta davvin'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Magritt'"/>
    <xsl:variable name="author1_ln" select="'Brustad'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Ammar Ali'"/>
    <xsl:variable name="author2_ln" select="'Hassan'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Torkjel M'"/>
    <xsl:variable name="author3_ln" select="'Sandanger'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="6_mattrygghet_i_nord.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'5=50, 9=45'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'8=7, 11=7, 12=7'"/>
    <xsl:variable name="inner_left_margin" select="'8=7, 11=7, 12=7'"/>
    <xsl:variable name="inner_top_margin" select="'8=12, 11=20, 12=12'"/>
    <xsl:variable name="inner_bottom_margin" select="'8=47, 11=42, 12=60'"/>
