...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="5_quantitative_changes_status.pdf"/>
        ...
        <parallel_text xml:lang="nno" location="2_kvantitative_endringar.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'36-41'"/>
    ...
    <xsl:variable name="top_margin" select="'3=29, 5=27, 7=41, 16=48, 20=34, 22=25'"/>
    <xsl:variable name="bottom_margin" select="'3=26, 5=20, 7=22, 9=18, 13=16, 15=19, 16=18, 20=32, 21=13, 27=38, 28=13, 29=13'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'21=7, 24=7, 28=7, 29=7'"/>
    <xsl:variable name="inner_left_margin" select="'21=7, 24=7, 28=7, 29=7'"/>
    <xsl:variable name="inner_top_margin" select="'21=40, 24=35, 28=51, 29=55'"/>
    <xsl:variable name="inner_bottom_margin" select="'21=40, 24=18, 28=24, 29=27'"/>
