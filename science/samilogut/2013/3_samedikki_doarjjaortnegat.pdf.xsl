...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="3_sametingets_midler.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'25'"/>
    ...
    <xsl:variable name="top_margin" select="'5=75, 9=50, 11=30, 17=50, 21=36'"/>
    <xsl:variable name="bottom_margin" select="'11=39, 24=73'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'10=7, 14=7'"/>
    <xsl:variable name="inner_left_margin" select="'10=7, 14=7'"/>
    <xsl:variable name="inner_top_margin" select="'10=36, 14=57'"/>
    <xsl:variable name="inner_bottom_margin" select="'10=30, 14=20'"/>
