...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://samas.brage.unit.no/samas-xmlui/bitstream/handle/11250/2626064/Ellen%20Ravna%20-%20G%C3%A1idosis%20lahkoneamen%20s%C3%A1m%C3%A1stangoaht%C3%A1i_Nuppigiela%20oahppi%20s%C3%A1rtnodeapmi%20oahpaheaddjiin%20g%C3%A1iddusoahpahusas.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Gáidosis lahkoneamen sámástangoahtái. Nuppigiela oahppi sártnodeapmi oahpaheaddjiin gáiddusoahpahusas'"/>
    <!--
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-2, 4-8, 86-93, 95-97, 100-106'"/>
