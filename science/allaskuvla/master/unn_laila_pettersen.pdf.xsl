...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://samas.brage.unit.no/samas-xmlui/bitstream/handle/11250/2627250/Unn%20Laila%20Pettersen%20-%20%C4%8C%C3%A1llima%20b%C3%A1lg%C3%A1t%20ja%20mohkit.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'“Čállima bálgát ja mohkit” Sámegiela vuosttašgiela oahpaheapmi máŋggagielat birrasisálgooahpahusagi ohppiid čállima iešvuođat'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Unn Laila'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-2, 5-10, 94-100, 102, 104, 105-109'"/>
