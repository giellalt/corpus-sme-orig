...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://samas.brage.unit.no/samas-xmlui/bitstream/handle/11250/2651661/Jouni%20S.%20Laiti%20-%20%C3%81dj%C3%A1%20%C3%A1ddj%C3%A1s%20%C3%A1rbi_Duoj%C3%A1ra%20beaggima%20huksen%20%C4%8D%C3%A1j%C3%A1husa%20bokte.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ádjá áddjás árbi. Duojára beaggima huksen čájáhusa bokte'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Jouni'"/>
    <xsl:variable name="author1_ln" select="'Laiti'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1, 5, 61-72'"/>
