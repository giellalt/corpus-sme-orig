...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://samas.brage.unit.no/samas-xmlui/bitstream/handle/11250/2650333/Marit%20Anna%20Hætta%20Klemetsen%20-%20Luodda%20šadda%20gálidettiin.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'“Luodda šaddá gálidettiin” Motivašuvdna sámegiela čállinoahpahusas joatkkaskuvllas fidnofágasuorggis. Mastergrádadutkamuš sámegiela didaktihkas.'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Marit Anna Hætta'"/>
    <xsl:variable name="author1_ln" select="'Klemetsen'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-2, 7-10, 87-98'"/>
