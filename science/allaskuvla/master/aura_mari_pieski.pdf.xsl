...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://samas.brage.unit.no/samas-xmlui/bitstream/handle/11250/2635696/Aura%20Mari%20Pieski%20-%20Gulahallat%20eatnamiin%20ja%20%C4%8D%C3%A1ziin_Muitalusat%20eami%C3%A1lbmot%20oahppan-%20ja%20gulahallanvugiin%20Deanuleagis.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Gulahallat eatnamiin ja čáziin. Muitalusat eamiálbmot oahppan- ja gulahallanvugiin Deanuleagis'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Aura Mari'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-4, 7-9, 102-107, 109-121'"/>
