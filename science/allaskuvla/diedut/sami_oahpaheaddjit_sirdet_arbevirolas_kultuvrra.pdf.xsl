...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://brage.bibsys.no/xmlui/bitstream/handle/11250/177109/Diedut-2008-4-BOKBLOKKA.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámi oahpaheaddjit sirdet árbevirolaš kultuvrra boahttevaš buolvvaide. Dekoloniserema akšuvdnadutkamuš Ruoŧa beale Sámis'"/>
    <!--
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-2, 5-6, 8, 108-125'"/>
    ...
    <xsl:variable name="bottom_margin" select="'31=22, 32=16, 74=19, 75=19, 84=17, 97=19'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'19=7, 28=7'"/>
    <xsl:variable name="inner_left_margin" select="'19=7, 28=7'"/>
    <xsl:variable name="inner_top_margin" select="'19=52, 28=27'"/>
    <xsl:variable name="inner_bottom_margin" select="'19=20, 28=63'"/>
