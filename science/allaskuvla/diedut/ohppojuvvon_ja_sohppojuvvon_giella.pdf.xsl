...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Ohppojuvvon ja sohppojuvvon giella. Gielladiđolašvuohta, čálamáhttu ja guovttegielatvuohta'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Nils Øivind'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-4, 6, 8-12, 80, 82-83, 86, 109, 127, 173, 186, 237-262'"/>
    ...
    <xsl:variable name="top_margin" select="'all=10, 66=42, 77=35, 84=47, 87=26, 128=47, 129=62, 145=45, 175=52, 182=25, 189=52, 191=16, 192=18, 198=80, 220=45'"/>
    <xsl:variable name="bottom_margin" select="'all=11, 21=50, 23=35, 65=15, 76=57, 79=29, 112=40, 136=30, 138=20, 181=47, 190=34, 191=31, 194=42, 216=45, 228=15'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'53=7, 57=46, 101=48, 105=57, 116=7, 125=7, 146=7, 149=37, 150=45, 207=46'"/>
    <xsl:variable name="inner_left_margin" select="'53=7, 57=7, 101=7, 105=7, 116=7, 125=47, 146=7, 149=7, 150=7, 207=7'"/>
    <xsl:variable name="inner_top_margin" select="'53=25, 57=46, 101=45, 105=65, 116=47, 125=80, 146=37, 149=7, 150=35, 207=25'"/>
    <xsl:variable name="inner_bottom_margin" select="'53=42, 57=10, 101=7, 105=7, 116=21, 125=7, 146=48, 149=35, 150=7, 207=37'"/>
