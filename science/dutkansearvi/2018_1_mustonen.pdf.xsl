...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Livččiigo buoret ahte don humat suomagiela? Mot davvisámegielat giellasearvvuš sáhttá doarjut ja nuppe dáfus váttásmahttit sámásteami?'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Risten'"/>
    <xsl:variable name="author1_ln" select="'Mustonen'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-31, 43-110'"/>
    ...
    <xsl:variable name="bottom_margin" select="'42=40'"/>
