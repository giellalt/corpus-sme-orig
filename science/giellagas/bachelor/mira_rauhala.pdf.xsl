...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://jultika.oulu.fi/files/nbnfioulu-201711243170.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'DAVVISÁMEGIELA GOALLOSSÁTNEGERUNDDAT'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Mira'"/>
    <xsl:variable name="author1_ln" select="'Rauhala'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="top_margin" select="'11=57'"/>
    ...
    <xsl:variable name="inner_bottom_margin" select="'6=46'"/>
