...
Premises and implications for population-based studies on health and living conditions in Norway'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="torunn_pettersen.pdf"/>
        ...
        <parallel_text xml:lang="nob" location="torunn_pettersen.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-11, 13-137'"/>
    ...
    <xsl:variable name="top_margin" select="'12=10'"/>
