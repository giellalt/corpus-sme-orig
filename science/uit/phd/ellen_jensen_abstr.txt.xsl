...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://munin.uit.no/handle/10037/15353?fbclid=IwAR0MyExoibqmnwA_iwvhkgTkfvUw9kD78dOAze_IARWaj5SQqRzh_zqWQYQ'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Diasporic Indigeneity and Storytelling Across Media: A Case Study of Narratives of Early Twentieth Century Sámi Immigrant Women'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Ellen Marie'"/>
    ...
    -->
    <xsl:variable name="author1_nat" select="'US'"/>
