...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'NUTRIENTS AND TOXIC ELEMENTS IN SEMI- DOMESTICATED REINDEER IN NORWAY. Nutritional and Food Safety Aspects'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Ammar Eltayeb Ali'"/>
    <xsl:variable name="author1_ln" select="'Hassan'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-12, 15-126'"/>
