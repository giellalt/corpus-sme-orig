...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://munin.uit.no/bitstream/handle/10037/9976/thesis.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ellos dearvan giellamat. Sámegiella nubbigiella oahpahus joatkkaskuvllas'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Inger Anne'"/>
    ...
    <xsl:variable name="author1_born" select="'1965'"/>
    <!--
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1, 4-6, 8, 44, 90-102'"/>
    ...
    <xsl:variable name="top_margin" select="'45=40'"/>
