...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'“Dáiddát leahkit sápmelaš, muhto it seamma
ládje dego sápmelaččat leat dáppe”. Narratologalaš analysa románain Kátjá (1986) ja SMS:at Sohpparis (2011).'"/>
    <!--
