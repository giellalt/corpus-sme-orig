...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://munin.uit.no/bitstream/handle/10037/19353/thesis.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nominatiiva vai akkusatiiva? Davvisámegiela studeanttaid kásusoahppan. Sámegiela masterčálus.'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Katarzyna Zofia'"/>
    <xsl:variable name="author1_ln" select="'Dominczak'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-4, 8-11, 83-94'"/>
    ...
    <xsl:variable name="top_margin" select="'47=40, 69=50, 75=80'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'17=35'"/>
    <xsl:variable name="inner_bottom_margin" select="'17=35'"/>
