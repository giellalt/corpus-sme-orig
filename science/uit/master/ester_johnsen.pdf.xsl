...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://munin.uit.no/bitstream/handle/10037/11465/thesis.pdf'"/>
    <xsl:variable name="text_encoding" select="'“Ravget iežas bođuid ovddežis”. Guovddášpersovnnaid iešvuođat, rollat ja ovdáneapmi sámi perspektiivvas ja narratologiija guorahallamiin Earrodearvvuođat ja Jievjaheargi noveallain.'"/>
    <xsl:variable name="title" select="''"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Ester Kristine'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'5-6, 91-95'"/>
