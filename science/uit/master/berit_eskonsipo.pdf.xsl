...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://munin.uit.no/bitstream/handle/10037/18505/thesis.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sátnegirjegeavaheami čalmmustahttin neahttasátnegirjji loggafiilla analysa bokte. Sámi gielladiehtaga masterdutkamuš.'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Berit Merete Nystad'"/>
    <xsl:variable name="author1_ln" select="'Eskonsipo'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'1977'"/>
    <!--
    ...
    <xsl:variable name="publisher" select="'UiT'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-2, 5-8, 47, 60, 79-84'"/>
    ...
    <xsl:variable name="top_margin" select="'31=65, 44=65, 48;61=20, 54=50'"/>
    <xsl:variable name="bottom_margin" select="'all=9, 21=15, 33=45, 43=43, 53=50, 78=75'"/>
