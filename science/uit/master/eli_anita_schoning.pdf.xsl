...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'From “Lapp” to “Margrete”. Representation of Sámi People in Photographic Postcards from Norwegian Sápmi'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Eli-Anita Øivand'"/>
    <xsl:variable name="author1_ln" select="'Schøning'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="eli_anita_schoning.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-6, 8-93'"/>
    ...
    <xsl:variable name="bottom_margin" select="'7=50'"/>
