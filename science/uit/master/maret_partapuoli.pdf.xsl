...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://munin.uit.no/bitstream/handle/10037/7642/thesis.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'“Váikkuheapmi – hástaleapmi – ovdáneapmi” Vuoi dan Kárenina ja Mu ártegis eallin váldopersovnnaid ovdáneapmi sosiála oktavuođain'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Máret Káre-Elle'"/>
    <xsl:variable name="author1_ln" select="'Partapuoli'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-2, 4-6, 68, 95-99'"/>
    ...
    <xsl:variable name="bottom_margin" select="'10=25, 11=20, all=10, 17=12, 20=15, 21=18, 22=19, 23=16, 24=13, 28=13, 30=17, 35=18, 40=20, 48=16, 55=14, 65=14, 67=16, 71=12, 72=14, 78=15, 86=20, 92=13'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'37=7'"/>
    <xsl:variable name="inner_left_margin" select="'37=7'"/>
    <xsl:variable name="inner_top_margin" select="'37=33'"/>
    <xsl:variable name="inner_bottom_margin" select="'37=36'"/>
