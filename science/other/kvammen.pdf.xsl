...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://brage.bibsys.no/xmlui/bitstream/id/237033/Kvammen.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kodeveksling i nettkommunikasjon. En studie av samisktalende nordmenns lingvistiske praksiser på internett.'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Vilde'"/>
    <xsl:variable name="author1_ln" select="'Kvammen'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-9, 11-108'"/>
    ...
    <xsl:variable name="bottom_margin" select="'10=20'"/>
