...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'north_sami_html.html'"/>
  <xsl:variable name="title" select="'O&#x111;&#x111;a testamenta'"/>
...
<xsl:variable name="note" select="'Excluded from conversion in favor of new xml-file north_sami_new_testament.bible.xml'"/>
