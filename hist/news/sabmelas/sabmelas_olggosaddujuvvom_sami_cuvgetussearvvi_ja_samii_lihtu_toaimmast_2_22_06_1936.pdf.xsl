...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Sábmelaš_olggosâddujuvvom_Sami_čuvgetusseärvvi_jâ_Samii_lihtu_toaimmast_2_22_06_1936.pdf'"/>
    ...
    <!-- Publication year -->
    <xsl:variable name="year" select="'1936'"/>
