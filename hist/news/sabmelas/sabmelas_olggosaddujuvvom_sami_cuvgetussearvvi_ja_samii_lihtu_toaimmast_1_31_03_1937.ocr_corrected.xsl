...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'sabmelas_olggosaddujuvvom_sami_cuvgetussearvvi_ja_samii_lihtu_toaimmast_1_31_03_1937.pdf'"/>
    ...
    <!-- Publication year -->
    <xsl:variable name="year" select="'1937'"/>
