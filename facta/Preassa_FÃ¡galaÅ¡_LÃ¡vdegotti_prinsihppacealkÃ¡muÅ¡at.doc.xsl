...
<xsl:variable name="filename" select="'Preassa Fágalaš Lávdegotti prinsihppacealkámušat.doc'"/>
<xsl:variable name="title" select="'Preassa Fágalaš Lávdegotti prinsihppacealkámušat'"/>
