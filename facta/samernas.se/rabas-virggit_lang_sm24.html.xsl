...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samernas.se/rabas-virggit/?lang=sm'"/>
    ...
    <parallel_text xml:lang="smj" location="rabas-virge_lang_ls24.html"/></xsl:variable>
