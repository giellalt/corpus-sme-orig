...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samernas.se/oahpahusat/gaiddusoahpahusat/?lang=sm'"/>
    ...
    <parallel_text xml:lang="smj" location="_799-2_841-2__lang_ls11.html"/>
