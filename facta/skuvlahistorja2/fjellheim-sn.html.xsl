...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/fjellheim-sn.htm'"/>
<xsl:variable name="title" select="'Vuosttaš oahpaheaddji boazodoalloskuvllas'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fjellheim-n.html" xml:lang="nob"/>
