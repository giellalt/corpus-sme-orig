...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/suongir-s.htm'"/>
<xsl:variable name="title" select="'Dárogielhálli eadni sámeskuvllas'"/>
...
<xsl:variable name="wordcount" select="'2620'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="suongir-n.html" xml:lang="nob"/>
</xsl:variable>
