...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/ingunn-s.htm'"/>
...
<xsl:variable name="wordcount" select="'4487'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ingunn-n.html" xml:lang="nno"/>
</xsl:variable>
