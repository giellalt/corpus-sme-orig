...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/sivras-s.htm'"/>
<xsl:variable name="title" select="'Mátta-Várjjaga sámi skuvlahistorjjás'"/>
...
<xsl:variable name="wordcount" select="'4022'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sivras-n.html" xml:lang="nob"/>
</xsl:variable>
