...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/loppa-s.htm'"/>
...
<xsl:variable name="translator_fn" select="'Elle Márjá'"/>
<xsl:variable name="translator_ln" select="'Vars'"/>
...
<xsl:variable name="wordcount" select="'3090'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="loppa-n.html" xml:lang="nob"/>
</xsl:variable>
