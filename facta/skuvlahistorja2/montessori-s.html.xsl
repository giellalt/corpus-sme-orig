...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/montessori-s.htm'"/>
...
<xsl:variable name="wordcount" select="'2201'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="montessori-n.html" xml:lang="nob"/>
</xsl:variable>
