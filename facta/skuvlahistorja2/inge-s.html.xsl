...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/inge-s.htm'"/>
...
<xsl:variable name="wordcount" select="'2074'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="inge-n.html" xml:lang="nob"/>
</xsl:variable>
