...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/hansner-s.htm'"/>
<xsl:variable name="title" select="'Rektor stivrra haga'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hansner-n.html" xml:lang="nob"/>
</xsl:variable>
