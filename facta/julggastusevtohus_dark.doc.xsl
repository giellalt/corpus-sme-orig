...
<xsl:variable name="filename" select="'julggastusevtohus dark.doc'"/>
<xsl:variable name="title" select="'ÁLGOÁLBMOGIID VUOIGATVUOĐAID JULGGAŠTUSEVTTOHUS: Njozes julggaštusproseassa moalkkes geainnus'"/>
<xsl:variable name="author1_fn" select="'Kati'"/>
