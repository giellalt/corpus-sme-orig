...
<xsl:variable name="filename" select="'algoalbmogii olmmosvuoigatvuodat dark.doc.xsl'"/>
<xsl:variable name="title" select="'Álgoálbmogat čáhkkehit saji Ovttastuvvan Nášuvnnain'"/>
