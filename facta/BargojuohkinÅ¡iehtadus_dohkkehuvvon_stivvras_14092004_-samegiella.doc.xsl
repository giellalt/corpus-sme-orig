...
<xsl:variable name="filename" select="'Bargojuohkinšiehtadus dohkkehuvvon stivvras 14092004 -samegiella.doc'"/>
<xsl:variable name="title" select="'BARGOJUOHKIN 2004/2005 FÁGABARGIIDE'"/>
