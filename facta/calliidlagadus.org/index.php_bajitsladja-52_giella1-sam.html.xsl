...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/web/index.php?bajitsladja=52&amp;giella1=sam'"/>
    ...
    <parallel_text xml:lang="sma" location="index.php_bajitsladja-52_giella1-sam.html"/></xsl:variable>
