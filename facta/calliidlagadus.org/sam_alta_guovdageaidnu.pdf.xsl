...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/govat/doc/sam_alta_guovdageaidnu.pdf'"/>
    ...
    <parallel_text xml:lang="nob" location="nor_altasaken.pdf"/></xsl:variable>
