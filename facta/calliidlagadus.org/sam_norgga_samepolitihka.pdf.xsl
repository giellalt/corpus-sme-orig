...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/govat/doc/sam_norgga_samepolitihka.pdf'"/>
    ...
    <parallel_text xml:lang="nob" location="nor_norsksamepolitikk.pdf"/></xsl:variable>
