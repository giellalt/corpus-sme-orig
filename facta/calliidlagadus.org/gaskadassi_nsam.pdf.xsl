...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/govat/doc/gaskadassi_nsam.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="gaskadassi_ssam.pdf"/></xsl:variable>
