...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/govat/doc/plakat_deatnu.pdf'"/>
    ...
    <parallel_text xml:lang="nob" location="plakat_tana.pdf"/></xsl:variable>
