...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/govat/doc/davvisamegillii_joatkkaskuvlla_dassi.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="joatkkaskuvlladassi_mattasamegillii.jpg.pdf"/></xsl:variable>
