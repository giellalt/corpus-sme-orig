...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/web/index.php?egavpi=1&amp;girji=85&amp;giella1=sam'"/>
    ...
    <parallel_text xml:lang="sma" location="index.php_egavpi-1_girji-85_giella1-sam.html"/></xsl:variable>
