...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'RIT10aGASTRO_2.doc'"/>
  <xsl:variable name="title" select="'Don leat ____________ dii. ______________ fidnen iskkadandiimmu, mas dus iskkaduvvo ?ottaoari suvrodaga.'"/>
  <xsl:variable name="author1_fn" select="'Rolf'"/>
