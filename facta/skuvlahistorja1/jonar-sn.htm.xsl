...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/jonar-sn.htm'"/>
...
<xsl:variable name="wordcount" select="'2214'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jonar_n.html" xml:lang="nno"/>
