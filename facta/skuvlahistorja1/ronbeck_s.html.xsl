...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'ronbeck_s.htm'"/>
  <xsl:variable name="title" select="'Hans Rønbeck jearahallama bájuheapmi'"/>
  ...
  <xsl:variable name="place" select="'http://girji.info/skolehist/ronbeck-s.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ronbeck_n.html" xml:lang="nob"/>
</xsl:variable>
