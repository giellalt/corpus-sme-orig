...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/ebbasofie-sn.htm'"/>
<xsl:variable name="title" select="'Internáhtta buoret go giliskuvla'"/>
...
<xsl:variable name="wordcount" select="'1206'"/>
...
<xsl:variable name="para_nno" select="'ebbasofie_n.html'"/>
