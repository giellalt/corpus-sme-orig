...
<xsl:stylesheet version="1.0" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:variable name="filename" select="'uskav2_s.htm'"/>
  <xsl:variable name="title" select="'Golbma eallima masson oahpuin'"/>
  ...
  <xsl:variable name="place" select="'http://girji.info/skolehist/uskav2-s.htm'"/>
  ...
  <xsl:variable name="wordcount" select="'1541'"/>
...
<xsl:variable name="para_nob" select="'uskav2_n.html'"/>
