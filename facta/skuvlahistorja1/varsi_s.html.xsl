...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'varsi_s.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'- Jurddaš ahte min oahpaheaddjit duođaid ledje dáruiduhttima vuostá!'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://girji.info/skolehist/varsi-s.htm'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="varsi_n.html"/>
