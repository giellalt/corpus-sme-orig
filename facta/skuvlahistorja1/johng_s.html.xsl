...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'johng_s.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Muosáin olbmuid máddu lea Louis Philippe'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://girji.info/skolehist/johng-s.htm'"/>
    ...
    <xsl:variable name="wordcount" select="'1201'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="johng_n.html"/>
