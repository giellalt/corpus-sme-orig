...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'lind_s.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Girku rolla sámi oahpahusas'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://girji.info/skolehist/lind-s.htm'"/>
    ...
    <xsl:variable name="wordcount" select="'4608'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="lind_n.html"/>
