...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'boon_s.htm'"/>
  <xsl:variable name="title" select="'Guovttegielalaš oahpahus - máná dihtii'"/>
  ...
  <xsl:variable name="place" select="'http://girji.info/skolehist/boon-s.htm'"/>
  ...
  <xsl:variable name="wordcount" select="'1918'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="boon_n.html" xml:lang="nob"/>
</xsl:variable>
