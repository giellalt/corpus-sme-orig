...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'gullich_s.htm'"/>
  <xsl:variable name="title" select="'Guhkkin davvin Dávggáid vuolde - Muittut Sirpmás 1953-62'"/>
  ...
  <xsl:variable name="place" select="'http://girji.info/skolehist/gullich-s.htm'"/>
  ...
  <xsl:variable name="wordcount" select="'2523'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gullich_n.html" xml:lang="nob"/>
</xsl:variable>
