...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'skotte_s.htm'"/>
  <xsl:variable name="title" select="'Vásáhusat dáža oahpaheaddjin Sámis - Buolbmát skuvllas 1950-logus'"/>
  ...
  <xsl:variable name="place" select="'http://girji.info/skolehist/skotte-s.htm'"/>
  ...
  <xsl:variable name="wordcount" select="'2212'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="skotte-e.htm" xml:lang="ger"/>
</xsl:variable>
