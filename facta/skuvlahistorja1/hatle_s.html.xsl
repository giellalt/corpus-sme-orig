...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'hatle_s.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Boaittobealde Sámis, boaittobealde Norggas'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://girji.info/skolehist/hatle-s.htm'"/>
    ...
    <xsl:variable name="wordcount" select="'2920'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="hatle_n.html"/>
