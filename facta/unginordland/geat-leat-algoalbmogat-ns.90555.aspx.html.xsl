...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra-2/davvisamegiella/vuoigatvodat/geat-leat-algoalbmogat-ns.90555.aspx'"/>
    ...
    <parallel_text xml:lang="nob" location="hvem-er-urfolk.90068.aspx.html"/></xsl:variable>
