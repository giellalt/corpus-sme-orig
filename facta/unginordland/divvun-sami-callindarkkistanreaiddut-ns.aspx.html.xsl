...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra-2/norsk/divvun-sami-callindarkkistanreaiddut-ns.aspx'"/>
    ...
    <parallel_text xml:lang="sma" location="davvome-saemien-riektestjaelemedirrege.aspx.html"/></xsl:variable>
