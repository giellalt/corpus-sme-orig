...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra-2/davvisamegiella/dearvvsvuohta/diehtojuohkin-manaide-ja-nuoraide-hpv-boahkuheami-birra.90537.aspx'"/>
    ...
    <parallel_text xml:lang="sma" location="maanaj-jih-noeri-bievnemegoevtese.90665.aspx.html"/></xsl:variable>
