...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra-2/davvisamegiella/kultuvra-asttuaigi/sami-albmotlavlla-ns.90547.aspx'"/>
    ...
    <parallel_text xml:lang="nob" location="samefolkets-sang.90696.aspx.html"/></xsl:variable>
