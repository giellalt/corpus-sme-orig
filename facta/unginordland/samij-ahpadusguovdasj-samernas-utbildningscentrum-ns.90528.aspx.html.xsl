...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra-2/davvisamegiella/oahppu/samij-ahpadusguovdasj-samernas-utbildningscentrum-ns.90528.aspx'"/>
