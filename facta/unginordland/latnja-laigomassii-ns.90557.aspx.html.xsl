...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra-2/davvisamegiella/vuoigatvodat/latnja-laigomassii-ns.90557.aspx'"/>
    ...
    <parallel_text xml:lang="smj" location="lajkkut-lanjav-ls.90589.aspx.html"/>
