...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra-2/davvisamegiella/bargu/bargojearahallan-ns.90525.aspx'"/>
    ...
    <parallel_text xml:lang="smj" location="barggo-gatjadallam.90575.aspx.html"/></xsl:variable>
