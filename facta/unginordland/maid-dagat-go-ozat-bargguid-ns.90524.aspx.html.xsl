...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra-2/davvisamegiella/bargu/maid-dagat-go-ozat-bargguid-ns.90524.aspx'"/>
    ...
    <parallel_text xml:lang="smj" location="atsalvis.90581.aspx.html"/></xsl:variable>
