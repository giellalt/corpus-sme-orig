...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra-2/davvisamegiella/stipeanda/frifond-ns.90553.aspx'"/>
    ...
    <parallel_text xml:lang="sma" location="frifoente-maanah-jih-noerh.90656.aspx.html"/></xsl:variable>
