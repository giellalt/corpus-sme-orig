...
<xsl:variable name="filename" select="'australia koloniseren dark.doc'"/>
<xsl:variable name="title" select="'AUSTRALIIJA KOLONISEREN: Eŋglándda bahádahkkit šadde riikkahálddašeaddjin'"/>
