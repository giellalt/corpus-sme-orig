...
<xsl:variable name="filename" select="'Panelaságastallan.doc'"/>
<xsl:variable name="title" select="'Panelaságastallan: Sámegielaid boahtte áigi. Makkár doaibmabijut dárbbašuvvojit?'"/>
