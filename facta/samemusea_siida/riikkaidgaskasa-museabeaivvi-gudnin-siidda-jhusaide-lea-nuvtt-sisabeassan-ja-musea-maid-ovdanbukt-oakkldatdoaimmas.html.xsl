...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisdoallu/diedahusat/riikkaidgaskasa-museabeaivvi-gudnin-siidda-jhusaide-lea-nuvtt-sisabeassan-ja-musea-maid-ovdanbukt-oakkldatdoaimmas'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kansainvlisen-museopivn-kunniaksi-vapaa-psy-siidan-nyttelyihin-sek-kokoelmatoiminnan-esittely.html"/>
