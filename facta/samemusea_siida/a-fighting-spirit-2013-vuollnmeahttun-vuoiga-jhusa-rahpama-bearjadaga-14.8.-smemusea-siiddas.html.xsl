...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisdoallu/diedahusat/a-fighting-spirit-2013-vuollnmeahttun-vuoiga-jhusa-rahpama-bearjadaga-14.8.-smemusea-siiddas'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="suohpanterror-ulkonyttely-saamelaismuseo-siidaan-1.html"/>
