...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisdoallu/diedahusat/kultureahket-siiddas-2013-lea-shka-outi-korpilhde-nkkosgirjjis-rivgoeamidiid-birra'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kulttuuri-ilta-siidassa-2013-esittelyss-outi-korpilhteen-vitskirja-riukuvaimoista.html"/>
