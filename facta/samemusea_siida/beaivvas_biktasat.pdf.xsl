...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <language xml:lang="eng"/><language xml:lang="fin"/></xsl:variable>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-2, 5, 6, 9, 13, 15, 16, 19, 20, 26, 29, 33-35, 37-43, 45-47, 49-53, 55-60'"/>
    ...
    <!--
        ...
        1;3;8=20, 4;5;7=10
    -->
    <xsl:variable name="right_margin" select="'all=70, 3;4;32;36;44;48;54=7'"/>
    <xsl:variable name="left_margin" select="''"/>
    <xsl:variable name="top_margin" select="'3;36=60, 32;26;40;44;48;54=50'"/>
