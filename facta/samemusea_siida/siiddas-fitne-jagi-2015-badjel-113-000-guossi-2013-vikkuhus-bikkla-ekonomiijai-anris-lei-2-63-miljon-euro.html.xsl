...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisdoallu/diedahusat/siiddas-fitne-jagi-2015-badjel-113-000-guossi-2013-vikkuhus-bikkla-ekonomiijai-anris-lei-2-63-miljon-euro'"/>
