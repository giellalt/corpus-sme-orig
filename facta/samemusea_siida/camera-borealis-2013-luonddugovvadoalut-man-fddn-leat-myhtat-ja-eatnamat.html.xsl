...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisdoallu/diedahusat/camera-borealis-2013-luonddugovvadoalut-man-fddn-leat-myhtat-ja-eatnamat'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="camera-borealis-2013-luontokuvatapahtumassa-myyttej-ja-maisemia.html"/>
