...
<xsl:variable name="filename" select="'OHCEJOGA_GIELDDA_OAHPAHUSDOAIMMA.doc'"/>
<xsl:variable name="title" select="'OHCEJOGA GIELDDA  OAHPAHUS-DOAIMMA OVDDIĐANPLÁNA 2004-08'"/>
...
<xsl:variable name="place" select="'http://www.plappi.fi/files/orig/4005_OHCEJOGA%20%20GIELDDA%20%20OAHPAHUSDOAIMMA.doc'"/>
