...
<xsl:variable name="filename" select="'algoalbmogat albmogiid lihttu ja ON dark.doc'"/>
<xsl:variable name="title" select="'Álgoálbmogiid bargu Álbmogiid Lihtus ja ON:s'"/>
