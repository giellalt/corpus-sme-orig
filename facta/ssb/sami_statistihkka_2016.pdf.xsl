...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sámi statistihkka 2016'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Tove Irene'"/>
    <xsl:variable name="author1_ln" select="'Slaastad'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="samisk_statistikk_2016.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-78, 81, 94-154'"/>
    ...
    <xsl:variable name="top_margin" select="'85=16, 88=70, all=6'"/>
    <xsl:variable name="bottom_margin" select="'84=57, 86=52, 89=87, 90=80'"/>
