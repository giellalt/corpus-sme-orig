...
<xsl:variable name="filename" select="'sapmelaccat organiserejit dark.doc'"/>
<xsl:variable name="title" select="'SÁPMELAČČAT ORGANISEREJIT: Sámi áššit muhtašuvve álgoálbmotáššin'"/>
