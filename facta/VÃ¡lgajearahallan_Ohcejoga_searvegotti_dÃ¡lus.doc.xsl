...
<xsl:variable name="filename" select="'Válgajearahallan Ohcejoga searvegotti dálus.doc'"/>
<xsl:variable name="title" select="'Válgajearahallan Ohcejoga searvegotti dálus Čakčamánu 16. beaivvi 2007'"/>
<xsl:variable name="author1_fn" select="'Torkel'"/>
<xsl:variable name="author1_ln" select="'Rasmussen'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_born" select="'19650825'"/>
