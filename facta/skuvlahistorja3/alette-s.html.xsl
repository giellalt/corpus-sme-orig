...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/alette-s.htm'"/>
<xsl:variable name="title" select="'– Fertejin leat garas'"/>
...
<xsl:variable name="wordcount" select="'979'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="alette-n.html" xml:lang="nno"/>
</xsl:variable>
