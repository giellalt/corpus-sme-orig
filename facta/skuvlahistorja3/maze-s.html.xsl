...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/maze-s.htm'"/>
...
<xsl:variable name="wordcount" select="'1889'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="maze-n.html" xml:lang="nno"/>
</xsl:variable>
