...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/issat-s.htm'"/>
...
<xsl:variable name="wordcount" select="'3781'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="issat-n.html" xml:lang="nob"/>
</xsl:variable>
