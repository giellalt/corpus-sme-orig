...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/alfred-s.htm'"/>
<xsl:variable name="title" select="'Viđain jagiin maŋŋonan skuvlaálgin'"/>
...
<xsl:variable name="wordcount" select="'1994'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="alfred-n.html" xml:lang="nno"/>
</xsl:variable>
