...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/arild-s.htm'"/>
<xsl:variable name="title" select="'Fálesnuori oahpaheaddji muitala'"/>
...
<xsl:variable name="wordcount" select="'1003'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arild-n.html" xml:lang="nob"/>
</xsl:variable>
