...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/ellentg-s.htm'"/>
<xsl:variable name="title" select="'40 jagi Máze skuvllas'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ellentg-n.html" xml:lang="nob"/>
</xsl:variable>
