...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/richard-s.htm'"/>
...
<xsl:variable name="translator_fn" select="'Issát Sammol'"/>
...
<xsl:variable name="wordcount" select="'2811'"/>
