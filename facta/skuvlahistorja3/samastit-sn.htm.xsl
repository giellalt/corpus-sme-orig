...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/samastit-sn.htm'"/>
...
<xsl:variable name="translator_fn" select="'Ellen J. Eira'"/>
...
<xsl:variable name="wordcount" select="'2378'"/>
