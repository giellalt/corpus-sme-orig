...
<xsl:variable name="filename" select="'koloniseren samis dark.doc'"/>
<xsl:variable name="title" select="'KOLONISEREN SÁMIS: Dallego stáhtat stivregohte sápmelaččaid eallima'"/>
