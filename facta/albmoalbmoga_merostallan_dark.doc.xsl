...
<xsl:variable name="filename" select="'albmoalbmoga merostalla dark.doc'"/>
<xsl:variable name="title" select="'ÁLGOÁLBMOGA MEROŠTALLAN Álbmot, álgoálbmot vai vehádat?
'"/>
