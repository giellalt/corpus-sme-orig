...
<xsl:variable name="filename" select="'Prinsihppacealkámušat.doc'"/>
<xsl:variable name="title" select="'Prinsihppacealkámušat'"/>
...
<xsl:variable name="translated_from" select="'no'"/>
