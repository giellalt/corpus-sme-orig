...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.lundui.fi/se/odasvuorka/-/asset_publisher/sJx7NkJgclPx/content/urho-kekkonen-albmotmeahci-boares-rahkadusat-ozzo-joatkkaaiggi'"/>
