...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
            ...
            <xsl:import href="file:///usr/lib/python2.7/site-packages/CorpusTools-0.9.0b4-py2.7.egg/corpustools/xslt/common.xsl"/>
    ...
    <xsl:variable name="filename" select="'http://www.lundui.fi/se/duottarsamiluondduguovddas/balvalusat/duottarsamiluondduguovddas/balvalusat/oahpaheddjiide'"/>
