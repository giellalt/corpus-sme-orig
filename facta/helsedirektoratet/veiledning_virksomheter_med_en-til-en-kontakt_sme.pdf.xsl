...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.helsedirektoratet.no/english/corona/Samisk%20-%20Veiledning%20virksomheter%20med%20e%CC%81n-til-e%CC%81n-kontakt%20som%20fris%C3%B8rer%20kroppspleie%20mv.pdf/_/attachment/inline/9e78fcbe-212f-4089-874f-2ba6fca81309:2c2aabf882abcd4b0949c4c5178be6d1fb63e11b/Samisk%20-%20Veiledning%20virksomheter%20med%20e%CC%81n-til-e%CC%81n-kontakt%20som%20fris%C3%B8rer%20kroppspleie%20mv.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Covid-19 epidemiija: Bagadus mo njoammunsuodjalusfágalaččat lea dohkálaš bargat gávpedoaimmain gos lea oktavuohta guovtti olbmo gaskkas, nu mo vuoktačuohppit, rumašdikšu jna.'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="''"/>
    <xsl:variable name="author1_ln" select="'Helsedirektoratet'"/>
    <!-- m, f or unknown -->
