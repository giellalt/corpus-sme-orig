...
<xsl:variable name="filename" select="'iesmearrideapmi dark.doc'"/>
<xsl:variable name="title" select="'IEŠMEARRIDEAPMI: Ođđa stáhtaid vuolggasadji ja álgoálbmogiid doaivva'"/>
