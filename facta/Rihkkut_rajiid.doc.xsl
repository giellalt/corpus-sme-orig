...
<xsl:variable name="filename" select="'Rihkkut rajiid.doc'"/>
<xsl:variable name="title" select="'Mii báhcá dutnje millii go leat lohkan Lars Wilhelm Svonni girjji ”Rihkkut rájiid”?'"/>
