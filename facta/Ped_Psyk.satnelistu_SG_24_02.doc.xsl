...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Ped_Psyk.satnelistu_SG_24_02.doc'"/>
  <xsl:variable name="title" select="'Pedagogalaš- ja psykologalaš sátnelista'"/>
  <xsl:variable name="author1_fn" select="''"/>
  <xsl:variable name="author1_ln" select="'Inga Margrethe Eira'"/>
  ...
  <xsl:variable name="sub_name" select="'Maaren Palismaa'"/>
  <xsl:variable name="sub_email" select="'maren.palismaa@samediggi.no'"/>
