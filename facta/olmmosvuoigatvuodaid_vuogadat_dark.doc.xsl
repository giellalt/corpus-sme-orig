...
<xsl:variable name="filename" select="'olmmosvuoigatvuodaid vuogadat dark.doc'"/>
<xsl:variable name="title" select="'OLMMOŠVUOIGATVUOĐAID VUOGÁDAT Geat suodjalit olmmošvuoigatvuođaid?'"/>
