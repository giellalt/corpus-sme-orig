...
<xsl:variable name="filename" select="'suddadanfiggamusat dark.doc'"/>
<xsl:variable name="title" select="'Mas vulggii suddadanpolitihkka ja masa doalvvui sápmelaččaid'"/>
