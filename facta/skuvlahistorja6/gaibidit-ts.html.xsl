...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/gaibidit-ts.htm'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Berit Randi'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'John Trygve'"/>
    <xsl:variable name="author2_ln" select="'Solbakk'"/>
    <xsl:variable name="author2_gender" select="'m'"/>
    <xsl:variable name="author2_nat" select="'NO'"/>
    <xsl:variable name="author2_born" select="'1945'"/>
