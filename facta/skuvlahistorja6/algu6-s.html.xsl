...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/algu6-s.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sámi skuvlahistorjá-prošeakta ollašuvvan?'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="algu6-n.html" xml:lang="nob"/>
</xsl:variable>
