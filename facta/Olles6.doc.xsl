...
<xsl:variable name="filename" select="'Olles6.doc'"/>
<xsl:variable name="title" select="'Jávohuvvá ja ealáska Davvisámegielagiid demografiija ja buolvvaidgaskasaš sirdáseapmi Norggas ja Suomas'"/>
