...
<xsl:variable name="filename" select="'Media váilevaš mediaberoštupmi.doc'"/>
<xsl:variable name="title" select="'Miellagiddevaš válgadigaštallan -Váilevaš mediaberoštupmi'"/>
