...
<xsl:variable name="current_version" select="'$Revision: 1.24 $'"/>
...
<xsl:with-param name="target" select="'e$/e$-/n$/a$/o$/r$/ios/±/n`/¤/u3u/¢/aoou/e1-/ñ/aÀ/ð/a4-/s=/{/kwa/ddeT/oaT/aǦ/oǦ/uǦ/c`/'"/>
<xsl:with-param name="replacement" select="'ē/ē/n̄/ā/ō/r̄/i̮s/ŋ/ń/đ/ušu/č/ažžu/e̮/ŋ/å/´/a̭/š/̜/kʷa/ddeδ/oaδ/ä/ö/ü/ć/'"/>
