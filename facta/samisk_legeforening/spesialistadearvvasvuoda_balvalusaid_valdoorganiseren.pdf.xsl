...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samisklegeforening.no/images/KALSTAD_SA_2016-Spesialistadearvvasvuoa.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Spesialistadearvvašvuođa bálvalusaid	váldoorganiseren sámi	álbmogii	Norggas'"/>
    <!--
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'2, 14, 18, 30, 42, 44, 49-50'"/>
    ...
    <xsl:variable name="top_margin" select="'15=30, 43=27, 45=50, 46=22, 47=33'"/>
    <xsl:variable name="bottom_margin" select="'29=39, 38=56, 40=87, 41=21, 43=19'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'16=28'"/>
    <xsl:variable name="inner_bottom_margin" select="'16=16'"/>
