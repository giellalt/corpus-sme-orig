...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Nordområdestrategi_SAM_Tor_Rolf.doc'"/>
  <xsl:variable name="title" select="'Ráđđehusa ollislaš davviguovlostrategiija'"/>
  ...
  <xsl:variable name="translator_fn" select="'Rolf'"/>
  <xsl:variable name="translator_ln" select="'Olsen'"/>
  <xsl:variable name="translator_gender" select="'unknown'"/>
  <xsl:variable name="translator_born" select="''"/>
  <xsl:variable name="translator_nat" select="''"/>
  <!-- select license type: free, standard or other -->
  <xsl:variable name="license_type" select="''"/>
  <xsl:variable name="sub_name" select="'Audun Lona'"/>
  <xsl:variable name="sub_email" select="'alona@broadpark.no'"/>
