...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'82_7374_157_5.pdf'"/>
  <xsl:variable name="title" select="'Samisk skole eller Norsk Standard?'"/>
  ...
  <xsl:variable name="place" select="'http://www.davvi.no/db/pcbdavvi/pdf/82-7374-515-5.pdf'"/>
