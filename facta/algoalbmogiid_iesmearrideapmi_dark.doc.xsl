...
<xsl:variable name="filename" select="'algoalbmogiid iesmearrideapmi dark.doc'"/>
<xsl:variable name="title" select="'ÁLGOÁLBMOGIID IEŠMEARRIDEAPMI: Mo galggašii dan áddet?'"/>
