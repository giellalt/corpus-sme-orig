...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ajtte.com/wp-content/uploads/2009/05/Akta_arran.pdf'"/>
    ...
    <parallel_text xml:lang="swe" location="en_eldstad.pdf"/></xsl:variable>
