...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.noklus.no/Portals/2/Diabetesregisteret/Samtykke/Informasjonsskriv%20og%20samtykkeerklaering%20januar%202019_versjon%204_1_NORDSAMISK.pdf?ver=2019-03-15-131905-083'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Jearaldat čálihit iežas Norsk diabetesregister for voksne registtarii'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="''"/>
    <xsl:variable name="author1_ln" select="'HELSE BERGEN Haukeland Universitetssykehus'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="bottom_margin" select="'3=48, 2=18, 1=11'"/>
