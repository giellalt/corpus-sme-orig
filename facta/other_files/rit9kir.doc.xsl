...
<!-- Format query results for display --><xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'RIT9KIR.doc'"/>
  <xsl:variable name="title" select="'Dutnje, guhte leat suotnajariid geažil čuohpaduvvon.'"/>
  ...
  <xsl:variable name="publisher" select="'UNN'"/>
