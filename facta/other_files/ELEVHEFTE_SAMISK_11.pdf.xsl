...
<!-- Format query results for display --><xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'ELEVHEFTE_SAMISK_11.pdf'"/>
  <xsl:variable name="title" select="'Astta lohkat'"/>
  <xsl:variable name="author1_fn" select="'Arne'"/>
  <xsl:variable name="author1_ln" select="'Svingen'"/>
  ...
  <xsl:variable name="publisher" select="'http://www.skolenettet.no/'"/>
  <xsl:variable name="publChannel" select="''"/>
  <xsl:variable name="year" select="''"/>
  <xsl:variable name="ISBN" select="''"/>
  <xsl:variable name="ISSN" select="''"/>
  <xsl:variable name="place" select="'http://skolenettet.no/upload/Moduler/gi rom for lesing/ELEVHEFTE_SAMISK_11.pdf'"/>
  ...
  <xsl:variable name="wordcount" select="'604'"/>
