...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sápmelaš loatnasánit suopmelaš gielaid davvejoavkkus'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Ante'"/>
    <xsl:variable name="author1_ln" select="'Aikio'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="publisher" select="'Oulu universitehta'"/>
    ...
    <xsl:variable name="wordcount" select="'30314'"/>
    ...
    <language xml:lang="sme"/><language xml:lang="fin"/><language xml:lang="eng"/></xsl:variable>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               <xsl:with-param name="inputString" select="$text"/>
<xsl:with-param name="target" select="'e$/e$-/n$/a$/o$/r$/u$/s$/$/ios/n`/u3u/aoou/e1-/ñ/aÀ/ð/a4-/s=/t{/kwa/eT/oaT/aǦ/oǦ/uǦ/c`/ραδιξ/c=ua\lguj/kua\vska\/'"/>
<xsl:with-param name="replacement" select="'ē/ē/n̄/ā/ō/r̄/ū/s̄/̄/i̮s/ń/ušu/ažžu/e̮/ŋ/å/´/a̭/š/ț/kʷa/eδ/oaδ/ä/ö/ü/ć/čualguj/kuavska'"/>
                <xsl:with-param name="continue" select="0"/>
            </xsl:call-template>
</xsl:element>
</xsl:template>
