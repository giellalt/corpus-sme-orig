...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Mánná buohcá'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Helena'"/>
    <xsl:variable name="author1_ln" select="'Varonen'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Minna'"/>
    <xsl:variable name="author2_ln" select="'Kaila'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Mirja'"/>
    <xsl:variable name="author3_ln" select="'Hämäläinen'"/>
    ...
    <xsl:variable name="ISBN" select="'978-951-42-8369-7'"/>
    ...
    -->
    <xsl:variable name="translated_from" select="'fi'"/>
    <!-- Translator variables have the same format as the author ones -->
    <xsl:variable name="translator_fn" select="'Ellen'"/>
    <xsl:variable name="translator_ln" select="'Näkkäläjärvi'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'4, 6-10, 15-16, 155-166'"/>
    ...
    <xsl:variable name="bottom_margin" select="'all=12, 5=40'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'1=50'"/>
    <xsl:variable name="inner_left_margin" select="'1=10'"/>
    <xsl:variable name="inner_top_margin" select="'1=60'"/>
    <xsl:variable name="inner_bottom_margin" select="'1=5'"/>
    ...
    <!--
        ...
        1;3;8=20, 4;5;7=10
    -->
    <xsl:variable name="linespacing" select="'1;5=3'"/>
...
<xsl:template match="p[parent::body][not(./em | ./span)][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                <xsl:with-param name="inputString" select="$text"/>
                <xsl:with-param name="target" select="'vd-d/i-g/h-t/-hall/l-d/o-/i-d/a-m/e-k/e-m/p-p/á-m/u-v/s-d/v-v/h-p/r-k/t-t/k-k/h-k/á-r/ht-t/m-m/l-l/n-g/id-g/lk-k/t-g/l-g/e-/k-t/p-m/i-d/s-s/c-c/-vuo/-bu/ea-/-dettiin/n-n/-lepm/-hah/-tuv/-da/ea-/t-t/g-g/r-r/-sii/d-d/-tuh/-gie/t-t/k-t/-h/k-k/b-m/s-tt/-rii/-pii/vd-n/v-r/d-j/b-b/-lit/t-k/s-k/b-b/i-de/b-b/an-/l-k/u-vv/-hit/j-j/-sii/-dea/-ma/-sit/-mii/-sat/-hah/'"/>
                <xsl:with-param name="replacement" select="'vdd/ig/ht/hall/ld/o/id/am/ek/em/pp/ám/uv/sd/vv/hp/rk/tt/kk/hk/ár/htt/mm/ll/ng/idg/lkk/tg/lg/e/kt/pm/id/ss/cc/vuo/bu/ea/dettiin/nn/lepm/hah/tuv/da/ea/tt/gg/rr/sii/dd/tuh/gie/tt/kt/h/kk/bm/stt/rii/pii/vdn/vr/dj/bb/lit/tk/sk/bb/ide/bb/an/lk/uvv/hit/jj/sii/dea/ma/sit/mii/sat/hah/'"/>
                <xsl:with-param name="continue" select="0"/>
            </xsl:call-template>
        </xsl:element>
    </xsl:template>
