...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://s3.eu-west-1.amazonaws.com/ah-web-prod/documents/F%C3%A1kt%C3%A1-%C3%A1rka_Vuoigatvuo%C4%91at_ja_b%C3%A1lvalusat.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Fáktá-árka. Vuoigatvuođat ja bálvalusat'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="fakta_ark_rettigheter_og_tjenester.pdf"/>
