...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://aoh-prod.s3.amazonaws.com/documents/F%C3%A1dd%C3%A1%C3%A1rka_V%C3%A1ldeguoddedil%C3%A1la%C5%A1vuohta_Lob%C3%A1la%C5%A1vuo%C4%91af%C3%A1pmudus_Boahtte%C3%A1iggef%C3%A1pmudus_n_ngbdUhC.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Váldeguoddedilálašvuohta – Lobálašvuođafápmudus – Boahtteáiggefápmudus'"/>
    <!--
