...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://brage.bibsys.no/xmlui/bitstream/handle/11250/116033/HI-Nytt_4-2010_sam.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lea go vejolaš stáráid fas šaddadit? Havforksningsnytt'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Beate'"/>
    <xsl:variable name="author1_ln" select="'Hoddevik'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author4_fn" select="'Henning'"/>
    <xsl:variable name="author4_ln" select="'Steen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="/hi-nytt_4-2010.pdf"/>
