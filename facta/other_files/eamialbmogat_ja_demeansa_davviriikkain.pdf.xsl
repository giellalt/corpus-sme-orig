...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://norden.diva-portal.org/smash/get/diva2:1390956/FULLTEXT01.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Eamiálbmogat ja demeansa Davviriikkain'"/>
    <!--
    ...
    <xsl:variable name="bottom_margin" select="'8=16, 9=27, 11=20, 12=14, 14=17, 15=33, 20=16'"/>
