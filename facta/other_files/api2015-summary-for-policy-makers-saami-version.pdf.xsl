...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'API2015-Summary-for-Policy-Makers-Saami-version.pdf'"/>
    ...
    <xsl:variable name="translator_fn" select="'John E.'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="api2015-summary-for-policy-makers.pdf"/>
