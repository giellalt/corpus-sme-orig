...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="428_1.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-3, 5-13, 15-20, 27-31, 33, 35-39, 43, 48-52'"/>
    ...
    <!--
        ...
        1;3;8=20, 4;5;7=10
    -->
    <xsl:variable name="right_margin" select="'all=7, 14=70,  21=50, 22=50, 23=50, 24=50, 25=50, 26=50, 40=50, 41=50, 42=50, 44=50, 45=50, 46=50, 47=50'"/>
    <xsl:variable name="left_margin" select="'all=7'"/>
    <xsl:variable name="top_margin" select="'all=7'"/>
    <xsl:variable name="bottom_margin" select="'all=7, 23=25, 25=20, 26=55, 34=35, 44=40'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'46=7'"/>
    <xsl:variable name="inner_left_margin" select="'46=7'"/>
    <xsl:variable name="inner_top_margin" select="'46=40'"/>
    <xsl:variable name="inner_bottom_margin" select="'46=20'"/>
...
<xsl:template match="p[parent::body][not(./em | ./span)][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                <xsl:with-param name="inputString" select="$text"/>
                <xsl:with-param name="target" select="'Salgsutstilling i i tilknytning til den årlige urfolkskonferansen i Alaska/Her kunne samiske duojare hentet nye ideer/Det negative forsterkes/Halkavarre – langt løp til folkeretten/Om å gjøre duodji synlig/'"/>
