...
<xsl:variable name="title" select="'Mánát ja nuorat geain lea heajut doaibmannákca
– makkár vuoigatvuodat leat bearrašis?'"/>
...
<xsl:variable name="para_nob" select="'barn-og-unge-med-nedsatt-funksjonsevne-hvilke-rettigheter-har-familien.pdf'"/>
