...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://lauda.ulapland.fi/bitstream/handle/10024/62774/Giehtagirji%20Doaibmabidjoevttohusat%20njuov%20ilis%20skuvlasirda%20uvvamiidda%20Sámis.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Giehtagirji. Doaibmabidjoevttohusat njuovžilis skuvlasirdasuvvamiidda Sámis.'"/>
    <!--
    ...
    <xsl:variable name="author2_ln" select="'Körkkö'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Merja'"/>
    <xsl:variable name="author3_ln" select="'Paksuniemi'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'21-24'"/>
    ...
    <!--
        ...
        1;3;8=20, 4;5;7=10
    -->
    <xsl:variable name="linespacing" select="'20=3'"/>
