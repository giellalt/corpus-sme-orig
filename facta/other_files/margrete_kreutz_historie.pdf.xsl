...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://site.uit.no/smartstien/files/2012/02/hefte_n_samisk_mobile.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Margrete Kreutz historjá'"/>
    <!--
    ...
    <xsl:variable name="translator_fn" select="'Arnstein'"/>
    <xsl:variable name="translator_ln" select="'Johnskareng'"/>
