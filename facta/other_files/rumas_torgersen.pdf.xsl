...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/egirjjit/Rumas/files/assets/common/downloads/RUMA.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Rumaš'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Trond-Viggo'"/>
    <xsl:variable name="author1_ln" select="'Torgersen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="translator_fn" select="'Heidi'"/>
    <xsl:variable name="translator_ln" select="'Einarsen'"/>
    ...
    <!--
        ...
        1;3;8=20, 4;5;7=10
    -->
    <xsl:variable name="right_margin" select="'all=5'"/>
