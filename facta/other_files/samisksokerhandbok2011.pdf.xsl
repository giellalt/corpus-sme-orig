...
<xsl:variable name="filename" select="'http://www.samordnaopptak.no/info/sami/SamiskSokerhandbok2011.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ohccigiehtagirji'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sokerhandbok-2011.pdf" xml:lang="nno"/>
</xsl:variable>
