...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.utviklingssenter.no/getfile.php/2174896.1875.ctfxdeqctw/H%C3%A5ndbok+2013+WEB.pdf'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Kristine Gaup'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Lars Petter'"/>
    <xsl:variable name="author2_ln" select="'Grønmo'"/>
    ...
    <xsl:variable name="translator_ln" select="'Karasjok kommune'"/>
    ...
    <language xml:lang="nob"/><language xml:lang="sma"/><language xml:lang="fkv"/><language xml:lang="smj"/><language xml:lang="eng"/><language xml:lang="rus"/></xsl:variable>
