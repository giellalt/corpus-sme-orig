...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://s3.eu-west-1.amazonaws.com/ah-web-prod/documents/F%C3%A1kt%C3%A1-%C3%A1rka_V%C3%A1ldeguoddedil%C3%A1la%C5%A1vuohta_-_Lob%C3%A1la%C5%A1vuo%C4%91af%C3%A1pmudus_-_Boahtte%C3%A1iggef%C3%A1pmudus.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Fáktá-árka'"/>
    <!--
