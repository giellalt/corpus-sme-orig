...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'veiledning_i_vurdering__12.03.2002.doc'"/>
  <xsl:variable name="title" select="'Go lea sÃ¡hka ÄÃ¡lalaÅ¡ sÃ¡megielas, eandalit teaksta ÄÃ¡llimis, de oahppi teaksta galgÃ¡ lohkkot olles teakstan'"/>
