...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/reiersen-s.htm'"/>
<xsl:variable name="title" select="'- Jávki čeardda ballu'"/>
<xsl:variable name="author1_fn" select="'Johannes'"/>
<xsl:variable name="author1_ln" select="'Reiersen'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_born" select="'1873'"/>
...
<xsl:variable name="wordcount" select="'1404'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reiersen-n.html" xml:lang="dan"/>
</xsl:variable>
