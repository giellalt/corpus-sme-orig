...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/brygfjeld-s.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'– Ii leat ágga rievdadit'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Christen'"/>
    <xsl:variable name="author1_ln" select="'Brynfjeld'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'1863'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'3583'"/>
