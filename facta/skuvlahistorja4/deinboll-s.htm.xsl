...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/deinboll-s.htm'"/>
<xsl:variable name="title" select="'Ovddidit skuvlladoaimma seavdnjatvuođa riikkas'"/>
<xsl:variable name="author1_fn" select="'Peter Vogelius'"/>
<xsl:variable name="author1_ln" select="'Deinboll'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_born" select="'1783'"/>
<xsl:variable name="author1_nat" select="'DK'"/>
...
<xsl:variable name="wordcount" select="'945'"/>
