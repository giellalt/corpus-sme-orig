...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/leem-s.htm'"/>
<xsl:variable name="title" select="'Duohta hállu gullat Ipmila sániid iežaset gillii'"/>
<xsl:variable name="author1_fn" select="'Knud'"/>
<xsl:variable name="author1_ln" select="'Leem'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_born" select="'1697'"/>
