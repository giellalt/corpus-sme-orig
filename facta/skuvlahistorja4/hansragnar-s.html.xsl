...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/hansragnar-s.htm'"/>
<xsl:variable name="title" select="'Skuvlaveallájeaddji'"/>
...
<xsl:variable name="translator_fn" select="'Hans Ragnar'"/>
<xsl:variable name="translator_ln" select="'Mathisen'"/>
<xsl:variable name="translator_gender" select="'m'"/>
<xsl:variable name="translator_born" select="'1945'"/>
...
<xsl:variable name="wordcount" select="'2587'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hansragnar-n.html" xml:lang="nob"/>
</xsl:variable>
