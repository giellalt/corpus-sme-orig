...
<xsl:variable name="filename" select="'Prográmma 11.10.05 sg.doc'"/>
<xsl:variable name="title" select="'Sámegielaid buolvvaidgaskasaš sirdaseapmi: Ohcamin vugiid bearráigeahččat gielladili'"/>
