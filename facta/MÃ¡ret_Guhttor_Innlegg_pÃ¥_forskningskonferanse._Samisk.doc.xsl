...
<xsl:stylesheet version="1.0" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:variable name="filename" select="'Ma___�ret_Guhttor_Innlegg_pa___�_forskningskonferanse._Samisk.doc'"/>
  <xsl:variable name="title" select="'Sáhkavuorru dutkankonferánssas Árran – julevsámi guovddážis njukčamánu 21. ja 22.b. 2006  Divttasvuonas'"/>
  <xsl:variable name="author1_fn" select="'Máret'"/>
  <xsl:variable name="author1_ln" select="'Guhttor'"/>
