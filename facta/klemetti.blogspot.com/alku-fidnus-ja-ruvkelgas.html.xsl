...
<xsl:variable name="filename" select="'alku-fidnus-ja-ruvkelgas.html'"/>
<xsl:variable name="title" select="'ALKU-fidnus ja ruvkelágas'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/12/alku-fidnus-ja-ruvkelgas.html'"/>
...
<xsl:variable name="wordcount" select="'1059'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="alku-hankkeesta-ja-kaivoslaista.html" xml:lang="fin"/>
</xsl:variable>
