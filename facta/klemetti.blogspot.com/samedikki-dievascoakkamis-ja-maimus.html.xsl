...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'samedikki-dievascoakkamis-ja-maimus.html'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikki dievasčoakkámis ja maŋimus vahkuid dáhpáhusain'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/07/samedikki-dievascoakkamis-ja-maimus.html'"/>
    ...
    <xsl:variable name="wordcount" select="'1054'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajien-kokouksesta-ja-viime.html"/>
