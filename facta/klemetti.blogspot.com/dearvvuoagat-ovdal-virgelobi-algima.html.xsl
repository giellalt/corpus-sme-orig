...
<xsl:variable name="filename" select="'dearvvuoagat-ovdal-virgelobi-algima.html'"/>
<xsl:variable name="title" select="'Dearvvuođagat ovdal virgelobi álgima'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/05/dearvvuoagat-ovdal-virgelobi-algima.html'"/>
...
<xsl:variable name="wordcount" select="'1966'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="terveiset-ennen-virkavapauttani.html" xml:lang="fin"/>
</xsl:variable>
