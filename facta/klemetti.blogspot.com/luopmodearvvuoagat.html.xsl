...
<xsl:variable name="filename" select="'luopmodearvvuoagat.html'"/>
<xsl:variable name="title" select="'Luopmodearvvuođagat'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/07/luopmodearvvuoagat.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="terveiset-lomalta.html" xml:lang="fin"/>
</xsl:variable>
