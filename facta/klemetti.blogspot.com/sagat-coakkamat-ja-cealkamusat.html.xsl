...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'sagat-coakkamat-ja-cealkamusat.html'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ságat, čoakkámat ja cealkámušat'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/10/sagat-coakkamat-ja-cealkamusat.html'"/>
    ...
    <xsl:variable name="wordcount" select="'1049'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kuulemisia-kokouksia-ja-lausuntoja.html"/>
