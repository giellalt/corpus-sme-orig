...
<xsl:variable name="filename" select="'stivrra-oakkn-anris.html'"/>
<xsl:variable name="title" select="'Stivrra čoakkán Anáris'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/02/stivrra-oakkn-anris.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hallituksen-kokous-inarissa.html" xml:lang="fin"/>
</xsl:variable>
