...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'sami-parlamentaralas-rai-stivrra.html'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámi parlamentáralaš ráđi stivrra čoakkámis'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/01/sami-parlamentaralas-rai-stivrra.html'"/>
    ...
    <xsl:variable name="wordcount" select="'715'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisen-parlamentaarisen-neuvoston.html"/>
