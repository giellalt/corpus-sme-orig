...
<xsl:variable name="filename" select="'boazodoalu-ja-luondduealhusaid.html'"/>
<xsl:variable name="title" select="'Boazodoalu ja luondduealáhusaid ruhtadanlága ođasnuhttimis'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/09/boazodoalu-ja-luondduealhusaid.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="porotalouden-ja-luontaiselinkeinojen.html" xml:lang="fin"/>
</xsl:variable>
