...
<xsl:variable name="filename" select="'jurdagat-smi-rdio-ja-kulturiestivrema.html'"/>
<xsl:variable name="title" select="'Jurdagat sámi rádio ja kulturiešstivrema ovddideamis'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/09/jurdagat-smi-rdio-ja-kulturiestivrema.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ajatuksia-saamelaisradion-ja-kulttuuri.html" xml:lang="fin"/>
</xsl:variable>
