...
<xsl:variable name="filename" select="'luoddaplnas-guhtura-ja-riebanjoga.html'"/>
<xsl:variable name="title" select="'Luoddaplánas Guhtura ja Riebanjoga gaskii'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/03/luoddaplnas-guhtura-ja-riebanjoga.html'"/>
...
<xsl:variable name="wordcount" select="'899'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kuttura-repojoen-tiehankkeesta.html" xml:lang="fin"/>
</xsl:variable>
