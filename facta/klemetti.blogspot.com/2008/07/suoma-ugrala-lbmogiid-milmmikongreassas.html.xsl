...
<xsl:variable name="filename" select="'suoma-ugrala-lbmogiid-milmmikongreassas.html'"/>
<xsl:variable name="title" select="'Suoma-ugralaš álbmogiid máilmmikongreassas'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/07/suoma-ugrala-lbmogiid-milmmikongreassas.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="suomalais-ugrilaisen-maailmankongressin.html" xml:lang="fin"/>
</xsl:variable>
