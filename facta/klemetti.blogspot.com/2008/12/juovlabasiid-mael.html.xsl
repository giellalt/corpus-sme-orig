...
<xsl:variable name="filename" select="'juovlabasiid-mael.html'"/>
<xsl:variable name="title" select="'Juovlabasiid maŋŋel'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/12/juovlabasiid-mael.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="joulupyhien-jlkeen.html" xml:lang="fin"/>
</xsl:variable>
