...
<xsl:variable name="filename" select="'mihcamrvahku-dearvvuoagat.html'"/>
<xsl:variable name="title" select="'Mihcamárvahku dearvvuođagat'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/06/mihcamrvahku-dearvvuoagat.html'"/>
...
<xsl:variable name="wordcount" select="'1155'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="juhannusviikon-terveisi.html" xml:lang="fin"/>
</xsl:variable>
