...
<xsl:variable name="filename" select="'oakkmat-cealkmuat-palaverat.html'"/>
<xsl:variable name="title" select="'Čoakkámat, cealkámušat, palaverat'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/06/oakkmat-cealkmuat-palaverat.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kokouksia-lausuntoja-palavereja.html" xml:lang="fin"/>
</xsl:variable>
