...
<xsl:variable name="filename" select="'jurdagat-guovlohlddaanoastusas.html'"/>
<xsl:variable name="title" select="'Jurdagat guovlohálddašanođastusas'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/10/jurdagat-guovlohlddaanoastusas.html'"/>
...
<xsl:variable name="wordcount" select="'1121'"/>
...
<xsl:variable name="para_mixed" select="'ajatuksia-aluehallintouudistuksesta.html'"/>
