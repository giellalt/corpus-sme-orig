...
<xsl:variable name="filename" select="'lappi-bargojoavkku-bargu-meaddel.html'"/>
<xsl:variable name="title" select="'Lappi-bargojoavkku bargu meaddel'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/10/lappi-bargojoavkku-bargu-meaddel.html'"/>
...
<xsl:variable name="wordcount" select="'1091'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lappi-tyryhmn-ty-on-ohi.html" xml:lang="fin"/>
</xsl:variable>
