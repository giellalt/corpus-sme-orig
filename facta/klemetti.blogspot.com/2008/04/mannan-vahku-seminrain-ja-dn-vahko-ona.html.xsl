...
<xsl:variable name="filename" select="'mannan-vahku-seminrain-ja-dn-vahko-ona.html'"/>
<xsl:variable name="title" select="'Mannan vahku seminárain ja dán vahko ON:a algoálbmogiid bissovaš forumas'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/04/mannan-vahku-seminrain-ja-dn-vahko-ona.html'"/>
...
<xsl:variable name="wordcount" select="'930'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="viime-viikon-seminaareista-ja-tmn.html" xml:lang="fin"/>
</xsl:variable>
