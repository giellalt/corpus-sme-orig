...
<xsl:variable name="filename" select="'seminrasgastallamat.html'"/>
<xsl:variable name="title" select="'Semináraságastallamat'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/04/seminrasgastallamat.html'"/>
...
<xsl:variable name="wordcount" select="'1065'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seminaarien-tiimoilta.html" xml:lang="fin"/>
</xsl:variable>
