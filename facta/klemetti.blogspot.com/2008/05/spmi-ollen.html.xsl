...
<xsl:variable name="filename" select="'spmi-ollen.html'"/>
<xsl:variable name="title" select="'Sápmái ollen'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/05/spmi-ollen.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="takaisin-koto-suomessa.html" xml:lang="fin"/>
</xsl:variable>
