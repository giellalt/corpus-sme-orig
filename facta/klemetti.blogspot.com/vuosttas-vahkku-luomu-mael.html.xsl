...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'vuosttas-vahkku-luomu-mael.html'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vuosttaš vahkku luomu maŋŋel'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/08/vuosttas-vahkku-luomu-mael.html'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="lomaltapaluu-terveiset.html"/>
