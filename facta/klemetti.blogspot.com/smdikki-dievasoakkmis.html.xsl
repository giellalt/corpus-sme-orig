...
<xsl:variable name="filename" select="'smdikki-dievasoakkmis.html'"/>
<xsl:variable name="title" select="'Sámádikki dievasčoakkámis.'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/10/smdikki-dievasoakkmis.html'"/>
...
<xsl:variable name="wordcount" select="'973'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="saamelaiskrjien-yleiskokouksesta.html" xml:lang="fin"/>
</xsl:variable>
