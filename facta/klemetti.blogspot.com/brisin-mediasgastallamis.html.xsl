...
<xsl:variable name="filename" select="'brisin-mediasgastallamis.html'"/>
<xsl:variable name="title" select="'Bárisin mediaságastallamis'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/11/brisin-mediasgastallamis.html'"/>
...
<xsl:variable name="wordcount" select="'1463'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mediakeskustelun-tiimoilta.html" xml:lang="fin"/>
</xsl:variable>
