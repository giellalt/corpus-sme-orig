...
<xsl:variable name="filename" select="'jagi-2008-dhphusat.html'"/>
<xsl:variable name="title" select="'Jagi 2008 dáhpáhusat'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/01/jagi-2008-dhphusat.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vuoden-2008-tapahtumia.html" xml:lang="fin"/>
</xsl:variable>
