...
<xsl:variable name="filename" select="'beassaziid-mael.html'"/>
<xsl:variable name="title" select="'Beassážiid maŋŋel'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/04/beassaziid-mael.html'"/>
...
<xsl:variable name="wordcount" select="'835'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="paasiaisen-jalkeen.html" xml:lang="fin"/>
</xsl:variable>
