...
<xsl:variable name="filename" select="'vuovdesertifiseremis.html'"/>
<xsl:variable name="title" select="'Vuovdesertifiseremis'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/03/vuovdesertifiseremis.html'"/>
...
<xsl:variable name="wordcount" select="'1314'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="metsasertifioinnista.html" xml:lang="fin"/>
</xsl:variable>
