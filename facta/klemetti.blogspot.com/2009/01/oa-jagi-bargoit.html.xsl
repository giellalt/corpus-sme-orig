...
<xsl:variable name="filename" select="'oa-jagi-bargoit.html'"/>
<xsl:variable name="title" select="'Ođđa jagi bargoáššit'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/01/oa-jagi-bargoit.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="uuden-vuoden-tyasioita.html" xml:lang="fin"/>
</xsl:variable>
