...
<xsl:variable name="filename" select="'manaidkulturguovddazis.html'"/>
<xsl:variable name="title" select="'Mánáidkulturguovddážis'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/01/manaidkulturguovddazis.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lastenkulttuurikeskushankkeesta.html" xml:lang="fin"/>
</xsl:variable>
