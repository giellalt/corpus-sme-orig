...
<xsl:variable name="filename" select="'sami-albmogis-avvudemiid-vahkku.html'"/>
<xsl:variable name="title" select="'Sámi álbmogis ávvudemiid vahkku'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/09/sami-albmogis-avvudemiid-vahkku.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="saamen-kansalla-juhlallisuuksien-viikko.html" xml:lang="fin"/>
</xsl:variable>
