...
<xsl:variable name="filename" select="'sapmelaccaid-ovttasbarggus.html'"/>
<xsl:variable name="title" select="'Sápmelaččaid ovttasbarggus'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2009/11/sapmelaccaid-ovttasbarggus.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="saamelaisten-yhteistyosta.html" xml:lang="fin"/>
</xsl:variable>
