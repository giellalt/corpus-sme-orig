...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'hyphenation_test.txt'"/>
  ...
  <xsl:variable name="sub_name" select="'Thomas Omma'"/>
  <xsl:variable name="sub_email" select="'Thomas.omma@samediggi.no'"/>
