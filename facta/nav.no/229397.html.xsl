...
<xsl:variable name="filename" select="'http://www.nav.no/Samisk/Familie/Familie/229397.cms'"/>
...
<xsl:variable name="mlang_nno" select="'805322311.html'"/>
<xsl:variable name="mlang_nob" select="'Foreldrepenger+ved+adopsjon.html'"/>
