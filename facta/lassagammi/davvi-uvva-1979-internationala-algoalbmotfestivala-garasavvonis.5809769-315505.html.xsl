...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.lassagammi.no/davvi-uvva-1979-internationala-algoalbmotfestivala-garasavvonis.5809769-315505.html'"/>
    ...
    <xsl:variable name="author1_ln" select="'Angell'"/>
    <!-- m, f or unknown -->
