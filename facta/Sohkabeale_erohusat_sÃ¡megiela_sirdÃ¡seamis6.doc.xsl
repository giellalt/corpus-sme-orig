...
<xsl:variable name="filename" select="'Sohkabeale erohusat sámegiela sirdáseamis6.doc'"/>
<xsl:variable name="title" select="'Sohkabeale erohusat sámegiela sirdáseamis'"/>
