...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/ihle-s.htm'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Knud Martin'"/>
    <xsl:variable name="author1_ln" select="'Ihle'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'1842'"/>
    <!--
