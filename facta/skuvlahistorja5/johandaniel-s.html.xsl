...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/johandaniel-s.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sápmelaččat ja Norgga oahppoplánat'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="johandaniel-n.html" xml:lang="nob"/>
</xsl:variable>
