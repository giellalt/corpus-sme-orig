...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/algu5-s.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Álggahus: Soahti, ođđasishuksen ja oahppoplánariiddut'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="algu5-n.html" xml:lang="nob"/>
</xsl:variable>
