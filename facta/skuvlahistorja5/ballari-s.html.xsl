...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/ballari-s.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Oahppoplánariidu Deanus'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ballari-n.html" xml:lang="nob"/>
</xsl:variable>
