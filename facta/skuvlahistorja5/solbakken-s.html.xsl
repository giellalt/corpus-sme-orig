...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/solbakken-s.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'– Mo bat sáhttá rievdadit skuvlla?'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="solbakken-n.html" xml:lang="nno"/>
</xsl:variable>
