...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/may-s.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Mielde váikkuheamen sámegiela boahtteáiggi?'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="may-n.html" xml:lang="nob"/>
</xsl:variable>
