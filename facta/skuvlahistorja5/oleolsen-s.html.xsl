...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/oleolsen-s.htm'"/>
    ...
    <xsl:variable name="translator_fn" select="'Ánná Káisá'"/>
    <xsl:variable name="translator_ln" select="'Partapuoli'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="oleolsen-n.html"/>
