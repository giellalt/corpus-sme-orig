...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/tie-s.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'«Jávohaga duhtat» – Skuvladilli eváhkos ja ođđasishuksenáigge'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tie-n.html" xml:lang="nno"/>
</xsl:variable>
