...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/bearbeide-s.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'« – Váikkuhit ceaggás álbmoga» – Skuvladilli Finnmárkkus soađi áigge'"/>
    <!--
    ...
    <xsl:variable name="translator_fn" select="'Rávdná Turi'"/>
    <xsl:variable name="translator_ln" select="'Henriksen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="bearbeide-n.html"/>
