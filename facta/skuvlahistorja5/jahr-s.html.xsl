...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/jahr-s.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sámi oahppoplánat departemeantta bealis'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jahr-n.html" xml:lang="nob"/>
</xsl:variable>
