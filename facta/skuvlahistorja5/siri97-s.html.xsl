...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/siri97-s.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Riiddos čakča – 1997’ oahppoplánavuostálastimat'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="siri97-n.html" xml:lang="nob"/>
</xsl:variable>
