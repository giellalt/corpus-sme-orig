...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/reisavgs-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ráissa joatkkaskuvlla sámegieloahpahus'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reisavgs-n.html" xml:lang="nob"/>
</xsl:variable>
