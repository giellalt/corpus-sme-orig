...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index2.php?option=com_content&amp;task=view&amp;id=102&amp;lang=davvi.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index2.php_option=com_content_task=view_id=102_lang=finnish.html" xml:lang="fin"/>
</xsl:variable>
