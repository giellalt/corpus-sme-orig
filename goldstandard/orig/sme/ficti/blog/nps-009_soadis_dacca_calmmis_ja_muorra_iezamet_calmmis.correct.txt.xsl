...
<xsl:variable name="filename" select="'http://johanailo.blogspot.com/2009/04/soais-dacca-calmmis-ja-muorra-iezamet.html'"/>
...
<xsl:variable name="note" select="'Innsamlingsdato: 6.7.2010'"/>
