...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://reindeerherding.org/blogga/eallin-boazodoallonuorat-buktet-ovdan-garra-diedu-arktalas-olgoriikaministeriidda-arktalas-radi/?lang=sa'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Philip'"/>
    <xsl:variable name="author1_ln" select="'Burgess'"/>
    <!-- m, f or unknown -->
