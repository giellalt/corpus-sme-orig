...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://rauna.net/2007/08/30/duppalstandarda-ja-olju-norga-ja-ecuador-dahje-gii-barga-maid-duostut-dalkkadatrievdama-hastalusaid/'"/>
    ...
    <xsl:variable name="author1_ln" select="'Kuokkanen'"/>
    <!-- m, f or unknown -->
