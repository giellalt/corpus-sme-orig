...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://giellamaret.wordpress.com/2015/12/31/mun-in-gille-mahte-sahte-dasa-lassin-balan/'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Máret Láilá'"/>
