...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.arjeplognytt.se/2018/06/10/eatnasat-samenuorain-asset-sameguovllu-olggobealde-ja-dat-hehtte-njalmmalas-arbevieruid-sirdasuvvama/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Eatnašat sámenuorain ásset Sámeguovllu olggobealde ja dat hehtte njálmmálaš árbevieruid sirdašuvvama'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Marianne'"/>
    <xsl:variable name="author1_ln" select="'Hofman'"/>
    <!-- m, f or unknown -->
