...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.arjeplognytt.se/2018/08/07/doaivvu-sahtta-gavdnat-seavdnjadamos-sajisge-anarlas-daiddar-govve-sami-boahttevuoda/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'“Doaivvu sáhttá gávdnat seavdnjadamos sajisge” – Anárlaš dáiddár govve Sámi boahttevuođa'"/>
    <!--
