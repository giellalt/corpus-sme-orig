...
<xsl:variable name="note" select="'Some of the Sami characters are broken. The file is not included in the conversion.'"/>
...
<!-- Include xsl-file that generates an empty xml-document -->
