...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'real-ImprtDu1-DerPassPrsSg3.correct.txt'"/>
    ...
    <xsl:variable name="publisher" select="'Divvun'"/>
    ...
    <xsl:variable name="genre" select="'grammar-realword'"/>
    ...
    -->
    <xsl:variable name="conversion_status" select="'no-correct-gs'"/>
